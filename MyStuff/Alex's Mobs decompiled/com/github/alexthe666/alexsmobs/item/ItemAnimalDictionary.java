...
public class ItemAnimalDictionary extends Item {
   ...
   public InteractionResult m_6880_(ItemStack stack, Player playerIn, LivingEntity target, InteractionHand hand) {
      ...
      if (playerIn instanceof ServerPlayer serverplayerentity) {
         ...
         serverplayerentity.m_36246_(Stats.f_12982_.m_12902_(this));
      }
   ...
   public void m_7373_(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
      tooltip.add(Component.m_237115_("item.alexsmobs.animal_dictionary.desc").m_130940_(ChatFormatting.GRAY));
   }
}
