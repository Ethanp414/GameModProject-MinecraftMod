   ...
   public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (this.type == 0) {
         ...
         if (entity instanceof EntityCentipedeBody) {
            float offset = (float)((((EntityCentipedeBody)entity).getBodyIndex() + 1) * Math.PI * 0.5);
            double walkOffset = offset * Math.PI * 0.5;
            ...
            this.body.rotationPointY = this.body.rotationPointY + (float)(Math.sin(ageInTicks * 0.1 - walkOffset) * 0.01);
         }
         ...
         this.tail.rotationPointY = this.tail.rotationPointY
            + (float)(Math.sin(limbSwing * walkSpeed - walkOffset) * limbSwingAmount * walkDegree - limbSwingAmount * walkDegree);
         this.tail.rotationPointY = this.tail.rotationPointY + (float)(Math.sin(ageInTicks * 0.1 - walkOffset) * 0.01);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return switch (this.type) {
         case 0 -> ImmutableList.of(
            this.root, this.head, this.head2, this.fangs, this.antenna_left, this.antenna_left_r1, this.antenna_right, this.antenna_right_r1
         );
         ...
         case 2 -> ImmutableList.of(
            ...
            this.leftTail,
            this.leftTailEnd,
            new AdvancedModelBox[]{this.rightTail, this.rightTailEnd}
         );
         default -> ImmutableList.of(this.root);
      };
   }
