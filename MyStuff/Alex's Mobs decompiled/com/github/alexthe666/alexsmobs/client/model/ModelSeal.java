...
public class ModelSeal extends AdvancedEntityModel<EntitySeal> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root, this.body, this.tail, this.leftLeg, this.rightLeg, this.head, this.leftArm, this.rightArm, this.leftWhisker, this.rightWhisker
      );
   }
   ...
   public void setupAnim(EntitySeal entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.head.rotationPointZ = this.head.rotationPointZ + (float)(Math.sin(ageInTicks * 0.7F) * 0.5 * bobbingProgress);
      ...
      if (!entity.m_20069_()) {
         ...
         this.body.rotationPointY = this.body.rotationPointY
            + 1.4F * Math.min(0.0F, (float)(Math.sin(limbSwing * walkSpeed) * limbSwingAmount * f1 * 9.0 - limbSwingAmount * f1 * 9.0));
         this.body.rotationPointZ = this.body.rotationPointZ
            + (float)(Math.sin(limbSwing * walkSpeed - 1.5F) * limbSwingAmount * f1 * 9.0 - limbSwingAmount * f1 * 9.0);
         this.head.rotationPointZ = this.head.rotationPointZ
            + (float)(Math.sin(limbSwing * walkSpeed - 2.0F) * limbSwingAmount * f1 * 2.0 - limbSwingAmount * f1 * 2.0F);
         ...
         this.body.rotationPointY = this.body.rotationPointY
            + (float)(Math.sin(limbSwing * swimSpeed) * limbSwingAmount * swimDegree * 9.0 - limbSwingAmount * swimDegree * 9.0);
