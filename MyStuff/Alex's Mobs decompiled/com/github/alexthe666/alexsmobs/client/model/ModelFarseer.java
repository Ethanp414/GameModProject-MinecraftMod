...
public class ModelFarseer extends AdvancedEntityModel<EntityFarseer> {
   ...
   public void setupAnim(EntityFarseer entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float partialTick = ageInTicks - entity.f_19797_;
      ...
      float clasp1Progress = Math.max(
         strike1Progress, (entity.prevClaspProgress[0] + (entity.claspProgress[0] - entity.prevClaspProgress[0]) * partialTick) * invPortalDegree
      );
      float clasp2Progress = Math.max(
         strike2Progress, (entity.prevClaspProgress[1] + (entity.claspProgress[1] - entity.prevClaspProgress[1]) * partialTick) * invPortalDegree
      );
      float clasp3Progress = Math.max(
         strike3Progress, (entity.prevClaspProgress[2] + (entity.claspProgress[2] - entity.prevClaspProgress[2]) * partialTick) * invPortalDegree
      );
      float clasp4Progress = Math.max(
         strike4Progress, (entity.prevClaspProgress[3] + (entity.claspProgress[3] - entity.prevClaspProgress[3]) * partialTick) * invPortalDegree
      );
      ...
      Vec3 angryShake = entity.angryShakeVec.m_82490_(angryProgress * 0.1F);
      ...
      this.leftArm.rotationPointX = (float)(this.leftArm.rotationPointX + (topArmOffset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 1.3F)) * invPortalDegree);
      this.leftArm.rotationPointY = (float)(this.leftArm.rotationPointY + (topArmOffset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 1.6F)) * invPortalDegree);
      this.leftArm.rotationPointZ = (float)(this.leftArm.rotationPointZ + (topArmOffset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 1.9F)) * invPortalDegree);
      this.leftArm.rotateAngleY += armYaw;
      this.leftArm2.rotationPointX = (float)(
         this.leftArm2.rotationPointX + (bottomArmOffset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 2.3F)) * invPortalDegree
      );
      this.leftArm2.rotationPointY = (float)(
         this.leftArm2.rotationPointY + (bottomArmOffset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 2.6F)) * invPortalDegree
      );
      this.leftArm2.rotationPointZ = (float)(
         this.leftArm2.rotationPointZ + (bottomArmOffset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 2.9F)) * invPortalDegree
      );
      this.leftArm2.rotateAngleY += armYaw;
      this.rightArm.rotationPointX = (float)(this.rightArm.rotationPointX + (topArmOffset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 3.3F)) * invPortalDegree);
      this.rightArm.rotationPointY = (float)(this.rightArm.rotationPointY + (topArmOffset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 3.6F)) * invPortalDegree);
      this.rightArm.rotationPointZ = (float)(this.rightArm.rotationPointZ + (topArmOffset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 3.9F)) * invPortalDegree);
      this.rightArm.rotateAngleY += armYaw;
      this.rightArm2.rotationPointX = (float)(
         this.rightArm2.rotationPointX + (bottomArmOffset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 4.3F)) * invPortalDegree
      );
      this.rightArm2.rotationPointY = (float)(
         this.rightArm2.rotationPointY + (bottomArmOffset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 4.6F)) * invPortalDegree
      );
      this.rightArm2.rotationPointZ = (float)(
         this.rightArm2.rotationPointZ + (bottomArmOffset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 4.9F)) * invPortalDegree
      );
      this.rightArm2.rotateAngleY += armYaw;
      this.bodyCube1.rotationPointX = (float)(
         this.bodyCube1.rotationPointX + (body1Offset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 7.3F)) * invPortalDegree
      );
      this.bodyCube1.rotationPointY = (float)(
         this.bodyCube1.rotationPointY + (body1Offset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 7.6F)) * invPortalDegree
      );
      this.bodyCube1.rotationPointZ = (float)(
         this.bodyCube1.rotationPointZ + (body1Offset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 7.9F)) * invPortalDegree
      );
      this.bodyCube2.rotationPointX = (float)(
         this.bodyCube2.rotationPointX + (body2Offset.f_82479_ + Math.sin(ageInTicks * idleSpeed + 5.3F)) * invPortalDegree
      );
      this.bodyCube2.rotationPointY = (float)(
         this.bodyCube2.rotationPointY + (body2Offset.f_82480_ + Math.sin(ageInTicks * idleSpeed + 5.6F)) * invPortalDegree
      );
      this.bodyCube2.rotationPointZ = (float)(
         this.bodyCube2.rotationPointZ + (body2Offset.f_82481_ + Math.cos(ageInTicks * idleSpeed + 5.9F)) * invPortalDegree
      );
      this.head.rotationPointX = (float)(this.head.rotationPointX + angryShake.f_82479_);
      this.head.rotationPointY = (float)(this.head.rotationPointY + angryShake.f_82480_);
      this.head.rotationPointZ = (float)(this.head.rotationPointZ + angryShake.f_82481_);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         new AdvancedModelBox[]{
            this.leftUpperRFinger,
            this.leftLowerRFinger,
            this.leftLowerLFinger,
            this.leftUpperLFinger,
            this.leftArm2,
            this.leftElbow2,
            this.leftHand2,
            this.leftUpperRFinger2,
            this.leftLowerRFinger2,
            this.leftLowerLFinger2,
            this.leftUpperLFinger2,
            this.rightArm,
            this.rightElbow,
            this.rightHand,
            this.rightUpperRFinger,
            this.rightLowerRFinger2,
            this.rightLowerLFinger,
            this.rightUpperLFinger,
            this.rightArm2,
            this.rightElbow2,
            this.rightHand2,
            this.rightUpperRFinger2,
            this.rightLowerRFinger3,
            this.rightLowerLFinger2,
            this.rightUpperLFinger2
         }
      );
   }
