...
public class ModelSeaBear extends AdvancedEntityModel<EntitySeaBear> {
   ...
   public void setupAnim(EntitySeaBear entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float landProgress = entity.prevOnLandProgress + (entity.onLandProgress - entity.prevOnLandProgress) * (ageInTicks - entity.f_19797_);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root, this.body, this.head, this.snout, this.right_arm, this.right_leg, this.right_ear, this.left_arm, this.left_leg, this.left_ear, this.tail
      );
   }
