...
public class ModelEndPirateDoor extends AdvancedEntityModel<Entity> {
   ...
   public void renderDoor(TileEntityEndPirateDoor door, float partialTick, boolean left) {
      ...
      this.doorRightHinge.rotateAngleY = (float)(this.doorRightHinge.rotateAngleY + (openAmount * Math.PI * 0.5 + wiggle));
      this.doorLeftHinge.rotateAngleY = (float)(this.doorLeftHinge.rotateAngleY - (openAmount * Math.PI * 0.5 + wiggle));
   }
}
