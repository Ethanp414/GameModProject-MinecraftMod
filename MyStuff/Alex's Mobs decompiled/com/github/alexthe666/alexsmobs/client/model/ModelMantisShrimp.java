...
public class ModelMantisShrimp extends AdvancedEntityModel<EntityMantisShrimp> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.whisker_right,
         this.flapper_left,
         new AdvancedModelBox[]{this.flapper_right, this.tail, this.legs_back, this.legs_front}
      );
   }
   ...
   public void setupAnim(EntityMantisShrimp entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float swimProgress = Math.min(limbSwingAmount, 0.25F)
         * 4.0F
         * (entity.prevInWaterProgress + (entity.inWaterProgress - entity.prevInWaterProgress) * partialTick);
