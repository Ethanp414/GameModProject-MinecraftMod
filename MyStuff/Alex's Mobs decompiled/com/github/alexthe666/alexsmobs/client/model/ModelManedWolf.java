...
public class ModelManedWolf extends AdvancedEntityModel<EntityManedWolf> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.left_leg,
         this.right_leg,
         new AdvancedModelBox[]{this.right_ear_pivot, this.left_ear_pivot}
      );
   }
   ...
   public void setupAnim(EntityManedWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float f2 = 0.2F * danceProgress * 6.0F * Mth.m_14089_(ageInTicks * 0.5F + 0.0F) * 0.3F * (danceProgress * 0.2F) + 0.0F * (danceProgress * 0.2F);
      ...
      this.right_leg.rotateAngleX = (float)(this.right_leg.rotateAngleX - Math.toRadians(f1 * 5.0F));
      this.left_leg.rotateAngleX = (float)(this.left_leg.rotateAngleX - Math.toRadians(f1 * 5.0F));
