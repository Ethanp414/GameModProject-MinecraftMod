...
public class ModelVoidWormBody extends AdvancedEntityModel<EntityVoidWormPart> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root,
         this.body,
         this.frillsbottom_left,
         this.frillsbottom_left_r1,
         this.frillsbottom_right,
         this.frillsbottom_right_r1,
         this.frillstop_left,
         this.frillstop_left_r1,
         this.frillstop_right,
         this.frillstop_right_r1
      );
   }
