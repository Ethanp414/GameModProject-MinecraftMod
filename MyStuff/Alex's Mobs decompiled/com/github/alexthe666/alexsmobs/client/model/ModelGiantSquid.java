...
public class ModelGiantSquid extends AdvancedEntityModel<EntityGiantSquid> {
   ...
   public void setupAnim(EntityGiantSquid entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (look != null) {
         ...
         float dist = Mth.m_14036_((float)vector3d.m_82546_(vector3d1).m_82553_() * 0.2F, 0.4F, 1.0F);
         ...
         double eyeXz = Mth.m_14116_((float)Math.abs(d1)) * -2.0F * (float)Math.signum(d1);
         this.left_pupil.setScale(eyeScale, eyeScale, eyeScale);
         this.left_pupil.rotationPointZ = this.left_pupil.rotationPointZ - (float)Mth.m_14008_(-eyeXz, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
         this.left_pupil.rotationPointY = this.left_pupil.rotationPointY + (float)Mth.m_14008_(-d0, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
         this.right_pupil.setScale(eyeScale, eyeScale, eyeScale);
         this.right_pupil.rotationPointZ = this.right_pupil.rotationPointZ + (float)Mth.m_14008_(eyeXz, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
         this.right_pupil.rotationPointY = this.right_pupil.rotationPointY + (float)Mth.m_14008_(-d0, -maxEyeDist / eyeScale, maxEyeDist / eyeScale);
      }
   }

   private float getArmRot(EntityGiantSquid entity, int offset, float partialTick, boolean pitch) {
      float rotWrap = Mth.m_14177_(entity.getRingBuffer(offset, partialTick, pitch) - entity.getRingBuffer(0, partialTick, pitch));
      return Mth.m_14036_(rotWrap, -50.0F, 50.0F) * 0.4F * (float) (Math.PI / 180.0);
   }
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.head,
         this.beak,
         this.right_pupil_pivot,
         this.left_pupil_pivot,
         this.left_FrontTentacle,
         this.left_FrontTentacleEnd,
         this.left_FrontMidTentacle,
         this.left_FrontMidTentacleEnd,
         this.right_FrontMidTentacle,
         this.right_FrontMidTentacleEnd,
         this.left_BackMidTentacle,
         new AdvancedModelBox[]{
            this.left_BackMidTentacleEnd,
            this.right_BackMidTentacle,
            this.right_BackMidTentacleEnd,
            this.left_BackTentacle,
            this.left_BackTentacleEnd,
            this.right_BackTentacle,
            this.right_BackTentacleEnd,
            this.right_FrontTentacle,
            this.right_tentacleEnd,
            this.left_arm,
            this.left_arm2,
            this.left_arm3,
            this.left_arm4,
