...
public class ModelFrilledShark extends AdvancedEntityModel<EntityFrilledShark> {
   ...
   public void setupAnim(EntityFrilledShark entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float landProgress = entityIn.prevOnLandProgress + (entityIn.onLandProgress - entityIn.prevOnLandProgress) * (ageInTicks - entityIn.f_19797_);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.tail2,
         this.jaw,
         this.pectoralfin_left,
         this.pectoralfin_right,
         this.pelvicfin_left,
         this.pelvicfin_right
      );
   }
