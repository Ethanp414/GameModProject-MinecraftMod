...
public class ModelCachalotWhale extends AdvancedEntityModel<EntityCachalotWhale> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root, this.head, this.body, this.tail1, this.tail2, this.tail3, this.top_fin, this.jaw, this.teeth, this.arm_left, this.arm_right
      );
   }
   ...
   public void setupAnim(EntityCachalotWhale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float f = Mth.m_14036_((float)entity.getMovementOffsets(7, partialTicks)[0] - renderYaw, -50.0F, 50.0F);
      this.tail1.rotateAngleY = this.tail1.rotateAngleY
         + Mth.m_14036_((float)entity.getMovementOffsets(15, partialTicks)[0] - renderYaw, -50.0F, 50.0F) * (float) (Math.PI / 180.0);
      this.tail2.rotateAngleY = this.tail2.rotateAngleY
         + Mth.m_14036_((float)entity.getMovementOffsets(17, partialTicks)[0] - renderYaw, -50.0F, 50.0F) * (float) (Math.PI / 180.0);
      ...
      this.head.rotateAngleY = (float)(this.head.rotateAngleY + Math.sin((entity.grabTime + partialTicks) * 0.3F) * 0.1F * grabProgress);
