...
public class ModelTerrapin extends AdvancedEntityModel<EntityTerrapin> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.right_foot,
         this.right_leg,
         new AdvancedModelBox[]{this.right_hand}
      );
   }
   ...
   public void setupAnim(EntityTerrapin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entity.isSpinning()) {
         ...
         float rollDeg = (float)Mth.m_14175_(Math.toDegrees(entity.clientSpin));
         ...
         if (swimProgress <= 0.0F) {
            ...
            this.left_arm.rotationPointY = this.left_arm.rotationPointY
               + 1.5F * (float)(Math.sin(limbSwing * walkSpeed - 2.5) * limbSwingAmount * walkDegree - limbSwingAmount * walkDegree);
