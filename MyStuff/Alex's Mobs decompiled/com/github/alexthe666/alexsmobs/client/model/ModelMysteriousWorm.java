...
public class ModelMysteriousWorm extends AdvancedEntityModel<Entity> {
   ...
   public void animateStack(ItemStack itemStackIn) {
      ...
      float tick = Minecraft.m_91087_().f_91074_ == null ? 0.0F : partialTick + Minecraft.m_91087_().f_91074_.f_19797_;
      ...
      this.chainWave(tail, 0.7F, 0.2F, -3.0, tick, Mth.m_14036_((float)(1.0 + Math.sin(tick * 0.04)), 0.0F, 0.5F) * 2.0F);
   }
}
