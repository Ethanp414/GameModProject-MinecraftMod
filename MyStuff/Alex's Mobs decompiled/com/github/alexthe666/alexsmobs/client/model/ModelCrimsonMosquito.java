...
public class ModelCrimsonMosquito extends AdvancedEntityModel<EntityCrimsonMosquito> {
   ...
   public void setupAnim(EntityCrimsonMosquito entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entityIn.m_20159_()) {
         ...
         this.mouth.setScale(1.0F, (float)(0.85F + Math.sin(ageInTicks) * 0.15F), 1.0F);
      } else {
      ...
      float bloatScale = 1.0F + entityIn.getBloodLevel() * 0.1F;
      this.tail.rotateAngleX = this.tail.rotateAngleX - entityIn.getBloodLevel() * 0.05F;
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.legR2,
         this.legR3,
         new AdvancedModelBox[]{this.tail, this.head, this.antennaL, this.antennaR, this.mouth}
      );
   }
