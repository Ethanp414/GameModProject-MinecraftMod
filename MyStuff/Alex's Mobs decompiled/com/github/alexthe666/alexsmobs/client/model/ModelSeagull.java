...
public class ModelSeagull extends AdvancedEntityModel<EntitySeagull> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.left_wing,
         this.left_wingtip,
         this.left_wingtip_r1,
         this.right_wing,
         this.right_wingtip,
         this.right_wingtip_r1,
         this.right_leg,
         this.left_leg,
         this.head,
         new AdvancedModelBox[]{this.beak}
      );
   }
   ...
   public void setupAnim(EntitySeagull entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.head.rotateAngleY = (float)(this.head.rotateAngleY + Math.toRadians(entity.getFlightLookYaw()) * flyProgress * 0.2F);
