...
public class ModelMurmurHead extends AdvancedEntityModel<EntityMurmurHead> {
   ...
   public void setupAnim(EntityMurmurHead entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (ageInTicks > 5.0F) {
         ...
         double d0 = Mth.m_14139_(partialTicks, entity.prevXHair, entity.xHair) - Mth.m_14139_(partialTicks, entity.f_19854_, entity.m_20185_());
         double d1 = Mth.m_14139_(partialTicks, entity.prevYHair, entity.yHair) - Mth.m_14139_(partialTicks, entity.f_19855_, entity.m_20186_());
         double d2 = Mth.m_14139_(partialTicks, entity.prevZHair, entity.zHair) - Mth.m_14139_(partialTicks, entity.f_19856_, entity.m_20189_());
         ...
         f1 = Mth.m_14036_(f1, -6.0F, 32.0F) * hairAnimateScale;
         float f2 = (float)(d0 * d3 + d2 * d4) * 100.0F;
         f2 = Mth.m_14036_(f2, 0.0F, 150.0F) * hairAnimateScale;
         float f3 = (float)(d0 * d4 - d2 * d3) * 100.0F;
         f3 = Mth.m_14036_(f3, -20.0F, 20.0F) * hairAnimateScale;
         if (f2 < 0.0F) {
            f2 = 0.0F;
         }

         f1 += Mth.m_14031_(Mth.m_14179_(partialTicks, entity.f_19867_, entity.f_19787_) * 6.0F) * 32.0F * 1.0F;
         float hairX = Maths.rad(6.0F + f2 / 2.0F + f1 - 180.0F);
