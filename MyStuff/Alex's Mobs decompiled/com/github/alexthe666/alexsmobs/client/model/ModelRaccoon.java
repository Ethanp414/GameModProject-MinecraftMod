...
public class ModelRaccoon extends AdvancedEntityModel<EntityRaccoon> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root, this.body, this.leg_left, this.leg_right, this.arm_left, this.arm_right, this.tail, this.head, this.ear_left, this.ear_right, this.snout
      );
   }
   ...
   public void setupAnim(EntityRaccoon entityRaccoon, float limbSwing, float limbSwingAmount, float ageInTicks, float v3, float v4) {
      ...
      if (washProgress > 0.0F) {
         this.arm_left.rotationPointY = this.arm_left.rotationPointY - (float)(-Math.abs(Math.sin(ageInTicks * 0.5F) * washProgress * 0.2 * 1.0));
         this.arm_left.rotationPointZ = this.arm_left.rotationPointZ - (float)(-Math.abs(Math.sin(ageInTicks * 0.25F) * washProgress * 0.2 * 3.0));
         this.arm_right.rotationPointY = this.arm_right.rotationPointY - (float)(-Math.abs(Math.sin(ageInTicks * 0.5F) * washProgress * 0.2 * 1.0));
         this.arm_right.rotationPointZ = this.arm_right.rotationPointZ - (float)(-Math.abs(Math.cos(ageInTicks * 0.25F) * washProgress * 0.2 * 3.0));
         ...
         float bodyFlap = (float)(Math.sin(ageInTicks * 0.5F) * washProgress * 0.2 * 0.15F);
   ...
   public Vec3 getRidingPosition(Vec3 offsetIn) {
      ...
      armOffsetVec.mul(armStack.m_85850_().m_252922_());
