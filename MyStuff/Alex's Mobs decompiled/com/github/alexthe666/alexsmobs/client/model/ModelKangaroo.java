...
public class ModelKangaroo extends AdvancedEntityModel<EntityKangaroo> {
   ...
   public void setupAnim(EntityKangaroo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float jumpRotation = Mth.m_14031_(entity.getJumpCompletion(partialTick) * (float) Math.PI);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.leg_right,
         this.knee_left,
         new AdvancedModelBox[]{this.knee_right, this.foot_left, this.foot_right, this.pouch, this.tail1, this.tail2, this.chest}
      );
   }
