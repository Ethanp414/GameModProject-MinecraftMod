...
public class ModelPotoo extends AdvancedEntityModel<EntityPotoo> {
   ...
   public void setupAnim(EntityPotoo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float eyeScale = Mth.m_14036_((15.0F - entity.getEyeScale(10, partialTick)) / 15.0F, 0.0F, 1.0F);
      ...
      this.left_foot.rotationPointZ = this.left_foot.rotationPointZ
         + 2.0F * (float)(Math.sin(limbSwing * walkSpeed - 2.5) * walkSwingAmount * walkDegree - walkSwingAmount * walkDegree);
      this.right_foot.rotationPointZ = this.right_foot.rotationPointZ
         + 2.0F * (float)(Math.sin(-(limbSwing * walkSpeed) + 2.5) * walkSwingAmount * walkDegree - walkSwingAmount * walkDegree);
      this.left_foot.rotationPointY = this.left_foot.rotationPointY
         + (float)(Math.sin(limbSwing * walkSpeed - 2.5) * walkSwingAmount * walkDegree - walkSwingAmount * walkDegree);
