...
public class ModelMimicOctopus extends AdvancedEntityModel<EntityMimicOctopus> {
   ...
   public void setupAnim(EntityMimicOctopus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float partialTicks = ageInTicks - entity.f_19797_;
      ...
      this.animateForMimicWater(
         entity.getMimicState(), entity, limbSwing, limbSwingAmount, ageInTicks, notSitProgress * transProgress * (1.0F - groundProgressNorm)
      );
   ...
   public void animateForMimicWater(
      EntityMimicOctopus.MimicState state, EntityMimicOctopus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float swimProgress
   ) {
      ...
      this.progressPosition(
         this.leftFrontArm2, swimProgress, this.leftFrontArm1.rotationPointX, this.leftFrontArm1.rotationPointY, this.leftFrontArm1.rotationPointZ, 5.0F
      );
      this.progressPosition(
         this.leftBackArm1, swimProgress, this.leftFrontArm1.rotationPointX, this.leftFrontArm1.rotationPointY, this.leftFrontArm1.rotationPointZ, 5.0F
      );
      this.progressPosition(
         this.leftBackArm2, swimProgress, this.leftFrontArm1.rotationPointX, this.leftFrontArm1.rotationPointY, this.leftFrontArm1.rotationPointZ, 5.0F
      );
      ...
      this.progressPosition(
         this.rightFrontArm2, swimProgress, this.rightFrontArm1.rotationPointX, this.rightFrontArm1.rotationPointY, this.rightFrontArm1.rotationPointZ, 5.0F
      );
      this.progressPosition(
         this.rightBackArm1, swimProgress, this.rightFrontArm1.rotationPointX, this.rightFrontArm1.rotationPointY, this.rightFrontArm1.rotationPointZ, 5.0F
      );
      this.progressPosition(
         this.rightBackArm2, swimProgress, this.rightFrontArm1.rotationPointX, this.rightFrontArm1.rotationPointY, this.rightFrontArm1.rotationPointZ, 5.0F
      );
      if (state == EntityMimicOctopus.MimicState.GUARDIAN) {
         ...
         if (swimProgress > 0.0F) {
            if (state == EntityMimicOctopus.MimicState.PUFFERFISH) {
               float f2 = 1.4F + 0.15F * Mth.m_14031_(speed * limbSwing - 2.0F) * swimProgress * 0.2F;
               this.progressPositionPrev(this.mantle, swimProgress, 0.0F, 1.0F, 0.0F, 5.0F);
               this.mantle.setScale(f2, f2, f2);
            } else {
               float scale = 1.1F + 0.3F * f * Mth.m_14031_(speed * limbSwing - 2.0F);
               this.mantle
                  .setScale(
                     (scale - 1.0F) * swimProgress * 0.05F + 1.0F, (scale - 1.0F) * swimProgress * 0.05F + 1.0F, (scale - 1.0F) * swimProgress * 0.2F + 1.0F
                  );
            }
         }
   ...
   public void animateForMimicGround(
      EntityMimicOctopus.MimicState state, EntityMimicOctopus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float groundProgress
   ) {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         new AdvancedModelBox[]{
            this.leftBackArm2, this.rightBackArm1, this.rightBackArm2, this.creeperPivots1, this.creeperPivots2, this.creeperPivots3, this.creeperPivots4
         }
      );
   }
