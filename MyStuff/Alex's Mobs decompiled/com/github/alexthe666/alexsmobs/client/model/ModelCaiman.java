...
public class ModelCaiman extends AdvancedEntityModel<EntityCaiman> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.rightLeg,
         this.rightFoot,
         new AdvancedModelBox[]{this.rightArm, this.rightHand, this.leftArm, this.leftHand}
      );
   }
   ...
   public void setupAnim(EntityCaiman entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.leftArm.rotationPointY = this.leftArm.rotationPointY
         + (Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -1.5F, 3.0F, false)) - bodyBob);
      ...
      this.leftHand.rotationPointY = this.leftHand.rotationPointY
         + Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.5F, walkDegree * 1.0F, true));
      ...
      this.rightArm.rotationPointY = this.rightArm.rotationPointY
         + (Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -1.5F, 3.0F, true)) - bodyBob);
      ...
      this.rightHand.rotationPointY = this.rightHand.rotationPointY
         + Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.5F, walkDegree * 1.0F, false));
      ...
      this.leftLeg.rotationPointY = this.leftLeg.rotationPointY
         + (Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 3.0F, true)) - bodyBob);
      ...
      this.leftLeg.rotationPointY = this.leftLeg.rotationPointY
         + Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.0F, walkDegree * 0.5F, false));
      ...
      this.rightLeg.rotationPointY = this.rightLeg.rotationPointY
         + (Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 3.0F, false)) - bodyBob);
      ...
      this.rightFoot.rotationPointY = this.rightFoot.rotationPointY
         + Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.0F, walkDegree * 0.5F, true));
