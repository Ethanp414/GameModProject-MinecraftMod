...
public class ModelGeladaMonkey extends AdvancedEntityModel<EntityGeladaMonkey> {
   ...
   public void setupAnim(EntityGeladaMonkey entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float sitProgress = entity.prevSitProgress + (entity.sitProgress - entity.prevSitProgress) * (ageInTicks - entity.f_19797_);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.root, this.body, this.tail, this.torso, this.neck, this.head, this.left_arm, this.left_leg, this.right_arm, this.right_leg, this.mouth
      );
   }
