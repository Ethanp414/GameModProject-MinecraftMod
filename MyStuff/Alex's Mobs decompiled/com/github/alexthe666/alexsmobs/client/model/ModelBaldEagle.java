...
public class ModelBaldEagle extends AdvancedEntityModel<EntityBaldEagle> {
   ...
   public void setupAnim(EntityBaldEagle entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float flapAmount = (entity.prevFlapAmount + (entity.flapAmount - entity.prevFlapAmount) * partialTicks)
         * flyProgress
         * 0.2F
         * (5.0F - swoopProgress)
         * 0.2F;
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.tipL,
         this.tipR,
         new AdvancedModelBox[]{this.hood_tie, this.feathersL, this.feathersR, this.legL, this.legR, this.footL, this.footR, this.topHead}
      );
   }
