...
public class ModelLaviathan extends AdvancedEntityModel<EntityLaviathan> {
   ...
   public void setupAnim(EntityLaviathan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.neck.rotationPointY = this.neck.rotationPointY - Mth.m_14036_(Math.abs(entity.getHeadYaw(partialTick)) / 50.0F, 0.0F, 1.0F);
      this.neck.rotateAngleY = (float)(this.neck.rotateAngleY + Math.toRadians(entity.getHeadYaw(partialTick) * 0.65F));
      this.neck2.rotateAngleY = (float)(this.neck2.rotateAngleY + Math.toRadians(entity.getHeadYaw(partialTick) * 0.6F));
      this.head.rotateAngleY = (float)(this.head.rotateAngleY + Math.toRadians(entity.getHeadYaw(partialTick) * 0.45F));
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.bottom_jaw,
         this.top_jaw,
         new AdvancedModelBox[]{this.shell, this.vent1, this.vent2, this.vent3, this.vent4}
      );
   }
