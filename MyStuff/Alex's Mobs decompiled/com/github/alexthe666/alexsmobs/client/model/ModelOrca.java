...
public class ModelOrca extends AdvancedEntityModel<EntityOrca> {
   ...
   public void setupAnim(EntityOrca entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (horizontalMag(entityIn.m_20184_()) > 1.0E-7) {
         this.body.rotateAngleX = this.body.rotateAngleX + (-0.05F + -0.05F * Mth.m_14089_(ageInTicks * 0.3F));
         this.tail1.rotateAngleX = this.tail1.rotateAngleX + -0.1F * Mth.m_14089_(ageInTicks * 0.3F);
         this.tailend.rotateAngleX = this.tailend.rotateAngleX + -0.2F * Mth.m_14089_(ageInTicks * 0.3F);
      }
   }
