...
public class ModelTriops extends AdvancedEntityModel<EntityTriops> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.tail1,
         this.tail2,
         this.leftTailFlipper,
         this.rightTailFlipper
      );
   }
   ...
   public void setupAnim(EntityTriops entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float tail1Rot = Mth.m_14177_(entity.prevTail1Yaw + (entity.tail1Yaw - entity.prevTail1Yaw) * partialTick - yaw) * 0.35F;
      float tail2Rot = Mth.m_14177_(entity.prevTail2Yaw + (entity.tail2Yaw - entity.prevTail2Yaw) * partialTick - yaw) * 0.35F;
      ...
      this.body.rotateAngleZ = this.body.rotateAngleZ + Maths.rad(swimRot);
      ...
      this.tail1.rotateAngleY = this.tail1.rotateAngleY + Maths.rad(tail1Rot);
      this.tail2.rotateAngleY = this.tail2.rotateAngleY + Maths.rad(tail2Rot);
   }
}
