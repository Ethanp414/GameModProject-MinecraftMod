...
public class ModelBunfungus extends AdvancedEntityModel<EntityBunfungus> {
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         ...
         this.left_arm,
         this.right_arm,
         new AdvancedModelBox[]{this.left_leg, this.right_leg, this.tail, this.belly, this.left_foot, this.right_foot}
      );
   }
   ...
   public void setupAnim(EntityBunfungus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.left_leg.rotationPointY = this.left_leg.rotationPointY
         + 2.0F * (float)(Math.sin(limbSwing * walkSpeed + 2.5) * limbSwingMod * walkDegree - limbSwingMod * walkDegree);
