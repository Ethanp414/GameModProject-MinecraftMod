...
public class AMModelLayers {
   ...
   public static void register(RegisterLayerDefinitions event) {
      event.registerLayerDefinition(SITTING_WANDERING_VILLAGER, () -> LayerDefinition.m_171565_(ModelWanderingVillagerRider.m_171052_(), 64, 64));
      event.registerLayerDefinition(UNDERMINER, () -> LayerDefinition.m_171565_(HumanoidModel.m_170681_(CubeDeformation.f_171458_, 0.05F), 64, 64));
