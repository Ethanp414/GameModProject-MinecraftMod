...
public class ParticleSunbirdFeather extends SimpleAnimatedParticle {
   ...
   private ParticleSunbirdFeather(ClientLevel world, double x, double y, double z, double xd, double yd, double zd, SpriteSet sprites) {
      ...
      float f1 = -((float)Mth.m_14136_(yd, f)) + Maths.rad(135.0);
   ...
   public void m_5989_() {
      ...
      if (this.f_107224_++ >= this.f_107225_) {
         ...
         if (!this.f_107218_) {
            this.f_107231_ = this.f_107231_ + (0.0F + (float)Math.sin(this.f_107224_ * 0.3F) * 0.5F * ((float)this.f_107224_ / this.f_107225_));
         }
