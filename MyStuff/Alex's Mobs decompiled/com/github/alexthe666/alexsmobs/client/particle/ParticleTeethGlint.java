...
public class ParticleTeethGlint extends TextureSheetParticle {
   ...
   private ParticleTeethGlint(
      ClientLevel p_i232444_1_, double p_i232444_2_, double p_i232444_4_, double p_i232444_6_, double p_i232444_8_, double p_i232444_10_, double p_i232444_12_
   ) {
      super(p_i232444_1_, p_i232444_2_, p_i232444_4_, p_i232444_6_, p_i232444_8_, p_i232444_10_, p_i232444_12_);
      float lvt_14_1_ = this.f_107223_.m_188501_() * 0.1F + 0.2F;
      ...
      this.m_107271_(1.0F - (float)this.f_107224_ / this.f_107225_ * 0.5F);
   }
   ...
   public void m_5989_() {
      ...
      this.f_107231_ = (float)(this.f_107231_ + 0.25 * Math.sin(this.f_107224_ * 2));
      this.f_107663_ = this.initScale * (1.0F - (float)this.f_107224_ / this.f_107225_ * 0.5F);
   }
   ...
   public static class Factory implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         SimpleParticleType p_199234_1_,
         ClientLevel p_199234_2_,
         double p_199234_3_,
         double p_199234_5_,
         double p_199234_7_,
         double p_199234_9_,
