...
public class ParticleGusterSandSpin extends TextureSheetParticle {
   ...
   private ParticleGusterSandSpin(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ, int variant) {
      ...
      this.f_107216_ = 0.0;
      this.f_107217_ = 0.0;
      this.f_107663_ = this.f_107663_ * (0.4F + this.f_107223_.m_188501_() * 1.4F);
   ...
   public static int selectColor(int variant, RandomSource rand) {
      if (variant == 2) {
         ...
         return variant == 1
            ? POSSIBLE_COLORS_RED[rand.m_188503_(POSSIBLE_COLORS_RED.length - 1)]
            : POSSIBLE_COLORS[rand.m_188503_(POSSIBLE_COLORS.length - 1)];
      }
   }
   ...
   public void m_5989_() {
      ...
      double extraX = this.targetX + radius * Mth.m_14031_((float) Math.PI + angle);
      double extraZ = this.targetZ + radius * Mth.m_14089_(angle);
      double d2 = extraX - this.f_107212_;
      double d3 = this.targetY - this.f_107213_;
      double d4 = extraZ - this.f_107214_;
      float speed = 0.02F;
      this.f_107215_ += d2 * speed;
      this.f_107216_ += d3 * speed;
      this.f_107217_ += d4 * speed;
   }
