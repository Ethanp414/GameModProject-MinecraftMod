...
public class ParticleInvertDig extends SimpleAnimatedParticle {
   ...
   public void m_5989_() {
      ...
      boolean live = false;
      this.f_107663_ = 0.1F + Math.min((float)this.f_107224_ / this.f_107225_, 0.5F) * 0.5F;
      if (this.f_107224_++ < this.f_107225_ && this.creator != null) {
         if (this.creator instanceof Player player) {
            ItemStack item = player.m_21211_();
            if (item.m_41720_() instanceof ItemDimensionalCarver) {
               this.f_107224_ = Mth.m_14045_(this.f_107225_ - player.m_21212_(), 0, this.f_107225_);
               live = true;
            }
         }
      } else {
