...
public class RenderFrilledShark extends MobRenderer<EntityFrilledShark, ModelFrilledShark> {
   ...
   public RenderFrilledShark(Context renderManagerIn) {
   ...
   public ResourceLocation getTextureLocation(EntityFrilledShark entity) {
      return entity.isKaiju()
         ? (entity.isDepressurized() ? TEXTURE_KAIJU_DEPRESSURIZED : TEXTURE_KAIJU)
         : (entity.isDepressurized() ? TEXTURE_DEPRESSURIZED : TEXTURE);
   }
   ...
   static class TeethLayer extends RenderLayer<EntityFrilledShark, ModelFrilledShark> {
      ...
      public void render(
         ...
         int packedLightIn,
         EntityFrilledShark entitylivingbaseIn,
         float limbSwing,
         ...
         VertexConsumer glintBuilder = buffer.m_6299_(AMRenderTypes.getEyesFlickering(RenderFrilledShark.TEXTURE_TEETH, 240.0F));
