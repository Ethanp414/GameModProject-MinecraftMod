...
public class RenderGrizzlyBear extends MobRenderer<EntityGrizzlyBear, ModelGrizzlyBear> {
   ...
   public boolean shouldRender(EntityGrizzlyBear livingEntityIn, Frustum camera, double camX, double camY, double camZ) {
      return livingEntityIn.getAprilFoolsFlag() == 5 ? false : super.m_5523_(livingEntityIn, camera, camX, camY, camZ);
   }
   ...
   class LayerFreddyEyes extends RenderLayer<EntityGrizzlyBear, ModelGrizzlyBear> {
      ...
      public void render(
         ...
         if (entitylivingbaseIn.getAprilFoolsFlag() == 4 && entitylivingbaseIn.f_19797_ % 6 <= 2) {
            VertexConsumer ivertexbuilder = bufferIn.m_6299_(AMRenderTypes.getEyesNoFog(RenderGrizzlyBear.TEXTURE_FREDDY_EYES));
            ((ModelGrizzlyBear)this.m_117386_())
               .m_7695_(matrixStackIn, ivertexbuilder, packedLightIn, LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F), 1.0F, 1.0F, 1.0F, 0.1F);
         }
      }
   }
   ...
   class LayerSnow extends RenderLayer<EntityGrizzlyBear, ModelGrizzlyBear> {
      ...
      public void render(
         ...
         if (entitylivingbaseIn.isSnowy()) {
            VertexConsumer ivertexbuilder = bufferIn.m_6299_(RenderType.m_110458_(RenderGrizzlyBear.TEXTURE_SNOWY));
            ((ModelGrizzlyBear)this.m_117386_())
