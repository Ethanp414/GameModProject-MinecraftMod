      ...
      public void render(
         ...
         if (entitylivingbaseIn.isSnowy()) {
            VertexConsumer ivertexbuilder = bufferIn.m_6299_(
               RenderType.m_110458_(entitylivingbaseIn.m_6162_() ? RenderBison.TEXTURE_BABY_SNOWY : RenderBison.TEXTURE_SNOWY)
            );
