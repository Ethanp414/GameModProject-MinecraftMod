...
public class RenderSkreecher extends MobRenderer<EntitySkreecher, ModelSkreecher> {
   ...
   public RenderSkreecher(Context renderManagerIn) {
      ...
      this.m_115326_(new RenderSkreecher.LayerScorch(this));
   }
   ...
   static class LayerScorch extends RenderLayer<EntitySkreecher, ModelSkreecher> {
      ...
      public void render(
         ...
         VertexConsumer scorch = bufferIn.m_6299_(AMRenderTypes.getEyesAlphaEnabled(RenderSkreecher.TEXTURE_GLOW));
         float alpha = (float)Math.sin((entitylivingbaseIn.f_19797_ + partialTicks) * 0.1F) * 0.35F + 0.5F;
         ((ModelSkreecher)this.m_117386_())
