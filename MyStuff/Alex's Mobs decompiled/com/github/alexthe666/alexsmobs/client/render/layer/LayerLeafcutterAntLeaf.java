...
public class LayerLeafcutterAntLeaf extends RenderLayer<EntityLeafcutterAnt, AdvancedEntityModel<EntityLeafcutterAnt>> {
   ...
   public void render(
      ...
      int packedLightIn,
      EntityLeafcutterAnt entitylivingbaseIn,
      float limbSwing,
      ...
      if (entitylivingbaseIn.hasLeaf() && !entitylivingbaseIn.isQueen() && this.m_117386_() instanceof ModelLeafcutterAnt) {
         ...
         int leafColor = Minecraft.m_91087_().getItemColors().m_92676_(new ItemStack(Items.f_41899_), 0);
         ...
         float f = (leafColor >> 16 & 0xFF) / 255.0F;
         float f1 = (leafColor >> 8 & 0xFF) / 255.0F;
         float f2 = (leafColor & 0xFF) / 255.0F;
         ((AdvancedEntityModel)this.m_117386_())
            .m_7695_(matrixStackIn, ivertexbuilder, packedLightIn, LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F), f, f1, f2, 1.0F);
      }
   }
}
