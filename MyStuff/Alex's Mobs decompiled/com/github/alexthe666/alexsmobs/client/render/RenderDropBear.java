...
public class RenderDropBear extends MobRenderer<EntityDropBear, ModelDropBear> {
   ...
   public RenderDropBear(Context renderManagerIn) {
      super(renderManagerIn, new ModelDropBear(), 0.7F);
      this.m_115326_(new RenderDropBear.EyeLayer(this));
   }
   ...
   static class EyeLayer extends RenderLayer<EntityDropBear, ModelDropBear> {
      ...
      public void render(
         ...
         int packedLightIn,
         EntityDropBear entitylivingbaseIn,
         float limbSwing,
         ...
         VertexConsumer ivertexbuilder = bufferIn.m_6299_(RenderType.m_110488_(RenderDropBear.TEXTURE_EYES));
         ((ModelDropBear)this.m_117386_())
