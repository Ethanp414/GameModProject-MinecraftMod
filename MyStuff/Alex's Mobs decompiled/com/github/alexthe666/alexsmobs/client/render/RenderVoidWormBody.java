...
public class RenderVoidWormBody extends LivingEntityRenderer<EntityVoidWormPart, EntityModel<EntityVoidWormPart>> {
   ...
   public RenderVoidWormBody(Context renderManagerIn) {
      super(renderManagerIn, new ModelVoidWormBody(0.0F), 1.0F);
      this.m_115326_(new LayerVoidWormGlow(this, renderManagerIn.m_174026_(), new ModelVoidWormBody(0.0F)) {
         @Override
         ...
         public float getAlpha(LivingEntity livingEntity) {
            ...
            return (float)Mth.m_14008_((worm.m_21223_() - worm.getHealthThreshold()) / (worm.m_21233_() - worm.getHealthThreshold()), 0.0, 1.0);
         }
      });
   }
