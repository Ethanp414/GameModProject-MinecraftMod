...
public class RenderWarpedMosco extends MobRenderer<EntityWarpedMosco, ModelWarpedMosco> {
   ...
   public RenderWarpedMosco(Context renderManagerIn) {
      super(renderManagerIn, new ModelWarpedMosco(), 1.0F);
      this.m_115326_(new RenderWarpedMosco.WarpedMoscoGlowLayer(this));
   }
   ...
   static class WarpedMoscoGlowLayer extends RenderLayer<EntityWarpedMosco, ModelWarpedMosco> {
      ...
      public void render(
         ...
         int packedLightIn,
         EntityWarpedMosco entitylivingbaseIn,
         float limbSwing,
         ...
         VertexConsumer ivertexbuilder = bufferIn.m_6299_(AMRenderTypes.getEyesFlickering(RenderWarpedMosco.TEXTURE_EYES, 0.0F));
         float alpha = 0.5F + (Mth.m_14089_(ageInTicks * 0.2F) + 1.0F) * 0.2F;
         ((ModelWarpedMosco)this.m_117386_())
            .m_7695_(matrixStackIn, ivertexbuilder, 240, LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F), 0.5F, 1.0F, 1.0F, alpha);
      }
   }
}
