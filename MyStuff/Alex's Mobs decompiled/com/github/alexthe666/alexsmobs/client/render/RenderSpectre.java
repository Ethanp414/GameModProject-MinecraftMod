...
public class RenderSpectre extends MobRenderer<EntitySpectre, ModelSpectre> {
   ...
   public float getAlphaForRender(EntitySpectre entityIn, float partialTicks) {
      return ((float)Math.sin((entityIn.f_19797_ + partialTicks) * 0.1F) + 1.5F) * 0.1F + 0.5F;
   }
   ...
   class SpectreMembraneLayer extends RenderLayer<EntitySpectre, ModelSpectre> {
      ...
      public void render(
         ...
         if (entitylivingbaseIn.m_21523_()) {
            VertexConsumer lead = bufferIn.m_6299_(AMRenderTypes.m_110458_(RenderSpectre.TEXTURE_LEAD));
            ((ModelSpectre)this.m_117386_())
               .m_7695_(matrixStackIn, lead, 15728640, LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F);
         }
      }
