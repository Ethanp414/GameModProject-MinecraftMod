...
public class RenderSquidGrapple extends EntityRenderer<EntitySquidGrapple> {
   ...
   public static <E extends Entity> void renderTentacle(
      ...
      double d0 = Mth.m_14179_(partialTick, bodyRot, bodyRot0) * (float) (Math.PI / 180.0) + (Math.PI / 2);
      ...
      double d3 = Mth.m_14139_(partialTick, mob.f_19854_, mob.m_20185_()) + d1;
      double d4 = Mth.m_14139_(partialTick, mob.f_19855_, mob.m_20186_()) + vec31.f_82480_;
      double d5 = Mth.m_14139_(partialTick, mob.f_19856_, mob.m_20189_()) + d2;
   ...
   public void render(EntitySquidGrapple entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
      ...
      matrixStackIn.m_252781_(Axis.f_252392_.m_252977_(Mth.m_14179_(partialTicks, entityIn.f_19859_, entityIn.m_146908_())));
      matrixStackIn.m_252781_(Axis.f_252529_.m_252977_(180.0F + Mth.m_14179_(partialTicks, entityIn.f_19860_, entityIn.m_146909_())));
