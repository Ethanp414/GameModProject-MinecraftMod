...
public class LayerSoulVultureGlow extends RenderLayer<EntitySoulVulture, ModelSoulVulture> {
   ...
   public void render(
      ...
      ((ModelSoulVulture)this.m_117386_())
         .m_7695_(
            matrixStackIn,
            bufferIn.m_6299_(AMRenderTypes.getGhost(TEXTURE_GLOW)),
            240,
      ...
      if (entitylivingbaseIn.hasSoulHeart()) {
         ((ModelSoulVulture)this.m_117386_())
            .m_7695_(
               matrixStackIn,
               bufferIn.m_6299_(AMRenderTypes.getGhost(this.getFlames(entitylivingbaseIn.f_19797_))),
               240,
               LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F),
               1.0F,
               1.0F,
