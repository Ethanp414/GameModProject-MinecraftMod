...
public class RenderRaccoon extends MobRenderer<EntityRaccoon, ModelRaccoon> {
   ...
   public RenderRaccoon(Context renderManagerIn) {
      ...
      public void render(
         ...
         if (raccoon.getColor() != null && !raccoon.m_20145_()) {
            ...
            if (raccoon.m_8077_() && "jeb_".equals(raccoon.m_7755_().m_214077_())) {
               ...
               float lvt_19_1_ = (raccoon.f_19797_ % 25 + p_225628_7_) / 25.0F;
               float[] lvt_20_1_ = Sheep.m_29829_(DyeColor.m_41053_(lvt_17_1_));
               float[] lvt_21_1_ = Sheep.m_29829_(DyeColor.m_41053_(lvt_18_1_));
               ...
               float[] lvt_14_2_ = Sheep.m_29829_(raccoon.getColor());
            ...
            ((ModelRaccoon)this.m_117386_())
               .m_7695_(
                  p_225628_1_,
                  p_225628_2_.m_6299_(AMRenderTypes.m_110458_(RenderRaccoon.TEXTURE_BANDANA)),
                  p_225628_3_,
