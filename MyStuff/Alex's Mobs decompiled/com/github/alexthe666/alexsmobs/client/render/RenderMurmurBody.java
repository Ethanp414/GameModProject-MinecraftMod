...
public class RenderMurmurBody extends MobRenderer<EntityMurmur, ModelMurmurBody> {
   ...
   public void render(EntityMurmur body, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
      super.m_7392_(body, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
      if (renderWithHead || body.shouldRenderFakeHead()) {
         float f = Mth.m_14189_(partialTicks, body.f_20884_, body.f_20883_);
         ...
         HEAD_MODEL.m_7695_(matrixStackIn, bufferIn.m_6299_(RenderType.m_110458_(loc)), packedLightIn, overlayCoords, 1.0F, 1.0F, 1.0F, 1.0F);
         matrixStackIn.m_252880_(0.0F, 0.5F, 0.0F);
         NECK_MODEL.resetToDefaultPose();
         NECK_MODEL.setAttributes(0.5F, 0.0F, 0.0F, 0.0F);
         NECK_MODEL.m_7695_(matrixStackIn, bufferIn.m_6299_(RenderType.m_110458_(loc)), packedLightIn, overlayCoords, 1.0F, 1.0F, 1.0F, 1.0F);
