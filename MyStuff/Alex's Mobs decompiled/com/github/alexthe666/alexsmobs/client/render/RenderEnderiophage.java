...
public class RenderEnderiophage extends MobRenderer<EntityEnderiophage, ModelEnderiophage> {
   ...
   public RenderEnderiophage(Context renderManagerIn) {
      ...
      this.m_115326_(new RenderEnderiophage.EnderiophageEyesLayer(this));
   }
   ...
   static class EnderiophageEyesLayer extends EyesLayer<EntityEnderiophage, ModelEnderiophage> {
      ...
      public void render(
         ...
         ((ModelEnderiophage)this.m_117386_()).m_7695_(matrixStackIn, ivertexbuilder, 15728640, OverlayTexture.f_118083_, 1.0F, 1.0F, 1.0F, 1.0F);
      }
