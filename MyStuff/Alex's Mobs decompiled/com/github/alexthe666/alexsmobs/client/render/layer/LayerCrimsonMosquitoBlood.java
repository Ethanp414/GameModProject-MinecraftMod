...
public class LayerCrimsonMosquitoBlood extends RenderLayer<EntityCrimsonMosquito, ModelCrimsonMosquito> {
   ...
   public void render(
      ...
      int packedLightIn,
      EntityCrimsonMosquito entitylivingbaseIn,
      float limbSwing,
      ...
      if (entitylivingbaseIn.getBloodLevel() > 0) {
         VertexConsumer ivertexbuilder = bufferIn.m_6299_(RenderType.m_110488_(entitylivingbaseIn.isSick() ? TEXTURE_SICK : TEXTURE));
         ((ModelCrimsonMosquito)this.m_117386_())
