...
public class LayerElephantOverlays extends RenderLayer<EntityElephant, ModelElephant> {
   ...
   public void render(
      ...
      if (elephant.isChested()) {
         VertexConsumer ivertexbuilder = bufferIn.m_6299_(RenderType.m_110452_(TEXTURE_CHEST));
         ((ModelElephant)this.m_117386_())
            .m_7695_(matrixStackIn, ivertexbuilder, packedLightIn, LivingEntityRenderer.m_115338_(elephant, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F);
      }
      ...
      if (lvt_11_1_ != null || elephant.isTrader()) {
         ...
         if (!elephant.isTrader()) {
            lvt_12_3_ = ELEPHANT_DECOR_TEXTURES[lvt_11_1_.m_41060_()];
         } else {
            lvt_12_3_ = TRADER_TEXTURE;
         }

         ((ModelElephant)this.m_117386_()).m_102624_(this.model);
         this.model.setupAnim(elephant, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
         VertexConsumer lvt_13_1_ = bufferIn.m_6299_(RenderType.m_110458_(lvt_12_3_));
