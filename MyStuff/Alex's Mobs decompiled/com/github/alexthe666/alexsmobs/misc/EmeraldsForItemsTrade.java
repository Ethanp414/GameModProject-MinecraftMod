...
public class EmeraldsForItemsTrade implements ItemListing {
   ...
   public MerchantOffer m_213663_(Entity p_221182_1_, RandomSource p_221182_2_) {
      ...
      return new MerchantOffer(lvt_3_1_, new ItemStack(Items.f_42616_, this.count), this.maxUses, this.xpValue, this.priceMultiplier);
   }
}
