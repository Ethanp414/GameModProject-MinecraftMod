...
public class AMSoundRegistry {
   public static final DeferredRegister<SoundEvent> DEF_REG = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, "alexsmobs");
   ...
   private static RegistryObject<SoundEvent> createSoundEvent(String soundName) {
      return DEF_REG.register(soundName, () -> SoundEvent.m_262824_(new ResourceLocation("alexsmobs", soundName)));
   }
}
