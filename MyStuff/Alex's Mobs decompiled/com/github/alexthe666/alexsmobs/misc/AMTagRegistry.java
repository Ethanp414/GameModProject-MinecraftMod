...
public class AMTagRegistry {
   ...
   private static TagKey<EntityType<?>> registerEntityTag(String name) {
      return TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("alexsmobs", name));
   }

   private static TagKey<Item> registerItemTag(String name) {
      return TagKey.m_203882_(Registries.f_256913_, new ResourceLocation("alexsmobs", name));
   }

   private static TagKey<Block> registerBlockTag(String name) {
      return TagKey.m_203882_(Registries.f_256747_, new ResourceLocation("alexsmobs", name));
   }

   private static TagKey<Biome> registerBiomeTag(String name) {
      return TagKey.m_203882_(Registries.f_256952_, new ResourceLocation("alexsmobs", name));
   }

   private static TagKey<Structure> registerStructureTag(String name) {
      return TagKey.m_203882_(Registries.f_256944_, new ResourceLocation("alexsmobs", name));
   }
}
