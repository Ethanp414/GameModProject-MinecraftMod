...
public class BiomeConfig {
   ...
   public static final Pair<String, SpawnBiomeData> alligatorSnappingTurtle = Pair.of(
      "alexsmobs:alligator_snapping_turtle_spawns", DefaultBiomes.ALLIGATOR_SNAPPING_TURTLE
   );
   ...
   public static final Pair<String, SpawnBiomeData> cachalot_whale_beached_spawns = Pair.of(
      "alexsmobs:cachalot_whale_beached_spawns", DefaultBiomes.BEACHED_CACHALOT_WHALE
   );
   ...
   public static boolean test(Pair<String, SpawnBiomeData> entry, Holder<Biome> biome, ResourceLocation name) {
      return !init ? false : biomeConfigValues.get(entry.getKey()).matches(biome, name);
   }

   public static boolean test(Pair<String, SpawnBiomeData> spawns, Holder<Biome> biome) {
      return test(spawns, biome, ForgeRegistries.BIOMES.getKey((Biome)biome.m_203334_()));
   }
}
