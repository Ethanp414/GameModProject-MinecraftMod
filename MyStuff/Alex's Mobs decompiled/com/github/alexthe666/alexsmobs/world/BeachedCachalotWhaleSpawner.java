...
public class BeachedCachalotWhaleSpawner {
   ...
   private boolean attemptSpawnWhale() {
      Player playerentity = this.world.m_8890_();
      if (playerentity == null) {
         ...
         if (blockpos2 != null && this.func_226559_a_(blockpos2) && blockpos2.m_123331_(blockpos) > 225.0) {
            ...
            EntityCachalotWhale whale = (EntityCachalotWhale)((EntityType)AMEntityRegistry.CACHALOT_WHALE.get()).m_20615_(this.world);
            whale.m_7678_(upPos.m_123341_() + 0.5, upPos.m_123342_() + 0.5, upPos.m_123343_() + 0.5, this.random.nextFloat() * 360.0F - 180.0F, 0.0F);
            whale.m_6518_(this.world, this.world.m_6436_(upPos), MobSpawnType.SPAWNER, null, null);
            whale.setBeached(true);
            AMWorldData worldinfo = AMWorldData.get(this.world);
            worldinfo.setBeachedCachalotID(whale.m_20148_());
            whale.m_21446_(upPos, 16);
            whale.setDespawnBeach(true);
            this.world.m_7967_(whale);
            return true;
         } else {
            return false;
         }
   ...
   private BlockPos func_221244_a(BlockPos p_221244_1_, int p_221244_2_) {
      ...
      for (int i = 0; i < 10; i++) {
         ...
         int l = this.world.m_6924_(Types.WORLD_SURFACE, j, k);
         BlockPos blockpos1 = new BlockPos(j, l, k);
         if (AMWorldRegistry.testBiome(BiomeConfig.cachalot_whale_beached_spawns, this.world.m_204166_(blockpos1))
            && NaturalSpawner.m_47051_(Type.ON_GROUND, this.world, blockpos1, EntityType.f_20494_)) {
            blockpos = blockpos1;
            break;
         }
      }
   ...
   private boolean func_226559_a_(BlockPos p_226559_1_) {
      for (BlockPos blockpos : BlockPos.m_121940_(p_226559_1_, p_226559_1_.m_7918_(1, 2, 1))) {
         if (!this.world.m_8055_(blockpos).m_60816_(this.world, blockpos).m_83281_() || !this.world.m_6425_(blockpos).m_76178_()) {
            return false;
         }
      }
