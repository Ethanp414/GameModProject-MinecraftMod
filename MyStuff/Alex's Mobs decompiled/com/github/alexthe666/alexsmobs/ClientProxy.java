...
public class ClientProxy extends CommonProxy {
   ...
   public void clientInit() {
      ...
      EntityRenderers.m_174036_((EntityType)AMEntityRegistry.CAIMAN.get(), RenderCaiman::new);
      EntityRenderers.m_174036_((EntityType)AMEntityRegistry.TRIOPS.get(), RenderTriops::new);
      ...
      try {
         ...
         ItemProperties.register(
            ...
            (stack, world, entity, j) -> {
               ...
               return entity != null && entity.m_20185_() >= x && entity.m_20185_() <= x + 16 && entity.m_20189_() >= z && entity.m_20189_() <= z + 16
                  ? 1.0F
                  : 0.0F;
            }
         );
   ...
   private static void onBakingCompleted(ModifyBakingResult e) {
      ...
      if (updateKind == 67) {
         if (entity instanceof EntityCockroach && entity.m_6084_()) {
            ...
            if (COCKROACH_SOUND_MAP.get(entity.m_19879_()) == null) {
               ...
               sound = (SoundLaCucaracha)COCKROACH_SOUND_MAP.get(entity.m_19879_());
            }
            ...
            if (f2 <= 0.0F) {
               ...
               if (WORMBOSS_SOUND_MAP.get(entity.m_19879_()) == null) {
                  ...
                  soundx = (SoundWormBoss)WORMBOSS_SOUND_MAP.get(entity.m_19879_());
               }
            ...
            if (BEAR_MUSIC_BOX_SOUND_MAP.get(entity.m_19879_()) == null) {
               ...
               soundxx = (SoundBearMusicBox)BEAR_MUSIC_BOX_SOUND_MAP.get(entity.m_19879_());
            }
   ...
   public static void setupParticles(RegisterParticleProvidersEvent registry) {
      ...
      registry.registerSpecial((ParticleType)AMParticleRegistry.BEAR_FREDDY.get(), new ParticleBearFreddy.Factory());
      registry.registerSpriteSet((ParticleType)AMParticleRegistry.SUNBIRD_FEATHER.get(), ParticleSunbirdFeather.Factory::new);
      registry.registerSpecial((ParticleType)AMParticleRegistry.STATIC_SPARK.get(), new ParticleStaticSpark.Factory());
      registry.registerSpecial((ParticleType)AMParticleRegistry.SKULK_BOOM.get(), new ParticleSkulkBoom.Factory());
