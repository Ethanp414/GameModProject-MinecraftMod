...
public class EntityGuster extends Monster {
   ...
   public Entity getLiftedEntity() {
      return !this.hasLiftedEntity() ? null : this.m_9236_().m_6815_((Integer)this.f_19804_.m_135370_(LIFT_ENTITY));
   }
   ...
   public void m_8107_() {
      ...
      if (lifted == null && !this.m_9236_().f_46443_ && this.f_19797_ % 15 == 0) {
         List<ItemEntity> list = this.m_9236_().m_45976_(ItemEntity.class, this.m_20191_().m_82400_(0.8F));
         ...
         for (int j = 0; j < 4; j++) {
            ...
            this.m_9236_()
               .m_7106_(
                  ...
                  this.m_20189_() + f2,
                  this.m_20185_(),
                  this.m_20186_() + this.f_19796_.m_188501_() * this.m_20206_() + 0.2F,
                  this.m_20189_()
               );
         }
      }
      ...
      if (lifted != null && this.liftingTime >= 0) {
         ...
         double extraX = this.m_20185_() + radius * Mth.m_14031_((float) Math.PI + angle);
         double extraZ = this.m_20189_() + radius * Mth.m_14089_(angle);
         double d0 = (extraX - lifted.m_20185_()) * resist;
         double d1 = (extraZ - lifted.m_20189_()) * resist;
         lifted.m_20334_(d0, 0.1 * resist, d1);
