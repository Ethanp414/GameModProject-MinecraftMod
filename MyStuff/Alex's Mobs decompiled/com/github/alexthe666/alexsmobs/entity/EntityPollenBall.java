...
public class EntityPollenBall extends EntityMobProjectile {
   ...
   public EntityPollenBall(Level worldIn, EntityFlutter flutter) {
      ...
      Vec3 vec3 = flutter.m_20182_().m_82549_(this.calcOffsetVec(new Vec3(0.0, 0.4F * flutter.m_6134_(), 0.0), flutter.getFlutterPitch(), flutter.m_146908_()));
   ...
   public void doBehavior() {
      ...
      if (entity instanceof Mob && ((Mob)entity).m_5448_() != null) {
         ...
         double d1 = target.m_20186_() + target.m_20206_() * 0.5F - this.m_20186_();
      ...
      if (this.m_9236_().f_46443_ && this.f_19796_.m_188503_(2) == 0) {
         ...
         this.m_9236_().m_7106_(ParticleTypes.f_123782_, this.m_20185_() + r1, this.m_20186_() + r2, this.m_20189_() + r3, r1 * 0.1F, r2 * 0.1F, r3 * 0.1F);
      }
   }
