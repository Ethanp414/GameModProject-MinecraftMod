...
public class TendonWhipUtil {
   ...
   public static void setLastTendon(LivingEntity entity, EntityTendonSegment tendon) {
      ...
      if (tendon == null) {
         tag.m_128473_("LastTendonUUIDAlexsMobs");
         tag.m_128405_("LastTendonIDAlexsMobs", -1);
      } else {
         tag.m_128362_("LastTendonUUIDAlexsMobs", tendon.m_20148_());
         tag.m_128405_("LastTendonIDAlexsMobs", tendon.m_19879_());
      }
   ...
   private static UUID getLastTendonUUID(LivingEntity entity) {
      CompoundTag tag = CitadelEntityData.getOrCreateCitadelTag(entity);
      return tag.m_128441_("LastTendonUUIDAlexsMobs") ? tag.m_128342_("LastTendonUUIDAlexsMobs") : null;
   }

   public static int getLastTendonId(LivingEntity entity) {
      CompoundTag tag = CitadelEntityData.getOrCreateCitadelTag(entity);
      return tag.m_128441_("LastTendonIDAlexsMobs") ? tag.m_128451_("LastTendonIDAlexsMobs") : -1;
   }
