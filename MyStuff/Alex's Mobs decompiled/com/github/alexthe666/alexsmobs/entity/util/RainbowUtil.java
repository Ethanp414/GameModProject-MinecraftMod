...
public class RainbowUtil {
   ...
   public static void setRainbowType(LivingEntity fabulous, int type) {
      ...
      tag.m_128405_("RainbowTypeAlexsMobs", type);
   ...
   public static int getRainbowType(LivingEntity entity) {
      ...
      return lassoedTag.m_128441_("RainbowTypeAlexsMobs") ? lassoedTag.m_128451_("RainbowTypeAlexsMobs") : 0;
   }
   ...
   public static int calculateGlassColor(BlockPos pos) {
      ...
      float f1 = (float)((AMSimplexNoise.noise((pos.m_123341_() + f) / f, (pos.m_123342_() + f) / f, (pos.m_123343_() + f) / f) + 1.0) * 0.5);
