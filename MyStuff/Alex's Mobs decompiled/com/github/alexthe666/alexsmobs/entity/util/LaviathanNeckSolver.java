...
public class LaviathanNeckSolver {
   ...
   public float getYawVariation(float partialTick) {
      return partialTick == 0.0F ? this.yawVariation : Mth.m_14179_(partialTick, this.prevYawVariation, this.yawVariation);
   }

   public float getPitchVariation(float partialTick) {
      return partialTick == 0.0F ? this.pitchVariation : Mth.m_14179_(partialTick, this.prevPitchVariation, this.pitchVariation);
   }
}
