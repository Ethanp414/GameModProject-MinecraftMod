...
public class EntityWarpedToad extends TamableAnimal implements ITargetsDroppedItems, IFollower, ISemiAquatic {
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(4, new TemptGoal(this, 1.0, Ingredient.m_204132_(AMTagRegistry.WARPED_TOAD_FOODSTUFFS), false));
   ...
   public InteractionResult m_6071_(Player player, InteractionHand hand) {
      ...
      } else if (this.m_21824_() && itemstack.m_204117_(AMTagRegistry.WARPED_TOAD_FOODSTUFFS)) {
      ...
      if (entityIn != null && this.attackProgress > 0.0F) {
         if (this.isTongueOut()) {
            ...
            Vec3 minus = new Vec3(
               ...
               this.m_20192_() - yHelp - this.m_5448_().m_20186_(),
            ...
            if (this.attackProgress == 0.5F) {
               ...
               entityIn.m_6469_(this.m_269291_().m_269333_(this), damage);
            }
         }
      }
   ...
   public static class FollowOwner extends Goal {
      ...
      public boolean m_8045_() {
         if (this.tameable.m_21573_().m_26571_()) {
            ...
            return !this.tameable.m_21827_() && this.tameable.getCommand() == 1 ? this.tameable.m_20280_(this.owner) > this.maxDist * this.maxDist : false;
         }
      }
   ...
   public static class TongueAttack extends Goal {
      ...
      public void m_8037_() {
         ...
         if (entityIn != null) {
            double dist = this.parentEntity.m_20270_(entityIn);
            if (dist < 8.0
