...
public class EtherealMoveController extends MoveControl {
   ...
   public void m_8126_() {
      if (this.f_24981_ == Operation.MOVE_TO) {
         ...
         this.parentEntity.m_20256_(this.parentEntity.m_20184_().m_82549_(vector3d.m_82490_(this.f_24978_ * this.speedGeneral * 0.025 / d0)));
         double yAdd = this.f_24976_ - this.parentEntity.m_20186_();
         if (d0 > this.parentEntity.m_20205_()) {
            this.parentEntity
               .m_20256_(
                  this.parentEntity
                     .m_20184_()
                     .m_82520_(0.0, (double)this.parentEntity.m_6113_() * this.speedGeneral * Mth.m_14008_(yAdd, -1.0, 1.0) * 0.6F, 0.0)
               );
      ...
      } else if (this.f_24981_ == Operation.STRAFE || this.f_24981_ == Operation.JUMPING) {
