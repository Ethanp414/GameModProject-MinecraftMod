...
public class GorillaAIFollowCaravan extends Goal {
   ...
   public boolean m_8036_() {
      if (!this.gorilla.isSilverback() && !this.gorilla.inCaravan() && !this.gorilla.isSitting()) {
         double dist = 15.0;
         List<EntityGorilla> list = this.gorilla.m_9236_().m_45976_(EntityGorilla.class, this.gorilla.m_20191_().m_82377_(dist, dist / 2.0, dist));
   ...
   public void m_8037_() {
      if (this.gorilla.inCaravan() && !this.gorilla.isSitting()) {
         ...
         if (llamaentity != null) {
            double d0 = this.gorilla.m_20270_(llamaentity);
            Vec3 vector3d = new Vec3(
                  llamaentity.m_20185_() - this.gorilla.m_20185_(),
                  llamaentity.m_20186_() - this.gorilla.m_20186_(),
                  llamaentity.m_20189_() - this.gorilla.m_20189_()
               )
               .m_82541_()
            ...
            if (this.gorilla.m_21573_().m_26571_()) {
               try {
                  this.gorilla
                     .m_21573_()
                     .m_26519_(
                        this.gorilla.m_20185_() + vector3d.f_82479_,
                        this.gorilla.m_20186_() + vector3d.f_82480_,
                        this.gorilla.m_20189_() + vector3d.f_82481_,
                        this.speedModifier
                     );
