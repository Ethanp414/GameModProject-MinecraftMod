...
public class SnowLeopardAIMelee extends Goal {
   ...
   private static BlockPos getRandomDelta(
      ...
      if (p_226343_4_ != null && p_226343_5_ < Math.PI) {
         double lvt_7_2_ = Mth.m_14136_(p_226343_4_.f_82481_, p_226343_4_.f_82479_) - (float) (Math.PI / 2);
         double lvt_9_2_ = lvt_7_2_ + (2.0F * p_226343_0_.m_188501_() - 1.0F) * p_226343_5_;
         double lvt_11_1_ = Math.sqrt(p_226343_0_.m_188500_()) * Mth.f_13994_ * p_226343_1_;
   ...
   public static BlockPos moveUpToAboveSolid(BlockPos p_226342_0_, int p_226342_1_, int p_226342_2_, Predicate<BlockPos> p_226342_3_) {
      if (p_226342_1_ < 0) {
         ...
         while (lvt_5_1_.m_123342_() < p_226342_2_ && lvt_5_1_.m_123342_() - lvt_4_1_.m_123342_() < p_226342_1_) {
            BlockPos lvt_6_1_ = lvt_5_1_.m_7494_();
   ...
   public boolean m_8036_() {
      return this.leopard.m_5448_() != null
         && !this.leopard.m_5803_()
         && !this.leopard.isSitting()
         && (this.leopard.m_5448_().m_6084_() || this.leopard.m_5448_() instanceof Player)
         && !this.leopard.m_6162_();
   }
      ...
      if (this.stalk) {
         if (this.secondPartOfLeap) {
            ...
            if (this.leopard.m_20270_(this.target) < 3.0F && this.leopard.m_142582_(this.target)) {
               this.target.m_6469_(this.leopard.m_269291_().m_269333_(this.leopard), (float)(this.leopard.m_21051_(Attributes.f_22281_).m_22135_() * 2.5));
               this.stalk = false;
               this.secondPartOfLeap = false;
               ...
               this.leopard.m_20334_(vector3d1.f_82479_, vector3d1.f_82480_ + 0.6F, vector3d1.f_82481_);
            }
            ...
            if (this.leopard.m_20275_(this.leapPos.f_82479_, this.leapPos.f_82480_, this.leapPos.f_82481_) < 9.0 && this.leopard.m_142582_(this.target)) {
         ...
         this.leopard.setSlSneaking(false);
         this.leopard.m_21573_().m_5624_(this.target, 1.0);
   ...
   private Vec3 calculateFarPoint(double dist) {
      ...
      for (int i = 0; i < 10; i++) {
         Vec3 vector3d1 = this.calculateVantagePoint(
            ...
            3,
            1,
            this.target.m_20182_().m_82492_(this.leopard.m_20185_(), this.leopard.m_20186_(), this.leopard.m_20189_()),
            false,
            (float) (Math.PI / 2),
            this.leopard::m_21692_,
            false,
            0,
            0,
            true
         );
         if (vector3d1 != null && this.target.m_20238_(vector3d1) > dist && (highest == null || highest.m_7098_() < vector3d1.f_82480_)) {
            highest = vector3d1;
         }
      }
   ...
   private Vec3 calculateVantagePoint(
      ...
      if (this.leopard.m_21536_()) {
         lvt_15_2_ = this.leopard.m_21534_().m_203195_(creature.m_20182_(), this.leopard.m_21535_() + xz + 1.0);
      } else {
         lvt_15_2_ = false;
      }
      ...
      for (int lvt_20_1_ = 0; lvt_20_1_ < 10; lvt_20_1_++) {
         ...
         if (lvt_21_1_ != null) {
            ...
            if (this.leopard.m_21536_() && xz > 1) {
               ...
               if (creature.m_20185_() > lvt_25_2_.m_123341_()) {
                  lvt_22_1_ -= lvt_14_1_.m_188503_(xz / 2);
               } else {
                  lvt_22_1_ += lvt_14_1_.m_188503_(xz / 2);
               }

               if (creature.m_20189_() > lvt_25_2_.m_123343_()) {
                  lvt_24_1_ -= lvt_14_1_.m_188503_(xz / 2);
               } else {
                  lvt_24_1_ += lvt_14_1_.m_188503_(xz / 2);
               }
            }

            BlockPos lvt_25_2_x = AMBlockPos.fromCoords(lvt_22_1_ + creature.m_20185_(), lvt_23_1_ + creature.m_20186_(), lvt_24_1_ + creature.m_20189_());
            if (lvt_25_2_x.m_123342_() >= 0
               && lvt_25_2_x.m_123342_() <= creature.m_9236_().m_151558_()
               && (!lvt_15_2_ || this.leopard.m_21444_(lvt_25_2_x))
               && (!p_226339_12_ || lvt_13_1_.m_6342_(lvt_25_2_x))) {
               if (p_226339_9_) {
                  lvt_25_2_x = moveUpToAboveSolid(
                     lvt_25_2_x,
                     lvt_14_1_.m_188503_(p_226339_10_ + 1) + p_226339_11_,
                     creature.m_9236_().m_151558_(),
                     p_226341_1_ -> creature.m_9236_().m_8055_(p_226341_1_).m_280296_()
                  );
               }

               if (p_226339_5_ || !creature.m_9236_().m_6425_(lvt_25_2_x).m_205070_(FluidTags.f_13131_)) {
                  BlockPathTypes lvt_26_1_ = WalkNodeEvaluator.m_77604_(creature.m_9236_(), lvt_25_2_x.m_122032_());
      ...
      return lvt_16_1_ ? Vec3.m_82539_(lvt_19_1_) : null;
   }
}
