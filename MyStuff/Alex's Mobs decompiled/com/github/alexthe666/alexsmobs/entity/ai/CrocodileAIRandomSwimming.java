...
public class CrocodileAIRandomSwimming extends RandomStrollGoal {
   ...
   public boolean m_8036_() {
      if (!this.f_25725_.m_20160_()
         && !((EntityCrocodile)this.f_25725_).isSitting()
         && this.f_25725_.m_5448_() == null
         && (this.f_25725_.m_20069_() || !(this.f_25725_ instanceof ISemiAquatic) || ((ISemiAquatic)this.f_25725_).shouldEnterWater())) {
   ...
   protected Vec3 m_7037_() {
      if (this.f_25725_.m_21536_() && this.f_25725_.m_20238_(Vec3.m_82512_(this.f_25725_.m_21534_())) > this.f_25725_.m_21535_() * this.f_25725_.m_21535_()) {
         return DefaultRandomPos.m_148412_(this.f_25725_, 7, 3, Vec3.m_82539_(this.f_25725_.m_21534_()), 1.0);
      } else {
         ...
         Vec3 vector3d = DefaultRandomPos.m_148403_(this.f_25725_, 7, 3);
         int i = 0;
