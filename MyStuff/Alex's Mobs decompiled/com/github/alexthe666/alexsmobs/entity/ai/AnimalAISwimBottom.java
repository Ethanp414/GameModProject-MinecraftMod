   ...
   protected Vec3 m_7037_() {
      ...
      while (
         vec != null
            && !this.f_25725_
               .m_9236_()
               .m_8055_(AMBlockPos.fromVec3(vec))
               .m_60647_(this.f_25725_.m_9236_(), AMBlockPos.fromVec3(vec), PathComputationType.WATER)
            && var2++ < 10
      ) {
      ...
      if (vec == null) {
         ...
         while (
            this.f_25725_.m_9236_().m_6425_(pos).m_205070_(FluidTags.f_13131_)
               && this.f_25725_.m_9236_().m_8055_(pos).m_60647_(this.f_25725_.m_9236_(), AMBlockPos.fromVec3(vec), PathComputationType.WATER)
               && pos.m_123342_() > 1
         ) {
            pos = pos.m_7495_();
         }
