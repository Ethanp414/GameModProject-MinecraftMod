...
public class BoneSerpentAIFindLava extends Goal {
   ...
   public boolean m_8036_() {
      if ((this.creature.jumpCooldown == 0 || this.creature.m_20096_())
   ...
   public void m_8056_() {
      if (this.targetPos != null) {
         this.creature.m_21573_().m_26519_(this.targetPos.m_123341_(), this.targetPos.m_123342_(), this.targetPos.m_123343_(), 0.5);
      }
   }
