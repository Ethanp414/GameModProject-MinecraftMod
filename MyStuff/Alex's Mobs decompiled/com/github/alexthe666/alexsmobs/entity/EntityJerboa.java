...
public class EntityJerboa extends Animal {
   ...
   public static Builder bakeAttributes() {
      return Monster.m_33035_().m_22268_(Attributes.f_22276_, 4.0).m_22268_(Attributes.f_22279_, 0.45F);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new JerboaAIBeg(this, 1.0));
      this.f_21345_.m_25352_(2, new BreedGoal(this, 1.0));
      this.f_21345_.m_25352_(3, new AvoidEntityGoal(this, Player.class, 5.0F, 1.3, 1.0) {
         public boolean m_8036_() {
            return !EntityJerboa.this.isBefriended() && super.m_8036_();
         }
      });
      this.f_21345_.m_25352_(4, new AvoidEntityGoal(this, Cat.class, 9.0F, 1.3, 1.0));
      this.f_21345_.m_25352_(5, new AvoidEntityGoal(this, Ocelot.class, 9.0F, 1.3, 1.0));
      this.f_21345_.m_25352_(6, new AvoidEntityGoal(this, EntityRattlesnake.class, 9.0F, 1.3, 1.0));
      this.f_21345_.m_25352_(7, new PanicGoal(this, 1.1));
      this.f_21345_.m_25352_(8, new AnimalAIWanderRanged(this, 20, 1.0, 10, 7));
   ...
   public void m_8119_() {
      ...
      if ((Boolean)this.f_19804_.m_135370_(JUMP_ACTIVE)) {
   ...
   public void setBefriended(boolean befriended) {
      this.f_19804_.m_135381_(BEFRIENDED, befriended);
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      ...
      if (prev) {
         ...
         if (source.m_7639_() != null && source.m_7639_() instanceof LivingEntity) {
            ...
            if (hurter.m_21023_((MobEffect)AMEffectRegistry.FLEET_FOOTED.get())) {
   ...
   public static <T extends Mob> boolean canJerboaSpawn(
      ...
      return reason == MobSpawnType.SPAWNER || iServerWorld.m_45527_(pos.m_7494_()) && canMonsterSpawnInLight(entityType, iServerWorld, reason, pos, random);
   }
   ...
   protected void m_6135_() {
      ...
      if (d0 > 0.0) {
         double d1 = this.m_20184_().m_165924_();
         if (d1 < 0.01) {
         }
      }
   ...
   public AgeableMob m_142606_(ServerLevel p_146743_, AgeableMob p_146744_) {
      EntityJerboa boa = (EntityJerboa)((EntityType)AMEntityRegistry.JERBOA.get()).m_20615_(p_146743_);
   ...
   static class MoveHelperController extends MoveControl {
      ...
      public void m_8126_() {
         if (this.jerboa.hasJumper()
            && this.jerboa.m_20096_()
            && !this.jerboa.f_20899_
            && !((EntityJerboa.JumpHelperController)this.jerboa.f_21343_).getIsJumping()) {
