...
public class MessageTransmuteFromMenu {
   ...
   public static class Handler {
      public static void handle(MessageTransmuteFromMenu message, Supplier<Context> context) {
         ...
         context.get().enqueueWork(() -> {
            ...
            if (player.m_19879_() == message.playerId && player.f_36096_ instanceof MenuTransmutationTable table) {
