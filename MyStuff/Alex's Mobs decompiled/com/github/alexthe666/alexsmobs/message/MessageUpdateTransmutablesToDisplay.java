...
public class MessageUpdateTransmutablesToDisplay {
   ...
   public static MessageUpdateTransmutablesToDisplay read(FriendlyByteBuf buf) {
      return new MessageUpdateTransmutablesToDisplay(
         buf.readInt(), PacketBufferUtils.readItemStack(buf), PacketBufferUtils.readItemStack(buf), PacketBufferUtils.readItemStack(buf)
      );
   }
   ...
   public static class Handler {
      public static void handle(MessageUpdateTransmutablesToDisplay message, Supplier<Context> context) {
