...
public class AMMenuRegistry {
   ...
   public static final RegistryObject<MenuType<MenuTransmutationTable>> TRANSMUTATION_TABLE = DEF_REG.register(
      "transmutation_table", () -> new MenuType(MenuTransmutationTable::new, FeatureFlags.f_244332_)
   );
}
