...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   VanillaRecipeProvider(HolderLookup.Provider $$0, RecipeOutput $$1) {
      super($$0, $$1);
   }
   ...
   protected void buildRecipes() {
      ...
      this.colorItemWithDye($$0, $$1, "wool", RecipeCategory.BUILDING_BLOCKS);
      this.colorItemWithDye($$0, $$2, "bed_dye", RecipeCategory.DECORATIONS);
      this.colorItemWithDye($$0, $$3, "carpet_dye", RecipeCategory.DECORATIONS);
      this.colorItemWithDye($$0, $$4, "harness_dye", RecipeCategory.COMBAT);
      ...
      this.shapeless(RecipeCategory.FOOD, Items.MUSHROOM_STEW)
         ...
         .unlockedBy("has_red_mushroom", this.has(Blocks.RED_MUSHROOM))
         .save(this.output);
      BuiltInRegistries.ITEM.stream().forEach($$0x -> {
         SuspiciousEffectHolder $$1xx = SuspiciousEffectHolder.tryGet($$0x);
         if ($$1xx != null) {
            this.suspiciousStew($$0x, $$1xx);
         }
      });
      ...
      smithingTrims().forEach($$0x -> this.trimSmithing($$0x.template(), $$0x.patternId(), $$0x.recipeId()));
   ...
   public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
      return Stream.of(
         ...
         .map($$0 -> {
            Item $$1 = (Item)$$0.getFirst();
            ResourceKey<TrimPattern> $$2 = (ResourceKey)$$0.getSecond();
            ResourceKey<Recipe<?>> $$3 = ResourceKey.create(Registries.RECIPE, ResourceLocation.withDefaultNamespace(getItemName($$1) + "_smithing_trim"));
            return new VanillaRecipeProvider.TrimTemplate($$1, $$2, $$3);
         });
   }

   private void shulkerBoxRecipes() {
      Ingredient $$0 = this.tag(ItemTags.SHULKER_BOXES);

      for(DyeColor $$1 : DyeColor.values()) {
         TransmuteRecipeBuilder.transmute(RecipeCategory.DECORATIONS, $$0, Ingredient.of(DyeItem.byColor($$1)), ShulkerBoxBlock.getBlockByColor($$1).asItem())
   ...
   private void bundleRecipes() {
      Ingredient $$0 = this.tag(ItemTags.BUNDLES);

      for(DyeColor $$1 : DyeColor.values()) {
         DyeItem $$2 = DyeItem.byColor($$1);
         TransmuteRecipeBuilder.transmute(RecipeCategory.TOOLS, $$0, Ingredient.of($$2), BundleItem.getByColor($$1))
            .group("bundle_dye")
   ...
   public static class Runner extends RecipeProvider.Runner {
      public Runner(PackOutput $$0, CompletableFuture<HolderLookup.Provider> $$1) {
         super($$0, $$1);
      }

      @Override
      protected RecipeProvider createRecipeProvider(HolderLookup.Provider $$0, RecipeOutput $$1) {
         return new VanillaRecipeProvider($$0, $$1);
      }
