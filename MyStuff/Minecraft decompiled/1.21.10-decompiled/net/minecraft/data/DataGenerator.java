...
public class DataGenerator {
   ...
   public void run() throws IOException {
      ...
      this.providersToRun.forEach(($$2x, $$3) -> {
         if (!this.alwaysGenerate && !$$0.shouldRunInThisVersion($$2x)) {
            ...
            $$2.start();
            $$0.applyUpdate((HashCache.UpdateResult)$$0.generateUpdate($$2x, $$3::run).join());
            $$2.stop();
   ...
   public DataGenerator.PackGenerator getVanillaPack(boolean $$0) {
      return new DataGenerator.PackGenerator($$0, "vanilla", this.vanillaPackOutput);
   }

   public DataGenerator.PackGenerator getBuiltinDatapack(boolean $$0, String $$1) {
      Path $$2 = this.vanillaPackOutput.getOutputFolder(PackOutput.Target.DATA_PACK).resolve("minecraft").resolve("datapacks").resolve($$1);
      return new DataGenerator.PackGenerator($$0, $$1, new PackOutput($$2));
   }
