...
public class ProcessorLists {
   ...
   public static void bootstrap(BootstrapContext<StructureProcessorList> $$0) {
      ...
      register($$0, OUTPOST_ROT, ImmutableList.of(new BlockRotProcessor(0.05F)));
      register(
         $$0,
         BOTTOM_RAMPART,
         ImmutableList.of(
      ...
      register($$0, FOSSIL_ROT, ImmutableList.of(new BlockRotProcessor(0.9F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register($$0, FOSSIL_COAL, ImmutableList.of(new BlockRotProcessor(0.1F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register(
         $$0,
         FOSSIL_DIAMONDS,
         ImmutableList.of(
      ...
      register(
         ...
         ImmutableList.of(
            new BlockRotProcessor($$1.getOrThrow(BlockTags.ANCIENT_CITY_REPLACEABLE), 0.95F),
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.DEEPSLATE_BRICKS, 0.3F), AlwaysTrueTest.INSTANCE, Blocks.CRACKED_DEEPSLATE_BRICKS.defaultBlockState()
      ...
      register($$0, TRAIL_RUINS_TOWER_TOP_ARCHAEOLOGY, List.of(trailsArchyLootProcessor(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON, 2)));
      register(
         $$0,
