...
public class NetherFeatures {
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      FeatureUtils.register($$0, SMALL_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(ConstantInt.of(1), UniformInt.of(1, 4)));
      FeatureUtils.register($$0, LARGE_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(UniformInt.of(2, 3), UniformInt.of(5, 10)));
      FeatureUtils.register(
         $$0,
         BASALT_BLOBS,
      ...
      FeatureUtils.register($$0, GLOWSTONE_EXTRA, Feature.GLOWSTONE_BLOB);
      WeightedStateProvider $$1 = new WeightedStateProvider(
      ...
      FeatureUtils.register($$0, CRIMSON_FOREST_VEGETATION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig($$1, 8, 4));
      FeatureUtils.register($$0, CRIMSON_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig($$1, 3, 1));
      WeightedStateProvider $$2 = new WeightedStateProvider(
         WeightedList.<BlockState>builder()
      ...
      FeatureUtils.register($$0, WARPED_FOREST_VEGETION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig($$2, 8, 4));
      FeatureUtils.register($$0, WARPED_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig($$2, 3, 1));
      FeatureUtils.register(
         $$0, NETHER_SPROUTS, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(BlockStateProvider.simple(Blocks.NETHER_SPROUTS), 8, 4)
      );
      FeatureUtils.register(
         $$0,
      ...
      FeatureUtils.register($$0, TWISTING_VINES, Feature.TWISTING_VINES, new TwistingVinesConfig(8, 4, 8));
      FeatureUtils.register($$0, TWISTING_VINES_BONEMEAL, Feature.TWISTING_VINES, new TwistingVinesConfig(3, 1, 2));
      FeatureUtils.register($$0, WEEPING_VINES, Feature.WEEPING_VINES);
      FeatureUtils.register(
         $$0,
         PATCH_CRIMSON_ROOTS,
      ...
      FeatureUtils.register($$0, BASALT_PILLAR, Feature.BASALT_PILLAR);
      FeatureUtils.register(
         $$0,
         SPRING_LAVA_NETHER,
         Feature.SPRING,
