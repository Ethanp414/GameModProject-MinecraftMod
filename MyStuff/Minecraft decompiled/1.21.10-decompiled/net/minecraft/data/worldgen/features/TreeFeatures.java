...
public class TreeFeatures {
   ...
   private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(Block $$0, Block $$1, int $$2, int $$3, int $$4, int $$5) {
      return new TreeConfiguration.TreeConfigurationBuilder(
         BlockStateProvider.simple($$0),
         new StraightTrunkPlacer($$2, $$3, $$4),
         BlockStateProvider.simple($$1),
   ...
   private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenBirch(int $$0) {
      return createFallenTrees(Blocks.BIRCH_LOG, 5, $$0);
   }
   ...
   private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block $$0, int $$1, int $$2) {
      return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple($$0), UniformInt.of($$1, $$2))
         .logDecorators(
            ImmutableList.of(
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      ...
      BlockPredicate $$2 = BlockPredicate.matchesBlocks(
         Blocks.OAK_SAPLING,
      ...
      FeatureUtils.register($$0, OAK, Feature.TREE, createOak().build());
      FeatureUtils.register($$0, DARK_OAK, Feature.TREE, createDarkOak().ignoreVines().build());
      FeatureUtils.register(
         $$0,
         PALE_OAK,
         Feature.TREE,
      ...
      FeatureUtils.register($$0, BIRCH, Feature.TREE, createBirch().build());
      FeatureUtils.register(
         $$0,
         ACACIA,
         Feature.TREE,
      ...
      FeatureUtils.register($$0, CHERRY, Feature.TREE, cherry().build());
      FeatureUtils.register($$0, CHERRY_BEES_005, Feature.TREE, cherry().decorators(List.of($$6)).build());
      FeatureUtils.register(
         $$0,
         SPRUCE,
         Feature.TREE,
      ...
      FeatureUtils.register($$0, FANCY_OAK, Feature.TREE, createFancyOak().build());
      FeatureUtils.register($$0, JUNGLE_TREE_NO_VINE, Feature.TREE, createJungleTree().ignoreVines().build());
      FeatureUtils.register(
         $$0,
         MEGA_JUNGLE_TREE,
         Feature.TREE,
      ...
      FeatureUtils.register($$0, SUPER_BIRCH_BEES_0002, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$3)).build());
      FeatureUtils.register($$0, SUPER_BIRCH_BEES, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$7)).build());
      FeatureUtils.register(
         $$0,
         SWAMP_OAK,
         Feature.TREE,
      ...
      FeatureUtils.register(
         ...
         new TreeConfiguration.TreeConfigurationBuilder(
               ...
               new UpwardsBranchingTrunkPlacer(
                  2, 1, 4, UniformInt.of(1, 4), 0.5F, UniformInt.of(0, 1), $$1.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)
               ),
               ...
               Optional.of(
                  new MangroveRootPlacer(
                     ...
                     new MangroveRootPlacement(
                        $$1.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH),
      ...
      FeatureUtils.register(
         ...
         new TreeConfiguration.TreeConfigurationBuilder(
               BlockStateProvider.simple(Blocks.MANGROVE_LOG),
               new UpwardsBranchingTrunkPlacer(
                  4, 1, 9, UniformInt.of(1, 6), 0.5F, UniformInt.of(0, 1), $$1.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)
               ),
               BlockStateProvider.simple(Blocks.MANGROVE_LEAVES),
               new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70),
               Optional.of(
      ...
      FeatureUtils.register($$0, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createOak().decorators(List.of($$3, $$8, $$9)).build());
      FeatureUtils.register($$0, OAK_BEES_002, Feature.TREE, createOak().decorators(List.of($$5)).build());
      FeatureUtils.register($$0, OAK_BEES_005, Feature.TREE, createOak().decorators(List.of($$6)).build());
      FeatureUtils.register($$0, BIRCH_BEES_0002, Feature.TREE, createBirch().decorators(List.of($$3)).build());
      FeatureUtils.register($$0, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, createBirch().decorators(List.of($$3, $$8, $$9)).build());
      FeatureUtils.register($$0, BIRCH_BEES_002, Feature.TREE, createBirch().decorators(List.of($$5)).build());
      FeatureUtils.register($$0, BIRCH_BEES_005, Feature.TREE, createBirch().decorators(List.of($$6)).build());
      FeatureUtils.register($$0, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of($$3, $$8, $$9)).build());
      FeatureUtils.register($$0, FANCY_OAK_BEES_002, Feature.TREE, createFancyOak().decorators(List.of($$5)).build());
      FeatureUtils.register($$0, FANCY_OAK_BEES_005, Feature.TREE, createFancyOak().decorators(List.of($$6)).build());
      FeatureUtils.register($$0, FANCY_OAK_BEES, Feature.TREE, createFancyOak().decorators(List.of($$7)).build());
      FeatureUtils.register($$0, OAK_LEAF_LITTER, Feature.TREE, createOak().decorators(ImmutableList.of($$8, $$9)).build());
      FeatureUtils.register($$0, DARK_OAK_LEAF_LITTER, Feature.TREE, createDarkOak().ignoreVines().decorators(ImmutableList.of($$8, $$9)).build());
      FeatureUtils.register($$0, BIRCH_LEAF_LITTER, Feature.TREE, createBirch().decorators(ImmutableList.of($$8, $$9)).build());
      FeatureUtils.register($$0, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of($$8, $$9)).build());
      FeatureUtils.register($$0, FALLEN_OAK_TREE, Feature.FALLEN_TREE, createFallenOak().build());
      FeatureUtils.register($$0, FALLEN_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(8).build());
      FeatureUtils.register($$0, FALLEN_SUPER_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(15).build());
      FeatureUtils.register($$0, FALLEN_JUNGLE_TREE, Feature.FALLEN_TREE, createFallenJungle().build());
      FeatureUtils.register($$0, FALLEN_SPRUCE_TREE, Feature.FALLEN_TREE, createFallenSpruce().build());
   }
}
