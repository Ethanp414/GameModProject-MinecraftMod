...
public class OreFeatures {
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> $$0) {
      RuleTest $$1 = new TagMatchTest(BlockTags.BASE_STONE_OVERWORLD);
      RuleTest $$2 = new TagMatchTest(BlockTags.STONE_ORE_REPLACEABLES);
      RuleTest $$3 = new TagMatchTest(BlockTags.DEEPSLATE_ORE_REPLACEABLES);
      RuleTest $$4 = new BlockMatchTest(Blocks.NETHERRACK);
      RuleTest $$5 = new TagMatchTest(BlockTags.BASE_STONE_NETHER);
      List<OreConfiguration.TargetBlockState> $$6 = List.of(
         OreConfiguration.target($$2, Blocks.IRON_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_IRON_ORE.defaultBlockState())
      );
      List<OreConfiguration.TargetBlockState> $$7 = List.of(
         OreConfiguration.target($$2, Blocks.GOLD_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_GOLD_ORE.defaultBlockState())
      );
      List<OreConfiguration.TargetBlockState> $$8 = List.of(
         OreConfiguration.target($$2, Blocks.DIAMOND_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_DIAMOND_ORE.defaultBlockState())
      );
      List<OreConfiguration.TargetBlockState> $$9 = List.of(
         OreConfiguration.target($$2, Blocks.LAPIS_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState())
      );
      List<OreConfiguration.TargetBlockState> $$10 = List.of(
         OreConfiguration.target($$2, Blocks.COPPER_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_COPPER_ORE.defaultBlockState())
      );
      List<OreConfiguration.TargetBlockState> $$11 = List.of(
         OreConfiguration.target($$2, Blocks.COAL_ORE.defaultBlockState()), OreConfiguration.target($$3, Blocks.DEEPSLATE_COAL_ORE.defaultBlockState())
      );
      ...
      FeatureUtils.register($$0, ORE_COAL, Feature.ORE, new OreConfiguration($$11, 17));
      FeatureUtils.register($$0, ORE_COAL_BURIED, Feature.ORE, new OreConfiguration($$11, 17, 0.5F));
      FeatureUtils.register($$0, ORE_IRON, Feature.ORE, new OreConfiguration($$6, 9));
      FeatureUtils.register($$0, ORE_IRON_SMALL, Feature.ORE, new OreConfiguration($$6, 4));
      FeatureUtils.register($$0, ORE_GOLD, Feature.ORE, new OreConfiguration($$7, 9));
      FeatureUtils.register($$0, ORE_GOLD_BURIED, Feature.ORE, new OreConfiguration($$7, 9, 0.5F));
      FeatureUtils.register(
         ...
         new OreConfiguration(
            List.of(
               OreConfiguration.target($$2, Blocks.REDSTONE_ORE.defaultBlockState()),
               OreConfiguration.target($$3, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())
            ),
            8
         )
      );
      FeatureUtils.register($$0, ORE_DIAMOND_SMALL, Feature.ORE, new OreConfiguration($$8, 4, 0.5F));
      FeatureUtils.register($$0, ORE_DIAMOND_LARGE, Feature.ORE, new OreConfiguration($$8, 12, 0.7F));
      FeatureUtils.register($$0, ORE_DIAMOND_BURIED, Feature.ORE, new OreConfiguration($$8, 8, 1.0F));
      FeatureUtils.register($$0, ORE_DIAMOND_MEDIUM, Feature.ORE, new OreConfiguration($$8, 8, 0.5F));
      FeatureUtils.register($$0, ORE_LAPIS, Feature.ORE, new OreConfiguration($$9, 7));
      FeatureUtils.register($$0, ORE_LAPIS_BURIED, Feature.ORE, new OreConfiguration($$9, 7, 1.0F));
      FeatureUtils.register(
         $$0,
         ORE_INFESTED,
         Feature.ORE,
         new OreConfiguration(
            List.of(
               OreConfiguration.target($$2, Blocks.INFESTED_STONE.defaultBlockState()),
               OreConfiguration.target($$3, Blocks.INFESTED_DEEPSLATE.defaultBlockState())
            ),
            9
         )
      );
      FeatureUtils.register(
         ...
         new OreConfiguration(
            List.of(
               OreConfiguration.target($$2, Blocks.EMERALD_ORE.defaultBlockState()),
               OreConfiguration.target($$3, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())
            ),
            3
         )
      );
      FeatureUtils.register(
         $$0, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration($$5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F)
      );
      FeatureUtils.register(
         $$0, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration($$5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F)
      );
      FeatureUtils.register($$0, ORE_COPPPER_SMALL, Feature.ORE, new OreConfiguration($$10, 10));
      FeatureUtils.register($$0, ORE_COPPER_LARGE, Feature.ORE, new OreConfiguration($$10, 20));
