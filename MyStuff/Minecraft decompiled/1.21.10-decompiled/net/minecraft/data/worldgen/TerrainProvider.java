...
public class TerrainProvider {
   ...
   public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> overworldOffset(I $$0, I $$1, I $$2, boolean $$3) {
      ...
      return CubicSpline.<C, I>builder($$0, $$4)
   ...
   public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> overworldFactor(I $$0, I $$1, I $$2, I $$3, boolean $$4) {
      ...
      return CubicSpline.<C, I>builder($$0, NO_TRANSFORM)
   ...
   public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> overworldJaggedness(I $$0, I $$1, I $$2, I $$3, boolean $$4) {
      ...
      float $$6 = 0.65F;
      return CubicSpline.<C, I>builder($$0, $$5)
         .addPoint(-0.11F, 0.0F)
   ...
   private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> buildErosionJaggednessSpline(
      ...
      return CubicSpline.<C, I>builder($$0, $$7).addPoint(-1.0F, $$9).addPoint(-0.78F, $$10).addPoint(-0.5775F, $$10).addPoint(-0.375F, 0.0F).build();
   }
   ...
   private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> buildWeirdnessJaggednessSpline(I $$0, float $$1, BoundedFloatFunction<Float> $$2) {
      float $$3 = 0.63F * $$1;
      float $$4 = 0.3F * $$1;
      return CubicSpline.<C, I>builder($$0, $$2).addPoint(-0.01F, $$3).addPoint(0.01F, $$4).build();
   }
   ...
   private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> getErosionFactor(
      ...
      CubicSpline<C, I> $$6 = CubicSpline.<C, I>builder($$1, $$5).addPoint(-0.2F, 6.3F).addPoint(0.2F, $$3).build();
      CubicSpline.Builder<C, I> $$7 = CubicSpline.<C, I>builder($$0, $$5)
         .addPoint(-0.6F, $$6)
         .addPoint(-0.5F, CubicSpline.<C, I>builder($$1, $$5).addPoint(-0.05F, 6.3F).addPoint(0.05F, 2.67F).build())
         .addPoint(-0.35F, $$6)
         .addPoint(-0.25F, $$6)
         .addPoint(-0.1F, CubicSpline.<C, I>builder($$1, $$5).addPoint(-0.05F, 2.67F).addPoint(0.05F, 6.3F).build())
         .addPoint(0.03F, $$6);
      if ($$4) {
         CubicSpline<C, I> $$8 = CubicSpline.<C, I>builder($$1, $$5).addPoint(0.0F, $$3).addPoint(0.1F, 0.625F).build();
         CubicSpline<C, I> $$9 = CubicSpline.<C, I>builder($$2, $$5).addPoint(-0.9F, $$3).addPoint(-0.69F, $$8).build();
         $$7.addPoint(0.35F, $$3).addPoint(0.45F, $$9).addPoint(0.55F, $$9).addPoint(0.62F, $$3);
      } else {
         CubicSpline<C, I> $$10 = CubicSpline.<C, I>builder($$2, $$5).addPoint(-0.7F, $$6).addPoint(-0.15F, 1.37F).build();
         CubicSpline<C, I> $$11 = CubicSpline.<C, I>builder($$2, $$5).addPoint(0.45F, $$6).addPoint(0.7F, 1.56F).build();
   ...
   private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> buildMountainRidgeSplineWithPoints(
      ...
      CubicSpline.Builder<C, I> $$4 = CubicSpline.builder($$0, $$3);
      float $$5 = -0.7F;
      float $$6 = -1.0F;
   ...
   public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> buildErosionOffsetSpline(
      ...
      CubicSpline<C, I> $$21 = CubicSpline.<C, I>builder($$1, $$10).addPoint(-1.0F, $$2).addPoint(-0.4F, $$19).addPoint(0.0F, $$4 + 0.07F).build();
      CubicSpline<C, I> $$22 = ridgeSpline($$1, -0.02F, $$7, $$7, $$3, $$4, 0.0F, $$10);
      CubicSpline.Builder<C, I> $$23 = CubicSpline.<C, I>builder($$0, $$10)
         .addPoint(-0.85F, $$14)
         .addPoint(-0.7F, $$15)
         .addPoint(-0.4F, $$16)
         .addPoint(-0.35F, $$17)
   ...
   private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> ridgeSpline(
      ...
      float $$9 = 5.0F * ($$3 - $$2);
      return CubicSpline.<C, I>builder($$0, $$7)
         .addPoint(-1.0F, $$1, $$8)
