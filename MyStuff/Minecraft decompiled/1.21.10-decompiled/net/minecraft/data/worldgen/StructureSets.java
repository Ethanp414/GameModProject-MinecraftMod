...
public interface StructureSets {
   static void bootstrap(BootstrapContext<StructureSet> $$0) {
      ...
      $$0.register(
         ...
         new StructureSet(
            ...
            new RandomSpreadStructurePlacement(
               ...
               0.2F,
               165745296,
               Optional.of(new StructurePlacement.ExclusionZone($$3, 10)),
               32,
               8,
      ...
      $$0.register(
         ...
         new StructureSet(
            $$1.getOrThrow(BuiltinStructures.WOODLAND_MANSION), new RandomSpreadStructurePlacement(80, 20, RandomSpreadType.TRIANGULAR, 10387319)
         )
      );
      $$0.register(
      ...
      $$0.register(
         ...
         new StructureSet(
            List.of(
               StructureSet.entry($$1.getOrThrow(BuiltinStructures.FORTRESS), 2), StructureSet.entry($$1.getOrThrow(BuiltinStructures.BASTION_REMNANT), 3)
            ),
