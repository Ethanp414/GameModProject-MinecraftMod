...
public class DesertVillagePools {
   ...
   public static void bootstrap(BootstrapContext<StructureTemplatePool> $$0) {
      ...
      Holder<PlacedFeature> $$2 = $$1.getOrThrow(VillagePlacements.PATCH_CACTUS_VILLAGE);
      ...
      Holder<StructureProcessorList> $$5 = $$4.getOrThrow(ProcessorLists.ZOMBIE_DESERT);
      Holder<StructureProcessorList> $$6 = $$4.getOrThrow(ProcessorLists.FARM_DESERT);
      ...
      Holder<StructureTemplatePool> $$9 = $$7.getOrThrow(TERMINATORS_KEY);
      Holder<StructureTemplatePool> $$10 = $$7.getOrThrow(ZOMBIE_TERMINATORS_KEY);
      $$0.register(
         START,
         new StructureTemplatePool(
            ...
            ImmutableList.of(
               ...
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/town_centers/desert_meeting_point_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/town_centers/desert_meeting_point_2", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/town_centers/desert_meeting_point_3", $$5), 1)
            ),
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            ...
            ImmutableList.of(
               ...
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_large_farm_1", $$6), 11),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_farm_1", $$6), 4),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_farm_2", $$6), 4),
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$10,
            ImmutableList.of(
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_2", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_3", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_4", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_5", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_6", $$5), 1),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_7", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_small_house_8", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_medium_house_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/zombie/houses/desert_medium_house_2", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_butcher_shop_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_tool_smith_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_fletcher_house_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_shepherd_house_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_armorer_1", $$5), 1),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_fisher_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_tannery_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_cartographer_house_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_library_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_mason_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_weaponsmith_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_temple_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_temple_2", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_large_farm_1", $$5), 7),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_farm_1", $$5), 4),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_farm_2", $$5), 4),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_animal_pen_1", $$5), 2),
               Pair.of(StructurePoolElement.legacy("village/desert/houses/desert_animal_pen_2", $$5), 2),
               Pair.of(StructurePoolElement.empty(), 5)
            ),
            StructureTemplatePool.Projection.RIGID
         )
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$8,
            ImmutableList.of(
               Pair.of(StructurePoolElement.legacy("village/desert/desert_lamp_1", $$5), 10),
               Pair.of(StructurePoolElement.feature($$2), 4),
               Pair.of(StructurePoolElement.feature($$3), 4),
               Pair.of(StructurePoolElement.empty(), 10)
            ),
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$8, ImmutableList.of(Pair.of(StructurePoolElement.legacy("village/desert/camel_spawn"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
