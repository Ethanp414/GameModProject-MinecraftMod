...
public class NetherBiomes {
   public static Biome netherWastes(HolderGetter<PlacedFeature> $$0, HolderGetter<ConfiguredWorldCarver<?>> $$1) {
      MobSpawnSettings $$2 = new MobSpawnSettings.Builder()
      ...
      $$3.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_OPEN)
   ...
   public static Biome soulSandValley(HolderGetter<PlacedFeature> $$0, HolderGetter<ConfiguredWorldCarver<?>> $$1) {
      double $$2 = 0.7;
      double $$3 = 0.15;
      MobSpawnSettings $$4 = new MobSpawnSettings.Builder()
