...
public class Structures {
   public static void bootstrap(BootstrapContext<Structure> $$0) {
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_PILLAGER_OUTPOST))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
      ...
      $$0.register(
         ...
         new MineshaftStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_MINESHAFT))
      ...
      $$0.register(
         ...
         new MineshaftStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_MINESHAFT_MESA))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
               .build(),
      ...
      $$0.register(
         BuiltinStructures.WOODLAND_MANSION, new WoodlandMansionStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_WOODLAND_MANSION)))
      );
      $$0.register(BuiltinStructures.JUNGLE_TEMPLE, new JungleTempleStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_JUNGLE_TEMPLE))));
      $$0.register(BuiltinStructures.DESERT_PYRAMID, new DesertPyramidStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_DESERT_PYRAMID))));
      $$0.register(BuiltinStructures.IGLOO, new IglooStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_IGLOO))));
      $$0.register(BuiltinStructures.SHIPWRECK, new ShipwreckStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_SHIPWRECK)), false));
      $$0.register(
         BuiltinStructures.SHIPWRECK_BEACHED, new ShipwreckStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_SHIPWRECK_BEACHED)), true)
      );
      $$0.register(
         BuiltinStructures.SWAMP_HUT,
         new SwampHutStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_SWAMP_HUT))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
                     new StructureSpawnOverride(
      ...
      $$0.register(
         ...
         new StrongholdStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_STRONGHOLD)).terrainAdapation(TerrainAdjustment.BURY).build()
         )
      );
      $$0.register(
         BuiltinStructures.OCEAN_MONUMENT,
         new OceanMonumentStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_OCEAN_MONUMENT))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
                     new StructureSpawnOverride(
      ...
      $$0.register(
         ...
         new OceanRuinStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_COLD)), OceanRuinStructure.Type.COLD, 0.3F, 0.9F)
      );
      $$0.register(
         BuiltinStructures.OCEAN_RUIN_WARM,
         new OceanRuinStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_WARM)), OceanRuinStructure.Type.WARM, 0.3F, 0.9F)
      );
      $$0.register(
         BuiltinStructures.FORTRESS,
         new NetherFortressStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_NETHER_FORTRESS))
               .spawnOverrides(
                  Map.of(
      ...
      $$0.register(
         ...
         new NetherFossilStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_NETHER_FOSSIL))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_DECORATION)
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      $$0.register(BuiltinStructures.END_CITY, new EndCityStructure(new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_END_CITY))));
      $$0.register(
         BuiltinStructures.BURIED_TREASURE,
         new BuriedTreasureStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_BURIED_TREASURE))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
               .build()
         )
      );
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_BASTION_REMNANT)),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_VILLAGE_PLAINS)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_VILLAGE_DESERT)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_VILLAGE_SAVANNA)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_VILLAGE_SNOWY)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_VILLAGE_TAIGA)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_DESERT)),
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_JUNGLE)),
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_SWAMP)),
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_MOUNTAIN)),
            List.of(
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_OCEAN)),
      ...
      $$0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings($$1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_NETHER)),
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_ANCIENT_CITY))
               .spawnOverrides(
                  (Map<MobCategory, StructureSpawnOverride>)Arrays.stream(MobCategory.values())
                     .collect(
                        Collectors.toMap($$0x -> $$0x, $$0x -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedList.of()))
                     )
               )
               .generationStep(GenerationStep.Decoration.UNDERGROUND_DECORATION)
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_TRAIL_RUINS))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
      ...
      $$0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder($$1.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
               .terrainAdapation(TerrainAdjustment.ENCAPSULATE)
               .spawnOverrides(
                  (Map<MobCategory, StructureSpawnOverride>)Arrays.stream(MobCategory.values())
                     .collect(
                        Collectors.toMap($$0x -> $$0x, $$0x -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of()))
                     )
               )
               .build(),
