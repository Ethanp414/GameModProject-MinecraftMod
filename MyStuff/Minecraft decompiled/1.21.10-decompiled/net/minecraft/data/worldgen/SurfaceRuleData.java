...
public class SurfaceRuleData {
   ...
   public static SurfaceRules.RuleSource overworldLike(boolean $$0, boolean $$1, boolean $$2) {
      ...
      SurfaceRules.RuleSource $$21 = SurfaceRules.sequence(
         SurfaceRules.ifTrue(
         ...
         SurfaceRules.ifTrue(
            ...
            SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.05, 0.05), $$18), STONE)
         ),
      ...
      SurfaceRules.RuleSource $$24 = SurfaceRules.sequence(
         SurfaceRules.ifTrue(
         ...
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue($$15, STONE), $$22, SurfaceRules.ifTrue($$11, SNOW_BLOCK))
         ),
         SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), STONE),
         SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.GROVE), SurfaceRules.sequence($$22, DIRT)),
         $$21,
      ...
      SurfaceRules.RuleSource $$25 = SurfaceRules.sequence(
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.FROZEN_PEAKS),
            SurfaceRules.sequence(
               SurfaceRules.ifTrue($$15, PACKED_ICE),
         ...
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue($$15, STONE), $$23, SurfaceRules.ifTrue($$11, SNOW_BLOCK))
         ),
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue($$15, STONE), SurfaceRules.ifTrue($$11, SNOW_BLOCK))
         ),
         SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.GROVE), SurfaceRules.sequence($$23, SurfaceRules.ifTrue($$11, SNOW_BLOCK))),
         $$21,
         SurfaceRules.ifTrue(
         ...
         SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.ICE_SPIKES), SurfaceRules.ifTrue($$11, SNOW_BLOCK)),
         SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MANGROVE_SWAMP), MUD),
      ...
      SurfaceRules.RuleSource $$29 = SurfaceRules.sequence(
         SurfaceRules.ifTrue(
            ...
            SurfaceRules.sequence(
               SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.sequence(
                     ...
                     SurfaceRules.ifTrue($$10, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_CEILING, RED_SANDSTONE), RED_SAND)),
               ...
               SurfaceRules.ifTrue(
                  $$5,
                  SurfaceRules.sequence(SurfaceRules.ifTrue($$9, SurfaceRules.ifTrue(SurfaceRules.not($$6), ORANGE_TERRACOTTA)), SurfaceRules.bandlands())
               ),
            ...
            SurfaceRules.ifTrue(
               ...
               SurfaceRules.sequence(
                  SurfaceRules.ifTrue(
                     $$14,
                     SurfaceRules.ifTrue(
                        $$13, SurfaceRules.sequence(SurfaceRules.ifTrue($$11, AIR), SurfaceRules.ifTrue(SurfaceRules.temperature(), ICE), WATER)
                     )
                  ),
                  $$25
               )
         ...
         SurfaceRules.ifTrue(
            ...
            SurfaceRules.sequence(
               ...
               SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN), $$17),
               $$18
            )
         )
      );
      ...
      return SurfaceRules.sequence((SurfaceRules.RuleSource[])$$30.build().toArray($$0x -> new SurfaceRules.RuleSource[$$0x]));
   }
      ...
      return SurfaceRules.sequence(
         ...
         SurfaceRules.ifTrue(
            ...
            SurfaceRules.sequence(
               ...
               SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence($$12, SurfaceRules.ifTrue($$11, BASALT), BLACKSTONE))
            )
         ),
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.SOUL_SAND_VALLEY),
            SurfaceRules.sequence(
               SurfaceRules.ifTrue(SurfaceRules.UNDER_CEILING, SurfaceRules.sequence(SurfaceRules.ifTrue($$11, SOUL_SAND), SOUL_SOIL)),
               SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence($$12, SurfaceRules.ifTrue($$11, SOUL_SAND), SOUL_SOIL))
            )
         ),
         SurfaceRules.ifTrue(
            SurfaceRules.ON_FLOOR,
            SurfaceRules.sequence(
               ...
               SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.ifTrue(
                     SurfaceRules.not($$9), SurfaceRules.ifTrue($$0, SurfaceRules.sequence(SurfaceRules.ifTrue($$10, WARPED_WART_BLOCK), WARPED_NYLIUM))
                  )
               ),
               SurfaceRules.ifTrue(
                  SurfaceRules.isBiome(Biomes.CRIMSON_FOREST),
                  SurfaceRules.ifTrue(
                     SurfaceRules.not($$9), SurfaceRules.ifTrue($$0, SurfaceRules.sequence(SurfaceRules.ifTrue($$10, NETHER_WART_BLOCK), CRIMSON_NYLIUM))
                  )
               )
            )
         ),
            ...
            SurfaceRules.sequence(
               ...
               SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.ifTrue(
                     ...
                     SurfaceRules.ifTrue(
                        $$3,
                        SurfaceRules.ifTrue($$7, SurfaceRules.sequence(SurfaceRules.ifTrue($$1, GRAVEL), SurfaceRules.ifTrue(SurfaceRules.not($$5), GRAVEL)))
                     )
                  )
               )
            )
