...
public class MiscOverworldPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      PlacementUtils.register($$0, ICE_SPIKE, $$2, CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      ...
      PlacementUtils.register($$0, FOREST_ROCK, $$4, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register($$0, ICEBERG_BLUE, $$6, RarityFilter.onAverageOnceEvery(200), InSquarePlacement.spread(), BiomeFilter.biome());
      PlacementUtils.register($$0, ICEBERG_PACKED, $$5, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), BiomeFilter.biome());
      PlacementUtils.register(
         $$0,
         BLUE_ICE,
         $$7,
      ...
      PlacementUtils.register($$0, FREEZE_TOP_LAYER, $$13, BiomeFilter.biome());
      PlacementUtils.register($$0, VOID_START_PLATFORM, $$14, BiomeFilter.biome());
      PlacementUtils.register(
         $$0, DESERT_WELL, $$15, RarityFilter.onAverageOnceEvery(1000), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
      );
      PlacementUtils.register(
         $$0,
         SPRING_LAVA,
