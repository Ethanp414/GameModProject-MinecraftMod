...
public class OrePlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      Holder<ConfiguredFeature<?, ?>> $$22 = $$1.getOrThrow(OreFeatures.ORE_DIAMOND_MEDIUM);
      Holder<ConfiguredFeature<?, ?>> $$23 = $$1.getOrThrow(OreFeatures.ORE_DIAMOND_LARGE);
      Holder<ConfiguredFeature<?, ?>> $$24 = $$1.getOrThrow(OreFeatures.ORE_DIAMOND_BURIED);
      Holder<ConfiguredFeature<?, ?>> $$25 = $$1.getOrThrow(OreFeatures.ORE_LAPIS);
      Holder<ConfiguredFeature<?, ?>> $$26 = $$1.getOrThrow(OreFeatures.ORE_LAPIS_BURIED);
      Holder<ConfiguredFeature<?, ?>> $$27 = $$1.getOrThrow(OreFeatures.ORE_INFESTED);
      Holder<ConfiguredFeature<?, ?>> $$28 = $$1.getOrThrow(OreFeatures.ORE_EMERALD);
      Holder<ConfiguredFeature<?, ?>> $$29 = $$1.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_LARGE);
      Holder<ConfiguredFeature<?, ?>> $$30 = $$1.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_SMALL);
      Holder<ConfiguredFeature<?, ?>> $$31 = $$1.getOrThrow(OreFeatures.ORE_COPPPER_SMALL);
      Holder<ConfiguredFeature<?, ?>> $$32 = $$1.getOrThrow(OreFeatures.ORE_COPPER_LARGE);
      Holder<ConfiguredFeature<?, ?>> $$33 = $$1.getOrThrow(OreFeatures.ORE_CLAY);
      PlacementUtils.register(
         $$0, ORE_MAGMA, $$2, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(27), VerticalAnchor.absolute(36)))
      );
      PlacementUtils.register(
         $$0, ORE_SOUL_SAND, $$3, commonOrePlacement(12, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(31)))
      );
      PlacementUtils.register($$0, ORE_GOLD_DELTAS, $$4, commonOrePlacement(20, PlacementUtils.RANGE_10_10));
      PlacementUtils.register($$0, ORE_QUARTZ_DELTAS, $$5, commonOrePlacement(32, PlacementUtils.RANGE_10_10));
      PlacementUtils.register($$0, ORE_GOLD_NETHER, $$4, commonOrePlacement(10, PlacementUtils.RANGE_10_10));
      PlacementUtils.register($$0, ORE_QUARTZ_NETHER, $$5, commonOrePlacement(16, PlacementUtils.RANGE_10_10));
      PlacementUtils.register(
         $$0, ORE_GRAVEL_NETHER, $$6, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(5), VerticalAnchor.absolute(41)))
      );
      PlacementUtils.register(
         $$0, ORE_BLACKSTONE, $$7, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(5), VerticalAnchor.absolute(31)))
      );
      PlacementUtils.register(
         $$0, ORE_DIRT, $$8, commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(160)))
      );
      PlacementUtils.register($$0, ORE_GRAVEL, $$9, commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top())));
      PlacementUtils.register(
         $$0, ORE_GRANITE_UPPER, $$10, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         $$0, ORE_GRANITE_LOWER, $$10, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      PlacementUtils.register(
         $$0, ORE_DIORITE_UPPER, $$11, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         $$0, ORE_DIORITE_LOWER, $$11, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      PlacementUtils.register(
         $$0, ORE_ANDESITE_UPPER, $$12, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         $$0, ORE_ANDESITE_LOWER, $$12, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      PlacementUtils.register($$0, ORE_TUFF, $$13, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0))));
      PlacementUtils.register(
         $$0, ORE_COAL_UPPER, $$14, commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(136), VerticalAnchor.top()))
      );
      PlacementUtils.register(
         $$0, ORE_COAL_LOWER, $$15, commonOrePlacement(20, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(192)))
      );
      PlacementUtils.register(
         $$0, ORE_IRON_UPPER, $$16, commonOrePlacement(90, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384)))
      );
      PlacementUtils.register(
         $$0, ORE_IRON_MIDDLE, $$16, commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-24), VerticalAnchor.absolute(56)))
      );
      PlacementUtils.register(
         $$0, ORE_IRON_SMALL, $$17, commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(72)))
      );
      PlacementUtils.register(
         $$0, ORE_GOLD_EXTRA, $$18, commonOrePlacement(50, HeightRangePlacement.uniform(VerticalAnchor.absolute(32), VerticalAnchor.absolute(256)))
      );
      PlacementUtils.register(
         $$0, ORE_GOLD, $$19, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32)))
      );
      PlacementUtils.register(
         $$0,
         ORE_GOLD_LOWER,
      ...
      PlacementUtils.register(
         $$0, ORE_REDSTONE, $$20, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15)))
      );
      PlacementUtils.register(
         $$0, ORE_REDSTONE_LOWER, $$20, commonOrePlacement(8, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(32)))
      );
      PlacementUtils.register(
         $$0, ORE_DIAMOND, $$21, commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))
      );
      PlacementUtils.register(
         $$0, ORE_DIAMOND_MEDIUM, $$22, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-4)))
      );
      PlacementUtils.register(
         $$0, ORE_DIAMOND_LARGE, $$23, rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))
      );
      PlacementUtils.register(
         $$0, ORE_DIAMOND_BURIED, $$24, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))
      );
      PlacementUtils.register(
         $$0, ORE_LAPIS, $$25, commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32)))
      );
      PlacementUtils.register(
         $$0, ORE_LAPIS_BURIED, $$26, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64)))
      );
      PlacementUtils.register(
         $$0, ORE_INFESTED, $$27, commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(63)))
      );
      PlacementUtils.register(
         $$0, ORE_EMERALD, $$28, commonOrePlacement(100, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(480)))
      );
      PlacementUtils.register(
         $$0,
      ...
      PlacementUtils.register($$0, ORE_ANCIENT_DEBRIS_SMALL, $$30, InSquarePlacement.spread(), PlacementUtils.RANGE_8_8, BiomeFilter.biome());
      PlacementUtils.register(
         $$0, ORE_COPPER, $$31, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
      );
      PlacementUtils.register(
         $$0, ORE_COPPER_LARGE, $$32, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
      );
      PlacementUtils.register($$0, ORE_CLAY, $$33, commonOrePlacement(46, PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT));
   }
}
