...
public class CavePlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> $$0) {
      ...
      PlacementUtils.register(
         $$0, CLASSIC_VINES, $$16, CountPlacement.of(256), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome()
      );
      PlacementUtils.register(
         $$0,
         AMETHYST_GEODE,
      ...
      PlacementUtils.register($$0, SCULK_PATCH_ANCIENT_CITY, $$19);
      PlacementUtils.register(
         $$0,
         SCULK_VEIN,
         $$20,
