...
public class TrialChambersStructurePools {
   ...
   public static final List<PoolAliasBinding> ALIAS_BINDINGS = ImmutableList.<PoolAliasBinding>builder()
      ...
      .add(
         PoolAliasBinding.random(
            spawner("contents/melee"), WeightedList.builder().add(spawner("melee/zombie")).add(spawner("melee/husk")).add(spawner("melee/spider")).build()
         )
      )
      .add(
         PoolAliasBinding.random(
   ...
   public static void bootstrap(BootstrapContext<StructureTemplatePool> $$0) {
      ...
      Holder<StructureTemplatePool> $$3 = $$1.getOrThrow(HALLWAY_FALLBACK);
      HolderGetter<StructureProcessorList> $$4 = $$0.lookup(Registries.PROCESSOR_LIST);
      Holder<StructureProcessorList> $$5 = $$4.getOrThrow(ProcessorLists.TRIAL_CHAMBERS_COPPER_BULB_DEGRADATION);
      $$0.register(
         START,
         new StructureTemplatePool(
            $$2,
            List.of(
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/end_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/end_2", $$5), 1)
            ),
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chamber/entrance_cap", $$5), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$3,
            List.of(
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/chamber_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/assembly", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/eruption", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/slanted", $$5), 1)
            ),
            StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         ...
         new StructureTemplatePool(
            ...
            List.of(
               ...
               Pair.of(StructurePoolElement.single("trial_chambers/intersection/intersection_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/intersection/intersection_2", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/intersection/intersection_3", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/first_plate"), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/atrium_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/entrance_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/entrance_2", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/entrance_3", $$5), 1)
            ),
            StructureTemplatePool.Projection.RIGID
         )
      );
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2,
            List.of(
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_2", $$5), 2),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_3", $$5), 2),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_4", $$5), 2),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_5", $$5), 2),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_6", $$5), 2),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_7", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/corridor/straight_8", $$5), 2)
            ),
            StructureTemplatePool.Projection.RIGID
         )
      );
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            ...
            List.of(
               ...
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/upper_hallway_connector", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/lower_hallway_connector", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/rubble"), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/chamber_1", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/chamber_2", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/chamber_4", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/chamber_8", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/assembly", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/eruption", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/slanted", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/chamber/pedestal", $$5), 150),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/rubble_chamber", $$5), 10),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/rubble_chamber_thin", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/cache_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/left_corner", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/right_corner", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/corner_staircase", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/corner_staircase_down", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/long_straight_staircase", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/long_straight_staircase_down", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/straight", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/straight_staircase", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/straight_staircase_down", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/trapped_staircase", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/encounter_1", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/encounter_2", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/encounter_3", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/encounter_4", $$5), 1),
               Pair.of(StructurePoolElement.single("trial_chambers/hallway/encounter_5", $$5), 1)
            ),
            StructureTemplatePool.Projection.RIGID
         )
      );
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/decor/disposal"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/reward/vault"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/reward/ominous_vault"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chests/connectors/supply"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chests/supply"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/ranged"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/slow_ranged"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/melee"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/small_melee"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/connectors/breeze"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
      ...
      Pools.register(
         ...
         new StructureTemplatePool(
            $$2, List.of(Pair.of(StructurePoolElement.single("trial_chambers/spawner/breeze/breeze"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         $$0,
