...
public class BlockFamilies {
   ...
   private static BlockFamily.Builder familyBuilder(Block $$0) {
      BlockFamily.Builder $$1 = new BlockFamily.Builder($$0);
      BlockFamily $$2 = (BlockFamily)MAP.put($$0, $$1.getFamily());
      if ($$2 != null) {
         throw new IllegalStateException("Duplicate family definition for " + BuiltInRegistries.BLOCK.getKey($$0));
      } else {
         return $$1;
      }
   }
