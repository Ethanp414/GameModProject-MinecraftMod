...
public abstract class BlockItemTagsProvider {
   protected void run() {
      ...
      this.tag(BlockTags.ACACIA_LOGS, ItemTags.ACACIA_LOGS)
         .add(Blocks.ACACIA_LOG, Blocks.ACACIA_WOOD, Blocks.STRIPPED_ACACIA_LOG, Blocks.STRIPPED_ACACIA_WOOD);
      this.tag(BlockTags.SPRUCE_LOGS, ItemTags.SPRUCE_LOGS)
      ...
      this.tag(BlockTags.JUNGLE_LOGS, ItemTags.JUNGLE_LOGS)
         .add(Blocks.JUNGLE_LOG, Blocks.JUNGLE_WOOD, Blocks.STRIPPED_JUNGLE_LOG, Blocks.STRIPPED_JUNGLE_WOOD);
      this.tag(BlockTags.CHERRY_LOGS, ItemTags.CHERRY_LOGS)
      ...
      this.tag(BlockTags.SMALL_FLOWERS, ItemTags.SMALL_FLOWERS).add($$0).add(Blocks.CLOSED_EYEBLOSSOM);
      this.tag(BlockTags.FLOWERS, ItemTags.FLOWERS).addTag(BlockTags.SMALL_FLOWERS).add($$1);
      ...
      this.tag(BlockTags.BEE_ATTRACTIVE, ItemTags.BEE_FOOD).add($$0).add($$1);
   }

   protected abstract TagAppender<Block, Block> tag(TagKey<Block> var1, TagKey<Item> var2);
}
