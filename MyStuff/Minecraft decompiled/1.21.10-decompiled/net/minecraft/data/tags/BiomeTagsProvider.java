...
public class BiomeTagsProvider extends KeyTagProvider<Biome> {
   ...
   protected void addTags(HolderLookup.Provider $$0) {
      ...
      List<ResourceKey<Biome>> $$1 = MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD.usedBiomes().toList();
      this.tag(BiomeTags.IS_OVERWORLD).addAll($$1);
      ...
      this.tag(BiomeTags.HAS_TRIAL_CHAMBERS).addAll($$1.stream().filter($$0x -> $$0x != Biomes.DEEP_DARK));
