...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
   public VanillaBlockTagsProvider(PackOutput $$0, CompletableFuture<HolderLookup.Provider> $$1) {
      super($$0, Registries.BLOCK, $$1, $$0x -> $$0x.builtInRegistryHolder().key());
   }
   ...
   protected void addTags(HolderLookup.Provider $$0) {
      (new BlockItemTagsProvider() {
         ...
         protected TagAppender<Block, Block> tag(TagKey<Block> $$0, TagKey<Item> $$1) {
            return VanillaBlockTagsProvider.this.tag($$0);
         }
      }).run();
      ...
      this.tag(BlockTags.REPLACEABLE)
         .addAll($$0.lookupOrThrow(Registries.BLOCK).listElements().map(Holder.Reference::value).filter($$0x -> $$0x.defaultBlockState().canBeReplaced()));
