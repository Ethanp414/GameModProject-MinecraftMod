...
public class VanillaItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
   public VanillaItemTagsProvider(PackOutput $$0, CompletableFuture<HolderLookup.Provider> $$1) {
      super($$0, Registries.ITEM, $$1, $$0x -> $$0x.builtInRegistryHolder().key());
   }
   ...
   protected void addTags(HolderLookup.Provider $$0) {
      (new BlockItemTagsProvider() {
         ...
         protected TagAppender<Block, Block> tag(TagKey<Block> $$0, TagKey<Item> $$1) {
            return new VanillaItemTagsProvider.BlockToItemConverter(VanillaItemTagsProvider.this.tag($$1));
         }
      }).run();
      ...
      this.tag(ItemTags.TRIM_MATERIALS)
         .addAll(
            $$0.lookupOrThrow(Registries.ITEM)
               .listElements()
               .filter($$0x -> ((Item)$$0x.value()).components().has(DataComponents.PROVIDES_TRIM_MATERIAL))
               .sorted(Comparator.comparing($$0x -> $$0x.key().location()))
   ...
   static class BlockToItemConverter implements TagAppender<Block, Block> {
      ...
      public TagAppender<Block, Block> add(Block $$0) {
         this.itemAppender.add((Item)Objects.requireNonNull($$0.asItem()));
         return this;
      }

      public TagAppender<Block, Block> addOptional(Block $$0) {
         this.itemAppender.addOptional((Item)Objects.requireNonNull($$0.asItem()));
         return this;
      }
      ...
      public TagAppender<Block, Block> addTag(TagKey<Block> $$0) {
         this.itemAppender.addTag(blockTagToItemTag($$0));
         return this;
      }

      @Override
      public TagAppender<Block, Block> addOptionalTag(TagKey<Block> $$0) {
         this.itemAppender.addOptionalTag(blockTagToItemTag($$0));
         return this;
      }
   }
}
