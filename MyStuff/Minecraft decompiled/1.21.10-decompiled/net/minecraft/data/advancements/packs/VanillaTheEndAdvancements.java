...
public class VanillaTheEndAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider $$0, Consumer<AdvancementHolder> $$1) {
      ...
      AdvancementHolder $$4 = Advancement.Builder.advancement()
         ...
         .addCriterion("killed_dragon", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of($$2, EntityType.ENDER_DRAGON)))
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            "summoned_dragon", SummonedEntityTrigger.TriggerInstance.summonedEntity(EntityPredicate.Builder.entity().of($$2, EntityType.ENDER_DRAGON))
         )
      ...
      AdvancementHolder $$6 = Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            PlayerTrigger.TriggerInstance.located(
               LocationPredicate.Builder.inStructure($$0.<Structure>lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.END_CITY))
            )
         )
