...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider $$0, Consumer<AdvancementHolder> $$1) {
      ...
      HolderLookup.RegistryLookup<Enchantment> $$8 = $$0.lookupOrThrow(Registries.ENCHANTMENT);
      ...
      addFood(Advancement.Builder.advancement(), $$3)
         .parent($$10)
         .display(
            Items.APPLE,
      ...
      AdvancementHolder $$12 = Advancement.Builder.advancement()
         .parent($$9)
         .display(
            Items.LEAD,
      ...
      AdvancementHolder $$13 = addFish(Advancement.Builder.advancement(), $$3)
         .parent($$9)
         .requirements(AdvancementRequirements.Strategy.OR)
         .display(
            Items.FISHING_ROD,
      ...
      AdvancementHolder $$14 = addFishBuckets(Advancement.Builder.advancement(), $$3)
         .parent($$13)
         .requirements(AdvancementRequirements.Strategy.OR)
         .display(
      ...
      AdvancementHolder $$15 = Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of($$3, Items.AXOLOTL_BUCKET))
         )
         .display(
      ...
      Advancement.Builder.advancement()
         .parent($$15)
         .addCriterion(
            "kill_axolotl_target", EffectsChangedTrigger.TriggerInstance.gotEffectsFrom(EntityPredicate.Builder.entity().of($$2, EntityType.AXOLOTL))
         )
         .display(
      ...
      addCatVariants(Advancement.Builder.advancement(), $$6)
         .parent($$12)
         .display(
            Items.COD,
      ...
      addTamedWolfVariants(Advancement.Builder.advancement(), $$7)
         .parent($$12)
         .display(
            Items.BONE,
      ...
      AdvancementHolder $$16 = Advancement.Builder.advancement()
         .parent($$9)
         .addCriterion(
            "safely_harvest_honey",
            ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
               LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of($$4, BlockTags.BEEHIVES)).setSmokey(true),
               ItemPredicate.Builder.item().of($$3, Items.GLASS_BOTTLE)
            )
         )
         .display(
            Items.HONEY_BOTTLE,
      ...
      AdvancementHolder $$17 = Advancement.Builder.advancement()
         .parent($$16)
         .display(
            Items.HONEYCOMB,
         ...
         .addCriterion(
            "wax_on",
            ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
               LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of($$4, ((BiMap)HoneycombItem.WAXABLES.get()).keySet())),
               ItemPredicate.Builder.item().of($$3, Items.HONEYCOMB)
            )
         )
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            "wax_off",
            ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
               LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of($$4, ((BiMap)HoneycombItem.WAX_OFF_BY_BLOCK.get()).keySet())),
               ItemPredicate.Builder.item().of($$3, WAX_SCRAPING_TOOLS)
            )
         )
      ...
      AdvancementHolder $$18 = Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of($$3, Items.TADPOLE_BUCKET))
         )
         .display(
      ...
      AdvancementHolder $$19 = addLeashedFrogVariants($$2, $$3, $$5, Advancement.Builder.advancement())
         .parent($$18)
         .display(
            Items.LEAD,
                     ...
                     DataComponentMatchers.Builder.components()
                        .partial(
                           ...
                           EnchantmentsPredicate.enchantments(
                              List.of(new EnchantmentPredicate($$8.getOrThrow(Enchantments.SILK_TOUCH), MinMaxBounds.Ints.atLeast(1)))
                           )
                        )
                        .build()
                  ),
         ...
         .addCriterion(
            ...
            StartRidingTrigger.TriggerInstance.playerStartsRiding(
               EntityPredicate.Builder.entity()
                  .vehicle(EntityPredicate.Builder.entity().of($$2, EntityTypeTags.BOAT).passenger(EntityPredicate.Builder.entity().of($$2, EntityType.GOAT)))
            )
         )
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            "make_a_sign_glow",
            ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
               LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of($$4, BlockTags.ALL_SIGNS)),
               ItemPredicate.Builder.item().of($$3, Items.GLOW_INK_SAC)
            )
         )
         .save($$1, "husbandry/make_a_sign_glow");
      AdvancementHolder $$20 = Advancement.Builder.advancement()
         .parent($$9)
         .display(
            Items.COOKIE,
         ...
         .addCriterion(
            ...
            PickedUpItemTrigger.TriggerInstance.thrownItemPickedUpByPlayer(
               Optional.empty(), Optional.empty(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of($$2, EntityType.ALLAY)))
            )
         )
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            ItemUsedOnLocationTrigger.TriggerInstance.allayDropItemOnBlock(
               LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of($$4, Blocks.NOTE_BLOCK)),
               ItemPredicate.Builder.item().of($$3, Items.CAKE)
            )
         )
         .save($$1, "husbandry/allay_deliver_cake_to_note_block");
      AdvancementHolder $$21 = Advancement.Builder.advancement()
         .parent($$9)
         .display(
            Items.SNIFFER_EGG,
      ...
      AdvancementHolder $$22 = Advancement.Builder.advancement()
         .parent($$21)
         .display(
         ...
         .addCriterion(
            ...
            PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
               ItemPredicate.Builder.item().of($$3, ItemTags.SNIFFER_FOOD),
               Optional.of(
                  EntityPredicate.wrap(
                     EntityPredicate.Builder.entity().of($$2, EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.flags().setIsBaby(true))
                  )
               )
            )
         )
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            PlayerInteractTrigger.TriggerInstance.equipmentSheared(
               ItemPredicate.Builder.item().of($$3, Items.WOLF_ARMOR),
               Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of($$2, EntityType.WOLF)))
            )
         )
      ...
      Advancement.Builder.advancement()
         ...
         .addCriterion(
            "repair_wolf_armor",
            PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
               ItemPredicate.Builder.item().of($$3, Items.ARMADILLO_SCUTE),
               Optional.of(
                  EntityPredicate.wrap(
                     EntityPredicate.Builder.entity()
   ...
   public static AdvancementHolder createBreedAllAnimalsAdvancement(
      ...
      return addBreedable(Advancement.Builder.advancement(), $$3, $$2, $$4)
         .parent($$0)
         .display(
            Items.GOLDEN_CARROT,
   ...
   private static Advancement.Builder addLeashedFrogVariants(
      HolderGetter<EntityType<?>> $$0, HolderGetter<Item> $$1, HolderLookup<FrogVariant> $$2, Advancement.Builder $$3
   ) {
      sortedVariants($$2)
         .forEach(
            $$3x -> $$3.addCriterion(
                  $$3x.key().location().toString(),
                  PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                     ItemPredicate.Builder.item().of($$1, Items.LEAD),
                     Optional.of(
                        EntityPredicate.wrap(
                           EntityPredicate.Builder.entity()
   ...
   private static Advancement.Builder addBreedable(
      Advancement.Builder $$0, Stream<EntityType<?>> $$1, HolderGetter<EntityType<?>> $$2, Stream<EntityType<?>> $$3
   ) {
      $$1.forEach(
         $$2x -> $$0.addCriterion(
               EntityType.getKey($$2x).toString(), BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of($$2, $$2x))
            )
      );
      $$3.forEach(
         $$2x -> $$0.addCriterion(
               ...
               BredAnimalsTrigger.TriggerInstance.bredAnimals(
                  Optional.of(EntityPredicate.Builder.entity().of($$2, $$2x).build()),
                  Optional.of(EntityPredicate.Builder.entity().of($$2, $$2x).build()),
                  Optional.empty()
               )
            )
   ...
   private static Advancement.Builder addFishBuckets(Advancement.Builder $$0, HolderGetter<Item> $$1) {
      for(Item $$2 : FISH_BUCKETS) {
         $$0.addCriterion(
            BuiltInRegistries.ITEM.getKey($$2).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of($$1, $$2))
         );
      }
      ...
      for(Item $$2 : FISH) {
         $$0.addCriterion(
            ...
            FishingRodHookedTrigger.TriggerInstance.fishedItem(
               Optional.empty(), Optional.empty(), Optional.of(ItemPredicate.Builder.item().of($$1, $$2).build())
            )
         );
      }
   ...
   private static Advancement.Builder addCatVariants(Advancement.Builder $$0, HolderLookup<CatVariant> $$1) {
      sortedVariants($$1)
         .forEach(
            $$1x -> $$0.addCriterion(
                  $$1x.key().location().toString(),
                  TameAnimalTrigger.TriggerInstance.tamedAnimal(
                     EntityPredicate.Builder.entity()
                        .components(
                           DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.CAT_VARIANT, $$1x)).build()
                        )
                  )
               )
         );
   ...
   private static Advancement.Builder addTamedWolfVariants(Advancement.Builder $$0, HolderLookup<WolfVariant> $$1) {
      sortedVariants($$1)
         .forEach(
            $$1x -> $$0.addCriterion(
                  $$1x.key().location().toString(),
                  TameAnimalTrigger.TriggerInstance.tamedAnimal(
                     EntityPredicate.Builder.entity()
                        .components(
                           DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.WOLF_VARIANT, $$1x)).build()
                        )
                  )
               )
         );
