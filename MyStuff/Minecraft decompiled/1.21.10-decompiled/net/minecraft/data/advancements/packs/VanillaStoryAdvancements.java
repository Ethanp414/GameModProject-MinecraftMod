...
public class VanillaStoryAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider $$0, Consumer<AdvancementHolder> $$1) {
      ...
      AdvancementHolder $$3 = Advancement.Builder.advancement()
         .display(
            Blocks.GRASS_BLOCK,
         ...
         .save($$1, "story/root");
      AdvancementHolder $$4 = Advancement.Builder.advancement()
         .parent($$3)
         .display(
         ...
         .addCriterion("get_stone", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of($$2, ItemTags.STONE_TOOL_MATERIALS)))
      ...
      AdvancementHolder $$13 = Advancement.Builder.advancement()
         ...
         .addCriterion(
            ...
            PlayerTrigger.TriggerInstance.located(
               LocationPredicate.Builder.inStructure($$0.<Structure>lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.STRONGHOLD))
            )
         )
