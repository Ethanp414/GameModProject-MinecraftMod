...
public record VanillaFishingLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
   ...
   public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> $$0) {
      HolderLookup.RegistryLookup<Biome> $$1 = this.registries.lookupOrThrow(Registries.BIOME);
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.FISHING_FISH, fishingFishLootTable());
      $$0.accept(
                           ...
                           .when(
                              LocationCheck.checkLocation(
                                 LocationPredicate.Builder.location()
                                    .setBiomes(
                                       HolderSet.direct(
                                          $$1.getOrThrow(Biomes.JUNGLE), $$1.getOrThrow(Biomes.SPARSE_JUNGLE), $$1.getOrThrow(Biomes.BAMBOO_JUNGLE)
                                       )
                                    )
                              )
                           ))
