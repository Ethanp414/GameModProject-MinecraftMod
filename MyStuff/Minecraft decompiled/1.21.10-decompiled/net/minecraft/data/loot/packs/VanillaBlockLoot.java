...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      HolderLookup.RegistryLookup<Item> $$1 = this.registries.lookupOrThrow(Registries.ITEM);
      ...
      Blocks.COPPER_BARS.forEach($$1x -> this.dropSelf($$1x));
      ...
      Blocks.COPPER_CHAIN.forEach($$1x -> this.dropSelf($$1x));
      ...
      this.add(Blocks.SCULK_VEIN, $$0x -> this.createMultifaceBlockDrops($$0x, this.hasSilkTouch()));
      ...
      this.add(Blocks.PALE_MOSS_CARPET, $$1x -> this.createMossyCarpetBlockDrops($$1x));
      this.add(Blocks.PALE_HANGING_MOSS, $$1x -> this.createShearsOrSilkTouchOnlyDrop($$1x));
      ...
      this.add(Blocks.TUFF_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.TUFF_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_TUFF_SLAB, $$1x -> this.createSlabItemTable($$1x));
      ...
      this.add(Blocks.COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, $$1x -> this.createCopperGolemStatueBlock($$1x));
      ...
      this.add(Blocks.STONE, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.COBBLESTONE));
      this.add(Blocks.DEEPSLATE, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.COBBLED_DEEPSLATE));
      this.add(Blocks.GRASS_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DIRT));
      this.add(Blocks.PODZOL, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DIRT));
      this.add(Blocks.MYCELIUM, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DIRT));
      this.add(Blocks.TUBE_CORAL_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DEAD_TUBE_CORAL_BLOCK));
      this.add(Blocks.BRAIN_CORAL_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DEAD_BRAIN_CORAL_BLOCK));
      this.add(Blocks.BUBBLE_CORAL_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
      this.add(Blocks.FIRE_CORAL_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DEAD_FIRE_CORAL_BLOCK));
      this.add(Blocks.HORN_CORAL_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.DEAD_HORN_CORAL_BLOCK));
      this.add(Blocks.CRIMSON_NYLIUM, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.NETHERRACK));
      this.add(Blocks.WARPED_NYLIUM, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.NETHERRACK));
      this.add(Blocks.BOOKSHELF, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Items.BOOK, ConstantValue.exactly(3.0F)));
      this.add(Blocks.CLAY, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Items.CLAY_BALL, ConstantValue.exactly(4.0F)));
      this.add(Blocks.ENDER_CHEST, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Blocks.OBSIDIAN, ConstantValue.exactly(8.0F)));
      this.add(Blocks.SNOW_BLOCK, $$0x -> this.createSingleItemTableWithSilkTouch($$0x, Items.SNOWBALL, ConstantValue.exactly(4.0F)));
      ...
      this.add(Blocks.OAK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.PETRIFIED_OAK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SPRUCE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.BIRCH_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.JUNGLE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.ACACIA_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.DARK_OAK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.PALE_OAK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.MANGROVE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.CHERRY_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.BAMBOO_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.BAMBOO_MOSAIC_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.COBBLESTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.DARK_PRISMARINE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.NETHER_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.PRISMARINE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.PRISMARINE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.PURPUR_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.QUARTZ_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.RED_SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.CUT_RED_SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.CUT_SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.STONE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.STONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SMOOTH_STONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_GRANITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SMOOTH_RED_SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.MOSSY_STONE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_DIORITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.MOSSY_COBBLESTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.END_STONE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SMOOTH_SANDSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.SMOOTH_QUARTZ_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.GRANITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.ANDESITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.RED_NETHER_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_ANDESITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.DIORITE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.CRIMSON_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WARPED_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.BLACKSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_BLACKSTONE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.OXIDIZED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WEATHERED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.EXPOSED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.WAXED_CUT_COPPER_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.COBBLED_DEEPSLATE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.POLISHED_DEEPSLATE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.DEEPSLATE_TILE_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.DEEPSLATE_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.MUD_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.RESIN_BRICK_SLAB, $$1x -> this.createSlabItemTable($$1x));
      this.add(Blocks.OAK_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.SPRUCE_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.BIRCH_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.JUNGLE_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.ACACIA_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.DARK_OAK_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.PALE_OAK_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.MANGROVE_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.CHERRY_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.BAMBOO_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WARPED_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.CRIMSON_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.IRON_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.EXPOSED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WEATHERED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.OXIDIZED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WAXED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, $$1x -> this.createDoorTable($$1x));
      this.add(Blocks.BLACK_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.BLUE_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.BROWN_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.CYAN_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.GRAY_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.GREEN_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.LIGHT_BLUE_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.LIGHT_GRAY_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.LIME_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.MAGENTA_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.PURPLE_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.ORANGE_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.PINK_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.RED_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.WHITE_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.YELLOW_BED, $$0x -> this.createSinglePropConditionTable($$0x, BedBlock.PART, BedPart.HEAD));
      this.add(Blocks.LILAC, $$0x -> this.createSinglePropConditionTable($$0x, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.add(Blocks.SUNFLOWER, $$0x -> this.createSinglePropConditionTable($$0x, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.add(Blocks.PEONY, $$0x -> this.createSinglePropConditionTable($$0x, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.add(Blocks.ROSE_BUSH, $$0x -> this.createSinglePropConditionTable($$0x, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.add(
         Blocks.TNT,
         LootTable.lootTable()
            .withPool(
                           ...
                           LootItem.lootTableItem(Items.COCOA_BEANS)
                              .apply(
                                 SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        this.applyExplosionDecay(
                           Blocks.SEA_PICKLE,
                           LootItem.lootTableItem($$0x)
                              .apply(
                                 List.of(2, 3, 4),
                                 $$1x -> SetItemCountFunction.setCount(ConstantValue.exactly((float)$$1x.intValue()))
                                       .when(
                                          LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
                                             .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, $$1x))
                                       )
                              )
                        )
                     )
      ...
      this.add(
         Blocks.COMPOSTER,
         $$0x -> LootTable.lootTable()
               .withPool(LootPool.lootPool().add(this.applyExplosionDecay($$0x, LootItem.lootTableItem(Items.COMPOSTER))))
               .withPool(
                  LootPool.lootPool()
      ...
      this.add(Blocks.CAVE_VINES, $$1x -> this.createCaveVinesDrop($$1x));
      this.add(Blocks.CAVE_VINES_PLANT, $$1x -> this.createCaveVinesDrop($$1x));
      this.add(Blocks.CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.WHITE_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.ORANGE_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.MAGENTA_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.LIGHT_BLUE_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.YELLOW_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.LIME_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.PINK_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.GRAY_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.LIGHT_GRAY_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.CYAN_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.PURPLE_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.BLUE_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.BROWN_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.GREEN_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.RED_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.BLACK_CANDLE, $$1x -> this.createCandleDrops($$1x));
      this.add(Blocks.BEACON, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.BREWING_STAND, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.EXPOSED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.WEATHERED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.OXIDIZED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.WAXED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.WAXED_EXPOSED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.WAXED_WEATHERED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.DISPENSER, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.DROPPER, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.ENCHANTING_TABLE, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.FURNACE, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.HOPPER, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.TRAPPED_CHEST, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.SMOKER, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.BLAST_FURNACE, $$1x -> this.createNameableBlockEntityTable($$1x));
      this.add(Blocks.BARREL, $$1x -> this.createNameableBlockEntityTable($$1x));
      ...
      Blocks.COPPER_LANTERN.forEach($$0x -> this.add($$0x, this::createSingleItemTable));
      this.add(Blocks.SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.BLACK_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.BLUE_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.BROWN_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.CYAN_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.GRAY_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.GREEN_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.LIGHT_BLUE_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.LIGHT_GRAY_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.LIME_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.MAGENTA_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.ORANGE_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.PINK_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.PURPLE_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.RED_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.WHITE_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.YELLOW_SHULKER_BOX, $$1x -> this.createShulkerBoxDrop($$1x));
      this.add(Blocks.BLACK_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.BLUE_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.BROWN_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.CYAN_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.GRAY_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.GREEN_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.LIGHT_BLUE_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.LIGHT_GRAY_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.LIME_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.MAGENTA_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.ORANGE_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.PINK_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.PURPLE_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.RED_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.WHITE_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(Blocks.YELLOW_BANNER, $$1x -> this.createBannerDrop($$1x));
      this.add(
         Blocks.PLAYER_HEAD,
         $$0x -> LootTable.lootTable()
               .withPool(
      ...
      this.add(Blocks.BEE_NEST, $$1x -> this.createBeeNestDrop($$1x));
      this.add(Blocks.BEEHIVE, $$1x -> this.createBeeHiveDrop($$1x));
      this.add(Blocks.OAK_LEAVES, $$0x -> this.createOakLeavesDrops($$0x, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.SPRUCE_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.BIRCH_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.JUNGLE_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.JUNGLE_SAPLING, JUNGLE_LEAVES_SAPLING_CHANGES));
      this.add(Blocks.ACACIA_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.DARK_OAK_LEAVES, $$0x -> this.createOakLeavesDrops($$0x, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.PALE_OAK_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.PALE_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.CHERRY_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.CHERRY_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.AZALEA_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
      this.add(Blocks.FLOWERING_AZALEA_LEAVES, $$0x -> this.createLeavesDrops($$0x, Blocks.FLOWERING_AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
      LootItemCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.BEETROOTS)
      ...
      LootItemCondition.Builder $$3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.WHEAT)
         .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7));
      this.add(Blocks.WHEAT, this.createCropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, $$3));
      LootItemCondition.Builder $$4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.CARROTS)
         .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CarrotBlock.AGE, 7));
      LootItemCondition.Builder $$5 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.MANGROVE_PROPAGULE)
         .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(MangrovePropaguleBlock.AGE, 4));
      this.add(
         Blocks.MANGROVE_PROPAGULE,
         this.applyExplosionDecay(
            Blocks.MANGROVE_PROPAGULE, LootTable.lootTable().withPool(LootPool.lootPool().when($$5).add(LootItem.lootTableItem(Items.MANGROVE_PROPAGULE)))
         )
      );
      this.add(
      ...
      this.add(Blocks.PITCHER_CROP, $$0x -> this.createPitcherCropLoot());
                  ...
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.CARROT)
                           .apply(ApplyBonusCount.addBonusBinomialDistributionCount($$0.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3))
                     )
               )
         )
      );
      LootItemCondition.Builder $$6 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.POTATOES)
      ...
      this.add(
         ...
         this.applyExplosionDecay(
            ...
            LootTable.lootTable()
               ...
               .withPool(
                  LootPool.lootPool().when($$6).add(LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02F)))
               )
         )
      );
      this.add(
         Blocks.SWEET_BERRY_BUSH,
         $$1x -> this.applyExplosionDecay(
               $$1x,
               LootTable.lootTable()
                  .withPool(
                     LootPool.lootPool()
                        ...
                        .apply(ApplyBonusCount.addUniformBonusCount($$0.getOrThrow(Enchantments.FORTUNE)))
                  )
                  .withPool(
                     LootPool.lootPool()
                        .when(
      ...
      this.add(Blocks.BROWN_MUSHROOM_BLOCK, $$0x -> this.createMushroomBlockDrop($$0x, Blocks.BROWN_MUSHROOM));
      this.add(Blocks.RED_MUSHROOM_BLOCK, $$0x -> this.createMushroomBlockDrop($$0x, Blocks.RED_MUSHROOM));
      this.add(Blocks.COAL_ORE, $$0x -> this.createOreDrop($$0x, Items.COAL));
      this.add(Blocks.DEEPSLATE_COAL_ORE, $$0x -> this.createOreDrop($$0x, Items.COAL));
      this.add(Blocks.EMERALD_ORE, $$0x -> this.createOreDrop($$0x, Items.EMERALD));
      this.add(Blocks.DEEPSLATE_EMERALD_ORE, $$0x -> this.createOreDrop($$0x, Items.EMERALD));
      this.add(Blocks.NETHER_QUARTZ_ORE, $$0x -> this.createOreDrop($$0x, Items.QUARTZ));
      this.add(Blocks.DIAMOND_ORE, $$0x -> this.createOreDrop($$0x, Items.DIAMOND));
      this.add(Blocks.DEEPSLATE_DIAMOND_ORE, $$0x -> this.createOreDrop($$0x, Items.DIAMOND));
      this.add(Blocks.COPPER_ORE, $$1x -> this.createCopperOreDrops($$1x));
      this.add(Blocks.DEEPSLATE_COPPER_ORE, $$1x -> this.createCopperOreDrops($$1x));
      this.add(Blocks.IRON_ORE, $$0x -> this.createOreDrop($$0x, Items.RAW_IRON));
      this.add(Blocks.DEEPSLATE_IRON_ORE, $$0x -> this.createOreDrop($$0x, Items.RAW_IRON));
      this.add(Blocks.GOLD_ORE, $$0x -> this.createOreDrop($$0x, Items.RAW_GOLD));
      this.add(Blocks.DEEPSLATE_GOLD_ORE, $$0x -> this.createOreDrop($$0x, Items.RAW_GOLD));
      this.add(
         Blocks.NETHER_GOLD_ORE,
         $$1x -> this.createSilkTouchDispatchTable(
               $$1x,
               this.applyExplosionDecay(
                  $$1x,
                  LootItem.lootTableItem(Items.GOLD_NUGGET)
                     .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 6.0F)))
                     .apply(ApplyBonusCount.addOreBonusCount($$0.getOrThrow(Enchantments.FORTUNE)))
               )
            )
      );
      this.add(Blocks.LAPIS_ORE, $$1x -> this.createLapisOreDrops($$1x));
      this.add(Blocks.DEEPSLATE_LAPIS_ORE, $$1x -> this.createLapisOreDrops($$1x));
      this.add(
         Blocks.COBWEB, $$0x -> this.createSilkTouchOrShearsDispatchTable($$0x, this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.STRING)))
      );
      this.add(
         Blocks.DEAD_BUSH,
         $$0x -> this.createShearsDispatchTable(
               $$0x,
               this.applyExplosionDecay($$0x, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))))
            )
      );
      this.add(Blocks.SHORT_DRY_GRASS, $$1x -> this.createShearsOrSilkTouchOnlyDrop($$1x));
      this.add(Blocks.TALL_DRY_GRASS, $$1x -> this.createShearsOrSilkTouchOnlyDrop($$1x));
      this.add(Blocks.BUSH, $$1x -> this.createShearsOrSilkTouchOnlyDrop($$1x));
      this.add(Blocks.NETHER_SPROUTS, $$1x -> this.createShearsOnlyDrop($$1x));
      this.add(Blocks.SEAGRASS, $$1x -> this.createShearsOnlyDrop($$1x));
      this.add(Blocks.VINE, $$1x -> this.createShearsOnlyDrop($$1x));
      this.add(Blocks.GLOW_LICHEN, $$0x -> this.createMultifaceBlockDrops($$0x, this.hasShears()));
      this.add(Blocks.RESIN_CLUMP, $$1x -> this.createMultifaceBlockDrops($$1x));
      this.add(Blocks.HANGING_ROOTS, $$1x -> this.createShearsOnlyDrop($$1x));
      this.add(Blocks.SMALL_DRIPLEAF, $$1x -> this.createShearsOnlyDrop($$1x));
      this.add(Blocks.MANGROVE_LEAVES, $$1x -> this.createMangroveLeavesDrops($$1x));
      this.add(Blocks.TALL_SEAGRASS, this.createDoublePlantShearsDrop(Blocks.SEAGRASS));
      this.add(Blocks.LARGE_FERN, $$0x -> this.createDoublePlantWithSeedDrops($$0x, Blocks.FERN));
      this.add(Blocks.TALL_GRASS, $$0x -> this.createDoublePlantWithSeedDrops($$0x, Blocks.SHORT_GRASS));
      this.add(Blocks.MELON_STEM, $$0x -> this.createStemDrops($$0x, Items.MELON_SEEDS));
      this.add(Blocks.ATTACHED_MELON_STEM, $$0x -> this.createAttachedStemDrops($$0x, Items.MELON_SEEDS));
      this.add(Blocks.PUMPKIN_STEM, $$0x -> this.createStemDrops($$0x, Items.PUMPKIN_SEEDS));
      this.add(Blocks.ATTACHED_PUMPKIN_STEM, $$0x -> this.createAttachedStemDrops($$0x, Items.PUMPKIN_SEEDS));
      this.add(
         ...
         $$0x -> LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ConstantValue.exactly(1.0F))
                     .add(
                        this.applyExplosionCondition($$0x, LootItem.lootTableItem($$0x))
                           .when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS))
                     )
               )
      );
      this.add(Blocks.FERN, $$1x -> this.createGrassDrops($$1x));
      this.add(Blocks.SHORT_GRASS, $$1x -> this.createGrassDrops($$1x));
      this.add(
         Blocks.GLOWSTONE,
         $$1x -> this.createSilkTouchDispatchTable(
               $$1x,
      ...
      this.add(Blocks.REDSTONE_ORE, $$1x -> this.createRedstoneOreDrops($$1x));
      this.add(Blocks.DEEPSLATE_REDSTONE_ORE, $$1x -> this.createRedstoneOreDrops($$1x));
      this.add(
         Blocks.SEA_LANTERN,
         $$1x -> this.createSilkTouchDispatchTable(
               $$1x,
                           ...
                           LootItem.lootTableItem(Items.NETHER_WART)
                              .apply(
                                 SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties($$1x)
                                          .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                    )
                              )
                              .apply(
                                 ApplyBonusCount.addUniformBonusCount($$0.getOrThrow(Enchantments.FORTUNE))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties($$1x)
                                          .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                    )
                     ...
                     .add(
                        AlternativesEntry.alternatives(
                           AlternativesEntry.alternatives(
                                 ...
                                 $$1x -> ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL)
                                          .when(
                                             LootItemBlockStatePropertyCondition.hasBlockStateProperties($$0x)
                                                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, $$1x))
                                          ))
                                       .apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)$$1x.intValue())))
                              )
                              .when(this.doesNotHaveSilkTouch()),
                           AlternativesEntry.alternatives(
                              SnowLayerBlock.LAYERS.getPossibleValues(),
                              $$1x -> (LootPoolEntryContainer.Builder)($$1x == 8
         ...
         $$1x -> this.createSilkTouchDispatchTable(
               ...
               this.applyExplosionCondition(
                  ...
                  ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT)
                        .when(BonusLevelTableCondition.bonusLevelFlatChance($$0.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F)))
                     .otherwise(LootItem.lootTableItem($$1x))
               )
            )
      );
      this.add(
         Blocks.CAMPFIRE,
         $$0x -> this.createSilkTouchDispatchTable(
               $$0x,
               this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))
            )
      );
      this.add(
      ...
      this.add(
         ...
         $$0x -> this.createSilkTouchDispatchTable(
               $$0x,
               this.applyExplosionCondition($$0x, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
            )
      );
      this.add(
         Blocks.AMETHYST_CLUSTER,
         $$2x -> this.createSilkTouchDispatchTable(
               $$2x,
               ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD)
                     .apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F)))
                     .apply(ApplyBonusCount.addOreBonusCount($$0.getOrThrow(Enchantments.FORTUNE)))
                     .when(MatchTool.toolMatches(ItemPredicate.Builder.item().of($$1, ItemTags.CLUSTER_MAX_HARVESTABLES))))
                  .otherwise(
                     this.applyExplosionDecay(
                        $$2x, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                     )
                  )
            )
      );
               ...
               LootPool.lootPool()
                  .add(
                     AlternativesEntry.alternatives(
                        ...
                        $$0 -> {
                           LootItemBlockStatePropertyCondition.Builder $$1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP)
                              .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
                           LootItemBlockStatePropertyCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP)
                              .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, $$0));
                           return $$0 == 4
                              ...
                              : ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_POD).when($$2))
                                    .when($$1))
                                 .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)));
                        }
                     )
   ...
   private LootTable.Builder createMobSkullDrop(Block $$0) {
      return LootTable.lootTable()
         .withPool(
            this.applyExplosionCondition(
               $$0,
