...
public record VanillaChestLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
   ...
   public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> $$0) {
      ...
      $$0.accept(BuiltInLootTables.BASTION_BRIDGE, this.bastionBridgeLootTable());
      $$0.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, this.bastionHoglinStableLootTable());
      $$0.accept(BuiltInLootTables.BASTION_OTHER, this.bastionOtherLootTable());
      $$0.accept(BuiltInLootTables.BASTION_TREASURE, this.bastionTreasureLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.ANCIENT_CITY, this.ancientCityLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.DESERT_PYRAMID, this.desertPyramidLootTable());
      $$0.accept(BuiltInLootTables.END_CITY_TREASURE, this.endCityTreasureLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.JUNGLE_TEMPLE, this.jungleTempleLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.NETHER_BRIDGE, this.netherBridgeLootTable());
      $$0.accept(BuiltInLootTables.PILLAGER_OUTPOST, this.pillagerOutpostLootTable());
      $$0.accept(BuiltInLootTables.SHIPWRECK_MAP, this.shipwreckMapLootTable());
      $$0.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, this.shipwreckSupplyLootTable());
      $$0.accept(BuiltInLootTables.SHIPWRECK_TREASURE, this.shipwreckTreasureLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, this.strongholdCorridorLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, this.strongholdLibraryLootTable());
      $$0.accept(
      ...
      $$0.accept(BuiltInLootTables.WOODLAND_MANSION, this.woodlandMansionLootTable());
      $$0.accept(
                     ...
                     LootItem.lootTableItem(Items.BOOK)
                        ...
                        .apply(
                           new EnchantRandomlyFunction.Builder()
                              .withOneOf(
                                 HolderSet.direct(
                                    $$1.getOrThrow(Enchantments.SHARPNESS),
                                    $$1.getOrThrow(Enchantments.BANE_OF_ARTHROPODS),
                                    $$1.getOrThrow(Enchantments.EFFICIENCY),
                                    $$1.getOrThrow(Enchantments.FORTUNE),
                                    $$1.getOrThrow(Enchantments.SILK_TOUCH),
                                    $$1.getOrThrow(Enchantments.FEATHER_FALLING)
                                 )
                              )
                        )
                  )
                     ...
                     LootItem.lootTableItem(Items.BOOK)
                        ...
                        .apply(
                           new EnchantRandomlyFunction.Builder()
                              .withOneOf(
                                 HolderSet.direct(
                                    $$1.getOrThrow(Enchantments.RIPTIDE),
                                    $$1.getOrThrow(Enchantments.LOYALTY),
                                    $$1.getOrThrow(Enchantments.CHANNELING),
                                    $$1.getOrThrow(Enchantments.IMPALING),
                                    $$1.getOrThrow(Enchantments.MENDING)
                                 )
                              )
                        )
                  )
               ...
               LootPool.lootPool()
                     ...
                     LootItem.lootTableItem(Items.BOOK)
                        ...
                        .apply(
                           new EnchantRandomlyFunction.Builder()
                              .withOneOf(
                                 HolderSet.direct(
                                    $$1.getOrThrow(Enchantments.KNOCKBACK),
                                    $$1.getOrThrow(Enchantments.PUNCH),
                                    $$1.getOrThrow(Enchantments.SMITE),
                                    $$1.getOrThrow(Enchantments.LOOTING),
                                    $$1.getOrThrow(Enchantments.MULTISHOT)
                                 )
                              )
                        )
                  )
                  .add(
                     LootItem.lootTableItem(Items.BOOK)
                        ...
                        .apply(
                           new EnchantRandomlyFunction.Builder()
                              .withOneOf(HolderSet.direct($$1.getOrThrow(Enchantments.BREACH), $$1.getOrThrow(Enchantments.DENSITY)))
                        )
                  )
                  .add(
                     LootItem.lootTableItem(Items.BOOK)
                        .setWeight(2)
                        .apply(new SetEnchantmentsFunction.Builder().withEnchantment($$1.getOrThrow(Enchantments.WIND_BURST), ConstantValue.exactly(1.0F)))
                  )
      ...
      this.spawnerLootTables($$0);
   }

   public void spawnerLootTables(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> $$0) {
      HolderLookup.RegistryLookup<Enchantment> $$1 = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
      $$0.accept(
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(10)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment($$0.getOrThrow(Enchantments.SOUL_SPEED)))
               )
         )
         .withPool(
            LootPool.lootPool()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(3)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment($$0.getOrThrow(Enchantments.SWIFT_SNEAK)))
               )
