...
public record VanillaGiftLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
   ...
   public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> $$0) {
      HolderGetter<ChickenVariant> $$1 = this.registries.lookupOrThrow(Registries.CHICKEN_VARIANT);
      $$0.accept(
                                       ...
                                       DataComponentMatchers.Builder.components()
                                          .exact(
                                             DataComponentExactPredicate.expect(
                                                DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>($$1.getOrThrow(ChickenVariants.TEMPERATE))
                                             )
                                          )
                                          .build()
                                    )
                                 ...
                                 EntityPredicate.Builder.entity()
                                    .components(
                                       DataComponentMatchers.Builder.components()
                                          .exact(
                                             DataComponentExactPredicate.expect(
                                                DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>($$1.getOrThrow(ChickenVariants.WARM))
                                             )
                                          )
                                          .build()
                                    )
                                 ...
                                 EntityPredicate.Builder.entity()
                                    .components(
                                       DataComponentMatchers.Builder.components()
                                          .exact(
                                             DataComponentExactPredicate.expect(
                                                DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>($$1.getOrThrow(ChickenVariants.COLD))
                                             )
                                          )
                                          .build()
                                    )
