...
public class VanillaEntityLoot extends EntityLootSubProvider {
   public VanillaEntityLoot(HolderLookup.Provider $$0) {
      super(FeatureFlags.REGISTRY.allFlags(), $$0);
   }

   @Override
   public void generate() {
      HolderGetter<EntityType<?>> $$0 = this.registries.lookupOrThrow(Registries.ENTITY_TYPE);
      HolderGetter<FrogVariant> $$1 = this.registries.lookupOrThrow(Registries.FROG_VARIANT);
               ...
               LootPool.lootPool()
                  ...
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
                        LootContext.EntityTarget.ATTACKER, EntityPredicate.Builder.entity().of($$0, EntityTypeTags.SKELETONS)
                     )
                  )
            )
      );
                  ...
                  .when(
                     DamageSourceCondition.hasDamageSource(
                        DamageSourcePredicate.Builder.damageType()
                           ...
                           .direct(EntityPredicate.Builder.entity().of($$0, EntityType.FIREBALL))
                     )
                  )
                  .when(LootItemKilledByPlayerCondition.killedByPlayer())
            )
               ...
               LootPool.lootPool()
                  ...
                  .add(
                     ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.MAGMA_CREAM)
                           ...
                           .apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 1.0F)))
                           .when(this.killedByFrog($$0).invert()))
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                  ...
                  .add(
                     LootItem.lootTableItem(Items.PEARLESCENT_FROGLIGHT)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                        .when(this.killedByFrogVariant($$0, $$1, FrogVariants.WARM))
                  )
                  .add(
                     LootItem.lootTableItem(Items.VERDANT_FROGLIGHT)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                        .when(this.killedByFrogVariant($$0, $$1, FrogVariants.COLD))
                  )
                  .add(
                     LootItem.lootTableItem(Items.OCHRE_FROGLIGHT)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                        .when(this.killedByFrogVariant($$0, $$1, FrogVariants.TEMPERATE))
                  )
            )
      );
      ...
      LootData.WOOL_ITEM_BY_DYE
         .forEach(
            ($$0x, $$1x) -> this.add(
                  EntityType.SHEEP,
                  (ResourceKey<LootTable>)BuiltInLootTables.SHEEP_BY_DYE.get($$0x),
                  LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem($$1x)))
               )
         );
      this.add(
         EntityType.SHULKER,
         ...
         LootTable.lootTable()
            .withPool(
               LootPool.lootPool()
                  ...
                  .add(LootItem.lootTableItem(Items.SLIME_BALL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(this.killedByFrog($$0)))
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
                  ...
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
                        ...
                        EntityPredicate.Builder.entity()
                           ...
                           .vehicle(EntityPredicate.Builder.entity().of($$0, EntityType.CHICKEN))
                     )
                  )
            )
      );
