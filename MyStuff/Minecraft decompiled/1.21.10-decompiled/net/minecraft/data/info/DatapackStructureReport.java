...
public class DatapackStructureReport implements DataProvider {
   ...
   public CompletableFuture<?> run(CachedOutput $$0) {
      ...
      return DataProvider.saveStable($$0, DatapackStructureReport.Report.CODEC.encodeStart(JsonOps.INSTANCE, $$1).getOrThrow(), $$2);
   }
   ...
   private void putIfNotPresent(
      ...
      DatapackStructureReport.Entry $$3 = (DatapackStructureReport.Entry)$$0.putIfAbsent($$1, $$2);
      if ($$3 != null) {
         throw new IllegalStateException("Duplicate entry for key " + $$1.location());
      }
   }
   ...
   private Map<ResourceKey<? extends Registry<?>>, DatapackStructureReport.Entry> listRegistries() {
      ...
      MANUAL_ENTRIES.forEach(($$1, $$2) -> this.putIfNotPresent($$0, $$1, $$2));
      return $$0;
   }
