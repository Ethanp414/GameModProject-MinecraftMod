...
public class Main {
   ...
   public static void main(String[] $$0) throws IOException {
      ...
      OptionSpec<String> $$7 = $$1.accepts("output", "Output folder").withRequiredArg().defaultsTo("generated");
   ...
   private static <T extends DataProvider> DataProvider.Factory<T> bindRegistries(
      BiFunction<PackOutput, CompletableFuture<HolderLookup.Provider>, T> $$0, CompletableFuture<HolderLookup.Provider> $$1
   ) {
      return $$2 -> (T)$$0.apply($$2, $$1);
   }

   public static void addServerProviders(DataGenerator $$0, Collection<Path> $$1, boolean $$2, boolean $$3, boolean $$4) {
      DataGenerator.PackGenerator $$5 = $$0.getVanillaPack($$2);
      ...
      DataGenerator.PackGenerator $$7 = $$0.getVanillaPack($$2);
      ...
      CompletableFuture<HolderLookup.Provider> $$16 = $$15.thenApply(RegistrySetBuilder.PatchedRegistries::patches);
      DataGenerator.PackGenerator $$17 = $$0.getBuiltinDatapack($$2, "trade_rebalance");
