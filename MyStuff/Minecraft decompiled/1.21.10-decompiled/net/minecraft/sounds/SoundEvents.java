...
public class SoundEvents {
   ...
   private static Holder<SoundEvent> register(ResourceLocation $$0, ResourceLocation $$1, float $$2) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, $$0, SoundEvent.createFixedRangeEvent($$1, $$2));
   }

   private static SoundEvent register(String $$0) {
      return register(ResourceLocation.withDefaultNamespace($$0));
   }
   ...
   private static Holder.Reference<SoundEvent> registerForHolder(String $$0) {
      return registerForHolder(ResourceLocation.withDefaultNamespace($$0));
   }

   private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation $$0) {
      return registerForHolder($$0, $$0);
   }

   private static SoundEvent register(ResourceLocation $$0, ResourceLocation $$1) {
      return Registry.register(BuiltInRegistries.SOUND_EVENT, $$0, SoundEvent.createVariableRangeEvent($$1));
   }

   private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation $$0, ResourceLocation $$1) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, $$0, SoundEvent.createVariableRangeEvent($$1));
   }

   private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
      return (ImmutableList<Holder.Reference<SoundEvent>>)IntStream.range(0, 8)
         .mapToObj($$0 -> registerForHolder("item.goat_horn.sound." + $$0))
         .collect(ImmutableList.toImmutableList());
   }

   private static Map<WolfSoundVariants.SoundSet, WolfSoundVariant> registerWolfSoundVariants() {
      return (Map<WolfSoundVariants.SoundSet, WolfSoundVariant>)Stream.of(WolfSoundVariants.SoundSet.values())
         .collect(
            Collectors.toMap(
               $$0 -> $$0,
               $$0 -> {
                  String $$1 = $$0.getSoundEventSuffix();
                  return new WolfSoundVariant(
                     registerForHolder("entity.wolf" + $$1 + ".ambient"),
                     registerForHolder("entity.wolf" + $$1 + ".death"),
                     registerForHolder("entity.wolf" + $$1 + ".growl"),
                     registerForHolder("entity.wolf" + $$1 + ".hurt"),
                     registerForHolder("entity.wolf" + $$1 + ".pant"),
                     registerForHolder("entity.wolf" + $$1 + ".whine")
                  );
               }
            )
         );
