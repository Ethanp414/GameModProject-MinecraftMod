...
public abstract class EnchantmentsPredicate implements SingleComponentItemPredicate<ItemEnchantments> {
   ...
   public static EnchantmentsPredicate.Enchantments enchantments(List<EnchantmentPredicate> $$0) {
      return new EnchantmentsPredicate.Enchantments($$0);
   }

   public static EnchantmentsPredicate.StoredEnchantments storedEnchantments(List<EnchantmentPredicate> $$0) {
      return new EnchantmentsPredicate.StoredEnchantments($$0);
   }
