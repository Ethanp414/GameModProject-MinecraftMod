...
public class DataComponents {
   ...
   public static final DataComponentType<Integer> DAMAGE = register(
      "damage", $$0 -> $$0.persistent(ExtraCodecs.NON_NEGATIVE_INT).networkSynchronized(ByteBufCodecs.VAR_INT)
   );
   ...
   public static final DataComponentType<ResourceLocation> ITEM_MODEL = register(
      "item_model", $$0 -> $$0.persistent(ResourceLocation.CODEC).networkSynchronized(ResourceLocation.STREAM_CODEC).cacheEncoding()
   );
   ...
   public static final DataComponentType<Tool> TOOL = register(
      "tool", $$0 -> $$0.persistent(Tool.CODEC).networkSynchronized(Tool.STREAM_CODEC).cacheEncoding()
   );
   ...
   public static final DataComponentType<ResourceLocation> TOOLTIP_STYLE = register(
      "tooltip_style", $$0 -> $$0.persistent(ResourceLocation.CODEC).networkSynchronized(ResourceLocation.STREAM_CODEC).cacheEncoding()
   );
   ...
   public static final DataComponentType<ResourceLocation> NOTE_BLOCK_SOUND = register(
      "note_block_sound", $$0 -> $$0.persistent(ResourceLocation.CODEC).networkSynchronized(ResourceLocation.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<Bees> BEES = register(
      "bees", $$0 -> $$0.persistent(Bees.CODEC).networkSynchronized(Bees.STREAM_CODEC).cacheEncoding()
   );
   ...
   public static final DataComponentType<Fox.Variant> FOX_VARIANT = register(
      "fox/variant", $$0 -> $$0.persistent(Fox.Variant.CODEC).networkSynchronized(Fox.Variant.STREAM_CODEC)
   );
   public static final DataComponentType<Salmon.Variant> SALMON_SIZE = register(
      "salmon/size", $$0 -> $$0.persistent(Salmon.Variant.CODEC).networkSynchronized(Salmon.Variant.STREAM_CODEC)
   );
   public static final DataComponentType<Parrot.Variant> PARROT_VARIANT = register(
      "parrot/variant", $$0 -> $$0.persistent(Parrot.Variant.CODEC).networkSynchronized(Parrot.Variant.STREAM_CODEC)
   );
   public static final DataComponentType<TropicalFish.Pattern> TROPICAL_FISH_PATTERN = register(
      "tropical_fish/pattern", $$0 -> $$0.persistent(TropicalFish.Pattern.CODEC).networkSynchronized(TropicalFish.Pattern.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<MushroomCow.Variant> MOOSHROOM_VARIANT = register(
      "mooshroom/variant", $$0 -> $$0.persistent(MushroomCow.Variant.CODEC).networkSynchronized(MushroomCow.Variant.STREAM_CODEC)
   );
   public static final DataComponentType<Rabbit.Variant> RABBIT_VARIANT = register(
      "rabbit/variant", $$0 -> $$0.persistent(Rabbit.Variant.CODEC).networkSynchronized(Rabbit.Variant.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<Variant> HORSE_VARIANT = register(
      "horse/variant", $$0 -> $$0.persistent(Variant.CODEC).networkSynchronized(Variant.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<Llama.Variant> LLAMA_VARIANT = register(
      "llama/variant", $$0 -> $$0.persistent(Llama.Variant.CODEC).networkSynchronized(Llama.Variant.STREAM_CODEC)
   );
   public static final DataComponentType<Axolotl.Variant> AXOLOTL_VARIANT = register(
      "axolotl/variant", $$0 -> $$0.persistent(Axolotl.Variant.CODEC).networkSynchronized(Axolotl.Variant.STREAM_CODEC)
   );
