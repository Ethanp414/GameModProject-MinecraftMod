...
public final class DataComponentPatch {
      ...
      .xmap($$0 -> {
         if ($$0.isEmpty()) {
            ...
            for(Entry<DataComponentPatch.PatchKey, ?> $$2 : $$0.entrySet()) {
               DataComponentPatch.PatchKey $$3 = (DataComponentPatch.PatchKey)$$2.getKey();
               if ($$3.removed()) {
         ...
         for(Entry<DataComponentType<?>, Optional<?>> $$2 : Reference2ObjectMaps.fastIterable($$0.map)) {
      ...
      return new StreamCodec<RegistryFriendlyByteBuf, DataComponentPatch>() {
         public DataComponentPatch decode(RegistryFriendlyByteBuf $$0x) {
            ...
            if ($$1 == 0 && $$2 == 0) {
               ...
               for(int $$5 = 0; $$5 < $$1; ++$$5) {
                  DataComponentType<?> $$6 = DataComponentType.STREAM_CODEC.decode($$0);
                  Object $$7 = $$0.apply($$6).decode($$0);
                  $$4.put($$6, Optional.of($$7));
               }

               for(int $$8 = 0; $$8 < $$2; ++$$8) {
                  DataComponentType<?> $$9 = DataComponentType.STREAM_CODEC.decode($$0);
         ...
         public void encode(RegistryFriendlyByteBuf $$0x, DataComponentPatch $$1) {
            if ($$1.isEmpty()) {
               ...
               for(it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Optional<?>> $$4 : Reference2ObjectMaps.fastIterable($$1.map)) {
               ...
               for(it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Optional<?>> $$5 : Reference2ObjectMaps.fastIterable($$1.map)) {
               ...
               for(it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Optional<?>> $$8 : Reference2ObjectMaps.fastIterable($$1.map)) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof DataComponentPatch $$1 && this.map.equals($$1.map)) {
            return true;
         }
   ...
   static String toString(Reference2ObjectMap<DataComponentType<?>, Optional<?>> $$0) {
      ...
      for(Entry<DataComponentType<?>, Optional<?>> $$3 : Reference2ObjectMaps.fastIterable($$0)) {
         if ($$2) {
            $$2 = false;
         } else {
            $$1.append(", ");
