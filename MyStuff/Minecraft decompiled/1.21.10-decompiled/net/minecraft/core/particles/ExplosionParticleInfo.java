...
public record ExplosionParticleInfo(ParticleOptions particle, float scaling, float speed) {
   public static final MapCodec<ExplosionParticleInfo> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               Codec.FLOAT.optionalFieldOf("scaling", Float.valueOf(1.0F)).forGetter(ExplosionParticleInfo::scaling),
               Codec.FLOAT.optionalFieldOf("speed", Float.valueOf(1.0F)).forGetter(ExplosionParticleInfo::speed)
            )
            .apply($$0, ExplosionParticleInfo::new)
   );
