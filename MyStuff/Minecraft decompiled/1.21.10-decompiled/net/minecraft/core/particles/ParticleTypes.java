...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleOptions> DUST = register(
      "dust", false, $$0 -> DustParticleOptions.CODEC, $$0 -> DustParticleOptions.STREAM_CODEC
   );
   public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
      "dust_color_transition", false, $$0 -> DustColorTransitionOptions.CODEC, $$0 -> DustColorTransitionOptions.STREAM_CODEC
   );
   ...
   public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register(
      "sculk_charge", true, $$0 -> SculkChargeParticleOptions.CODEC, $$0 -> SculkChargeParticleOptions.STREAM_CODEC
   );
   ...
   public static final ParticleType<VibrationParticleOption> VIBRATION = register(
      "vibration", true, $$0 -> VibrationParticleOption.CODEC, $$0 -> VibrationParticleOption.STREAM_CODEC
   );
   public static final ParticleType<TrailParticleOption> TRAIL = register(
      "trail", false, $$0 -> TrailParticleOption.CODEC, $$0 -> TrailParticleOption.STREAM_CODEC
   );
   ...
   public static final ParticleType<ShriekParticleOption> SHRIEK = register(
      "shriek", false, $$0 -> ShriekParticleOption.CODEC, $$0 -> ShriekParticleOption.STREAM_CODEC
   );
   ...
   private static <T extends ParticleOptions> ParticleType<T> register(
      String $$0,
      boolean $$1,
      final Function<ParticleType<T>, MapCodec<T>> $$2,
      final Function<ParticleType<T>, StreamCodec<? super RegistryFriendlyByteBuf, T>> $$3
   ) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, $$0, new ParticleType<T>($$1) {
         @Override
         public MapCodec<T> codec() {
            return (MapCodec<T>)$$2.apply(this);
         }

         @Override
         public StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec() {
            return (StreamCodec<? super RegistryFriendlyByteBuf, T>)$$3.apply(this);
         }
      });
   }
}
