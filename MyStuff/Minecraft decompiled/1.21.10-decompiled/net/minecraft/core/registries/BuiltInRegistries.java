...
public class BuiltInRegistries {
   ...
   public static final Registry<SoundEvent> SOUND_EVENT = registerSimple(Registries.SOUND_EVENT, $$0 -> SoundEvents.ITEM_PICKUP);
   public static final DefaultedRegistry<Fluid> FLUID = registerDefaultedWithIntrusiveHolders(Registries.FLUID, "empty", $$0 -> Fluids.EMPTY);
   public static final Registry<MobEffect> MOB_EFFECT = registerSimple(Registries.MOB_EFFECT, MobEffects::bootstrap);
   public static final DefaultedRegistry<Block> BLOCK = registerDefaultedWithIntrusiveHolders(Registries.BLOCK, "air", $$0 -> Blocks.AIR);
   ...
   public static final DefaultedRegistry<Item> ITEM = registerDefaultedWithIntrusiveHolders(Registries.ITEM, "air", $$0 -> Items.AIR);
   public static final Registry<Potion> POTION = registerSimple(Registries.POTION, Potions::bootstrap);
   public static final Registry<ParticleType<?>> PARTICLE_TYPE = registerSimple(Registries.PARTICLE_TYPE, $$0 -> ParticleTypes.BLOCK);
   ...
   public static final Registry<ResourceLocation> CUSTOM_STAT = registerSimple(Registries.CUSTOM_STAT, $$0 -> Stats.JUMP);
   public static final DefaultedRegistry<ChunkStatus> CHUNK_STATUS = registerDefaulted(Registries.CHUNK_STATUS, "empty", $$0 -> ChunkStatus.EMPTY);
   public static final Registry<RuleTestType<?>> RULE_TEST = registerSimple(Registries.RULE_TEST, $$0 -> RuleTestType.ALWAYS_TRUE_TEST);
   ...
   public static final Registry<PosRuleTestType<?>> POS_RULE_TEST = registerSimple(Registries.POS_RULE_TEST, $$0 -> PosRuleTestType.ALWAYS_TRUE_TEST);
   public static final Registry<MenuType<?>> MENU = registerSimple(Registries.MENU, $$0 -> MenuType.ANVIL);
   public static final Registry<RecipeType<?>> RECIPE_TYPE = registerSimple(Registries.RECIPE_TYPE, $$0 -> RecipeType.CRAFTING);
   public static final Registry<RecipeSerializer<?>> RECIPE_SERIALIZER = registerSimple(Registries.RECIPE_SERIALIZER, $$0 -> RecipeSerializer.SHAPELESS_RECIPE);
   public static final Registry<Attribute> ATTRIBUTE = registerSimple(Registries.ATTRIBUTE, Attributes::bootstrap);
   public static final Registry<PositionSourceType<?>> POSITION_SOURCE_TYPE = registerSimple(Registries.POSITION_SOURCE_TYPE, $$0 -> PositionSourceType.BLOCK);
   ...
   public static final Registry<StatType<?>> STAT_TYPE = registerSimple(Registries.STAT_TYPE, $$0 -> Stats.ITEM_USED);
   ...
   public static final DefaultedRegistry<SensorType<?>> SENSOR_TYPE = registerDefaulted(Registries.SENSOR_TYPE, "dummy", $$0 -> SensorType.DUMMY);
   public static final Registry<Schedule> SCHEDULE = registerSimple(Registries.SCHEDULE, $$0 -> Schedule.EMPTY);
   public static final Registry<Activity> ACTIVITY = registerSimple(Registries.ACTIVITY, $$0 -> Activity.IDLE);
   public static final Registry<LootPoolEntryType> LOOT_POOL_ENTRY_TYPE = registerSimple(Registries.LOOT_POOL_ENTRY_TYPE, $$0 -> LootPoolEntries.EMPTY);
   public static final Registry<LootItemFunctionType<?>> LOOT_FUNCTION_TYPE = registerSimple(Registries.LOOT_FUNCTION_TYPE, $$0 -> LootItemFunctions.SET_COUNT);
   public static final Registry<LootItemConditionType> LOOT_CONDITION_TYPE = registerSimple(Registries.LOOT_CONDITION_TYPE, $$0 -> LootItemConditions.INVERTED);
   ...
   public static final Registry<LootNbtProviderType> LOOT_NBT_PROVIDER_TYPE = registerSimple(Registries.LOOT_NBT_PROVIDER_TYPE, $$0 -> NbtProviders.CONTEXT);
   ...
   public static final Registry<FloatProviderType<?>> FLOAT_PROVIDER_TYPE = registerSimple(Registries.FLOAT_PROVIDER_TYPE, $$0 -> FloatProviderType.CONSTANT);
   public static final Registry<IntProviderType<?>> INT_PROVIDER_TYPE = registerSimple(Registries.INT_PROVIDER_TYPE, $$0 -> IntProviderType.CONSTANT);
   ...
   public static final Registry<BlockPredicateType<?>> BLOCK_PREDICATE_TYPE = registerSimple(Registries.BLOCK_PREDICATE_TYPE, $$0 -> BlockPredicateType.NOT);
   public static final Registry<WorldCarver<?>> CARVER = registerSimple(Registries.CARVER, $$0 -> WorldCarver.CAVE);
   public static final Registry<Feature<?>> FEATURE = registerSimple(Registries.FEATURE, $$0 -> Feature.ORE);
   ...
   public static final Registry<StructurePieceType> STRUCTURE_PIECE = registerSimple(Registries.STRUCTURE_PIECE, $$0 -> StructurePieceType.MINE_SHAFT_ROOM);
   public static final Registry<StructureType<?>> STRUCTURE_TYPE = registerSimple(Registries.STRUCTURE_TYPE, $$0 -> StructureType.JIGSAW);
   ...
   public static final Registry<RootPlacerType<?>> ROOT_PLACER_TYPE = registerSimple(Registries.ROOT_PLACER_TYPE, $$0 -> RootPlacerType.MANGROVE_ROOT_PLACER);
   public static final Registry<TreeDecoratorType<?>> TREE_DECORATOR_TYPE = registerSimple(Registries.TREE_DECORATOR_TYPE, $$0 -> TreeDecoratorType.LEAVE_VINE);
   ...
   public static final Registry<ConsumeEffect.Type<?>> CONSUME_EFFECT_TYPE = registerSimple(
      Registries.CONSUME_EFFECT_TYPE, $$0 -> ConsumeEffect.Type.APPLY_EFFECTS
   );
   ...
   public static final Registry<TicketType> TICKET_TYPE = registerSimple(Registries.TICKET_TYPE, $$0 -> TicketType.UNKNOWN);
   ...
   private static <T> Registry<T> registerSimple(ResourceKey<? extends Registry<T>> $$0, BuiltInRegistries.RegistryBootstrap<T> $$1) {
      return internalRegister($$0, new MappedRegistry<>($$0, Lifecycle.stable(), false), $$1);
   }

   private static <T> Registry<T> registerSimpleWithIntrusiveHolders(ResourceKey<? extends Registry<T>> $$0, BuiltInRegistries.RegistryBootstrap<T> $$1) {
      return internalRegister($$0, new MappedRegistry<>($$0, Lifecycle.stable(), true), $$1);
   }

   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> $$0, String $$1, BuiltInRegistries.RegistryBootstrap<T> $$2) {
      return internalRegister($$0, new DefaultedMappedRegistry<>($$1, $$0, Lifecycle.stable(), false), $$2);
   }

   private static <T> DefaultedRegistry<T> registerDefaultedWithIntrusiveHolders(
      ResourceKey<? extends Registry<T>> $$0, String $$1, BuiltInRegistries.RegistryBootstrap<T> $$2
   ) {
      return internalRegister($$0, new DefaultedMappedRegistry<>($$1, $$0, Lifecycle.stable(), true), $$2);
   }

   private static <T, R extends WritableRegistry<T>> R internalRegister(
      ResourceKey<? extends Registry<T>> $$0, R $$1, BuiltInRegistries.RegistryBootstrap<T> $$2
   ) {
      Bootstrap.checkBootstrapCalled(() -> "registry " + $$0.location());
      ResourceLocation $$3 = $$0.location();
      LOADERS.put($$3, (Supplier)() -> $$2.run($$1));
