...
public class Registries {
   ...
   private static <T> ResourceKey<Registry<T>> createRegistryKey(String $$0) {
      return ResourceKey.createRegistryKey(ResourceLocation.withDefaultNamespace($$0));
   }

   public static String elementsDirPath(ResourceKey<? extends Registry<?>> $$0) {
      return $$0.location().getPath();
   }

   public static String tagsDirPath(ResourceKey<? extends Registry<?>> $$0) {
