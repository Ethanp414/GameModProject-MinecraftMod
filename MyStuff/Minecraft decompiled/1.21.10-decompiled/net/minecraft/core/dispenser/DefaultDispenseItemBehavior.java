...
public class DefaultDispenseItemBehavior implements DispenseItemBehavior {
   ...
   public static void spawnItem(Level $$0, ItemStack $$1, int $$2, Direction $$3, Position $$4) {
      ...
      $$8.setDeltaMovement(
         $$0.random.triangle((double)$$3.getStepX() * $$9, 0.0172275 * (double)$$2),
         $$0.random.triangle(0.2, 0.0172275 * (double)$$2),
         $$0.random.triangle((double)$$3.getStepZ() * $$9, 0.0172275 * (double)$$2)
      );
      $$0.addFreshEntity($$8);
   }
