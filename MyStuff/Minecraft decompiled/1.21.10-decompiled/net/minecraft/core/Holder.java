...
public interface Holder<T> {
   ...
   default String getRegisteredName() {
      return (String)this.unwrapKey().map($$0 -> $$0.location().toString()).orElse("[unregistered]");
   }
   ...
   public static class Reference<T> implements Holder<T> {
      ...
      protected Reference(Holder.Reference.Type $$0, HolderOwner<T> $$1, @Nullable ResourceKey<T> $$2, @Nullable T $$3) {
         this.owner = $$1;
         this.type = $$0;
         this.key = $$2;
         this.value = $$3;
      ...
      public static <T> Holder.Reference<T> createStandAlone(HolderOwner<T> $$0, ResourceKey<T> $$1) {
         return new Holder.Reference<>(Holder.Reference.Type.STAND_ALONE, $$0, $$1, (T)null);
      }

      @Deprecated
      public static <T> Holder.Reference<T> createIntrusive(HolderOwner<T> $$0, @Nullable T $$1) {
         return new Holder.Reference<>(Holder.Reference.Type.INTRUSIVE, $$0, null, $$1);
      }
      ...
      protected void bindValue(T $$0) {
         if (this.type == Holder.Reference.Type.INTRUSIVE && this.value != $$0) {
