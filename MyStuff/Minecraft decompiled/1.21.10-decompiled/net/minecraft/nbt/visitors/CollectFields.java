...
public class CollectFields extends CollectToTag {
   ...
   public StreamTagVisitor.ValueResult visitRootEntry(TagType<?> $$0) {
      return $$0 != CompoundTag.TYPE ? StreamTagVisitor.ValueResult.HALT : super.visitRootEntry($$0);
   }
   ...
   public StreamTagVisitor.EntryResult visitEntry(TagType<?> $$0) {
      ...
      if (this.depth() > $$1.depth()) {
         ...
         return !this.wantedTypes.contains($$0) ? StreamTagVisitor.EntryResult.SKIP : super.visitEntry($$0);
      }
   }
   ...
   public StreamTagVisitor.EntryResult visitEntry(TagType<?> $$0, String $$1) {
      ...
      if (this.depth() > $$2.depth()) {
         ...
         if ($$0 == CompoundTag.TYPE) {
            FieldTree $$3 = (FieldTree)$$2.fieldsToRecurse().get($$1);
            if ($$3 != null) {
               this.stack.push($$3);
               return super.visitEntry($$0, $$1);
            }
