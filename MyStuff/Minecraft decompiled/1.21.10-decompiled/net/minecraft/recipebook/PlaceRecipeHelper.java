...
public interface PlaceRecipeHelper {
   static <T> void placeRecipe(int $$0, int $$1, Recipe<?> $$2, Iterable<T> $$3, PlaceRecipeHelper.Output<T> $$4) {
   ...
   static <T> void placeRecipe(int $$0, int $$1, int $$2, int $$3, Iterable<T> $$4, PlaceRecipeHelper.Output<T> $$5) {
      ...
      for(int $$8 = 0; $$8 < $$1; ++$$8) {
         ...
         for(int $$11 = 0; $$11 < $$0; ++$$11) {
            ...
            if ($$13) {
               $$5.addItemToSlot((T)$$6.next(), $$7, $$11, $$8);
            } else if ($$12 == $$11) {
               $$7 += $$0 - $$11;
               break;
            }
