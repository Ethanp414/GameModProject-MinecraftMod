...
public class ServerPlaceRecipe<R extends Recipe<?>> {
   ...
   public static <I extends RecipeInput, R extends Recipe<I>> RecipeBookMenu.PostPlaceAction placeRecipe(
      ServerPlaceRecipe.CraftingMenuAccess<R> $$0,
      int $$1,
      int $$2,
      List<Slot> $$3,
      List<Slot> $$4,
      ...
      ServerPlaceRecipe<R> $$9 = new ServerPlaceRecipe<>($$0, $$5, $$7, $$1, $$2, $$3, $$4);
   ...
   private ServerPlaceRecipe(ServerPlaceRecipe.CraftingMenuAccess<R> $$0, Inventory $$1, boolean $$2, int $$3, int $$4, List<Slot> $$5, List<Slot> $$6) {
      this.menu = $$0;
      this.inventory = $$1;
      this.useMaxItems = $$2;
      this.gridWidth = $$3;
   ...
   private void placeRecipe(RecipeHolder<R> $$0, StackedItemContents $$1) {
      ...
      if ($$1.canCraft($$0.value(), $$6, $$7::add)) {
         ...
         PlaceRecipeHelper.placeRecipe(
            this.gridWidth, this.gridHeight, $$0.value(), $$0.value().placementInfo().slotsToIngredientIndex(), ($$2x, $$3x, $$4, $$5) -> {
               if ($$2x != -1) {
                  Slot $$6 = (Slot)this.inputGridSlots.get($$3x);
                  Holder<Item> $$7xx = (Holder)$$7.get($$2x);
                  int $$8xx = $$8;
   
                  while($$8xx > 0) {
                     $$8xx = this.moveItemToGrid($$6, $$7xx, $$8xx);
                     if ($$8xx == -1) {
                        return;
                     }
                  }
   ...
   private boolean testClearGrid() {
      List<ItemStack> $$0 = Lists.<ItemStack>newArrayList();
