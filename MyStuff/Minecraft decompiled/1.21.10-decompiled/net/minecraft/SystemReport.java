...
public class SystemReport {
   ...
   public SystemReport() {
      ...
      this.setDetail("JVM Flags", (Supplier<String>)(() -> printJvmFlags($$0 -> $$0.startsWith("-X"))));
      this.setDetail("Debug Flags", (Supplier<String>)(() -> printJvmFlags($$0 -> $$0.startsWith("-DMC_DEBUG_"))));
   }
   ...
   private void putPhysicalMemory(List<PhysicalMemory> $$0) {
      ...
      for(PhysicalMemory $$2 : $$0) {
         ...
         this.setDetail($$3 + "capacity (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$2.getCapacity()))));
   ...
   private void putVirtualMemory(VirtualMemory $$0) {
      this.setDetail("Virtual memory max (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$0.getVirtualMax()))));
      this.setDetail("Virtual memory used (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$0.getVirtualInUse()))));
      this.setDetail("Swap memory total (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$0.getSwapTotal()))));
      this.setDetail("Swap memory used (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$0.getSwapUsed()))));
   }
   ...
   private void putGraphics(List<GraphicsCard> $$0) {
      ...
      for(GraphicsCard $$2 : $$0) {
         ...
         this.setDetail($$3 + "VRAM (MiB)", (Supplier<String>)(() -> String.format(Locale.ROOT, "%.2f", sizeInMiB($$2.getVRam()))));
   ...
   private void putProcessor(CentralProcessor $$0) {
      ...
      this.setDetail("Number of physical packages", (Supplier<String>)(() -> String.valueOf($$0.getPhysicalPackageCount())));
      this.setDetail("Number of physical CPUs", (Supplier<String>)(() -> String.valueOf($$0.getPhysicalProcessorCount())));
      this.setDetail("Number of logical CPUs", (Supplier<String>)(() -> String.valueOf($$0.getLogicalProcessorCount())));
   }
