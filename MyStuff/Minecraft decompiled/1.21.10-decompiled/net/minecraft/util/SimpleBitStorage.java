...
public class SimpleBitStorage implements BitStorage {
   ...
   public SimpleBitStorage(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new SimpleBitStorage.InitializationException("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   public int getAndSet(int $$0, int $$1) {
      Validate.inclusiveBetween(0L, (long)(this.size - 1), (long)$$0);
      Validate.inclusiveBetween(0L, this.mask, (long)$$1);
      int $$2 = this.cellIndex($$0);
      long $$3 = this.data[$$2];
      int $$4 = ($$0 - $$2 * this.valuesPerLong) * this.bits;
      int $$5 = (int)($$3 >> $$4 & this.mask);
      this.data[$$2] = $$3 & ~(this.mask << $$4) | ((long)$$1 & this.mask) << $$4;
      return $$5;
   }
