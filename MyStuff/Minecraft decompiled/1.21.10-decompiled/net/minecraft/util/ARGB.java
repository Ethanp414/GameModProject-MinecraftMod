...
public class ARGB {
   ...
   public static int scaleRGB(int $$0, float $$1, float $$2, float $$3) {
      return color(
         alpha($$0),
         Math.clamp((long)((int)((float)red($$0) * $$1)), 0, 255),
         Math.clamp((long)((int)((float)green($$0) * $$2)), 0, 255),
         Math.clamp((long)((int)((float)blue($$0) * $$3)), 0, 255)
      );
   }
   ...
   public static int scaleRGB(int $$0, int $$1) {
      return color(
         alpha($$0),
         Math.clamp((long)red($$0) * (long)$$1 / 255L, 0, 255),
         Math.clamp((long)green($$0) * (long)$$1 / 255L, 0, 255),
         Math.clamp((long)blue($$0) * (long)$$1 / 255L, 0, 255)
      );
   }

   public static int greyscale(int $$0) {
      int $$1 = (int)((float)red($$0) * 0.3F + (float)green($$0) * 0.59F + (float)blue($$0) * 0.11F);
      return color($$1, $$1, $$1);
   }
   ...
   public static Vector3f vector3fFromRGB24(int $$0) {
      float $$1 = (float)red($$0) / 255.0F;
      float $$2 = (float)green($$0) / 255.0F;
      float $$3 = (float)blue($$0) / 255.0F;
   ...
   public static int setBrightness(int $$0, float $$1) {
      ...
      if ($$9 == 0.0F) {
         ...
         float $$18 = ($$11 - (float)Math.floor((double)$$11)) * 6.0F;
         float $$19 = $$18 - (float)Math.floor((double)$$18);
         float $$20 = $$1 * (1.0F - $$9);
