...
public final class MinecraftServerStatistics implements DynamicMBean {
   ...
   private MinecraftServerStatistics(MinecraftServer $$0) {
      this.server = $$0;
      MBeanAttributeInfo[] $$1 = (MBeanAttributeInfo[])this.attributeDescriptionByName
         .values()
         .stream()
         .map(MinecraftServerStatistics.AttributeDescription::asMBeanAttributeInfo)
         .toArray($$0x -> new MBeanAttributeInfo[$$0x]);
   ...
   public Object getAttribute(String $$0) {
      MinecraftServerStatistics.AttributeDescription $$1 = (MinecraftServerStatistics.AttributeDescription)this.attributeDescriptionByName.get($$0);
