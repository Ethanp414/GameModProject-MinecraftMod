...
public class ParticleUtils {
   public static void spawnParticlesOnBlockFaces(Level $$0, BlockPos $$1, ParticleOptions $$2, IntProvider $$3) {
      for(Direction $$4 : Direction.values()) {
         spawnParticlesOnBlockFace($$0, $$1, $$2, $$3, $$4, () -> getRandomSpeedRanges($$0.random), 0.55);
      }
   }
   ...
   public static void spawnParticlesOnBlockFace(Level $$0, BlockPos $$1, ParticleOptions $$2, IntProvider $$3, Direction $$4, Supplier<Vec3> $$5, double $$6) {
      ...
      for(int $$8 = 0; $$8 < $$7; ++$$8) {
         spawnParticleOnFace($$0, $$1, $$4, $$2, (Vec3)$$5.get(), $$6);
      }
   }
   ...
   public static void spawnParticleInBlock(LevelAccessor $$0, BlockPos $$1, int $$2, ParticleOptions $$3) {
      ...
      spawnParticles($$0, $$1, $$2, 0.5, $$6, true, $$3);
   }
   ...
   public static void spawnParticles(LevelAccessor $$0, BlockPos $$1, int $$2, double $$3, double $$4, boolean $$5, ParticleOptions $$6) {
      ...
      for(int $$8 = 0; $$8 < $$2; ++$$8) {
         ...
         if ($$5 || !$$0.getBlockState(BlockPos.containing($$13, $$14, $$15).below()).isAir()) {
   ...
   public static void spawnSmashAttackParticles(LevelAccessor $$0, BlockPos $$1, int $$2) {
      ...
      for(int $$5 = 0; (float)$$5 < (float)$$2 / 3.0F; ++$$5) {
         ...
         double $$9 = $$0.getRandom().nextGaussian() * 0.2F;
         double $$10 = $$0.getRandom().nextGaussian() * 0.2F;
         double $$11 = $$0.getRandom().nextGaussian() * 0.2F;
         $$0.addParticle($$4, $$6, $$7, $$8, $$9, $$10, $$11);
      }

      for(int $$12 = 0; (float)$$12 < (float)$$2 / 1.5F; ++$$12) {
         double $$13 = $$3.x + 3.5 * Math.cos((double)$$12) + $$0.getRandom().nextGaussian() / 2.0;
         double $$14 = $$3.y;
         double $$15 = $$3.z + 3.5 * Math.sin((double)$$12) + $$0.getRandom().nextGaussian() / 2.0;
         double $$16 = $$0.getRandom().nextGaussian() * 0.05F;
         double $$17 = $$0.getRandom().nextGaussian() * 0.05F;
         double $$18 = $$0.getRandom().nextGaussian() * 0.05F;
