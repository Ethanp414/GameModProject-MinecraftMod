...
public class ItemStackTheFlatteningFix extends DataFix {
   private static final Map<String, String> MAP = DataFixUtils.make(Maps.newHashMap(), $$0 -> {
   ...
   private static final Set<String> IDS = (Set<String>)MAP.keySet().stream().map($$0 -> $$0.substring(0, $$0.indexOf(46))).collect(Collectors.toSet());
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, $$2x -> {
         ...
         if ($$3.isEmpty()) {
            ...
            Typed<?> $$4 = $$2x;
            Dynamic<?> $$5 = $$2x.get(DSL.remainderFinder());
            int $$6 = $$5.get("Damage").asInt(0);
            String $$7 = updateItem((String)((Pair)$$3.get()).getSecond(), $$6);
            if ($$7 != null) {
               $$4 = $$2x.set($$1, Pair.of(References.ITEM_NAME.typeName(), $$7));
            }

            if (DAMAGE_IDS.contains(((Pair)$$3.get()).getSecond())) {
               Typed<?> $$8 = $$2x.getOrCreateTyped($$2);
               Dynamic<?> $$9 = $$8.get(DSL.remainderFinder());
   ...
   public static String updateItem(@Nullable String $$0, int $$1) {
      if (IDS.contains($$0)) {
         String $$2 = (String)MAP.get($$0 + "." + $$1);
         return $$2 == null ? (String)MAP.get($$0 + ".0") : $$2;
      } else {
         return null;
      }
   }
