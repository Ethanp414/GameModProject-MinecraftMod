      ...
      return this.writeFixAndRead(
         ...
         $$0 -> {
            ...
            if ($$1.isPresent()) {
               ...
               $$0 = Dynamic.copyField((Dynamic<?>)$$1.get(), "using_converts_to", $$0, "minecraft:use_remainder");
               $$0 = $$0.set("minecraft:food", ((Dynamic)$$1.get()).remove("eat_seconds").remove("effects").remove("using_converts_to"));
               return $$0.set(
