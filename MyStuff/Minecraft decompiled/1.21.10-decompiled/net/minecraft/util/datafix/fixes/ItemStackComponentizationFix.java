...
public class ItemStackComponentizationFix extends DataFix {
   ...
   private static void fixItemStack(ItemStackComponentizationFix.ItemStackData $$0, Dynamic<?> $$1) {
      ...
      $$0.fixSubTag("BlockEntityTag", false, $$1x -> {
         String $$2xx = NamespacedSchema.ensureNamespaced($$1x.get("id").asString(""));
         $$1x = fixBlockEntityTag($$0, $$1x, $$2xx);
      ...
      if ($$0.is("minecraft:filled_map")) {
         ...
         Map<? extends Dynamic<?>, ? extends Dynamic<?>> $$6 = (Map)$$0.removeTag("Decorations")
            .asStream()
   ...
   private static Dynamic<?> fixBlockStateTag(Dynamic<?> $$0) {
      return DataFixUtils.orElse($$0.asMapOpt().result().map($$0x -> (Map)$$0x.collect(Collectors.toMap(Pair::getFirst, $$0xx -> {
            ...
            return $$4.isPresent() ? $$2.createString(((Number)$$4.get()).toString()) : $$2;
         }))).map($$0::createMap), $$0);
   }
   ...
   private static Dynamic<?> fixDisplay(ItemStackComponentizationFix.ItemStackData $$0, Dynamic<?> $$1, int $$2) {
      ...
      if ($$7.isPresent()) {
         $$0.setComponent("minecraft:item_name", LegacyComponentDataFixUtils.createTranslatableComponent($$1.getOps(), (String)$$7.get()));
      }
   ...
   private static <T> Dynamic<T> fixBlockEntityTag(ItemStackComponentizationFix.ItemStackData $$0, Dynamic<T> $$1, String $$2) {
      ...
      if ($$3.isPresent()) {
         Dynamic<T> $$4 = $$1.emptyMap().set("loot_table", (Dynamic<?>)$$3.get());
      ...
      return switch($$2) {
         ...
         case "minecraft:decorated_pot" -> {
            ...
            if ($$6.isPresent()) {
               $$0.setComponent(
                  "minecraft:container", $$1.createList(Stream.of($$1.emptyMap().set("slot", $$1.createInt(0)).set("item", (Dynamic<?>)$$6.get())))
               );
            }
         ...
         case "minecraft:banner" -> {
            ...
            if ($$7.isPresent()) {
               $$0.setComponent("minecraft:base_color", $$1.createString(ExtraDataFixUtils.dyeColorIdToName(((Number)$$7.get()).intValue())));
            }
   ...
   private static void fixEnchantments(ItemStackComponentizationFix.ItemStackData $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
      ...
      if (!$$6.isEmpty() || $$4) {
         ...
         for(Pair<String, Integer> $$9 : $$6) {
            $$8 = $$8.set((String)$$9.getFirst(), $$1.createInt($$9.getSecond()));
         }
   ...
   private static Optional<Pair<String, Integer>> parseEnchantment(Dynamic<?> $$0) {
      return $$0.get("id").asString().apply2stable(($$0x, $$1) -> Pair.of($$0x, Mth.clamp($$1.intValue(), 0, 255)), $$0.get("lvl").asNumber()).result();
   }
         ...
         Dynamic<?> $$6 = $$1.emptyMap()
            .set(
               ...
               $$1.createList(
                  ((Dynamic)$$5.get())
                     .asStream()
                     .map($$0x -> DataFixUtils.orElse($$0x.asString().map($$1x -> fixBlockStatePredicate($$0x, $$1x)).result(), $$0x))
               )
            );
         if ($$4) {
            $$6 = $$6.set("show_in_tooltip", $$1.createBoolean(false));
   ...
   private static Pair<Dynamic<?>, Dynamic<?>> fixMapDecoration(Dynamic<?> $$0) {
      Dynamic<?> $$1 = DataFixUtils.orElseGet($$0.get("id").result(), () -> $$0.createString(""));
   ...
   private static void fixPotionContents(ItemStackComponentizationFix.ItemStackData $$0, Dynamic<?> $$1) {
      ...
      if ($$3.isPresent()) {
         $$2 = $$2.set("potion", $$1.createString((String)$$3.get()));
      }
   ...
   private static Dynamic<?> createFilteredText(Dynamic<?> $$0, String $$1, Optional<String> $$2) {
      ...
      if ($$2.isPresent()) {
         $$3 = $$3.set("filtered", $$0.createString((String)$$2.get()));
      }
   ...
   public static Dynamic<?> fixProfile(Dynamic<?> $$0) {
      ...
      if ($$1.isPresent()) {
         return isValidPlayerName((String)$$1.get()) ? $$0.emptyMap().set("name", $$0.createString((String)$$1.get())) : $$0.emptyMap();
      } else {
   ...
   private static Dynamic<?> fixProfileProperties(OptionalDynamic<?> $$0) {
      Map<String, List<Pair<String, Optional<String>>>> $$1 = $$0.asMap($$0x -> $$0x.asString(""), $$0x -> $$0x.asList($$0xx -> {
            String $$1xx = $$0xx.get("Value").asString("");
            Optional<String> $$2 = $$0xx.get("Signature").asString().result();
            return Pair.of($$1xx, $$2);
         }));
      return $$1.isEmpty() ? null : $$0.createList($$1.entrySet().stream().flatMap($$1x -> ((List)$$1x.getValue()).stream().map($$2 -> {
            ...
            Optional<String> $$4 = (Optional)$$2.getSecond();
            return $$4.isPresent() ? $$3.set("signature", $$0.createString((String)$$4.get())) : $$3;
         })));
   }
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead(
         "ItemStack componentization", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), $$0 -> {
            ...
            return DataFixUtils.orElse($$1, $$0);
         }
      );
   }
   ...
   static class ItemStackData {
      ...
      public static Optional<ItemStackComponentizationFix.ItemStackData> read(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(
               ($$1, $$2) -> new ItemStackComponentizationFix.ItemStackData($$1, $$2.intValue(), $$0.remove("id").remove("Count")),
               $$0.get("Count").asNumber()
            )
            .result();
      }
      ...
      public Dynamic<?> moveTagInto(String $$0, Dynamic<?> $$1, String $$2) {
         ...
         return $$3.isPresent() ? $$1.set($$2, (Dynamic<?>)$$3.get()) : $$1;
      }
      ...
      private static <T> Dynamic<T> mergeRemainder(Dynamic<T> $$0, Dynamic<?> $$1) {
         ...
         return (Dynamic<T>)$$2.getMap($$0.getValue())
            .flatMap($$2x -> $$2.mergeToMap($$1.convert($$2).getValue(), $$2x))
            .map($$1x -> new Dynamic<>($$2, (T)$$1x))
            .result()
            .orElse($$0);
      }
