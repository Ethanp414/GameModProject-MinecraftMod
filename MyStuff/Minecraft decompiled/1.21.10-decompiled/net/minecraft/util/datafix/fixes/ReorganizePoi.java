...
public class ReorganizePoi extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals($$0, this.getInputSchema().getType(References.POI_CHUNK))) {
         ...
         return this.fixTypeEverywhere("POI reorganization", $$0, $$0x -> $$0xx -> $$0xx.mapSecond(ReorganizePoi::cap));
      }
   }

   private static <T> Dynamic<T> cap(Dynamic<T> $$0) {
      Map<Dynamic<T>, Dynamic<T>> $$1 = Maps.<Dynamic<T>, Dynamic<T>>newHashMap();
