...
public class BoatSplitFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("BoatSplitFix", $$1, $$2, $$2x -> {
         ...
         if ($$3.isPresent() && isAnyBoat((String)$$3.get())) {
            Dynamic<?> $$4 = $$2x.getOrCreate(DSL.remainderFinder());
            Optional<String> $$5 = $$4.get("Type").asString().result();
            String $$6;
            if (isChestBoat((String)$$3.get())) {
               $$6 = (String)$$5.map(BoatSplitFix::mapVariantToChestBoat).orElse("minecraft:oak_chest_boat");
            } else {
               $$6 = (String)$$5.map(BoatSplitFix::mapVariantToNormalBoat).orElse("minecraft:oak_boat");
            }
