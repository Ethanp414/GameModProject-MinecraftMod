...
public class VillagerDataFix extends NamedEntityFix {
   ...
   protected Typed<?> fix(Typed<?> $$0) {
      Dynamic<?> $$1 = $$0.get(DSL.remainderFinder());
      return $$0.set(
         DSL.remainderFinder(),
         $$1.remove("Profession")
            .remove("Career")
            ...
            .set(
               ...
               $$1.createMap(
                  ImmutableMap.of(
                     ...
                     $$1.createString(upgradeData($$1.get("Profession").asInt(0), $$1.get("Career").asInt(0))),
                     $$1.createString("level"),
                     DataFixUtils.orElse($$1.get("CareerLevel").result(), $$1.createInt(1))
                  )
               )
            )
      );
