...
public class WorldGenSettingsFix extends DataFix {
   ...
   private static <T> Dynamic<T> vanillaBiomeSource(Dynamic<T> $$0, long $$1, boolean $$2, boolean $$3) {
      Builder<Dynamic<T>, Dynamic<T>> $$4 = ImmutableMap.<Dynamic<T>, Dynamic<T>>builder()
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> fixFlatStructures(DynamicOps<T> $$0, OptionalDynamic<T> $$1) {
      ...
      if ($$1.result().isEmpty()) {
         $$5.setTrue();
         $$6.put("minecraft:village", DEFAULTS.get("minecraft:village"));
      }
                                       ...
                                       switch($$9) {
                                          ...
                                          case "separation":
                                             if ("oceanmonument".equals($$8)) {
                                                WorldGenSettingsFix.StructureFeatureConfiguration $$11 = (WorldGenSettingsFix.StructureFeatureConfiguration)$$6.getOrDefault(
                                                   "minecraft:monument", DEFAULTS.get("minecraft:monument")
                                                );
                                                int $$12 = getInt($$10, $$11.separation, 1);
                                                $$6.put(
                                                   "minecraft:monument",
                                                   new WorldGenSettingsFix.StructureFeatureConfiguration($$12, $$11.separation, $$11.salt)
                                                );
                                             }
      ...
      $$7.put(
         ...
         $$1.createMap(
            (Map<? extends Dynamic<?>, ? extends Dynamic<?>>)$$6.entrySet()
               .stream()
               .collect(
                  Collectors.toMap(
   ...
   private static void setSpacing(Map<String, WorldGenSettingsFix.StructureFeatureConfiguration> $$0, String $$1, String $$2, int $$3) {
      WorldGenSettingsFix.StructureFeatureConfiguration $$4 = (WorldGenSettingsFix.StructureFeatureConfiguration)$$0.getOrDefault($$1, DEFAULTS.get($$1));
   ...
   static final class StructureFeatureConfiguration {
      ...
      public <T> Dynamic<T> serialize(DynamicOps<T> $$0) {
         return new Dynamic<>($$0, (T)CODEC.encodeStart($$0, this).result().orElse($$0.emptyMap()));
      }
   }
}
