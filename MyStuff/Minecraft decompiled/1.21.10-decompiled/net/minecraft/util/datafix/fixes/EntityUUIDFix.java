...
public class EntityUUIDFix extends AbstractUUIDFix {
   ...
   private static Dynamic<?> updatePiglin(Dynamic<?> $$0) {
      return $$0.update(
         "Brain",
         $$0x -> $$0x.update(
               "memories", $$0xx -> $$0xx.update("minecraft:angry_at", $$0xxx -> (Dynamic)replaceUUIDString($$0xxx, "value", "value").orElseGet(() -> {
   ...
   private static Dynamic<?> updateEvokerFangs(Dynamic<?> $$0) {
      return (Dynamic<?>)replaceUUIDLeastMost($$0, "OwnerUUID", "Owner").orElse($$0);
   }

   private static Dynamic<?> updateZombieVillager(Dynamic<?> $$0) {
      return (Dynamic<?>)replaceUUIDLeastMost($$0, "ConversionPlayer", "ConversionPlayer").orElse($$0);
   }
   ...
   private static Dynamic<?> updateShulkerBullet(Dynamic<?> $$0) {
      $$0 = (Dynamic)replaceUUIDMLTag($$0, "Owner", "Owner").orElse($$0);
      return (Dynamic<?>)replaceUUIDMLTag($$0, "Target", "Target").orElse($$0);
   }

   private static Dynamic<?> updateItem(Dynamic<?> $$0) {
      $$0 = (Dynamic)replaceUUIDMLTag($$0, "Owner", "Owner").orElse($$0);
      return (Dynamic<?>)replaceUUIDMLTag($$0, "Thrower", "Thrower").orElse($$0);
   }
   ...
   private static Dynamic<?> updateFox(Dynamic<?> $$0) {
      ...
      return DataFixUtils.orElse($$1.map($$1x -> $$0.remove("TrustedUUIDs").set("Trusted", $$1x)), $$0);
   }

   private static Dynamic<?> updateHurtBy(Dynamic<?> $$0) {
      return (Dynamic<?>)replaceUUIDString($$0, "HurtBy", "HurtBy").orElse($$0);
   }

   private static Dynamic<?> updateAnimalOwner(Dynamic<?> $$0) {
      Dynamic<?> $$1 = updateAnimal($$0);
      return (Dynamic<?>)replaceUUIDString($$1, "OwnerUUID", "Owner").orElse($$1);
   }

   private static Dynamic<?> updateAnimal(Dynamic<?> $$0) {
      Dynamic<?> $$1 = updateMob($$0);
      return (Dynamic<?>)replaceUUIDLeastMost($$1, "LoveCause", "LoveCause").orElse($$1);
   }

   private static Dynamic<?> updateMob(Dynamic<?> $$0) {
      return updateLivingEntity($$0).update("Leash", $$0x -> (Dynamic)replaceUUIDLeastMost($$0x, "UUID", "UUID").orElse($$0x));
   }
   ...
   private static Dynamic<?> updateProjectile(Dynamic<?> $$0) {
      return DataFixUtils.orElse($$0.get("OwnerUUID").result().map($$1 -> $$0.remove("OwnerUUID").set("Owner", $$1)), $$0);
   }

   public static Dynamic<?> updateEntityUUID(Dynamic<?> $$0) {
      return (Dynamic<?>)replaceUUIDLeastMost($$0, "UUID", "UUID").orElse($$0);
   }
