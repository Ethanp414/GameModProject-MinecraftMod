...
public class ItemPotionFix extends DataFix {
   ...
   private static final String[] POTIONS = DataFixUtils.make(new String[128], $$0 -> {
      $$0[0] = "minecraft:water";
         ...
         if ($$3.isPresent() && Objects.equals(((Pair)$$3.get()).getSecond(), "minecraft:potion")) {
            ...
            if ($$5.isPresent()) {
               ...
               if ($$9.isEmpty()) {
                  ...
                  $$7 = $$2x.set($$2, $$11);
                  if (($$6 & 16384) == 16384) {
                     $$7 = $$7.set($$1, Pair.of(References.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                  }
               }
