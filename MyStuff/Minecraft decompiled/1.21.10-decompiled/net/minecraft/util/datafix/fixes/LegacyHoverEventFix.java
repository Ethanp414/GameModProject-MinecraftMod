...
public class LegacyHoverEventFix extends DataFix {
      ...
      if (!$$2.equals(this.getInputSchema().getType(References.TEXT_COMPONENT))) {
         ...
         return this.fixTypeEverywhere(
            ...
            $$1x -> $$1xx -> $$1xx.mapSecond($$1xxx -> $$1xxx.mapRight($$1xxxx -> $$1xxxx.mapSecond($$1xxxxx -> $$1xxxxx.mapSecond($$1xxxxxx -> {
                              Dynamic<?> $$2xx = (Dynamic)$$1xxxxxx.getSecond();
                              Optional<? extends Dynamic<?>> $$3 = $$2xx.get("hoverEvent").result();
                              if ($$3.isEmpty()) {
                                 return $$1xxxxxx;
                              } else {
                                 ...
                                 if ($$4.isEmpty()) {
                                    ...
                                    String $$5 = (String)((Either)$$1xxxxxx.getFirst()).left().map(Pair::getFirst).orElse("");
   ...
   private <H> H fixHoverEvent(Type<H> $$0, String $$1, Dynamic<?> $$2) {
      return (H)("show_text".equals($$1) ? fixShowTextHover($$0, $$2) : createPlaceholderHover($$0, $$2));
   }

   private static <H> H fixShowTextHover(Type<H> $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.renameField("value", "contents");
      return Util.readTypedOrThrow($$0, $$2).getValue();
   }

   private static <H> H createPlaceholderHover(Type<H> $$0, Dynamic<?> $$1) {
      JsonElement $$2 = $$1.convert(JsonOps.INSTANCE).getValue();
      Dynamic<?> $$3 = new Dynamic<>(
         JavaOps.INSTANCE, Map.of("action", "show_text", "contents", Map.of("text", "Legacy hoverEvent: " + GsonHelper.toStableString($$2)))
      );
      return Util.readTypedOrThrow($$0, $$3).getValue();
   }
}
