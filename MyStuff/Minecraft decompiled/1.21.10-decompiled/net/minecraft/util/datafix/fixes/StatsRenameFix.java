...
public class StatsRenameFix extends DataFix {
   ...
   private TypeRewriteRule createCriteriaRule() {
      ...
      if ($$4 == null) {
         ...
         return this.fixTypeEverywhereTyped(
            ...
            $$0,
            $$3x -> $$3x.updateTyped(
                  $$2, $$2xx -> $$2xx.updateTyped($$5, $$1xxx -> $$1xxx.update($$6, $$0xxxx -> (String)this.renames.getOrDefault($$0xxxx, $$0xxxx)))
               )
         );
      }
   }
   ...
   private TypeRewriteRule createStatRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$3x -> $$3x.updateTyped(
               $$2, $$2xx -> $$2xx.updateTyped($$3, $$1xxx -> $$1xxx.update($$4, $$0xxxx -> (String)this.renames.getOrDefault($$0xxxx, $$0xxxx)))
            )
      );
   }
}
