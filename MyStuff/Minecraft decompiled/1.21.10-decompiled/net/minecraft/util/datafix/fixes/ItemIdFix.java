...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = DataFixUtils.make(new Int2ObjectOpenHashMap(), $$0 -> {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
      Type<Pair<String, String>> $$1 = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$2x -> $$2x.update($$2, $$1, $$0xx -> $$0xx.map($$0xxx -> Pair.of(References.ITEM_NAME.typeName(), getItem($$0xxx)), $$0xxx -> $$0xxx))
      );
   }
}
