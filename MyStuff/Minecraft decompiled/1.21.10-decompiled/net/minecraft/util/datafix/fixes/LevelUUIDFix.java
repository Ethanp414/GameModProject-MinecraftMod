...
public class LevelUUIDFix extends AbstractUUIDFix {
   ...
   private Dynamic<?> updateWanderingTrader(Dynamic<?> $$0) {
      return (Dynamic<?>)replaceUUIDString($$0, "WanderingTraderId", "WanderingTraderId").orElse($$0);
   }
   ...
   private Dynamic<?> updateDragonFight(Dynamic<?> $$0) {
      return $$0.update(
         ...
         $$0x -> $$0x.updateMapValues(
               $$0xx -> $$0xx.mapSecond(
                     $$0xxx -> $$0xxx.update("DragonFight", $$0xxxx -> (Dynamic)replaceUUIDLeastMost($$0xxxx, "DragonUUID", "Dragon").orElse($$0xxxx))
                  )
            )
      );
   }
