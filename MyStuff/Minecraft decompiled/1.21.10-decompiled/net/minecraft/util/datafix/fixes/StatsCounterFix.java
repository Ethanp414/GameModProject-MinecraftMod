...
public class StatsCounterFix extends DataFix {
   ...
   private static StatsCounterFix.StatType unpackLegacyKey(String $$0) {
      if (SKIP.contains($$0)) {
         ...
         String $$1 = (String)CUSTOM_MAP.get($$0);
         if ($$1 != null) {
            ...
            if ($$2 < 0) {
               ...
               if ("stat.mineBlock".equals($$3)) {
                  ...
                  String $$5 = (String)ITEM_KEYS.get($$3);
                  if ($$5 != null) {
                     ...
                     String $$9 = (String)ENTITY_KEYS.get($$3);
                     if ($$9 != null) {
                        String $$10 = $$0.substring($$2 + 1).replace('.', ':');
                        String $$11 = (String)ENTITIES.getOrDefault($$10, $$10);
   ...
   private TypeRewriteRule makeStatFixer() {
      ...
      return this.fixTypeEverywhereTyped("StatsCounterFix", $$0, $$1, $$1x -> {
         Dynamic<?> $$2 = $$1x.get(DSL.remainderFinder());
         Map<Dynamic<?>, Dynamic<?>> $$3 = Maps.<Dynamic<?>, Dynamic<?>>newHashMap();
            ...
            for(Entry<? extends Dynamic<?>, ? extends Dynamic<?>> $$5 : ((Map)$$4.get()).entrySet()) {
               if (((Dynamic)$$5.getValue()).asNumber().result().isPresent()) {
                  ...
                  if ($$7 != null) {
                     ...
                     Dynamic<?> $$9 = (Dynamic)$$3.computeIfAbsent($$8, $$1xx -> $$2.emptyMap());
   ...
   private TypeRewriteRule makeObjectiveFixer() {
      ...
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         Dynamic<?> $$2 = $$1x.get(DSL.remainderFinder());
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
               if (SPECIAL_OBJECTIVE_CRITERIA.contains($$0xxx)) {
                  return $$0xxx;
               } else {
                  StatsCounterFix.StatType $$1xxx = unpackLegacyKey($$0xxx);
                  return $$1xxx == null ? "dummy" : V1451_6.packNamespacedWithDot($$1xxx.type) + ":" + V1451_6.packNamespacedWithDot($$1xxx.typeKey);
               }
            }).map($$0xx::createString), $$0xx));
         return Util.readTypedOrThrow($$1, $$3);
      });
   }
