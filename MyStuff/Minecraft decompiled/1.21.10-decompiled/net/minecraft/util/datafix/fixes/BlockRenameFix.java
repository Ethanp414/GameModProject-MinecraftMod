   ...
   public TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$4 = this.fixTypeEverywhereTyped(
            ...
            $$0x -> $$0x.update(
                  DSL.remainderFinder(), $$0xx -> DataFixUtils.orElse($$0xx.asString().result().map(this::fixFlatBlockState).map($$0xx::createString), $$0xx)
               )
         );
         return TypeRewriteRule.seq($$2, $$3, $$4);
      }
   }

   private Dynamic<?> fixBlockState(Dynamic<?> $$0) {
      Optional<String> $$1 = $$0.get("Name").asString().result();
      return $$1.isPresent() ? $$0.set("Name", $$0.createString(this.renameBlock((String)$$1.get()))) : $$0;
   }
