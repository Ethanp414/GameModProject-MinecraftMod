...
public class PlayerEquipmentFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.writeFixAndRead("Player Equipment Fix", $$0, $$1, $$0x -> {
         ...
         return $$0x.set("equipment", $$0x.createMap($$1xx));
      });
   }
}
