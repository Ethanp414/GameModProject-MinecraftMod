...
public class EmptyItemInHotbarFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "EmptyItemInHotbarFix", this.getInputSchema().getType(References.HOTBAR), $$1 -> $$1.update($$0, $$0xx -> $$0xx.mapSecond($$0xxx -> {
                  Optional<String> $$1xx = ((Either)$$0xxx.getFirst()).left().map(Pair::getSecond);
                  Dynamic<?> $$2 = (Dynamic)((Pair)$$0xxx.getSecond()).getSecond();
                  boolean $$3 = $$1xx.isEmpty() || ((String)$$1xx.get()).equals("minecraft:air");
