...
public class FixProjectileStoredItem extends DataFix {
   ...
   private static <T> Typed<T> fixArrow(Typed<?> $$0, Type<T> $$1) {
      return Util.writeAndReadTypedOrThrow($$0, $$1, $$0x -> $$0x.set("item", createItemStack($$0x, getArrowType($$0x))));
   }
   ...
   private static <T> Typed<T> fixSpectralArrow(Typed<?> $$0, Type<T> $$1) {
      return Util.writeAndReadTypedOrThrow($$0, $$1, $$0x -> $$0x.set("item", createItemStack($$0x, "minecraft:spectral_arrow")));
   }
   ...
   private static <T> Typed<T> castUnchecked(Typed<?> $$0, Type<T> $$1) {
      return new Typed<>($$1, $$0.getOps(), (T)$$0.getValue());
   }
