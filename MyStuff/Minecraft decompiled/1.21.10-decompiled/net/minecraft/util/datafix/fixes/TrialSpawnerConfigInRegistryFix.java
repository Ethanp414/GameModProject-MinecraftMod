...
public class TrialSpawnerConfigInRegistryFix extends NamedEntityFix {
   ...
   public Dynamic<?> fixTag(Dynamic<Tag> $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         if ($$2.isEmpty()) {
            ...
            ResourceLocation $$3 = (ResourceLocation)TrialSpawnerConfigInRegistryFix.VanillaTrialChambers.CONFIGS_TO_KEY
               .get(Pair.of((Dynamic)$$1.get(), (Dynamic)$$2.get()));
            return $$3 == null
               ? $$0
               : $$0.set("normal_config", $$0.createString($$3.withSuffix("/normal").toString()))
                  .set("ominous_config", $$0.createString($$3.withSuffix("/ominous").toString()));
         }
      }
   }
   ...
   protected Typed<?> fix(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.fixTag($$0x.convert(NbtOps.INSTANCE));
         return $$2.convert($$1);
      });
   }
