...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", $$0, $$0x -> $$0x.update(DSL.remainderFinder(), this::fixChildren));
   }

   private Dynamic<?> fixChildren(Dynamic<?> $$0) {
      return $$0.update("Children", $$1 -> $$0.createList($$1.asStream().map($$1x -> this.fixTag($$0, $$1x))));
   }

   private Dynamic<?> fixTag(Dynamic<?> $$0, Dynamic<?> $$1) {
      String $$2 = $$0.get("id").asString("");
      if (RENAMES.containsKey($$2)) {
         Pair<String, ImmutableMap<String, String>> $$3 = RENAMES.get($$2);
         if (((String)$$3.getFirst()).equals($$1.get("id").asString(""))) {
            String $$4 = $$1.get("Template").asString("");
            $$1 = $$1.set("Template", $$1.createString((String)$$3.getSecond().getOrDefault($$4, $$4)));
         }
      }
