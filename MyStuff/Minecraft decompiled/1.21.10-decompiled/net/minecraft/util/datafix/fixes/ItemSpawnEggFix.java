...
public class ItemSpawnEggFix extends DataFix {
   private static final String[] ID_TO_ENTITY = DataFixUtils.make(new String[256], $$0 -> {
      $$0[1] = "Item";
      $$0[2] = "XPOrb";
      $$0[7] = "ThrownEgg";
      $$0[8] = "LeashKnot";
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", $$1, $$5x -> {
         Optional<Pair<String, String>> $$6xx = $$5x.getOptional($$2);
         if ($$6xx.isPresent() && Objects.equals(((Pair)$$6xx.get()).getSecond(), "minecraft:spawn_egg")) {
            Dynamic<?> $$7 = $$5x.get(DSL.remainderFinder());
            ...
            Typed<?> $$13 = $$5x;
            String $$14 = ID_TO_ENTITY[$$8 & 255];
            if ($$14 != null && ($$12.isEmpty() || !Objects.equals($$12.get(), $$14))) {
               Typed<?> $$15 = $$5x.getOrCreateTyped($$4);
               Dynamic<?> $$16 = DataFixUtils.orElse($$15.getOptionalTyped($$5).map($$0xx -> $$0xx.write().getOrThrow()), $$7.emptyMap());
               $$16 = $$16.set("id", $$16.createString($$14));
               $$13 = $$5x.set($$4, ExtraDataFixUtils.readAndSet($$15, $$5, $$16));
            }
