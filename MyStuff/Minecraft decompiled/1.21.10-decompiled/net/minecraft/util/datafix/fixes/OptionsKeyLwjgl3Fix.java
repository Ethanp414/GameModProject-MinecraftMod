...
public class OptionsKeyLwjgl3Fix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         ...
         $$0 -> $$0.update(
               DSL.remainderFinder(),
               $$0x -> (Dynamic)$$0x.getMapValues()
                     .map($$1 -> $$0x.createMap((Map<? extends Dynamic<?>, ? extends Dynamic<?>>)$$1.entrySet().stream().map($$0xxx -> {
                           if (((Dynamic)$$0xxx.getKey()).asString("").startsWith("key_")) {
                              int $$1xx = Integer.parseInt(((Dynamic)$$0xxx.getValue()).asString(""));
                              if ($$1xx < 0) {
                                 int $$2 = $$1xx + 100;
                                 String $$3;
                                 if ($$2 == 0) {
                                 ...
                                 String $$7 = (String)MAP.getOrDefault($$1xx, "key.unknown");
