...
public class RemoveBlockEntityTagFix extends DataFix {
   ...
   private Typed<?> removeBlockEntity(Typed<?> $$0, OpticFinder<?> $$1, OpticFinder<String> $$2, String $$3) {
      ...
      if ($$4.isEmpty()) {
         ...
         String $$5 = (String)((Typed)$$4.get()).getOptional($$2).orElse("");
         return !this.blockEntityIdsToDrop.contains($$5) ? $$0 : Util.writeAndReadTypedOrThrow($$0, $$0.getType(), $$1x -> $$1x.remove($$3));
      }
   }
}
