...
public class ExtraDataFixUtils {
   public static Dynamic<?> fixBlockPos(Dynamic<?> $$0) {
      ...
      return !$$1.isEmpty() && !$$2.isEmpty() && !$$3.isEmpty()
         ? createBlockPos($$0, ((Number)$$1.get()).intValue(), ((Number)$$2.get()).intValue(), ((Number)$$3.get()).intValue())
         : $$0;
   }
   ...
   public static Dynamic<?> fixInlineBlockPos(Dynamic<?> $$0, String $$1, String $$2, String $$3, String $$4) {
      ...
      return !$$5.isEmpty() && !$$6.isEmpty() && !$$7.isEmpty()
         ? $$0.remove($$1)
            .remove($$2)
            .remove($$3)
            .set($$4, createBlockPos($$0, ((Number)$$5.get()).intValue(), ((Number)$$6.get()).intValue(), ((Number)$$7.get()).intValue()))
         : $$0;
   }

   public static Dynamic<?> createBlockPos(Dynamic<?> $$0, int $$1, int $$2, int $$3) {
      return $$0.createIntList(IntStream.of(new int[]{$$1, $$2, $$3}));
   }

   public static <T, R> Typed<R> cast(Type<R> $$0, Typed<T> $$1) {
      return new Typed<>($$0, $$1.getOps(), (R)$$1.getValue());
   }

   public static <T> Typed<T> cast(Type<T> $$0, Object $$1, DynamicOps<?> $$2) {
      return new Typed<>($$0, $$2, (T)$$1);
   }
   ...
   public static Dynamic<?> blockState(String $$0, Map<String, String> $$1) {
      ...
      Dynamic<Tag> $$3 = $$2.set("Name", $$2.createString($$0));
      if (!$$1.isEmpty()) {
         $$3 = $$3.set(
            "Properties",
            $$2.createMap(
               (Map<? extends Dynamic<?>, ? extends Dynamic<?>>)$$1.entrySet()
                  .stream()
   ...
   public static Dynamic<?> fixStringField(Dynamic<?> $$0, String $$1, UnaryOperator<String> $$2) {
      return $$0.update($$1, $$2x -> DataFixUtils.orElse($$2x.asString().map($$2).map($$0::createString).result(), $$2x));
   }
