...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder $$0) {
      ...
      $$0.addFixer(
         new DataFix($$58, false) {
            ...
            protected TypeRewriteRule makeRule() {
               ...
               OpticFinder<String> $$1 = DSL.fieldFinder("id", NamespacedSchema.namespacedString());
               ...
               return this.fixTypeEverywhereTyped(
                  ...
                  $$0,
                  $$3x -> {
                     String $$4 = (String)$$3x.getOptional($$1).orElse("");
                     return !"minecraft:commandblock_minecart".equals($$4)
                        ? $$3x
                        : $$3x.updateTyped($$2, $$1xx -> $$1xx.update($$3, $$0xxx -> $$0xxx.mapSecond(LegacyComponentDataFixUtils::createTextComponentJson)));
                  }
               );
            }
         }
      ...
      Schema $$127 = $$0.addSchema(2558, SAME_NAMESPACED);
      $$0.addFixer(new MissingDimensionFix($$127, false));
      $$0.addFixer(new OptionsRenameFieldFix($$127, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
      Schema $$128 = $$0.addSchema(2568, V2568::new);
      $$0.addFixer(new AddNewChoices($$128, "Added Piglin Brute", References.ENTITY));
      Schema $$129 = $$0.addSchema(2571, V2571::new);
      $$0.addFixer(new AddNewChoices($$129, "Added Goat", References.ENTITY));
      Schema $$130 = $$0.addSchema(2679, SAME_NAMESPACED);
      $$0.addFixer(new CauldronRenameFix($$130, false));
      Schema $$131 = $$0.addSchema(2680, SAME_NAMESPACED);
      $$0.addFixer(ItemRenameFix.create($$131, "Renamed grass path item to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      $$0.addFixer(BlockRenameFix.create($$131, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      Schema $$132 = $$0.addSchema(2684, V2684::new);
      $$0.addFixer(new AddNewChoices($$132, "Added Sculk Sensor", References.BLOCK_ENTITY));
      Schema $$133 = $$0.addSchema(2686, V2686::new);
      $$0.addFixer(new AddNewChoices($$133, "Added Axolotl", References.ENTITY));
      Schema $$134 = $$0.addSchema(2688, V2688::new);
      $$0.addFixer(new AddNewChoices($$134, "Added Glow Squid", References.ENTITY));
      $$0.addFixer(new AddNewChoices($$134, "Added Glow Item Frame", References.ENTITY));
      Schema $$135 = $$0.addSchema(2690, SAME_NAMESPACED);
      ImmutableMap<String, String> $$136 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(ItemRenameFix.create($$135, "Renamed copper block items to new oxidized terms", createRenamer($$136)));
      $$0.addFixer(BlockRenameFix.create($$135, "Renamed copper blocks to new oxidized terms", createRenamer($$136)));
      Schema $$137 = $$0.addSchema(2691, SAME_NAMESPACED);
      ImmutableMap<String, String> $$138 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(ItemRenameFix.create($$137, "Rename copper item suffixes", createRenamer($$138)));
      $$0.addFixer(BlockRenameFix.create($$137, "Rename copper blocks suffixes", createRenamer($$138)));
      Schema $$139 = $$0.addSchema(2693, SAME_NAMESPACED);
      $$0.addFixer(new AddFlagIfNotPresentFix($$139, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema $$140 = $$0.addSchema(2696, SAME_NAMESPACED);
      ImmutableMap<String, String> $$141 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(ItemRenameFix.create($$140, "Renamed grimstone block items to deepslate", createRenamer($$141)));
      $$0.addFixer(BlockRenameFix.create($$140, "Renamed grimstone blocks to deepslate", createRenamer($$141)));
      Schema $$142 = $$0.addSchema(2700, SAME_NAMESPACED);
      $$0.addFixer(
         BlockRenameFix.create(
            $$142,
      ...
      Schema $$143 = $$0.addSchema(2701, SAME_NAMESPACED);
      $$0.addFixer(new SavedDataFeaturePoolElementFix($$143));
      Schema $$144 = $$0.addSchema(2702, SAME_NAMESPACED);
      $$0.addFixer(new AbstractArrowPickupFix($$144));
      Schema $$145 = $$0.addSchema(2704, V2704::new);
      $$0.addFixer(new AddNewChoices($$145, "Added Goat", References.ENTITY));
      Schema $$146 = $$0.addSchema(2707, V2707::new);
      $$0.addFixer(new AddNewChoices($$146, "Added Marker", References.ENTITY));
      $$0.addFixer(new AddFlagIfNotPresentFix($$146, References.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
      Schema $$147 = $$0.addSchema(2710, SAME_NAMESPACED);
      $$0.addFixer(new StatsRenameFix($$147, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema $$148 = $$0.addSchema(2717, SAME_NAMESPACED);
      $$0.addFixer(
         ItemRenameFix.create(
            $$148, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
         )
      );
      $$0.addFixer(
         BlockRenameFix.create(
      ...
      Schema $$149 = $$0.addSchema(2825, SAME_NAMESPACED);
      $$0.addFixer(new AddFlagIfNotPresentFix($$149, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema $$150 = $$0.addSchema(2831, V2831::new);
      $$0.addFixer(new SpawnerDataFix($$150));
      Schema $$151 = $$0.addSchema(2832, V2832::new);
      $$0.addFixer(new WorldGenSettingsHeightAndBiomeFix($$151));
      $$0.addFixer(new ChunkHeightAndBiomeFix($$151));
      Schema $$152 = $$0.addSchema(2833, SAME_NAMESPACED);
      $$0.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix($$152));
      Schema $$153 = $$0.addSchema(2838, SAME_NAMESPACED);
      $$0.addFixer(new NamespacedTypeRenameFix($$153, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES)));
      Schema $$154 = $$0.addSchema(2841, SAME_NAMESPACED);
      $$0.addFixer(new ChunkProtoTickListFix($$154));
      Schema $$155 = $$0.addSchema(2842, V2842::new);
      $$0.addFixer(new ChunkRenamesFix($$155));
      Schema $$156 = $$0.addSchema(2843, SAME_NAMESPACED);
      $$0.addFixer(new OverreachingTickFix($$156));
      $$0.addFixer(
         new NamespacedTypeRenameFix($$156, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean"))
      );
      Schema $$157 = $$0.addSchema(2846, SAME_NAMESPACED);
      $$0.addFixer(
         new AdvancementsRenameFix(
            $$157,
            false,
      ...
      Schema $$158 = $$0.addSchema(2852, SAME_NAMESPACED);
      $$0.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix($$158));
      Schema $$159 = $$0.addSchema(2967, SAME_NAMESPACED);
      $$0.addFixer(new StructureSettingsFlattenFix($$159));
      Schema $$160 = $$0.addSchema(2970, SAME_NAMESPACED);
      $$0.addFixer(new StructuresBecomeConfiguredFix($$160));
      Schema $$161 = $$0.addSchema(3076, V3076::new);
      $$0.addFixer(new AddNewChoices($$161, "Added Sculk Catalyst", References.BLOCK_ENTITY));
      Schema $$162 = $$0.addSchema(3077, SAME_NAMESPACED);
      $$0.addFixer(new ChunkDeleteIgnoredLightDataFix($$162));
      Schema $$163 = $$0.addSchema(3078, V3078::new);
      $$0.addFixer(new AddNewChoices($$163, "Added Frog", References.ENTITY));
      $$0.addFixer(new AddNewChoices($$163, "Added Tadpole", References.ENTITY));
      $$0.addFixer(new AddNewChoices($$163, "Added Sculk Shrieker", References.BLOCK_ENTITY));
      Schema $$164 = $$0.addSchema(3081, V3081::new);
      $$0.addFixer(new AddNewChoices($$164, "Added Warden", References.ENTITY));
      Schema $$165 = $$0.addSchema(3082, V3082::new);
      $$0.addFixer(new AddNewChoices($$165, "Added Chest Boat", References.ENTITY));
      Schema $$166 = $$0.addSchema(3083, V3083::new);
      $$0.addFixer(new AddNewChoices($$166, "Added Allay", References.ENTITY));
      Schema $$167 = $$0.addSchema(3084, SAME_NAMESPACED);
      $$0.addFixer(
      ...
      Schema $$168 = $$0.addSchema(3086, SAME_NAMESPACED);
      $$0.addFixer(
         new EntityVariantFix(
            $$168, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      ImmutableMap<String, String> $$169 = ImmutableMap.builder()
      ...
      $$0.addFixer(
         new CriteriaRenameFix(
            $$168, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", $$1x -> (String)$$169.getOrDefault($$1x, $$1x)
         )
      );
      Schema $$170 = $$0.addSchema(3087, SAME_NAMESPACED);
      $$0.addFixer(
         new EntityVariantFix(
            $$170, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      Schema $$171 = $$0.addSchema(3090, SAME_NAMESPACED);
      $$0.addFixer(new EntityFieldsRenameFix($$171, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
      Schema $$172 = $$0.addSchema(3093, SAME_NAMESPACED);
      $$0.addFixer(new EntityGoatMissingStateFix($$172));
      Schema $$173 = $$0.addSchema(3094, SAME_NAMESPACED);
      $$0.addFixer(new GoatHornIdFix($$173));
      Schema $$174 = $$0.addSchema(3097, SAME_NAMESPACED);
      $$0.addFixer(new FilteredBooksFix($$174));
      $$0.addFixer(new FilteredSignsFix($$174));
      Map<String, String> $$175 = Map.of("minecraft:british", "minecraft:british_shorthair");
      $$0.addFixer(new VariantRenameFix($$174, "Rename british shorthair", References.ENTITY, "minecraft:cat", $$175));
      $$0.addFixer(
         new CriteriaRenameFix(
            $$174,
      ...
      $$0.addFixer(new PoiTypeRemoveFix($$174, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
      Schema $$176 = $$0.addSchema(3108, SAME_NAMESPACED);
      $$0.addFixer(new BlendingDataRemoveFromNetherEndFix($$176));
      Schema $$177 = $$0.addSchema(3201, SAME_NAMESPACED);
      $$0.addFixer(new OptionsProgrammerArtFix($$177));
      Schema $$178 = $$0.addSchema(3202, V3202::new);
      $$0.addFixer(new AddNewChoices($$178, "Added Hanging Sign", References.BLOCK_ENTITY));
      Schema $$179 = $$0.addSchema(3203, V3203::new);
      $$0.addFixer(new AddNewChoices($$179, "Added Camel", References.ENTITY));
      Schema $$180 = $$0.addSchema(3204, V3204::new);
      $$0.addFixer(new AddNewChoices($$180, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
      Schema $$181 = $$0.addSchema(3209, SAME_NAMESPACED);
      $$0.addFixer(new ItemStackSpawnEggFix($$181, false, "minecraft:pig_spawn_egg"));
      Schema $$182 = $$0.addSchema(3214, SAME_NAMESPACED);
      $$0.addFixer(new OptionsAmbientOcclusionFix($$182));
      Schema $$183 = $$0.addSchema(3319, SAME_NAMESPACED);
      $$0.addFixer(new OptionsAccessibilityOnboardFix($$183));
      Schema $$184 = $$0.addSchema(3322, SAME_NAMESPACED);
      $$0.addFixer(new EffectDurationFix($$184));
      Schema $$185 = $$0.addSchema(3325, V3325::new);
      $$0.addFixer(new AddNewChoices($$185, "Added displays", References.ENTITY));
      Schema $$186 = $$0.addSchema(3326, V3326::new);
      $$0.addFixer(new AddNewChoices($$186, "Added Sniffer", References.ENTITY));
      Schema $$187 = $$0.addSchema(3327, V3327::new);
      $$0.addFixer(new AddNewChoices($$187, "Archaeology", References.BLOCK_ENTITY));
      Schema $$188 = $$0.addSchema(3328, V3328::new);
      $$0.addFixer(new AddNewChoices($$188, "Added interaction", References.ENTITY));
      Schema $$189 = $$0.addSchema(3438, V3438::new);
      $$0.addFixer(
         BlockEntityRenameFix.create(
            $$189, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")
         )
      );
      $$0.addFixer(new EntityBrushableBlockFieldsRenameFix($$189));
      $$0.addFixer(
         ItemRenameFix.create(
            $$189,
      ...
      $$0.addFixer(new AddNewChoices($$189, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
      Schema $$190 = $$0.addSchema(3439, V3439::new);
      $$0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix($$190, "Updated sign text format for Signs", "minecraft:sign"));
      Schema $$191 = $$0.addSchema(3439, 1, V3439_1::new);
      $$0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix($$191, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema $$192 = $$0.addSchema(3440, SAME_NAMESPACED);
      $$0.addFixer(
         new NamespacedTypeRenameFix(
            $$192,
      ...
      $$0.addFixer(new FeatureFlagRemoveFix($$192, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema $$193 = $$0.addSchema(3447, SAME_NAMESPACED);
      $$0.addFixer(
         ItemRenameFix.create(
            $$193,
      ...
      Schema $$194 = $$0.addSchema(3448, V3448::new);
      $$0.addFixer(new DecoratedPotFieldRenameFix($$194));
      Schema $$195 = $$0.addSchema(3450, SAME_NAMESPACED);
      $$0.addFixer(
      ...
      Schema $$196 = $$0.addSchema(3451, SAME_NAMESPACED);
      $$0.addFixer(new ChunkDeleteLightFix($$196));
      Schema $$197 = $$0.addSchema(3459, SAME_NAMESPACED);
      $$0.addFixer(new LegacyDragonFightFix($$197));
      Schema $$198 = $$0.addSchema(3564, SAME_NAMESPACED);
      $$0.addFixer(new DropInvalidSignDataFix($$198, "minecraft:sign"));
      Schema $$199 = $$0.addSchema(3564, 1, SAME_NAMESPACED);
      $$0.addFixer(new DropInvalidSignDataFix($$199, "minecraft:hanging_sign"));
      Schema $$200 = $$0.addSchema(3565, SAME_NAMESPACED);
      $$0.addFixer(new RandomSequenceSettingsFix($$200));
      Schema $$201 = $$0.addSchema(3566, SAME_NAMESPACED);
      $$0.addFixer(new ScoreboardDisplaySlotFix($$201));
      Schema $$202 = $$0.addSchema(3568, SAME_NAMESPACED);
      $$0.addFixer(new MobEffectIdFix($$202));
      Schema $$203 = $$0.addSchema(3682, V3682::new);
      $$0.addFixer(new AddNewChoices($$203, "Added Crafter", References.BLOCK_ENTITY));
      Schema $$204 = $$0.addSchema(3683, V3683::new);
      $$0.addFixer(new PrimedTntBlockStateFixer($$204));
      Schema $$205 = $$0.addSchema(3685, V3685::new);
      $$0.addFixer(new FixProjectileStoredItem($$205));
      Schema $$206 = $$0.addSchema(3689, V3689::new);
      $$0.addFixer(new AddNewChoices($$206, "Added Breeze", References.ENTITY));
      $$0.addFixer(new AddNewChoices($$206, "Added Trial Spawner", References.BLOCK_ENTITY));
      Schema $$207 = $$0.addSchema(3692, SAME_NAMESPACED);
      UnaryOperator<String> $$208 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
      $$0.addFixer(BlockRenameFix.create($$207, "Rename grass block to short_grass", $$208));
      $$0.addFixer(ItemRenameFix.create($$207, "Rename grass item to short_grass", $$208));
      Schema $$209 = $$0.addSchema(3799, V3799::new);
      $$0.addFixer(new AddNewChoices($$209, "Added Armadillo", References.ENTITY));
      Schema $$210 = $$0.addSchema(3800, SAME_NAMESPACED);
      UnaryOperator<String> $$211 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      $$0.addFixer(ItemRenameFix.create($$210, "Rename scute item to turtle_scute", $$211));
      Schema $$212 = $$0.addSchema(3803, SAME_NAMESPACED);
      $$0.addFixer(new RenameEnchantmentsFix($$212, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema $$213 = $$0.addSchema(3807, V3807::new);
      $$0.addFixer(new AddNewChoices($$213, "Added Vault", References.BLOCK_ENTITY));
      Schema $$214 = $$0.addSchema(3807, 1, SAME_NAMESPACED);
      $$0.addFixer(new MapBannerBlockPosFormatFix($$214));
      Schema $$215 = $$0.addSchema(3808, V3808::new);
      $$0.addFixer(new HorseBodyArmorItemFix($$215, "minecraft:horse", "ArmorItem", true));
      Schema $$216 = $$0.addSchema(3808, 1, V3808_1::new);
      $$0.addFixer(new HorseBodyArmorItemFix($$216, "minecraft:llama", "DecorItem", false));
      Schema $$217 = $$0.addSchema(3808, 2, V3808_2::new);
      $$0.addFixer(new HorseBodyArmorItemFix($$217, "minecraft:trader_llama", "DecorItem", false));
      Schema $$218 = $$0.addSchema(3809, SAME_NAMESPACED);
      $$0.addFixer(new ChestedHorsesInventoryZeroIndexingFix($$218));
      Schema $$219 = $$0.addSchema(3812, SAME_NAMESPACED);
      $$0.addFixer(new FixWolfHealth($$219));
      Schema $$220 = $$0.addSchema(3813, V3813::new);
      $$0.addFixer(new BlockPosFormatAndRenamesFix($$220));
      Schema $$221 = $$0.addSchema(3814, SAME_NAMESPACED);
      $$0.addFixer(
         new AttributesRenameLegacy($$221, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength"))
      );
      Schema $$222 = $$0.addSchema(3816, V3816::new);
      $$0.addFixer(new AddNewChoices($$222, "Added Bogged", References.ENTITY));
      Schema $$223 = $$0.addSchema(3818, V3818::new);
      $$0.addFixer(new BeehiveFieldRenameFix($$223));
      $$0.addFixer(new EmptyItemInHotbarFix($$223));
      Schema $$224 = $$0.addSchema(3818, 1, SAME_NAMESPACED);
      $$0.addFixer(new BannerPatternFormatFix($$224));
      Schema $$225 = $$0.addSchema(3818, 2, SAME_NAMESPACED);
      $$0.addFixer(new TippedArrowPotionToItemFix($$225));
      Schema $$226 = $$0.addSchema(3818, 3, V3818_3::new);
      $$0.addFixer(new WriteAndReadFix($$226, "Inject data component types", References.DATA_COMPONENTS));
      Schema $$227 = $$0.addSchema(3818, 4, V3818_4::new);
      $$0.addFixer(new ParticleUnflatteningFix($$227));
      Schema $$228 = $$0.addSchema(3818, 5, V3818_5::new);
      $$0.addFixer(new ItemStackComponentizationFix($$228));
      Schema $$229 = $$0.addSchema(3818, 6, SAME_NAMESPACED);
      $$0.addFixer(new AreaEffectCloudPotionFix($$229));
      Schema $$230 = $$0.addSchema(3820, SAME_NAMESPACED);
      $$0.addFixer(new PlayerHeadBlockProfileFix($$230));
      $$0.addFixer(new LodestoneCompassComponentFix($$230));
      Schema $$231 = $$0.addSchema(3825, V3825::new);
      $$0.addFixer(new ItemStackCustomNameToOverrideComponentFix($$231));
      $$0.addFixer(new BannerEntityCustomNameToOverrideComponentFix($$231));
      $$0.addFixer(new TrialSpawnerConfigFix($$231));
      $$0.addFixer(new AddNewChoices($$231, "Added Ominous Item Spawner", References.ENTITY));
      Schema $$232 = $$0.addSchema(3828, SAME_NAMESPACED);
      $$0.addFixer(new EmptyItemInVillagerTradeFix($$232));
      Schema $$233 = $$0.addSchema(3833, SAME_NAMESPACED);
      $$0.addFixer(new RemoveEmptyItemInBrushableBlockFix($$233));
      Schema $$234 = $$0.addSchema(3938, V3938::new);
      $$0.addFixer(new ProjectileStoredWeaponFix($$234));
      Schema $$235 = $$0.addSchema(3939, SAME_NAMESPACED);
      $$0.addFixer(new FeatureFlagRemoveFix($$235, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema $$236 = $$0.addSchema(3943, SAME_NAMESPACED);
      $$0.addFixer(new OptionsMenuBlurrinessFix($$236));
      Schema $$237 = $$0.addSchema(3945, SAME_NAMESPACED);
      $$0.addFixer(new AttributeModifierIdFix($$237));
      $$0.addFixer(new JukeboxTicksSinceSongStartedFix($$237));
      Schema $$238 = $$0.addSchema(4054, SAME_NAMESPACED);
      $$0.addFixer(new OminousBannerRarityFix($$238));
      Schema $$239 = $$0.addSchema(4055, SAME_NAMESPACED);
      $$0.addFixer(new AttributeIdPrefixFix($$239));
      Schema $$240 = $$0.addSchema(4057, SAME_NAMESPACED);
      $$0.addFixer(new CarvingStepRemoveFix($$240));
      Schema $$241 = $$0.addSchema(4059, V4059::new);
      $$0.addFixer(new FoodToConsumableFix($$241));
      Schema $$242 = $$0.addSchema(4061, SAME_NAMESPACED);
      $$0.addFixer(new TrialSpawnerConfigInRegistryFix($$242));
      Schema $$243 = $$0.addSchema(4064, SAME_NAMESPACED);
      $$0.addFixer(new FireResistantToDamageResistantComponentFix($$243));
      Schema $$244 = $$0.addSchema(4067, V4067::new);
      $$0.addFixer(new BoatSplitFix($$244));
      $$0.addFixer(new FeatureFlagRemoveFix($$244, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema $$245 = $$0.addSchema(4068, SAME_NAMESPACED);
      $$0.addFixer(new LockComponentPredicateFix($$245));
      $$0.addFixer(new ContainerBlockEntityLockPredicateFix($$245));
      Schema $$246 = $$0.addSchema(4070, V4070::new);
      $$0.addFixer(new AddNewChoices($$246, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
      Schema $$247 = $$0.addSchema(4071, V4071::new);
      $$0.addFixer(new AddNewChoices($$247, "Added Creaking", References.ENTITY));
      $$0.addFixer(new AddNewChoices($$247, "Added Creaking Heart", References.BLOCK_ENTITY));
      Schema $$248 = $$0.addSchema(4081, SAME_NAMESPACED);
      $$0.addFixer(new EntitySalmonSizeFix($$248));
      Schema $$249 = $$0.addSchema(4173, SAME_NAMESPACED);
      $$0.addFixer(new EntityFieldsRenameFix($$249, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema $$250 = $$0.addSchema(4175, SAME_NAMESPACED);
      $$0.addFixer(new EquippableAssetRenameFix($$250));
      $$0.addFixer(new CustomModelDataExpandFix($$250));
      Schema $$251 = $$0.addSchema(4176, SAME_NAMESPACED);
      $$0.addFixer(new InvalidBlockEntityLockFix($$251));
      $$0.addFixer(new InvalidLockComponentFix($$251));
      Schema $$252 = $$0.addSchema(4180, SAME_NAMESPACED);
      $$0.addFixer(new FeatureFlagRemoveFix($$252, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema $$253 = $$0.addSchema(4181, SAME_NAMESPACED);
      $$0.addFixer(new BlockEntityFurnaceBurnTimeFix($$253, "minecraft:furnace"));
      $$0.addFixer(new BlockEntityFurnaceBurnTimeFix($$253, "minecraft:smoker"));
      $$0.addFixer(new BlockEntityFurnaceBurnTimeFix($$253, "minecraft:blast_furnace"));
      Schema $$254 = $$0.addSchema(4187, SAME_NAMESPACED);
      $$0.addFixer(
         new EntityAttributeBaseValueFix(
            $$254, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", $$0x -> $$0x == 48.0 ? 16.0 : $$0x
         )
      );
      $$0.addFixer(
         new EntityAttributeBaseValueFix($$254, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", $$0x -> $$0x == 48.0 ? 16.0 : $$0x)
      );
      $$0.addFixer(
         new EntityAttributeBaseValueFix($$254, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", $$0x -> $$0x == 48.0 ? 16.0 : $$0x)
      );
      $$0.addFixer(
         new EntityAttributeBaseValueFix($$254, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", $$0x -> $$0x == 40.0 ? 16.0 : $$0x)
      );
      $$0.addFixer(
         new EntityAttributeBaseValueFix(
            $$254, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", $$0x -> $$0x == 16.0 ? 12.0 : $$0x
         )
      );
      $$0.addFixer(
         new EntityAttributeBaseValueFix($$254, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", $$0x -> $$0x == 16.0 ? 24.0 : $$0x)
      );
      Schema $$255 = $$0.addSchema(4290, V4290::new);
      $$0.addFixer(new UnflattenTextComponentFix($$255));
      Schema $$256 = $$0.addSchema(4291, SAME_NAMESPACED);
      $$0.addFixer(new LegacyHoverEventFix($$256));
      $$0.addFixer(new TextComponentStringifiedFlagsFix($$256));
      Schema $$257 = $$0.addSchema(4292, V4292::new);
      $$0.addFixer(new TextComponentHoverAndClickEventFix($$257));
      Schema $$258 = $$0.addSchema(4293, SAME_NAMESPACED);
      $$0.addFixer(new DropChancesFormatFix($$258));
      Schema $$259 = $$0.addSchema(4294, SAME_NAMESPACED);
      $$0.addFixer(
      ...
      Schema $$260 = $$0.addSchema(4295, SAME_NAMESPACED);
      $$0.addFixer(new BlendingDataFix($$260));
      Schema $$261 = $$0.addSchema(4296, SAME_NAMESPACED);
      $$0.addFixer(new AreaEffectCloudDurationScaleFix($$261));
      Schema $$262 = $$0.addSchema(4297, SAME_NAMESPACED);
      $$0.addFixer(new ForcedChunkToTicketFix($$262));
      Schema $$263 = $$0.addSchema(4299, SAME_NAMESPACED);
      $$0.addFixer(new EntitySpawnerItemVariantComponentFix($$263));
      Schema $$264 = $$0.addSchema(4300, V4300::new);
      $$0.addFixer(new SaddleEquipmentSlotFix($$264));
      Schema $$265 = $$0.addSchema(4301, V4301::new);
      $$0.addFixer(new EquipmentFormatFix($$265));
      Schema $$266 = $$0.addSchema(4302, V4302::new);
      $$0.addFixer(new AddNewChoices($$266, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
      Schema $$267 = $$0.addSchema(4303, SAME_NAMESPACED);
      $$0.addFixer(new EntityFallDistanceFloatToDoubleFix($$267, References.ENTITY));
      $$0.addFixer(new EntityFallDistanceFloatToDoubleFix($$267, References.PLAYER));
      Schema $$268 = $$0.addSchema(4305, SAME_NAMESPACED);
      $$0.addFixer(new BlockPropertyRenameAndFix($$268, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", $$0x -> $$0x));
      Schema $$269 = $$0.addSchema(4306, V4306::new);
      $$0.addFixer(new ThrownPotionSplitFix($$269));
      Schema $$270 = $$0.addSchema(4307, V4307::new);
      $$0.addFixer(new TooltipDisplayComponentFix($$270));
      Schema $$271 = $$0.addSchema(4309, SAME_NAMESPACED);
      $$0.addFixer(new RaidRenamesDataFix($$271));
      $$0.addFixer(new ChunkTicketUnpackPosFix($$271));
      Schema $$272 = $$0.addSchema(4311, SAME_NAMESPACED);
      $$0.addFixer(
         new AdvancementsRenameFix(
            $$272, false, "Use lodestone category change", createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")
         )
      );
      Schema $$273 = $$0.addSchema(4312, V4312::new);
      $$0.addFixer(new PlayerEquipmentFix($$273));
      Schema $$274 = $$0.addSchema(4314, SAME_NAMESPACED);
      $$0.addFixer(new InlineBlockPosFormatFix($$274));
      Schema $$275 = $$0.addSchema(4420, V4420::new);
      $$0.addFixer(new NamedEntityConvertUncheckedFix($$275, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
      Schema $$276 = $$0.addSchema(4421, V4421::new);
      $$0.addFixer(new AddNewChoices($$276, "Added Happy Ghast", References.ENTITY));
      Schema $$277 = $$0.addSchema(4424, SAME_NAMESPACED);
      $$0.addFixer(new FeatureFlagRemoveFix($$277, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
      $$0.addFixer(new AddFieldFix($$277, References.PLAYER, "style", $$0x -> $$0x.createString("minecraft:default"), "locator_bar_icon"));
      $$0.addFixer(new AddFieldFix($$277, References.ENTITY, "style", $$0x -> $$0x.createString("minecraft:default"), "locator_bar_icon"));
      Schema $$278 = $$0.addSchema(4531, V4531::new);
      $$0.addFixer(new AddNewChoices($$278, "Added Copper Golem", References.ENTITY));
      Schema $$279 = $$0.addSchema(4532, V4532::new);
      $$0.addFixer(new AddNewChoices($$279, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
      Schema $$280 = $$0.addSchema(4533, V4533::new);
      $$0.addFixer(new AddNewChoices($$280, "Added Shelf", References.BLOCK_ENTITY));
      Schema $$281 = $$0.addSchema(4535, SAME_NAMESPACED);
      $$0.addFixer(new CopperGolemWeatherStateFix($$281));
      Schema $$282 = $$0.addSchema(4537, SAME_NAMESPACED);
      $$0.addFixer(new ChunkDeleteLightFix($$282));
      Schema $$283 = $$0.addSchema(4541, SAME_NAMESPACED);
      $$0.addFixer(BlockRenameFix.create($$283, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
      $$0.addFixer(ItemRenameFix.create($$283, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
      Schema $$284 = $$0.addSchema(4543, V4543::new);
      $$0.addFixer(new AddNewChoices($$284, "Added Mannequin", References.ENTITY));
      Schema $$285 = $$0.addSchema(4544, SAME_NAMESPACED);
      $$0.addFixer(new LegacyWorldBorderFix($$285));
      Schema $$286 = $$0.addSchema(4548, SAME_NAMESPACED);
      $$0.addFixer(new WorldSpawnDataFix($$286));
      $$0.addFixer(new PlayerRespawnDataFix($$286));
   }
   ...
   private static UnaryOperator<String> createRenamer(Map<String, String> $$0) {
      return $$1 -> (String)$$0.getOrDefault(NamespacedSchema.ensureNamespaced($$1), $$1);
   }
