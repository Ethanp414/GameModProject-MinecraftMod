...
public class V1460 extends NamespacedSchema {
   ...
   protected static void registerInventory(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, (Supplier<TypeTemplate>)(() -> V1458.nameableInventory($$0)));
   }

   @Override
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = Maps.newHashMap();
      $$0.register($$1, "minecraft:area_effect_cloud", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Particle", References.PARTICLE.in($$0))));
      registerMob($$0, $$1, "minecraft:armor_stand");
      $$0.register($$1, "minecraft:arrow", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in($$0))));
      ...
      $$0.register(
         ...
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields(
               "DisplayState", References.BLOCK_STATE.in($$0), "Items", DSL.list(References.ITEM_STACK.in($$0))
            ))
      );
      ...
      $$0.register(
         ...
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields(
               "DisplayState", References.BLOCK_STATE.in($$0), "LastOutput", References.TEXT_COMPONENT.in($$0)
            ))
      );
      ...
      $$0.register(
         ...
         "minecraft:donkey",
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields(
               "Items", DSL.list(References.ITEM_STACK.in($$0)), "SaddleItem", References.ITEM_STACK.in($$0)
            ))
      );
      ...
      $$0.register(
         $$1, "minecraft:enderman", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in($$0)))
      );
      ...
      $$0.register(
         ...
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields(
               "BlockState", References.BLOCK_STATE.in($$0), "TileEntityData", References.BLOCK_ENTITY.in($$0)
            ))
      );
      $$0.registerSimple($$1, "minecraft:fireball");
      $$0.register(
         $$1, "minecraft:fireworks_rocket", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in($$0)))
      );
      $$0.register(
         $$1, "minecraft:furnace_minecart", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in($$0)))
      );
      ...
      $$0.register(
         $$1,
         "minecraft:horse",
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in($$0), "SaddleItem", References.ITEM_STACK.in($$0)))
      );
      registerMob($$0, $$1, "minecraft:husk");
      registerMob($$0, $$1, "minecraft:illusion_illager");
      $$0.register($$1, "minecraft:item", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Item", References.ITEM_STACK.in($$0))));
      $$0.register($$1, "minecraft:item_frame", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Item", References.ITEM_STACK.in($$0))));
      ...
      $$0.register($$1, "minecraft:minecart", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in($$0))));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in($$0))));
      ...
      $$0.register(
         ...
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in($$0), References.UNTAGGED_SPAWNER.in($$0)))
      );
      $$0.register(
         $$1, "minecraft:spectral_arrow", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in($$0)))
      );
      ...
      $$0.register($$1, "minecraft:tnt_minecart", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in($$0))));
      ...
      $$0.register($$1, "minecraft:zombie_horse", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in($$0))));
      registerMob($$0, $$1, "minecraft:zombie_pigman");
      $$0.register(
         $$1,
         "minecraft:zombie_villager",
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in($$0)))))
      );
      return $$1;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:jukebox", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("RecordItem", References.ITEM_STACK.in($$0))));
      registerInventory($$0, $$1, "minecraft:dispenser");
      registerInventory($$0, $$1, "minecraft:dropper");
      $$0.register($$1, "minecraft:sign", (Supplier<TypeTemplate>)(() -> V99.sign($$0)));
      $$0.register($$1, "minecraft:mob_spawner", (Function<String, TypeTemplate>)($$1x -> References.UNTAGGED_SPAWNER.in($$0)));
      ...
      $$0.register($$1, "minecraft:enchanting_table", (Supplier<TypeTemplate>)(() -> V1458.nameable($$0)));
      $$0.registerSimple($$1, "minecraft:end_portal");
      $$0.register($$1, "minecraft:beacon", (Supplier<TypeTemplate>)(() -> V1458.nameable($$0)));
      $$0.register($$1, "minecraft:skull", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("custom_name", References.TEXT_COMPONENT.in($$0))));
      ...
      $$0.register($$1, "minecraft:banner", (Supplier<TypeTemplate>)(() -> V1458.nameable($$0)));
      $$0.registerSimple($$1, "minecraft:structure_block");
      $$0.registerSimple($$1, "minecraft:end_gateway");
      $$0.register($$1, "minecraft:command_block", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("LastOutput", References.TEXT_COMPONENT.in($$0))));
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  ...
                  Pair.of("minecraft:crafted", (TypeTemplate)$$3.get()),
                  Pair.of("minecraft:used", (TypeTemplate)$$3.get()),
                  Pair.of("minecraft:broken", (TypeTemplate)$$3.get()),
                  Pair.of("minecraft:picked_up", (TypeTemplate)$$3.get()),
                  Pair.of("minecraft:dropped", (TypeTemplate)$$3.get()),
