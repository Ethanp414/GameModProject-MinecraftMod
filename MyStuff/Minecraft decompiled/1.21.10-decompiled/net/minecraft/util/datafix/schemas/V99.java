...
public class V99 extends Schema {
   ...
   static final Map<String, String> ITEM_TO_BLOCKENTITY = DataFixUtils.make(Maps.newHashMap(), $$0 -> {
   ...
   protected static void registerMinecart(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, (Supplier<TypeTemplate>)(() -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in($$0))));
   }

   protected static void registerInventory(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, (Supplier<TypeTemplate>)(() -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in($$0)))));
   }

   @Override
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = Maps.newHashMap();
      $$0.register($$1, "Item", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Item", References.ITEM_STACK.in($$0))));
      $$0.registerSimple($$1, "XPOrb");
      registerThrowableProjectile($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inTile", References.BLOCK_NAME.in($$0))));
      $$0.register($$1, "TippedArrow", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inTile", References.BLOCK_NAME.in($$0))));
      $$0.register($$1, "SpectralArrow", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inTile", References.BLOCK_NAME.in($$0))));
      ...
      $$0.register(
         $$1,
         "ThrownPotion",
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("inTile", References.BLOCK_NAME.in($$0), "Potion", References.ITEM_STACK.in($$0)))
      );
      registerThrowableProjectile($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Item", References.ITEM_STACK.in($$0))));
      ...
      $$0.register($$1, "FireworksRocketEntity", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in($$0))));
      $$0.registerSimple($$1, "Boat");
      $$0.register(
         $$1,
         "Minecart",
         (Supplier<TypeTemplate>)(() -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in($$0), "Items", DSL.list(References.ITEM_STACK.in($$0))))
      );
      ...
      $$0.register(
         $$1,
         "MinecartSpawner",
         (Supplier<TypeTemplate>)(() -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in($$0), References.UNTAGGED_SPAWNER.in($$0)))
      );
      $$0.register(
         $$1,
         "MinecartHopper",
      ...
      $$0.register(
         ...
         (Supplier<TypeTemplate>)(() -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in($$0), "LastOutput", References.TEXT_COMPONENT.in($$0)))
      );
      ...
      $$0.register($$1, "Enderman", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("carried", References.BLOCK_NAME.in($$0))));
      ...
      $$0.register($$1, "AreaEffectCloud", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Particle", References.PARTICLE.in($$0))));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("RecordItem", References.ITEM_STACK.in($$0))));
      registerInventory($$0, $$1, "Trap");
      registerInventory($$0, $$1, "Dropper");
      $$0.register($$1, "Sign", (Supplier<TypeTemplate>)(() -> sign($$0)));
      $$0.register($$1, "MobSpawner", (Function<String, TypeTemplate>)($$1x -> References.UNTAGGED_SPAWNER.in($$0)));
      ...
      $$0.register($$1, "Control", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("LastOutput", References.TEXT_COMPONENT.in($$0))));
      $$0.registerSimple($$1, "Beacon");
      $$0.register($$1, "Skull", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("custom_name", References.TEXT_COMPONENT.in($$0))));
      ...
      $$0.register(
         $$1,
         "FlowerPot",
         (Function<String, TypeTemplate>)($$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in($$0))))
      );
      $$0.register($$1, "Banner", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("CustomName", References.TEXT_COMPONENT.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(
         ...
         () -> DSL.and(
               ...
               DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", DSL.string(), $$1))
            )
      );
      $$0.registerType(
         true,
   ...
   protected static <T> T addNames(Dynamic<T> $$0, Map<String, String> $$1, Map<String, String> $$2) {
      return $$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
            String $$3xx = (String)$$0.get("id").asString().result().map(NamespacedSchema::ensureNamespaced).orElse("minecraft:air");
            if (!"minecraft:air".equals($$3xx)) {
               String $$4 = (String)$$1.get($$3xx);
               if ($$4 != null) {
                  return $$2xx.set("id", $$0.createString($$4));
               }

               LOGGER.warn("Unable to resolve BlockEntity for ItemStack: {}", $$3xx);
            }
            ...
            if ($$2xx.get("id").result().isPresent()) {
               ...
               String $$3xx = NamespacedSchema.ensureNamespaced($$0.get("id").asString(""));
               String $$4 = (String)$$2.get($$3xx);
