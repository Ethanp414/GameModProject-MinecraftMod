...
public class V4059 extends NamespacedSchema {
   ...
   public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema $$0) {
      ...
      $$1.put("minecraft:use_remainder", (Supplier)() -> References.ITEM_STACK.in($$0));
      $$1.put(
         "minecraft:equippable",
         (Supplier)() -> DSL.optionalFields("allowed_entities", DSL.or(References.ENTITY_NAME.in($$0), DSL.list(References.ENTITY_NAME.in($$0))))
      );
      return $$1;
   }
