...
public class V704 extends Schema {
   ...
   protected static final HookFunction ADD_NAMES = new HookFunction() {
      ...
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return V99.addNames(new Dynamic<>($$0, $$1), V704.ITEM_TO_BLOCKENTITY, V99.ITEM_TO_ENTITY);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), References.BLOCK_ENTITY.typeName())
         ? super.getChoiceType($$0, NamespacedSchema.ensureNamespaced($$1))
         : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      BlockEntityIdFix.ID_MAP
         .forEach(($$1x, $$2) -> $$1.put($$2, (Supplier)Objects.requireNonNull((Supplier)$$1.remove($$1x), () -> "Didn't find " + $$1x + " in schema")));
      return $$1;
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields("components", References.DATA_COMPONENTS.in($$0), DSL.taggedChoiceLazy("id", NamespacedSchema.namespacedString(), $$2))
      );
      $$0.registerType(
         true,
