...
public enum DataFixTypes {
      ...
      return new Codec<A>() {
         ...
         public <T> DataResult<T> encode(A $$0x, DynamicOps<T> $$1x, T $$2x) {
            return $$0.encode($$0, $$1, $$2)
               .flatMap($$1xxx -> $$1.mergeToMap((T)$$1xxx, $$1.createString("DataVersion"), $$1.createInt(DataFixTypes.currentVersion())));
         }
   ...
   public CompoundTag update(DataFixer $$0, CompoundTag $$1, int $$2, int $$3) {
      return this.update($$0, new Dynamic<>(NbtOps.INSTANCE, $$1), $$2, $$3).getValue();
   }
