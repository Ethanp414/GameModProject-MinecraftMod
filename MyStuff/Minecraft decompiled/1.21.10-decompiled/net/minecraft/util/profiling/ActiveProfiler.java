...
public class ActiveProfiler implements ProfileCollector {
      ...
      if (!this.started) {
         ...
         if ($$2 > WARNING_TIME_NANOS && !this.suppressWarnings.getAsBoolean()) {
            LOGGER.warn(
               ...
               LogUtils.defer(() -> ProfileResults.demanglePath(this.path)),
               LogUtils.defer(() -> (double)$$2 / 1000000.0)
            );
         }
   ...
   private ActiveProfiler.PathEntry getCurrentEntry() {
      if (this.currentEntry == null) {
         this.currentEntry = (ActiveProfiler.PathEntry)this.entries.computeIfAbsent(this.path, $$0 -> new ActiveProfiler.PathEntry());
      }
   ...
   public void incrementCounter(String $$0, int $$1) {
      this.getCurrentEntry().counters.addTo($$0, (long)$$1);
   }

   @Override
   public void incrementCounter(Supplier<String> $$0, int $$1) {
      this.getCurrentEntry().counters.addTo((String)$$0.get(), (long)$$1);
   }
   ...
   public ActiveProfiler.PathEntry getEntry(String $$0) {
      return (ActiveProfiler.PathEntry)this.entries.get($$0);
   }
