...
public class TracyZoneFiller implements ProfilerFiller {
   ...
   public void push(String $$0) {
      ...
      if (SharedConstants.IS_RUNNING_IN_IDE) {
         Optional<StackFrame> $$4 = (Optional)STACK_WALKER.walk(
            $$0x -> $$0x.filter(
   ...
   public void pop() {
      if (this.activeZones.isEmpty()) {
         ...
         com.mojang.jtracy.Zone $$0 = (com.mojang.jtracy.Zone)this.activeZones.removeLast();
         $$0.close();
      }
   }
   ...
   public void incrementCounter(String $$0, int $$1) {
      ((TracyZoneFiller.PlotAndValue)this.plots.computeIfAbsent($$0, $$1x -> new TracyZoneFiller.PlotAndValue(this.name + " " + $$0))).add($$1);
   }

   @Override
   public void incrementCounter(Supplier<String> $$0, int $$1) {
      this.incrementCounter((String)$$0.get(), $$1);
   }
