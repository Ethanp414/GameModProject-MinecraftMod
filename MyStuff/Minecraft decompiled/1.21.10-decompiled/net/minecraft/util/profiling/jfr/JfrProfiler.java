...
public class JfrProfiler implements JvmProfiler {
   ...
   private boolean start(Reader $$0, Environment $$1) {
      if (this.isRunning()) {
         ...
         try {
            ...
            this.recording = Util.make(new Recording($$2), $$2 -> {
   ...
   private NetworkSummaryEvent.SumAggregation networkStatFor(SocketAddress $$0) {
      return (NetworkSummaryEvent.SumAggregation)this.networkTrafficByAddress.computeIfAbsent($$0.toString(), NetworkSummaryEvent.SumAggregation::new);
   }
