...
public record GcHeapStat(Instant timestamp, long heapUsed, GcHeapStat.Timing timing) {
   ...
   private static double calculateAllocationRatePerSecond(List<GcHeapStat> $$0) {
      long $$1 = 0L;
      Map<GcHeapStat.Timing, List<GcHeapStat>> $$2 = (Map)$$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.timing));
      List<GcHeapStat> $$3 = (List)$$2.get(GcHeapStat.Timing.BEFORE_GC);
      List<GcHeapStat> $$4 = (List)$$2.get(GcHeapStat.Timing.AFTER_GC);
      ...
      Duration $$8 = Duration.between(((GcHeapStat)$$0.get(1)).timestamp, ((GcHeapStat)$$0.get($$0.size() - 1)).timestamp);
