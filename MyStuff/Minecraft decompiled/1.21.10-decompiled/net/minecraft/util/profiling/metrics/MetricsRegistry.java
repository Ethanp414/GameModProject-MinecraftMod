...
public class MetricsRegistry {
   ...
   public List<MetricSampler> getRegisteredSamplers() {
      Map<String, List<MetricSampler>> $$0 = (Map)this.measuredInstances
         .keySet()
         .stream()
   ...
   private static List<MetricSampler> aggregateDuplicates(Map<String, List<MetricSampler>> $$0) {
      return (List<MetricSampler>)$$0.entrySet().stream().map($$0x -> {
         String $$1 = (String)$$0x.getKey();
         List<MetricSampler> $$2 = (List)$$0x.getValue();
   ...
   static class AggregatedMetricSampler extends MetricSampler {
      ...
      AggregatedMetricSampler(String $$0, List<MetricSampler> $$1) {
         super($$0, ((MetricSampler)$$1.get(0)).getCategory(), () -> averageValueFromDelegates($$1), () -> beforeTick($$1), thresholdTest($$1));
         this.delegates = $$1;
      }
