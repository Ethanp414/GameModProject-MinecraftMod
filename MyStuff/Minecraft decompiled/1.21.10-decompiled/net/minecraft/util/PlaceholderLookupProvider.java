...
public class PlaceholderLookupProvider implements HolderGetter.Provider {
      ...
      return new RegistryContextSwapper() {
         ...
         public <T> DataResult<T> swapTo(Codec<T> $$0, T $$1, HolderLookup.Provider $$2) {
            return $$0.encodeStart(PlaceholderLookupProvider.this.createSerializationContext(JavaOps.INSTANCE), $$1)
               .flatMap($$2x -> $$0.parse($$2.createSerializationContext(JavaOps.INSTANCE), (T)$$2x));
         }
      };
   }
   ...
   class UniversalLookup implements HolderGetter<Object>, HolderOwner<Object> {
      ...
      private Holder.Reference<Object> getOrCreate(ResourceKey<Object> $$0) {
         return (Holder.Reference<Object>)PlaceholderLookupProvider.this.holders.computeIfAbsent($$0, $$0x -> Holder.Reference.createStandAlone(this, $$0x));
      }
      ...
      private HolderSet.Named<Object> getOrCreate(TagKey<Object> $$0) {
         return (HolderSet.Named<Object>)PlaceholderLookupProvider.this.holderSets.computeIfAbsent($$0, $$0x -> HolderSet.emptyNamed(this, $$0x));
      }
