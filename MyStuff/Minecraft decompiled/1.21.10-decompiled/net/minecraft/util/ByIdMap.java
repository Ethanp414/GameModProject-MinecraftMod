...
public class ByIdMap {
   ...
   public static <T> IntFunction<T> continuous(ToIntFunction<T> $$0, T[] $$1, ByIdMap.OutOfBoundsStrategy $$2) {
      T[] $$3 = (T[])createSortedArray($$0, $$1);
      int $$4 = $$3.length;

      return switch($$2.ordinal()) {
         case 0 -> {
            T $$5 = $$3[0];
            yield $$3x -> $$3x >= 0 && $$3x < $$4 ? $$3[$$3x] : $$5;
         }
         case 1 -> $$2x -> $$3[Mth.positiveModulo($$2x, $$4)];
         case 2 -> $$2x -> $$3[Mth.clamp($$2x, 0, $$4 - 1)];
