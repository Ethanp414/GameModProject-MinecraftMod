...
public class StaticCache2D<T> {
   ...
   public static <T> StaticCache2D<T> create(int $$0, int $$1, int $$2, StaticCache2D.Initializer<T> $$3) {
      int $$4 = $$0 - $$2;
      int $$5 = $$1 - $$2;
      int $$6 = 2 * $$2 + 1;
   ...
   private StaticCache2D(int $$0, int $$1, int $$2, int $$3, StaticCache2D.Initializer<T> $$4) {
      this.minX = $$0;
      this.minZ = $$1;
      this.sizeX = $$2;
      this.sizeZ = $$3;
      ...
      for(int $$5 = $$0; $$5 < $$0 + $$2; ++$$5) {
         for(int $$6 = $$1; $$6 < $$1 + $$3; ++$$6) {
            this.cache[this.getIndex($$5, $$6)] = $$4.get($$5, $$6);
         }
      }
   }
