...
public class CrudeIncrementalIntIdentityHashBiMap<K> implements IdMap<K> {
   ...
   private void grow(int $$0) {
      K[] $$1 = this.keys;
      int[] $$2 = this.values;
      CrudeIncrementalIntIdentityHashBiMap<K> $$3 = new CrudeIncrementalIntIdentityHashBiMap<>($$0);
   ...
   private int hash(@Nullable K $$0) {
      return (Mth.murmurHash3Mixer(System.identityHashCode($$0)) & 2147483647) % this.keys.length;
   }
