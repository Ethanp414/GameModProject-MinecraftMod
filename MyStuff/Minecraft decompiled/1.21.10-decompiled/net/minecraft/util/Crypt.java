...
public class Crypt {
   ...
   private static <T extends Key> T rsaStringToKey(String $$0, String $$1, String $$2, Crypt.ByteArrayToKeyFunction<T> $$3) throws CryptException {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey stringToPemRsaPrivateKey(String $$0) throws CryptException {
      return rsaStringToKey($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", Crypt::byteToPrivateKey);
   }

   public static PublicKey stringToRsaPublicKey(String $$0) throws CryptException {
      return rsaStringToKey($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", Crypt::byteToPublicKey);
   }
   ...
   public static record SaltSignaturePair(long salt, byte[] signature) {
      ...
      public static void write(FriendlyByteBuf $$0, Crypt.SaltSignaturePair $$1) {
         $$0.writeLong($$1.salt);
