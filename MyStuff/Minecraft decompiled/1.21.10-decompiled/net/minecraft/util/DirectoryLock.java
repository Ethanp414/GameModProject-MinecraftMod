...
public class DirectoryLock implements AutoCloseable {
   ...
   public static class LockException extends IOException {
      ...
      public static DirectoryLock.LockException alreadyLocked(Path $$0) {
         return new DirectoryLock.LockException($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
