...
public class SortedArraySet<T> extends AbstractSet<T> {
   ...
   public <U> U[] toArray(U[] $$0) {
      if ($$0.length < this.size) {
         return (U[])Arrays.copyOf(this.contents, this.size, $$0.getClass());
      } else {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof SortedArraySet $$1 && this.comparator.equals($$1.comparator)) {
