...
public final class WeightedList<E> {
   ...
   public static <E> WeightedList<E> of(E $$0) {
      return new WeightedList<>(List.of(new Weighted<E>($$0, 1)));
   }
   ...
   public boolean equals(@Nullable Object $$0) {
      if (this == $$0) {
         return true;
      } else if (!($$0 instanceof WeightedList)) {
         return false;
      } else {
   ...
   public static class Builder<E> {
      ...
      public WeightedList.Builder<E> add(E $$0, int $$1) {
         this.result.add((E)(new Weighted<E>($$0, $$1)));
         return this;
      }
   ...
   static class Compact<E> implements WeightedList.Selector<E> {
      ...
      Compact(List<Weighted<E>> $$0) {
         this.entries = (Weighted[])$$0.toArray($$0x -> new Weighted[$$0x]);
      }
