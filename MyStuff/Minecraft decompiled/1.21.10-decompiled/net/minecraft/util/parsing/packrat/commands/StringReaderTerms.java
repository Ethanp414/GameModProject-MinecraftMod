...
public interface StringReaderTerms {
   ...
   public abstract static class TerminalCharacters implements Term<StringReader> {
      ...
      public TerminalCharacters(CharList $$0) {
         String $$1 = (String)$$0.intStream().mapToObj(Character::toString).collect(Collectors.joining("|"));
         this.error = DelayedException.create(CommandSyntaxException.BUILT_IN_EXCEPTIONS.literalIncorrect(), String.valueOf($$1));
