...
public class HttpUtil {
   ...
   public static Path downloadFile(
      Path $$0, URL $$1, Map<String, String> $$2, HashFunction $$3, @Nullable HashCode $$4, int $$5, Proxy $$6, HttpUtil.DownloadProgressListener $$7
   ) {
      ...
      try {
         ...
         if ($$10 == null) {
            ...
            try {
               HashCode $$18 = downloadAndHash($$3, $$5, $$7, $$9, $$17);
               Path $$19 = cachedFilePath($$0, $$18);
               if (!checkExistingFile($$19, $$3, $$18)) {
   ...
   private static HashCode downloadAndHash(HashFunction $$0, int $$1, HttpUtil.DownloadProgressListener $$2, InputStream $$3, Path $$4) throws IOException {
      OutputStream $$5 = Files.newOutputStream($$4, StandardOpenOption.CREATE);
