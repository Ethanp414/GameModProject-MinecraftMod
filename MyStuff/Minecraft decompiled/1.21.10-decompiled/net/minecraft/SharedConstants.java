...
public class SharedConstants {
   ...
   private static boolean booleanProperty(String $$0) {
      String $$1 = System.getProperty($$0);
      return $$1 != null && ($$1.isEmpty() || Boolean.parseBoolean($$1));
   }

   private static boolean debugFlag(String $$0) {
      if (!DEBUG_ENABLED) {
         return false;
      } else {
         String $$1 = prefixDebugFlagName($$0);
         if (DEBUG_PRINT_PROPERTIES) {
            System.out.println("Debug property available: " + $$1 + ": bool");
         }

         return booleanProperty($$1);
      }
   }

   private static int debugIntValue(String $$0) {
      if (!DEBUG_ENABLED) {
         return 0;
      } else {
         String $$1 = prefixDebugFlagName($$0);
