...
public class GameTestRunner {
   ...
   protected GameTestRunner(
      ...
      this.allTestInfos = (List)this.batches.stream().flatMap($$0x -> $$0x.gameTestInfos().stream()).collect(Util.toMutableList());
      $$3.setRunner(this);
      ...
      if ($$0 >= this.batches.size()) {
         ...
         if ($$0 > 0 && this.clearBetweenBatches) {
            ...
            $$1.gameTestInfos().forEach($$0x -> {
               TestInstanceBlockEntity $$1 = $$0x.getTestInstanceBlockEntity();
         ...
         LOGGER.info("Running test environment '{}' batch {} ({} tests)...", $$2.environment().getRegisteredName(), $$2.index(), $$3.size());
         this.endCurrentEnvironment();
         ...
         $$4.addListener(new GameTestListener() {
            ...
            public void testFailed(GameTestInfo $$0x, GameTestRunner $$1) {
               if (GameTestRunner.this.haltOnError) {
                  ...
                  LongSet $$2 = new LongArraySet(GameTestRunner.this.level.getForceLoadedChunks());
                  $$2.forEach($$0xxx -> GameTestRunner.this.level.setChunkForced(ChunkPos.getX($$0xxx), ChunkPos.getZ($$0xxx), false));
            ...
            @Override
            public void testAddedForRerun(GameTestInfo $$0x, GameTestInfo $$1, GameTestRunner $$2) {
            }
         });
