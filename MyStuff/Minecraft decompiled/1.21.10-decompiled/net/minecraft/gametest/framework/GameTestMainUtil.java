...
public class GameTestMainUtil {
   ...
   public static void runGameTestServer(String[] $$0, Consumer<String> $$1) throws Exception {
      ...
      if ($$2.has(help)) {
         ...
         if ($$2.valueOf(verify) && !$$2.has(tests)) {
         ...
         String $$3 = $$2.valueOf(universe);
         createOrResetDir($$3);
         $$1.accept($$3);
         if ($$2.has(packs)) {
            String $$4 = $$2.valueOf(packs);
            copyPacks($$3, $$4);
         }

         LevelStorageSource.LevelStorageAccess $$5 = LevelStorageSource.createDefault(Paths.get($$3)).createAccess("gametestworld");
         ...
         try {
            for(Path $$5 : $$4.toList()) {
               ...
               if (Files.isDirectory($$5, new LinkOption[0])) {
                  if (Files.isRegularFile($$5.resolve("pack.mcmeta"), new LinkOption[0])) {
