...
public class BlockUtil {
   public static BlockUtil.FoundRectangle getLargestRectangleAround(
      BlockPos $$0, Direction.Axis $$1, int $$2, Direction.Axis $$3, int $$4, Predicate<BlockPos> $$5
   ) {
      ...
      $$14[$$11] = new BlockUtil.IntBounds(getLimit($$5, $$6.set($$0), $$9, $$4), getLimit($$5, $$6.set($$0), $$10, $$4));
      int $$15 = $$14[$$11].min;

      for(int $$16 = 1; $$16 <= $$11; ++$$16) {
         BlockUtil.IntBounds $$17 = $$14[$$13 - ($$16 - 1)];
         $$14[$$13 - $$16] = new BlockUtil.IntBounds(
      ...
      for(int $$18 = 1; $$18 <= $$12; ++$$18) {
         ...
         $$14[$$13 + $$18] = new BlockUtil.IntBounds(
      ...
      for(int $$25 = $$15; $$25 >= 0; --$$25) {
         ...
         BlockUtil.IntBounds $$31 = $$30.getFirst();
      ...
      return new BlockUtil.FoundRectangle($$0.relative($$1, $$20 - $$13).relative($$3, $$21 - $$15), $$22, $$23);
   }
   ...
   @VisibleForTesting
   static Pair<BlockUtil.IntBounds, Integer> getMaxRectangleLocation(int[] $$0) {
      int $$1 = 0;
      int $$2 = 0;
      int $$3 = 0;
