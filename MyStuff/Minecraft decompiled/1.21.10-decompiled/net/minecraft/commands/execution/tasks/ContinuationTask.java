...
public class ContinuationTask<T, P> implements EntryAction<T> {
   ...
   private ContinuationTask(ContinuationTask.TaskProvider<T, P> $$0, List<P> $$1, Frame $$2) {
      this.taskFactory = $$0;
      this.arguments = $$1;
   ...
   public void execute(ExecutionContext<T> $$0, Frame $$1) {
      P $$2 = (P)this.arguments.get(this.index);
   ...
   public static <T, P> void schedule(ExecutionContext<T> $$0, Frame $$1, List<P> $$2, ContinuationTask.TaskProvider<T, P> $$3) {
      int $$4 = $$2.size();
      switch($$4) {
         case 0:
            break;
         case 1:
            $$0.queueNext($$3.create($$1, (P)$$2.get(0)));
            break;
         case 2:
            $$0.queueNext($$3.create($$1, (P)$$2.get(0)));
            $$0.queueNext($$3.create($$1, (P)$$2.get(1)));
            break;
         default:
            $$0.queueNext((new ContinuationTask<>($$3, $$2, $$1)).selfEntry);
      }
   }
