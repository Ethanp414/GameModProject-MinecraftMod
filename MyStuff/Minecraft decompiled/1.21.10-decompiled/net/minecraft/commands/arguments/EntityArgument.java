...
public class EntityArgument implements ArgumentType<EntitySelector> {
   ...
   public static Entity getEntity(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return $$0.<EntitySelector>getArgument($$1, EntitySelector.class).findSingleEntity($$0.getSource());
   }
   ...
   public static Collection<? extends Entity> getEntities(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      Collection<? extends Entity> $$2 = getOptionalEntities($$0, $$1);
      if ($$2.isEmpty()) {
   ...
   public static Collection<? extends Entity> getOptionalEntities(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return $$0.<EntitySelector>getArgument($$1, EntitySelector.class).findEntities($$0.getSource());
   }
   ...
   public static Collection<ServerPlayer> getOptionalPlayers(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return $$0.<EntitySelector>getArgument($$1, EntitySelector.class).findPlayers($$0.getSource());
   }
   ...
   public static ServerPlayer getPlayer(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return $$0.<EntitySelector>getArgument($$1, EntitySelector.class).findSinglePlayer($$0.getSource());
   }
   ...
   public static Collection<ServerPlayer> getPlayers(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      List<ServerPlayer> $$2 = $$0.<EntitySelector>getArgument($$1, EntitySelector.class).findPlayers($$0.getSource());
      if ($$2.isEmpty()) {
   ...
   private EntitySelector parse(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$4.getMaxResults() > 1 && this.single) {
         if (this.playersOnly) {
            $$0.setCursor(0);
            throw ERROR_NOT_SINGLE_PLAYER.createWithContext($$0);
         } else {
            $$0.setCursor(0);
            throw ERROR_NOT_SINGLE_ENTITY.createWithContext($$0);
         }
      } else if ($$4.includesEntities() && this.playersOnly && !$$4.isSelfSelector()) {
         $$0.setCursor(0);
         throw ERROR_ONLY_PLAYERS_ALLOWED.createWithContext($$0);
      } else {
         return $$4;
      }
   }
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      ...
      if ($$3 instanceof SharedSuggestionProvider $$2) {
         ...
         return $$4.fillSuggestions($$1, $$1x -> {
            Collection<String> $$2xx = $$2.getOnlinePlayerNames();
            Iterable<String> $$3xx = (Iterable<String>)(this.playersOnly ? $$2xx : Iterables.concat($$2xx, $$2.getSelectedEntities()));
            SharedSuggestionProvider.suggest($$3xx, $$1x);
         });
      } else {
   ...
   public static class Info implements ArgumentTypeInfo<EntityArgument, EntityArgument.Info.Template> {
      ...
      public void serializeToNetwork(EntityArgument.Info.Template $$0, FriendlyByteBuf $$1) {
         int $$2 = 0;
         if ($$0.single) {
            $$2 |= 1;
         }
      ...
      public EntityArgument.Info.Template deserializeFromNetwork(FriendlyByteBuf $$0) {
         byte $$1 = $$0.readByte();
         return new EntityArgument.Info.Template(($$1 & 1) != 0, ($$1 & 2) != 0);
      }

      public void serializeToJson(EntityArgument.Info.Template $$0, JsonObject $$1) {
         $$1.addProperty("amount", $$0.single ? "single" : "multiple");
         $$1.addProperty("type", $$0.playersOnly ? "players" : "entities");
      }

      public EntityArgument.Info.Template unpack(EntityArgument $$0) {
         return new EntityArgument.Info.Template($$0.single, $$0.playersOnly);
      }
