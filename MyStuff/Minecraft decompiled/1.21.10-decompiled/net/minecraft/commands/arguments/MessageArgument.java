...
public class MessageArgument implements SignedArgument<MessageArgument.Message> {
   ...
   static final Dynamic2CommandExceptionType TOO_LONG = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("argument.message.too_long", $$0, $$1)
   );
   ...
   public static Component getMessage(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      MessageArgument.Message $$2 = $$0.getArgument($$1, MessageArgument.Message.class);
      return $$2.resolveComponent($$0.getSource());
   }
   ...
   public static void resolveChatMessage(CommandContext<CommandSourceStack> $$0, String $$1, Consumer<PlayerChatMessage> $$2) throws CommandSyntaxException {
      MessageArgument.Message $$3 = $$0.getArgument($$1, MessageArgument.Message.class);
   ...
   private static void resolveSignedMessage(Consumer<PlayerChatMessage> $$0, CommandSourceStack $$1, PlayerChatMessage $$2) {
      ...
      $$1.getChatMessageChainer().append($$4, $$3x -> {
         PlayerChatMessage $$4xx = $$2.withUnsignedContent($$5).filter($$3x.mask());
         $$0.accept($$4xx);
      });
   }
