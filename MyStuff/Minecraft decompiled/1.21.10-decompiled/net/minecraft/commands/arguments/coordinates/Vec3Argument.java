...
public class Vec3Argument implements ArgumentType<Coordinates> {
   ...
   public static Vec3 getVec3(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.<Coordinates>getArgument($$1, Coordinates.class).getPosition($$0.getSource());
   }

   public static Coordinates getCoordinates(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.getArgument($$1, Coordinates.class);
   }
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      if (!($$0.getSource() instanceof SharedSuggestionProvider)) {
         ...
         if (!$$2.isEmpty() && $$2.charAt(0) == '^') {
            ...
            $$3 = ((SharedSuggestionProvider)$$0.getSource()).getAbsoluteCoordinates();
         }
