...
public class GameModeArgument implements ArgumentType<GameType> {
   ...
   private static final DynamicCommandExceptionType ERROR_INVALID = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.gamemode.invalid", $$0)
   );
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return $$0.getSource() instanceof SharedSuggestionProvider
         ? SharedSuggestionProvider.suggest(Arrays.stream(VALUES).map(GameType::getName), $$1)
         : Suggestions.empty();
   }
   ...
   public static GameType getGameMode(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return $$0.getArgument($$1, GameType.class);
   }
}
