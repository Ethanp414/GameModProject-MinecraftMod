...
public class ComponentArgument extends ParserBasedArgument<Component> {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_COMPONENT = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.component.invalid", $$0)
   );
   ...
   public static Component getRawComponent(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.getArgument($$1, Component.class);
   }
   ...
   public static Component getResolvedComponent(CommandContext<CommandSourceStack> $$0, String $$1, @Nullable Entity $$2) throws CommandSyntaxException {
      return ComponentUtils.updateForEntity($$0.getSource(), getRawComponent($$0, $$1), $$2, 0);
   }

   public static Component getResolvedComponent(CommandContext<CommandSourceStack> $$0, String $$1) throws CommandSyntaxException {
      return getResolvedComponent($$0, $$1, $$0.getSource().getEntity());
   }
