...
public class AngleArgument implements ArgumentType<AngleArgument.SingleAngle> {
   ...
   public static float getAngle(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.<AngleArgument.SingleAngle>getArgument($$1, AngleArgument.SingleAngle.class).getAngle($$0.getSource());
   }

   public AngleArgument.SingleAngle parse(StringReader $$0) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         ...
         if (!Float.isNaN($$2) && !Float.isInfinite($$2)) {
            ...
            throw ERROR_INVALID_ANGLE.createWithContext($$0);
         }
      }
   }
