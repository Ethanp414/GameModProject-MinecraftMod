...
public class ResourceOrIdArgument<T> implements ArgumentType<Holder<T>> {
   ...
   public static final DynamicCommandExceptionType ERROR_FAILED_TO_PARSE = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.resource_or_id.failed_to_parse", $$0)
   );
   public static final Dynamic2CommandExceptionType ERROR_NO_SUCH_ELEMENT = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("argument.resource_or_id.no_such_element", $$0, $$1)
   );
   ...
   public static <T, O> Grammar<ResourceOrIdArgument.Result<T, O>> createGrammar(ResourceKey<? extends Registry<T>> $$0, DynamicOps<O> $$1) {
      ...
      Atom<ResourceLocation> $$5 = Atom.of("id");
      Atom<O> $$6 = Atom.of("value");
      $$3.put($$5, ResourceLocationParseRule.INSTANCE);
      $$3.put($$6, $$2.top().value());
      NamedRule<StringReader, ResourceOrIdArgument.Result<T, O>> $$7 = $$3.put($$4, Term.alternative($$3.named($$5), $$3.named($$6)), $$3x -> {
         ResourceLocation $$4xx = $$3x.get($$5);
         if ($$4xx != null) {
            return new ResourceOrIdArgument.ReferenceResult<>(ResourceKey.create($$0, $$4xx));
         } else {
            O $$5xx = $$3x.getOrThrow($$6);
            return new ResourceOrIdArgument.InlineResult<T, O>($$5xx);
         }
      });
      return new Grammar<>($$3, $$7);
   }

   public static ResourceOrIdArgument.LootTableArgument lootTable(CommandBuildContext $$0) {
   ...
   public static ResourceOrIdArgument.LootModifierArgument lootModifier(CommandBuildContext $$0) {
   ...
   public static ResourceOrIdArgument.LootPredicateArgument lootPredicate(CommandBuildContext $$0) {
   ...
   public static ResourceOrIdArgument.DialogArgument dialog(CommandBuildContext $$0) {
   ...
   private static <T> Holder<T> getResource(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.getArgument($$1, Holder.class);
   }
   ...
   private <O> Holder<T> parse(StringReader $$0, Grammar<ResourceOrIdArgument.Result<T, O>> $$1, DynamicOps<O> $$2) throws CommandSyntaxException {
      ResourceOrIdArgument.Result<T, O> $$3 = $$1.parseForCommands($$0);
      return this.elementLookup.isEmpty()
         ? null
         : $$3.parse($$0, this.registryLookup, $$2, this.codec, (HolderLookup.RegistryLookup<T>)this.elementLookup.get());
   }
   ...
   public static record InlineResult<T, O>(O value) implements ResourceOrIdArgument.Result<T, O> {
      ...
      public Holder<T> parse(ImmutableStringReader $$0, HolderLookup.Provider $$1, DynamicOps<O> $$2, Codec<T> $$3, HolderLookup.RegistryLookup<T> $$4) throws CommandSyntaxException {
         return Holder.direct(
            $$3.parse($$1.createSerializationContext($$2), (T)this.value)
   ...
   public static record ReferenceResult<T, O>(ResourceKey<T> key) implements ResourceOrIdArgument.Result<T, O> {
      ...
      public Holder<T> parse(ImmutableStringReader $$0, HolderLookup.Provider $$1, DynamicOps<O> $$2, Codec<T> $$3, HolderLookup.RegistryLookup<T> $$4) throws CommandSyntaxException {
         return (Holder<T>)$$4.get(this.key)
            .orElseThrow(() -> ResourceOrIdArgument.ERROR_NO_SUCH_ELEMENT.createWithContext($$0, this.key.location(), this.key.registry()));
      }
   }
