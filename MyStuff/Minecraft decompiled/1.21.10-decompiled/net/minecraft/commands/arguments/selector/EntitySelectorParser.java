...
public class EntitySelectorParser {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_SELECTOR_TYPE = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.entity.selector.unknown", $$0)
   );
   ...
   public static final DynamicCommandExceptionType ERROR_EXPECTED_OPTION_VALUE = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("argument.entity.options.valueless", $$0)
   );
   ...
   public static <S> boolean allowSelectors(S $$0) {
      if ($$0 instanceof PermissionSource $$1 && $$1.allowsSelectors()) {
         return true;
      }
   ...
   private void finalizePredicates() {
      ...
      if (this.level != null) {
         this.predicates.add((Predicate)$$0 -> {
            if ($$0 instanceof ServerPlayer $$1 && this.level.matches($$1.experienceLevel)) {
               return true;
            }
   ...
   public CompletableFuture<Suggestions> fillSuggestions(SuggestionsBuilder $$0, Consumer<SuggestionsBuilder> $$1) {
      return (CompletableFuture<Suggestions>)this.suggestions.apply($$0.createOffset(this.reader.getCursor()), $$1);
   }
