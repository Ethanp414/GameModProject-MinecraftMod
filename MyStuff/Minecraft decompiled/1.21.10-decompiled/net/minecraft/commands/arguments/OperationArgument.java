...
public class OperationArgument implements ArgumentType<OperationArgument.Operation> {
   ...
   public static OperationArgument.Operation getOperation(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.getArgument($$1, OperationArgument.Operation.class);
   }
