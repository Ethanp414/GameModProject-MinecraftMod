...
public class NbtPathArgument implements ArgumentType<NbtPathArgument.NbtPath> {
   ...
   public static final DynamicCommandExceptionType ERROR_NOTHING_FOUND = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("arguments.nbtpath.nothing_found", $$0)
   );
   static final DynamicCommandExceptionType ERROR_EXPECTED_LIST = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.data.modify.expected_list", $$0)
   );
   static final DynamicCommandExceptionType ERROR_INVALID_INDEX = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.data.modify.invalid_index", $$0)
   );
   ...
   public static NbtPathArgument.NbtPath getPath(CommandContext<CommandSourceStack> $$0, String $$1) {
      return $$0.getArgument($$1, NbtPathArgument.NbtPath.class);
   }

   public NbtPathArgument.NbtPath parse(StringReader $$0) throws CommandSyntaxException {
      List<NbtPathArgument.Node> $$1 = Lists.<NbtPathArgument.Node>newArrayList();
      int $$2 = $$0.getCursor();
      ...
      return new NbtPathArgument.NbtPath(
         $$0.getString().substring($$2, $$0.getCursor()), (NbtPathArgument.Node[])$$1.toArray(new NbtPathArgument.Node[0]), $$3
      );
   }
   ...
   private static NbtPathArgument.Node parseNode(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      ...
      switch($$0.peek()) {
         case '"':
         case '\'':
            var10000 = readObjectNode($$0, $$0.readString());
            break;
         case '[':
            $$0.skip();
            int $$3 = $$0.peek();
            if ($$3 == 123) {
               ...
               $$0.expect(']');
               var10000 = new NbtPathArgument.MatchElementNode($$4);
            } else if ($$3 == 93) {
               $$0.skip();
               ...
               int $$5 = $$0.readInt();
               $$0.expect(']');
               var10000 = new NbtPathArgument.IndexedElementNode($$5);
            }
            break;
         case '{':
            if (!$$1) {
            ...
            var10000 = new NbtPathArgument.MatchRootObjectNode($$2);
            break;
         default:
            var10000 = readObjectNode($$0, readUnquotedName($$0));
      }
   ...
   interface Node {
      ...
      default List<Tag> collect(List<Tag> $$0, BiConsumer<Tag, List<Tag>> $$1) {
         List<Tag> $$2 = Lists.<Tag>newArrayList();
