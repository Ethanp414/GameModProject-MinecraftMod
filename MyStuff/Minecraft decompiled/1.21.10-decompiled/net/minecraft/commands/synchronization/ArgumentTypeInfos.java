...
public class ArgumentTypeInfos {
   ...
   public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> $$0) {
      ...
      register($$0, "resource_location", ResourceLocationArgument.class, SingletonArgumentInfo.contextFree(ResourceLocationArgument::id));
      ...
      register(
         $$0, "loot_predicate", ResourceOrIdArgument.LootPredicateArgument.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::lootPredicate)
      );
   ...
   public static <A extends ArgumentType<?>> ArgumentTypeInfo<A, ?> byClass(A $$0) {
      ArgumentTypeInfo<?, ?> $$1 = (ArgumentTypeInfo)BY_CLASS.get($$0.getClass());
      if ($$1 == null) {
