...
class FunctionBuilder<T extends ExecutionCommandSource<T>> {
   ...
   public void addMacro(String $$0, int $$1, T $$2) {
      StringTemplate $$3;
      try {
         $$3 = StringTemplate.fromString($$0);
      } catch (Exception var7) {
         throw new IllegalArgumentException("Can't parse function line " + $$1 + ": '" + $$0 + "'", var7);
      }
      ...
      this.macroEntries.add(new MacroFunction.MacroEntry($$3, this.convertToIndices($$3.variables()), $$2));
   }

   public CommandFunction<T> build(ResourceLocation $$0) {
      return (CommandFunction<T>)(this.macroEntries != null
         ? new MacroFunction<>($$0, this.macroEntries, this.macroArguments)
         : new PlainTextFunction<>($$0, this.plainEntries));
   }
}
