...
public interface CommandFunction<T> {
   ...
   static <T extends ExecutionCommandSource<T>> CommandFunction<T> fromLines(ResourceLocation $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
   ...
   static <T extends ExecutionCommandSource<T>> UnboundEntryAction<T> parseCommand(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new BuildContexts.Unbound<>($$2.getString(), (ContextChain<T>)$$4.get());
      }
   }
}
