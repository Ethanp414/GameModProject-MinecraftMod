...
public record ChatTypeDecoration(String translationKey, List<ChatTypeDecoration.Parameter> parameters, Style style) {
   ...
   private Component[] resolveParameters(Component $$0, ChatType.Bound $$1) {
      ...
      for(int $$3 = 0; $$3 < $$2.length; ++$$3) {
         ChatTypeDecoration.Parameter $$4 = (ChatTypeDecoration.Parameter)this.parameters.get($$3);
         $$2[$$3] = $$4.select($$0, $$1);
      }
   ...
   public static enum Parameter implements StringRepresentable {
      ...
      TARGET(1, "target", ($$0, $$1) -> (Component)$$1.targetName().orElse(CommonComponents.EMPTY)),
      CONTENT(2, "content", ($$0, $$1) -> $$0);

      private static final IntFunction<ChatTypeDecoration.Parameter> BY_ID = ByIdMap.continuous($$0 -> $$0.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      ...
      private Parameter(final int param3, final String param4, final ChatTypeDecoration.Parameter.Selector param5) {
         this.id = $$0;
         this.name = $$1;
         this.selector = $$2;
      }
