...
public record SignableCommand<S>(List<SignableCommand.Argument<S>> arguments) {
   ...
   public static <S> SignableCommand<S> of(ParseResults<S> $$0) {
      ...
      List<SignableCommand.Argument<S>> $$4;
      CommandContextBuilder<S> $$5;
      for($$4 = collectArguments($$1, $$2); ($$5 = $$3.getChild()) != null && $$5.getRootNode() != $$2.getRootNode(); $$3 = $$5) {
   ...
   private static <S> List<SignableCommand.Argument<S>> collectArguments(String $$0, CommandContextBuilder<S> $$1) {
      ...
      for(ParsedCommandNode<S> $$3 : $$1.getNodes()) {
         ...
         if ($$5 instanceof ArgumentCommandNode $$4 && $$4.getType() instanceof SignedArgument) {
            ParsedArgument<S, ?> $$5x = (ParsedArgument)$$1.getArguments().get($$4.getName());
            if ($$5x != null) {
               String $$6 = $$5x.getRange().get($$0);
               $$2.add(new SignableCommand.Argument<S>($$4, $$6));
            }
         }
      }
