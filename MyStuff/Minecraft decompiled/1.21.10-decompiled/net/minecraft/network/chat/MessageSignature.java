...
public record MessageSignature(byte[] bytes) {
   ...
   public MessageSignature(byte[] param1) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof MessageSignature $$1 && Arrays.equals(this.bytes, $$1.bytes)) {
            return true;
         }
   ...
   public static record Packed(int id, @Nullable MessageSignature fullSignature) {
      ...
      public static MessageSignature.Packed read(FriendlyByteBuf $$0) {
         int $$1 = $$0.readVarInt() - 1;
         return $$1 == -1 ? new MessageSignature.Packed(MessageSignature.read($$0)) : new MessageSignature.Packed($$1);
      }

      public static void write(FriendlyByteBuf $$0, MessageSignature.Packed $$1) {
