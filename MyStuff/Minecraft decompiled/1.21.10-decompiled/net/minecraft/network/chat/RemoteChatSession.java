...
public record RemoteChatSession(UUID sessionId, ProfilePublicKey profilePublicKey) {
   ...
   public static record Data(UUID sessionId, ProfilePublicKey.Data profilePublicKey) {
      public static RemoteChatSession.Data read(FriendlyByteBuf $$0) {
         return new RemoteChatSession.Data($$0.readUUID(), new ProfilePublicKey.Data($$0));
      }

      public static void write(FriendlyByteBuf $$0, RemoteChatSession.Data $$1) {
