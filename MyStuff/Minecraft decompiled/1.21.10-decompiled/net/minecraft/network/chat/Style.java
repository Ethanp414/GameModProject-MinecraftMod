...
public final class Style {
   ...
   private static Style create(
      ...
      Style $$11 = new Style(
         (TextColor)$$0.orElse(null),
         (Integer)$$1.orElse(null),
         (Boolean)$$2.orElse(null),
         (Boolean)$$3.orElse(null),
         (Boolean)$$4.orElse(null),
         (Boolean)$$5.orElse(null),
         (Boolean)$$6.orElse(null),
         (ClickEvent)$$7.orElse(null),
         (HoverEvent)$$8.orElse(null),
         (String)$$9.orElse(null),
         (FontDescription)$$10.orElse(null)
      );
   ...
   public String toString() {
      ...
      Collector $$1 = new Collector(this);
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         return true;
      } else if (!($$0 instanceof Style)) {
         return false;
      } else {
         Style $$1 = (Style)$$0;
         return this.bold == $$1.bold
