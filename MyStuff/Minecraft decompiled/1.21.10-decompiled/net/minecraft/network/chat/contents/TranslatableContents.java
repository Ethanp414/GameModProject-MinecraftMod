...
public class TranslatableContents implements ComponentContents {
   ...
   private static Object[] adjustArgs(Optional<List<Object>> $$0) {
      return $$0.map($$0x -> $$0x.isEmpty() ? NO_ARGS : $$0x.toArray()).orElse(NO_ARGS);
   }

   private static TranslatableContents create(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new TranslatableContents($$0, (String)$$1.orElse(null), adjustArgs($$2));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof TranslatableContents $$1
