...
public class SynchedEntityData {
   ...
   public static record DataValue<T>(int id, EntityDataSerializer<T> serializer, T value) {
      ...
      public static SynchedEntityData.DataValue<?> read(RegistryFriendlyByteBuf $$0, int $$1) {
         int $$2 = $$0.readVarInt();
      ...
      private static <T> SynchedEntityData.DataValue<T> read(RegistryFriendlyByteBuf $$0, int $$1, EntityDataSerializer<T> $$2) {
