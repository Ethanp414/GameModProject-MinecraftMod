...
public class ClientboundSetPlayerTeamPacket implements Packet<ClientGamePacketListener> {
   ...
   private ClientboundSetPlayerTeamPacket(RegistryFriendlyByteBuf $$0) {
      ...
      if (shouldHavePlayerList(this.method)) {
         this.players = $$0.readList(FriendlyByteBuf::readUtf);
      } else {
   ...
   public static class Parameters {
      ...
      public Parameters(RegistryFriendlyByteBuf $$0) {
         ...
         this.nametagVisibility = Team.Visibility.STREAM_CODEC.decode($$0);
         this.collisionRule = Team.CollisionRule.STREAM_CODEC.decode($$0);
