...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
   ...
   private static void validateEntries(List<ClientboundCommandsPacket.Entry> $$0, BiPredicate<ClientboundCommandsPacket.Entry, IntSet> $$1) {
      ...
      while(!$$2.isEmpty()) {
         boolean $$3 = $$2.removeIf($$3x -> $$1.test((ClientboundCommandsPacket.Entry)$$0.get($$3x), $$2));
         if (!$$3) {
   ...
   private static <S> List<ClientboundCommandsPacket.Entry> createEntries(Object2IntMap<CommandNode<S>> $$0, ClientboundCommandsPacket.NodeInspector<S> $$1) {
      ...
      for(Object2IntMap.Entry<CommandNode<S>> $$3 : Object2IntMaps.fastIterable($$0)) {
   ...
   private static ClientboundCommandsPacket.Entry readNode(FriendlyByteBuf $$0) {
      byte $$1 = $$0.readByte();
   ...
   @Nullable
   private static ClientboundCommandsPacket.NodeStub read(FriendlyByteBuf $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.readUtf();
         int $$4 = $$0.readVarInt();
         ArgumentTypeInfo<?, ?> $$5 = BuiltInRegistries.COMMAND_ARGUMENT_TYPE.byId($$4);
         if ($$5 == null) {
            return null;
         } else {
            ArgumentTypeInfo.Template<?> $$6 = $$5.deserializeFromNetwork($$0);
            ResourceLocation $$7 = ($$1 & 16) != 0 ? $$0.readResourceLocation() : null;
   ...
   private static <S> ClientboundCommandsPacket.Entry createEntry(
      ...
      switch(SwitchBootstraps.typeSwitch<"typeSwitch",RootCommandNode,ArgumentCommandNode,LiteralCommandNode>($$0, var7)) {
         case 0:
   ...
   static record ArgumentNodeStub(String id, ArgumentTypeInfo.Template<?> argumentType, @Nullable ResourceLocation suggestionId)
      ...
      private static <A extends ArgumentType<?>, T extends ArgumentTypeInfo.Template<A>> void serializeCap(
         FriendlyByteBuf $$0, ArgumentTypeInfo<A, T> $$1, ArgumentTypeInfo.Template<A> $$2
      ) {
         $$0.writeVarInt(BuiltInRegistries.COMMAND_ARGUMENT_TYPE.getId($$1));
         $$1.serializeToNetwork((T)$$2, $$0);
      }
   }
   ...
   static class NodeResolver<S> {
      ...
      public CommandNode<S> resolve(int $$0) {
         CommandNode<S> $$1 = (CommandNode)this.nodes.get($$0);
         if ($$1 != null) {
            return $$1;
         } else {
            ClientboundCommandsPacket.Entry $$2 = (ClientboundCommandsPacket.Entry)this.entries.get($$0);
            CommandNode<S> $$3;
            if ($$2.stub == null) {
