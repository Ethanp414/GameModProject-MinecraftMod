...
public class ClientboundPlayerInfoUpdatePacket implements Packet<ClientGamePacketListener> {
   ...
   private ClientboundPlayerInfoUpdatePacket(RegistryFriendlyByteBuf $$0) {
      ...
      this.entries = $$0.readList($$0x -> {
         ...
         for(ClientboundPlayerInfoUpdatePacket.Action $$2 : this.actions) {
            $$2.reader.read($$1, (RegistryFriendlyByteBuf)$$0x);
         }
   ...
   private void write(RegistryFriendlyByteBuf $$0) {
      ...
      $$0.writeCollection(this.entries, ($$0x, $$1) -> {
         ...
         for(ClientboundPlayerInfoUpdatePacket.Action $$2 : this.actions) {
            $$2.writer.write((RegistryFriendlyByteBuf)$$0x, $$1);
         }
      });
   }
   ...
   public static enum Action {
      ADD_PLAYER(($$0, $$1) -> {
         ...
         GameProfile $$2 = (GameProfile)Objects.requireNonNull($$1.profile());
      ...
      UPDATE_DISPLAY_NAME(
         ($$0, $$1) -> $$0.displayName = FriendlyByteBuf.readNullable($$1, ComponentSerialization.TRUSTED_STREAM_CODEC),
   ...
   public static record Entry(
      ...
      Entry(ServerPlayer $$0) {
         this(
            ...
            $$0.getTabListOrder(),
            Optionull.map($$0.getChatSession(), RemoteChatSession::asData)
         );
      }
   }
