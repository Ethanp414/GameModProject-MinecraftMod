...
public class GameProtocols {
   public static final CodecModifier<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket, GameProtocols.Context> HAS_INFINITE_MATERIALS = ($$0, $$1) -> new StreamCodec<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket>(
         
      ) {
         public ServerboundSetCreativeModeSlotPacket decode(RegistryFriendlyByteBuf $$0x) {
            if (!$$1.hasInfiniteMaterials()) {
               throw new SkipPacketDecoderException("Not in creative mode");
            } else {
               return (ServerboundSetCreativeModeSlotPacket)$$0.decode($$0);
            }
         }

         public void encode(RegistryFriendlyByteBuf $$0x, ServerboundSetCreativeModeSlotPacket $$1x) {
            if (!$$1.hasInfiniteMaterials()) {
   ...
   public static final UnboundProtocol<ServerGamePacketListener, RegistryFriendlyByteBuf, GameProtocols.Context> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.contextServerboundProtocol(
      ...
      $$0 -> $$0.addPacket(GamePacketTypes.SERVERBOUND_ACCEPT_TELEPORTATION, ServerboundAcceptTeleportationPacket.STREAM_CODEC)
   ...
   public static final SimpleUnboundProtocol<ClientGamePacketListener, RegistryFriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
      ConnectionProtocol.PLAY,
      $$0 -> $$0.withBundlePacket(GamePacketTypes.CLIENTBOUND_BUNDLE, ClientboundBundlePacket::new, new ClientboundBundleDelimiterPacket())
