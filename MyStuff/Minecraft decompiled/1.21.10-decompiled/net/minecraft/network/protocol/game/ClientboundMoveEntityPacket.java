...
public abstract class ClientboundMoveEntityPacket implements Packet<ClientGamePacketListener> {
   ...
   public static class Pos extends ClientboundMoveEntityPacket {
      ...
      private static ClientboundMoveEntityPacket.Pos read(FriendlyByteBuf $$0) {
         int $$1 = $$0.readVarInt();
         short $$2 = $$0.readShort();
         short $$3 = $$0.readShort();
         short $$4 = $$0.readShort();
   ...
   public static class PosRot extends ClientboundMoveEntityPacket {
      ...
      private static ClientboundMoveEntityPacket.PosRot read(FriendlyByteBuf $$0) {
         int $$1 = $$0.readVarInt();
         short $$2 = $$0.readShort();
         short $$3 = $$0.readShort();
         short $$4 = $$0.readShort();
   ...
   public static class Rot extends ClientboundMoveEntityPacket {
      ...
      private static ClientboundMoveEntityPacket.Rot read(FriendlyByteBuf $$0) {
         int $$1 = $$0.readVarInt();
         byte $$2 = $$0.readByte();
         byte $$3 = $$0.readByte();
