...
public record CommonPlayerSpawnInfo(
   ...
   public CommonPlayerSpawnInfo(RegistryFriendlyByteBuf $$0) {
      this(
         DimensionType.STREAM_CODEC.decode($$0),
         $$0.readResourceKey(Registries.DIMENSION),
         $$0.readLong(),
         GameType.byId($$0.readByte()),
         GameType.byNullableId($$0.readByte()),
         $$0.readBoolean(),
         $$0.readBoolean(),
         $$0.readOptional(FriendlyByteBuf::readGlobalPos),
         $$0.readVarInt(),
         $$0.readVarInt()
      );
   }
