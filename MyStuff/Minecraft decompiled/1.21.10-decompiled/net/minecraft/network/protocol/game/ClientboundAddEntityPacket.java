...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundAddEntityPacket(Entity $$0, ServerEntity $$1, int $$2) {
      this(
         ...
         $$0.getType(),
         $$2,
         $$1.getLastSentMovement(),
         (double)$$1.getLastSentYHeadRot()
      );
   }
   ...
   public ClientboundAddEntityPacket(Entity $$0, int $$1, BlockPos $$2) {
      this(
         ...
         $$1,
         $$0.getDeltaMovement(),
         (double)$$0.getYHeadRot()
      );
   }

   public ClientboundAddEntityPacket(
      int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, EntityType<?> $$7, int $$8, Vec3 $$9, double $$10
   ) {
      this.id = $$0;
      this.uuid = $$1;
      this.x = $$2;
   ...
   private ClientboundAddEntityPacket(RegistryFriendlyByteBuf $$0) {
      ...
      this.type = ByteBufCodecs.registry(Registries.ENTITY_TYPE).decode($$0);
      this.x = $$0.readDouble();
      this.y = $$0.readDouble();
      this.z = $$0.readDouble();
