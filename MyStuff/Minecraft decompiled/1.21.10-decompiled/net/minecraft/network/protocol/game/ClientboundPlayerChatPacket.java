...
public record ClientboundPlayerChatPacket(
   ...
   private ClientboundPlayerChatPacket(RegistryFriendlyByteBuf $$0) {
      this(
         ...
         $$0.readUUID(),
         $$0.readVarInt(),
         $$0.readNullable(MessageSignature::read),
         new SignedMessageBody.Packed($$0),
         FriendlyByteBuf.readNullable($$0, ComponentSerialization.TRUSTED_STREAM_CODEC),
         FilterMask.read($$0),
         (ChatType.Bound)ChatType.Bound.STREAM_CODEC.decode($$0)
      );
   }
