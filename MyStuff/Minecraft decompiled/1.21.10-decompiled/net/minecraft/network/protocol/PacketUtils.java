...
public class PacketUtils {
   ...
   public static <T extends PacketListener> ReportedException makeReportedException(Exception $$0, Packet<T> $$1, T $$2) {
      if ($$0 instanceof ReportedException $$3) {
   ...
   public static <T extends PacketListener> void fillCrashReport(CrashReport $$0, T $$1, @Nullable Packet<T> $$2) {
      if ($$2 != null) {
         ...
         $$3.setDetail("Type", (CrashReportDetail<String>)(() -> $$2.type().toString()));
         $$3.setDetail("Is Terminal", (CrashReportDetail<String>)(() -> Boolean.toString($$2.isTerminal())));
         $$3.setDetail("Is Skippable", (CrashReportDetail<String>)(() -> Boolean.toString($$2.isSkippable())));
      }
