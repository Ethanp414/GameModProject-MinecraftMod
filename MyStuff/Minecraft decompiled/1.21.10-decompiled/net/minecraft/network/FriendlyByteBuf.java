...
public class FriendlyByteBuf extends ByteBuf {
   ...
   public <T> T readWithCodec(DynamicOps<Tag> $$0, Codec<T> $$1, NbtAccounter $$2) {
      ...
      return $$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> FriendlyByteBuf writeWithCodec(DynamicOps<Tag> $$0, Codec<T> $$1, T $$2) {
      Tag $$3 = $$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.writeNbt($$3);
      return this;
   }
   ...
   public <T> T readLenientJsonWithCodec(Codec<T> $$0) {
      ...
      return $$2.getOrThrow($$0x -> new DecoderException("Failed to decode JSON: " + $$0x));
   }

   public <T> void writeJsonWithCodec(Codec<T> $$0, T $$1) {
      DataResult<JsonElement> $$2 = $$0.encodeStart(JsonOps.INSTANCE, $$1);
      this.writeUtf(GSON.toJson($$2.getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$1))));
   }
   ...
   public <K, V, M extends Map<K, V>> M readMap(
      IntFunction<M> $$0, StreamDecoder<? super FriendlyByteBuf, K> $$1, StreamDecoder<? super FriendlyByteBuf, V> $$2
   ) {
   ...
   public <K, V> void writeMap(Map<K, V> $$0, StreamEncoder<? super FriendlyByteBuf, K> $$1, StreamEncoder<? super FriendlyByteBuf, V> $$2) {
      this.writeVarInt($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <L, R> void writeEither(Either<L, R> $$0, StreamEncoder<? super FriendlyByteBuf, L> $$1, StreamEncoder<? super FriendlyByteBuf, R> $$2) {
      $$0.ifLeft($$1x -> {
         this.writeBoolean(true);
         $$1.encode(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public FriendlyByteBuf writeFixedSizeLongArray(long[] $$0) {
   ...
   public <T extends Enum<T>> T readEnum(Class<T> $$0) {
      return (T)$$0.getEnumConstants()[this.readVarInt()];
   }
   ...
   public static CompoundTag readNbt(ByteBuf $$0) {
      Tag $$1 = readNbt($$0, NbtAccounter.create(2097152L));
   ...
   public BlockHitResult readBlockHitResult() {
      ...
      return new BlockHitResult(
         new Vec3((double)$$0.getX() + (double)$$2, (double)$$0.getY() + (double)$$3, (double)$$0.getZ() + (double)$$4), $$1, $$0, $$5, $$6
      );
   }
