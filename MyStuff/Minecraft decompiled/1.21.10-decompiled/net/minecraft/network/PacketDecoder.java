   ...
   protected void decode(ChannelHandlerContext $$0, ByteBuf $$1, List<Object> $$2) throws Exception {
      ...
      if ($$1.readableBytes() > 0) {
         ...
         if (LOGGER.isDebugEnabled()) {
            LOGGER.debug(Connection.PACKET_RECEIVED_MARKER, " IN: [{}:{}] {} -> {} bytes", this.protocolInfo.id().id(), $$7, $$4.getClass().getName(), $$3);
         }

         ProtocolSwapHandler.handleInboundTerminalPacket($$0, $$4);
      }
   }
}
