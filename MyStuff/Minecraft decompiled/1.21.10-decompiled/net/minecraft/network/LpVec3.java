...
public class LpVec3 {
   ...
   public static Vec3 read(ByteBuf $$0) {
      ...
      if ($$1 == 0) {
         ...
         return new Vec3(unpack($$4 >> 3) * (double)$$5, unpack($$4 >> 18) * (double)$$5, unpack($$4 >> 33) * (double)$$5);
      }
   }
   ...
   public static void write(ByteBuf $$0, Vec3 $$1) {
      ...
      if ($$5 < 3.051944088384301E-5) {
         ...
         boolean $$7 = ($$6 & 3L) != $$6;
         long $$8 = $$7 ? $$6 & 3L | 4L : $$6;
         long $$9 = pack($$2 / (double)$$6) << 3;
         long $$10 = pack($$3 / (double)$$6) << 18;
         long $$11 = pack($$4 / (double)$$6) << 33;
         long $$12 = $$8 | $$9 | $$10 | $$11;
         $$0.writeByte((byte)((int)$$12));
         $$0.writeByte((byte)((int)($$12 >> 8)));
