...
public class IdDispatchCodec<B extends ByteBuf, V, T> implements StreamCodec<B, V> {
   ...
   public V decode(B $$0) {
      ...
      if ($$1 >= 0 && $$1 < this.byId.size()) {
         IdDispatchCodec.Entry<B, V, T> $$2 = (IdDispatchCodec.Entry)this.byId.get($$1);

         try {
            return $$2.serializer.decode($$0);
   ...
   public void encode(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         VarInt.write($$0, $$3);
         IdDispatchCodec.Entry<B, V, T> $$4 = (IdDispatchCodec.Entry)this.byId.get($$3);

         try {
            StreamCodec<? super B, V> $$5 = $$4.serializer;
            $$5.encode($$0, $$1);
