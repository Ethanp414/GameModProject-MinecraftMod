...
public class SimpleReloadInstance<S> implements ReloadInstance {
   ...
   private PreparableReloadListener.PreparationBarrier createBarrierForListener(
      ...
      return new PreparableReloadListener.PreparationBarrier() {
         ...
         public <T> CompletableFuture<T> wait(T $$0x) {
            ...
            return SimpleReloadInstance.this.allPreparations.thenCombine($$1, ($$1xx, $$2xx) -> $$0);
         }
      };
   }
   ...
   public float getActualProgress() {
      ...
      float $$1 = (float)weightProgress(this.finishedTasks.get(), this.finishedReloads.get(), $$0);
      float $$2 = (float)weightProgress(this.startedTasks.get(), this.startedReloads.get(), this.listenerCount);
      return $$1 / $$2;
   }
