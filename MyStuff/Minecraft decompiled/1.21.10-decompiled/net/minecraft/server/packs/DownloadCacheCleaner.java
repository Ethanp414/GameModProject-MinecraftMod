...
public class DownloadCacheCleaner {
   ...
   public static void vacuumCacheDir(Path $$0, int $$1) {
      try {
         ...
         for(int $$6 = 0; $$6 < $$3; ++$$6) {
            DownloadCacheCleaner.PathAndPriority $$7 = (DownloadCacheCleaner.PathAndPriority)$$4.get($$6);
            Path $$8 = $$7.path;
   ...
   private static List<DownloadCacheCleaner.PathAndTime> listFilesWithModificationTimes(final Path $$0) throws IOException {
      try {
         ...
         Files.walkFileTree($$0, new SimpleFileVisitor<Path>() {
            public FileVisitResult visitFile(Path $$0x, BasicFileAttributes $$1) {
               if ($$1.isRegularFile() && !$$0.getParent().equals($$0)) {
                  FileTime $$2x = $$1.lastModifiedTime();
                  $$1.add(new DownloadCacheCleaner.PathAndTime($$0, $$2x));
               }
