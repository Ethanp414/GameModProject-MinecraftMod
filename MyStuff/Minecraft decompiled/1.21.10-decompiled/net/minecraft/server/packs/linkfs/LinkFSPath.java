...
class LinkFSPath implements Path {
   ...
   LinkFSPath resolveName(String $$0) {
      if (isRelativeOrMissing(this.pathContents)) {
         ...
         if ($$2 instanceof PathContents.DirectoryContents $$1) {
            LinkFSPath $$2x = (LinkFSPath)$$1.children().get($$0);
            return $$2x != null ? $$2x : new LinkFSPath(this.fileSystem, $$0, this, PathContents.MISSING);
   ...
   private LinkFSPath toLinkPath(@Nullable Path $$0) {
      if ($$0 == null) {
         ...
         if ($$0 instanceof LinkFSPath $$1 && $$1.fileSystem == this.fileSystem) {
            return $$1;
         }
   ...
   public Path getTargetPath() {
      PathContents var2 = this.pathContents;
      return var2 instanceof PathContents.FileContents $$0 ? $$0.contents() : null;
   }

   @Nullable
   public PathContents.DirectoryContents getDirectoryContents() {
      PathContents var2 = this.pathContents;
      return var2 instanceof PathContents.DirectoryContents $$0 ? $$0 : null;
   }
