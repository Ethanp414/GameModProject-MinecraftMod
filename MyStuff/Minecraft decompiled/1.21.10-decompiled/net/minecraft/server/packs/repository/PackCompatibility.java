...
public enum PackCompatibility {
   ...
   public static PackCompatibility forVersion(InclusiveRange<PackFormat> $$0, PackFormat $$1) {
      if (((PackFormat)$$0.minInclusive()).major() == Integer.MAX_VALUE) {
         return UNKNOWN;
      } else if (((PackFormat)$$0.maxInclusive()).compareTo($$1) < 0) {
         return TOO_OLD;
      } else {
         return $$1.compareTo((PackFormat)$$0.minInclusive()) < 0 ? TOO_NEW : COMPATIBLE;
      }
   }
