...
public class VanillaPackResources implements PackResources {
   ...
   public void listRawPaths(PackType $$0, ResourceLocation $$1, Consumer<Path> $$2) {
      FileUtil.decomposePath($$1.getPath()).ifSuccess($$3 -> {
         ...
         for(Path $$5 : (List)this.pathsForType.get($$0)) {
            Path $$6 = $$5.resolve($$4);
   ...
   public void listResources(PackType $$0, String $$1, String $$2, PackResources.ResourceOutput $$3) {
      FileUtil.decomposePath($$2).ifSuccess($$3x -> {
         List<Path> $$4 = (List)this.pathsForType.get($$0);
         int $$5 = $$4.size();
         if ($$5 == 1) {
            getResources($$3, $$1, (Path)$$4.get(0), $$3x);
         } else if ($$5 > 1) {
            Map<ResourceLocation, IoSupplier<InputStream>> $$6 = new HashMap();

            for(int $$7 = 0; $$7 < $$5 - 1; ++$$7) {
               getResources($$6::putIfAbsent, $$1, (Path)$$4.get($$7), $$3x);
            }
   ...
   public IoSupplier<InputStream> getResource(PackType $$0, ResourceLocation $$1) {
      return FileUtil.decomposePath($$1.getPath()).mapOrElse($$2 -> {
         String $$3 = $$1.getNamespace();

         for(Path $$4 : (List)this.pathsForType.get($$0)) {
