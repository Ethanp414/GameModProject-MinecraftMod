...
public class ServerSettingsService {
   ...
   public static int operatorUserPermissionLevel(MinecraftApi $$0) {
      return $$0.serverSettingsService().getOperatorUserPermissionLevel();
   }

   public static int setOperatorUserPermissionLevel(MinecraftApi $$0, int $$1, ClientInfo $$2) {
      return $$0.serverSettingsService().setOperatorUserPermissionLevel($$1, $$2);
   }
