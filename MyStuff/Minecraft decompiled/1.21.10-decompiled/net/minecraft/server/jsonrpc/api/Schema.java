...
public record Schema(
   ...
   public static final Codec<Schema> CODEC = Codec.recursive(
      ...
      $$0 -> RecordCodecBuilder.create(
            $$1 -> $$1.group(
                     ...
                     Codec.unboundedMap(Codec.STRING, $$0).optionalFieldOf("properties").forGetter(Schema::properties),
   ...
   public static final SchemaComponent MESSAGE_SCHEMA = registerSchema(
      "message",
      record().withField("literal", STRING_SCHEMA).withField("translatable", STRING_SCHEMA).withField("translatableParams", STRING_SCHEMA.asArray())
   );
   ...
   public static final SchemaComponent IP_BAN_SCHEMA = registerSchema(
      "ip_ban",
      record().withField("ip", STRING_SCHEMA).withField("reason", STRING_SCHEMA).withField("source", STRING_SCHEMA).withField("expires", STRING_SCHEMA)
   );
   ...
   private static SchemaComponent registerSchema(String $$0, Schema $$1) {
      SchemaComponent $$2 = new SchemaComponent($$0, ReferenceUtil.createLocalReference($$0), $$1);
   ...
   public static Schema ofRef(URI $$0) {
      return new Schema(Optional.of($$0), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
   }

   public static Schema ofType(String $$0) {
      return new Schema(Optional.empty(), Optional.of($$0), Optional.empty(), Optional.empty(), Optional.empty());
   }

   public static <E extends Enum<E> & StringRepresentable> Schema ofEnum(Supplier<E[]> $$0) {
      List<String> $$1 = Stream.of((Enum[])$$0.get()).map($$0x -> ((StringRepresentable)$$0x).getSerializedName()).toList();
      return ofEnum($$1);
   }

   public static Schema ofEnum(List<String> $$0) {
      return new Schema(Optional.empty(), Optional.of("string"), Optional.empty(), Optional.empty(), Optional.of($$0));
   }

   public static Schema arrayOf(Schema $$0) {
      return new Schema(Optional.empty(), Optional.of("array"), Optional.of($$0), Optional.empty(), Optional.empty());
   }
   ...
   public static Schema record(Map<String, Schema> $$0) {
      return new Schema(Optional.empty(), Optional.of("object"), Optional.empty(), Optional.of($$0), Optional.empty());
   }

   public Schema withField(String $$0, Schema $$1) {
      HashMap<String, Schema> $$2 = new HashMap();
      this.properties.ifPresent($$2::putAll);
      $$2.put($$0, $$1);
      return record($$2);
   }
