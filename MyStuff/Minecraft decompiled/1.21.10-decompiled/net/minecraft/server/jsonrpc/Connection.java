...
public class Connection extends SimpleChannelInboundHandler<JsonElement> {
                  ...
                  ((PendingRpcRequest)$$1.getValue())
                     ...
                     .completeExceptionally(
                        new ReadTimeoutException(
                           "RPC method " + ((PendingRpcRequest)$$1.getValue()).method().key().location() + " timed out waiting for response"
                        )
                     );
               }
   ...
   private <Params, Result> CompletableFuture<Result> sendRequest(
      Holder.Reference<? extends OutgoingRpcMethod<Params, ? extends Result>> $$0, @Nullable Params $$1, boolean $$2
   ) {
      List<JsonElement> $$3 = $$1 != null ? List.of((JsonElement)Objects.requireNonNull($$0.value().encodeParams($$1))) : List.of();
      if ($$2) {
         ...
         this.pendingRequests.put($$5, new PendingRpcRequest<Result>($$0, $$4, $$6 + 5000L));
         this.channel.writeAndFlush(JsonRPCUtils.createRequest($$5, $$0.key().location(), $$3));
         return $$4;
      } else {
         this.channel.writeAndFlush(JsonRPCUtils.createRequest(null, $$0.key().location(), $$3));
         return null;
      }
   }
      ...
      try {
         ...
         if ($$2 != null && $$3 == null && $$5 == null) {
            ...
            return $$2 == null && $$3 == null && $$5 != null
               ...
               : JsonRPCErrors.INVALID_REQUEST.createWithoutData((JsonElement)Objects.requireNonNullElse($$1, JsonNull.INSTANCE));
         }
   ...
   private JsonObject handleIncomingRequest(@Nullable JsonElement $$0, String $$1, @Nullable JsonElement $$2) {
      ...
      try {
         ...
         LOGGER.debug("Invalid parameter invocation {}: {}, {}", $$1, $$2, var6.getMessage());
   ...
   public JsonElement dispatchIncomingRequest(String $$0, @Nullable JsonElement $$1) {
      ...
      if ($$2 == null) {
         ...
         if ($$3.isEmpty()) {
         ...
         } else if (((IncomingRpcMethod)$$3.get()).attributes().runOnMainThread()) {
            try {
               return (JsonElement)this.minecraftApi
                  .submit((Supplier)(() -> ((IncomingRpcMethod)$$3.get()).apply(this.minecraftApi, $$1, this.clientInfo)))
                  .join();
            } catch (CompletionException var8) {
               Throwable var7 = var8.getCause();
               if (var7 instanceof RuntimeException $$5) {
                  throw $$5;
               } else {
                  throw var8;
               }
            ...
            return ((IncomingRpcMethod)$$3.get()).apply(this.minecraftApi, $$1, this.clientInfo);
         }
      }
   }
