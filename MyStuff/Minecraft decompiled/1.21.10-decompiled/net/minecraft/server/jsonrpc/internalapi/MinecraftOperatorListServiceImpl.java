...
public class MinecraftOperatorListServiceImpl implements MinecraftOperatorListService {
   ...
   public MinecraftOperatorListServiceImpl(MinecraftServer $$0, JsonRpcLogger $$1) {
   ...
   @Override
   public void op(NameAndId $$0, Optional<Integer> $$1, Optional<Boolean> $$2, ClientInfo $$3) {
      this.jsonrpcLogger.log($$3, "Op '{}'", $$0);
      this.minecraftServer.getPlayerList().op($$0, $$1, $$2);
   }
