...
public class ServerConfigurationPacketListenerImpl extends ServerCommonPacketListenerImpl implements ServerConfigurationPacketListener, TickablePacketListener {
   ...
   public void onDisconnect(DisconnectionDetails $$0) {
      LOGGER.info("{} ({}) lost connection: {}", this.gameProfile.name(), this.gameProfile.id(), $$0.reason().getString());
   ...
   public void startConfiguration() {
      ...
      ServerLinks $$0 = this.server.serverLinks();
      if (!$$0.isEmpty()) {
   ...
   private void addOptionalTasks() {
      ...
      if (!$$0.isEmpty()) {
         this.configurationTasks.add(new ServerCodeOfConductConfigurationTask(() -> {
            String $$1 = (String)$$0.get(this.clientInformation.language().toLowerCase(Locale.ROOT));
            if ($$1 == null) {
               $$1 = (String)$$0.get("en_us");
            }

            if ($$1 == null) {
               $$1 = (String)$$0.values().iterator().next();
            }
   ...
   private void startNextTask() {
      if (this.currentTask != null) {
         ...
         ConfigurationTask $$0 = (ConfigurationTask)this.configurationTasks.poll();
         if ($$0 != null) {
            this.currentTask = $$0;
