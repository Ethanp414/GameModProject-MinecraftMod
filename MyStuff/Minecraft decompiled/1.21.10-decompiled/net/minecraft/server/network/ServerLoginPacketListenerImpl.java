...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener, TickablePacketListener {
   ...
   public void handleHello(ServerboundHelloPacket $$0) {
      ...
      Validate.validState(StringUtil.isValidPlayerName($$0.name()), "Invalid characters in username");
   ...
   public void handleKey(ServerboundKeyPacket $$0) {
      ...
      Thread $$8 = new Thread("User Authenticator #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            String $$0 = (String)Objects.requireNonNull(ServerLoginPacketListenerImpl.this.requestedUsername, "Player name not initialized");

            try {
               ProfileResult $$1 = ServerLoginPacketListenerImpl.this.server.services().sessionService().hasJoinedServer($$0, $$5, this.getAddress());
               if ($$1 != null) {
                  ...
                  ServerLoginPacketListenerImpl.LOGGER.error("Username '{}' tried to join with an invalid session", $$0);
               }
         ...
         private InetAddress getAddress() {
            ...
            return ServerLoginPacketListenerImpl.this.server.getPreventProxyConnections() && $$0 instanceof InetSocketAddress
   ...
   public void handleLoginAcknowledgement(ServerboundLoginAcknowledgedPacket $$0) {
      ...
      CommonListenerCookie $$1 = CommonListenerCookie.createInitial((GameProfile)Objects.requireNonNull(this.authenticatedProfile), this.transferred);
   ...
   public void fillListenerSpecificCrashDetails(CrashReport $$0, CrashReportCategory $$1) {
      $$1.setDetail("Login phase", (CrashReportDetail<String>)(() -> this.state.toString()));
   }
