...
public class PlayerSafetyServiceTextFilter extends ServerTextFilter {
   ...
   public static ServerTextFilter createTextFilterFromConfig(String $$0) {
      ...
      ServerTextFilter.MessageEncoder $$19 = ($$2x, $$3x) -> {
         JsonObject $$4xx = new JsonObject();
         $$4xx.addProperty("userId", $$2x.id().toString());
         $$4xx.addProperty("userDisplayName", $$2x.name());
         $$4xx.addProperty("server", $$5);
         $$4xx.addProperty("room", $$8);
         $$4xx.addProperty("area", "JavaChatRealms");
         $$4xx.addProperty("data", $$3x);
         $$4xx.addProperty("language", "*");
         return $$4xx;
      };
      ...
      try {
         InputStream $$22 = Files.newInputStream(Path.of($$9));
      ...
      try {
         $$27 = ConfidentialClientApplication.builder($$6, $$23)
            .sendX5c(true)
            .executorService($$21)
