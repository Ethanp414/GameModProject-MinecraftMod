...
public class ServerConnectionListener {
   ...
   public void startTcpServerListener(@Nullable InetAddress $$0, int $$1) throws IOException {
      synchronized(this.channels) {
         ...
         if (Epoll.isAvailable() && this.server.isEpollEnabled()) {
            ...
            $$3 = (EventLoopGroup)SERVER_EPOLL_EVENT_GROUP.get();
            LOGGER.info("Using epoll channel type");
         } else {
            $$2 = NioServerSocketChannel.class;
            $$3 = (EventLoopGroup)SERVER_EVENT_GROUP.get();
            LOGGER.info("Using default channel type");
         }

         this.channels.add(new ServerBootstrap().channel($$2).childHandler(new ChannelInitializer<Channel>() {
            @Override
            protected void initChannel(Channel $$0) {
               ...
               if (ServerConnectionListener.this.server.repliesToStatus()) {
                  $$1.addLast("legacy_query", new LegacyQueryHandler(ServerConnectionListener.this.getServer()));
               }
               ...
               Connection $$3 = (Connection)($$2 > 0 ? new RateKickingConnection($$2) : new Connection(PacketFlow.SERVERBOUND));
   ...
   public SocketAddress startMemoryChannel() {
      ...
      synchronized(this.channels) {
         $$0 = new ServerBootstrap()
            ...
            .group((EventLoopGroup)SERVER_EVENT_GROUP.get())
   ...
   static class LatencySimulator extends ChannelInboundHandlerAdapter {
      ...
      private void onTimeout(Timeout $$0) {
         ServerConnectionListener.LatencySimulator.DelayedMessage $$1 = (ServerConnectionListener.LatencySimulator.DelayedMessage)this.queuedMessages
            .remove(0);
