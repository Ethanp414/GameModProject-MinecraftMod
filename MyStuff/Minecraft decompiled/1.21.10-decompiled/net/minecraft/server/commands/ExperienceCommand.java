...
public class ExperienceCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> $$0) {
      ...
      $$0.register(Commands.literal("xp").requires(Commands.hasPermission(2)).redirect($$1));
   }
      ...
      if ($$1.size() == 1) {
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.experience.add." + $$3.name + ".success.single", $$2, ((ServerPlayer)$$1.iterator().next()).getDisplayName()
               ),
            true
         );
      } else {
   ...
   private static int setExperience(CommandSourceStack $$0, Collection<? extends ServerPlayer> $$1, int $$2, ExperienceCommand.Type $$3) throws CommandSyntaxException {
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.experience.set." + $$3.name + ".success.single", $$2, ((ServerPlayer)$$1.iterator().next()).getDisplayName()
                  ),
               true
            );
         } else {
