...
public class DebugConfigCommand {
                           ...
                           Commands.argument("dialog", ResourceOrIdArgument.dialog($$1))
                              .executes(
                                 $$0x -> showDialog(
                                       ...
                                       UuidArgument.getUuid($$0x, "target"),
   ...
   private static Iterable<String> getUuidsInConfig(MinecraftServer $$0) {
      ...
      for(Connection $$2 : $$0.getConnection().getConnections()) {
         PacketListener var5 = $$2.getPacketListener();
         if (var5 instanceof ServerConfigurationPacketListenerImpl $$3) {
   ...
   private static ServerConfigurationPacketListenerImpl findConfigPlayer(MinecraftServer $$0, UUID $$1) {
      for(Connection $$2 : $$0.getConnection().getConnections()) {
         PacketListener var5 = $$2.getPacketListener();
         if (var5 instanceof ServerConfigurationPacketListenerImpl $$3 && $$3.getOwner().id().equals($$1)) {
            return $$3;
         }
      }
