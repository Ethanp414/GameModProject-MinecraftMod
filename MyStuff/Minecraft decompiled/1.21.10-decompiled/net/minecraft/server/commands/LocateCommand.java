...
public class LocateCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_NOT_FOUND = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.locate.structure.not_found", $$0)
   );
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_INVALID = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.locate.structure.invalid", $$0)
   );
   private static final DynamicCommandExceptionType ERROR_BIOME_NOT_FOUND = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.locate.biome.not_found", $$0)
   );
   private static final DynamicCommandExceptionType ERROR_POI_NOT_FOUND = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.locate.poi.not_found", $$0)
   );
   ...
   private static Optional<? extends HolderSet.ListBacked<Structure>> getHolders(ResourceOrTagKeyArgument.Result<Structure> $$0, Registry<Structure> $$1) {
      return $$0.unwrap().map($$1x -> $$1.get($$1x).map($$0xx -> HolderSet.direct($$0xx)), $$1::get);
   }
   ...
   private static int locateStructure(CommandSourceStack $$0, ResourceOrTagKeyArgument.Result<Structure> $$1) throws CommandSyntaxException {
      ...
      HolderSet<Structure> $$3 = (HolderSet)getHolders($$1, $$2).orElseThrow(() -> ERROR_STRUCTURE_INVALID.create($$1.asPrintable()));
   ...
   private static int locatePoi(CommandSourceStack $$0, ResourceOrTagArgument.Result<PoiType> $$1) throws CommandSyntaxException {
      ...
      if ($$5.isEmpty()) {
         ...
         return showLocateResult($$0, $$1, $$2, ((Pair)$$5.get()).swap(), "commands.locate.poi.success", false, $$4.elapsed());
      }
   }

   public static int showLocateResult(
      CommandSourceStack $$0,
      ResourceOrTagArgument.Result<?> $$1,
      BlockPos $$2,
      ...
      String $$7 = $$1.unwrap().map($$1x -> $$1.asPrintable(), $$2x -> $$1.asPrintable() + " (" + $$3.getSecond().getRegisteredName() + ")");
      return showLocateResult($$0, $$2, $$3, $$4, $$5, $$7, $$6);
   }

   public static int showLocateResult(
      CommandSourceStack $$0,
      ResourceOrTagKeyArgument.Result<?> $$1,
      BlockPos $$2,
      Pair<BlockPos, ? extends Holder<?>> $$3,
      String $$4,
      boolean $$5,
      ...
      String $$7 = $$1.unwrap().map($$0x -> $$0x.location().toString(), $$1x -> "#" + $$1x.location() + " (" + $$3.getSecond().getRegisteredName() + ")");
      return showLocateResult($$0, $$2, $$3, $$4, $$5, $$7, $$6);
   }
   ...
   private static int showLocateResult(
      ...
      BlockPos $$7 = $$2.getFirst();
      int $$8 = $$4 ? Mth.floor(Mth.sqrt((float)$$1.distSqr($$7))) : Mth.floor(dist($$1.getX(), $$1.getZ(), $$7.getX(), $$7.getZ()));
      String $$9 = $$4 ? String.valueOf($$7.getY()) : "~";
      Component $$10 = ComponentUtils.wrapInSquareBrackets(Component.translatable("chat.coordinates", $$7.getX(), $$9, $$7.getZ()))
         .withStyle(
            $$2x -> $$2x.withColor(ChatFormatting.GREEN)
                  .withClickEvent(new ClickEvent.SuggestCommand("/tp @s " + $$7.getX() + " " + $$9 + " " + $$7.getZ()))
                  .withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat.coordinates.tooltip")))
         );
      $$0.sendSuccess(() -> Component.translatable($$3, $$5, $$10, $$8), false);
