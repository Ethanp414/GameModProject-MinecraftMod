...
public class ScheduleCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_CANT_REMOVE = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.schedule.cleared.failure", $$0)
   );
   ...
   private static final SuggestionProvider<CommandSourceStack> SUGGEST_SCHEDULE = ($$0, $$1) -> SharedSuggestionProvider.suggest(
         $$0.getSource().getServer().getWorldData().overworldData().getScheduledEvents().getEventsIds(), $$1
      );
   ...
   private static int schedule(
      ...
      Pair<ResourceLocation, Either<CommandFunction<CommandSourceStack>, Collection<CommandFunction<CommandSourceStack>>>> $$1,
      int $$2,
      boolean $$3
      ...
      if ($$2 == 0) {
         ...
         ResourceLocation $$5 = $$1.getFirst();
         TimerQueue<MinecraftServer> $$6 = $$0.getServer().getWorldData().overworldData().getScheduledEvents();
         Optional<CommandFunction<CommandSourceStack>> $$7 = $$1.getSecond().left();
         if ($$7.isPresent()) {
            ...
            $$0.sendSuccess(() -> Component.translatable("commands.schedule.created.function", Component.translationArg($$5), $$2, $$4), true);
         } else {
            String $$9 = "#" + $$5;
            if ($$3) {
               $$6.remove($$9);
            ...
            $$0.sendSuccess(() -> Component.translatable("commands.schedule.created.tag", Component.translationArg($$5), $$2, $$4), true);
         }
