...
public class ListPlayersCommand {
   public static void register(CommandDispatcher<CommandSourceStack> $$0) {
      $$0.register(
         Commands.literal("list")
            .executes($$0x -> listPlayers((CommandSourceStack)$$0x.getSource()))
   ...
   private static int listPlayersWithUuids(CommandSourceStack $$0) {
      return format($$0, $$0x -> Component.translatable("commands.list.nameAndId", $$0x.getName(), Component.translationArg($$0x.getGameProfile().id())));
   }
