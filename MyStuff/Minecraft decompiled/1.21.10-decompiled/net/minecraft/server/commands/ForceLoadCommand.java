...
public class ForceLoadCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.forceload.toobig", $$0, $$1)
   );
   private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.forceload.query.failure", $$0, $$1)
   );
         ...
         Commands.literal("forceload")
                     ...
                     Commands.argument("from", ColumnPosArgument.columnPos())
                        .executes(
                           $$0x -> changeForceLoad(
                                 ...
                                 ColumnPosArgument.getColumnPos($$0x, "from"),
                                 ColumnPosArgument.getColumnPos($$0x, "from"),
                                 true
                              )
                        )
                           ...
                           Commands.argument("to", ColumnPosArgument.columnPos())
                              .executes(
                                 $$0x -> changeForceLoad(
                                       (CommandSourceStack)$$0x.getSource(),
                                       ColumnPosArgument.getColumnPos($$0x, "from"),
                                       ColumnPosArgument.getColumnPos($$0x, "to"),
                                       true
                                    )
                              )
                        )
            ...
            .then(
               Commands.literal("remove")
                  ...
                  .then(Commands.literal("all").executes($$0x -> removeAll((CommandSourceStack)$$0x.getSource())))
            )
            .then(
               Commands.literal("query")
                  .executes($$0x -> listForceLoad((CommandSourceStack)$$0x.getSource()))
                  .then(
                     Commands.argument("pos", ColumnPosArgument.columnPos())
                        .executes($$0x -> queryForceLoad((CommandSourceStack)$$0x.getSource(), ColumnPosArgument.getColumnPos($$0x, "pos")))
                  )
            )
      );
   }
   ...
   private static int queryForceLoad(CommandSourceStack $$0, ColumnPos $$1) throws CommandSyntaxException {
      ...
      if ($$5) {
         $$0.sendSuccess(
            () -> Component.translatable("commands.forceload.query.success", Component.translationArg($$2), Component.translationArg($$4.location())), false
         );
         return 1;
      } else {
   ...
   private static int listForceLoad(CommandSourceStack $$0) {
      ...
      if ($$4 > 0) {
         ...
         if ($$4 == 1) {
            $$0.sendSuccess(() -> Component.translatable("commands.forceload.list.single", Component.translationArg($$2.location()), $$5), false);
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.forceload.list.multiple", $$4, Component.translationArg($$2.location()), $$5), false);
         }
      } else {
         $$0.sendFailure(Component.translatable("commands.forceload.added.none", Component.translationArg($$2.location())));
      }
   ...
   private static int removeAll(CommandSourceStack $$0) {
      ...
      ResourceKey<Level> $$2 = $$1.dimension();
      LongSet $$3 = $$1.getForceLoadedChunks();
      $$3.forEach($$1x -> $$1.setChunkForced(ChunkPos.getX($$1x), ChunkPos.getZ($$1x), false));
      $$0.sendSuccess(() -> Component.translatable("commands.forceload.removed.all", Component.translationArg($$2.location())), true);
      return 0;
   }
               ...
               if ($$16 == 1) {
                  $$0.sendSuccess(
                     () -> Component.translatable(
                           "commands.forceload." + ($$3 ? "added" : "removed") + ".single",
                           Component.translationArg($$20),
                           Component.translationArg($$14.location())
                        ),
                     true
                  );
               } else {
                  ...
                  $$0.sendSuccess(
                     () -> Component.translatable(
                           "commands.forceload." + ($$3 ? "added" : "removed") + ".multiple",
                           $$16,
                           Component.translationArg($$14.location()),
                           Component.translationArg($$22),
                           Component.translationArg($$23)
                        ),
                     true
                  );
               }
