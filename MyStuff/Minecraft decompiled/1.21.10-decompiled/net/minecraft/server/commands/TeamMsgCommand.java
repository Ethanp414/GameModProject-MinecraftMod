...
public class TeamMsgCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> $$0) {
      LiteralCommandNode<CommandSourceStack> $$1 = $$0.register(
         Commands.literal("teammsg").then(Commands.argument("message", MessageArgument.message()).executes($$0x -> {
            CommandSourceStack $$1xx = (CommandSourceStack)$$0x.getSource();
            Entity $$2 = $$1xx.getEntityOrException();
            PlayerTeam $$3 = $$2.getTeam();
            if ($$3 == null) {
               throw ERROR_NOT_ON_TEAM.create();
            } else {
               List<ServerPlayer> $$4 = $$1xx.getServer().getPlayerList().getPlayers().stream().filter($$2x -> $$2x == $$2 || $$2x.getTeam() == $$3).toList();
               if (!$$4.isEmpty()) {
      ...
      $$0.register(Commands.literal("tm").redirect($$1));
   }
