...
public class BossBarCommands {
   private static final DynamicCommandExceptionType ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.bossbar.create.failed", $$0)
   );
   private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.bossbar.unknown", $$0)
   );
   ...
   public static final SuggestionProvider<CommandSourceStack> SUGGEST_BOSS_BAR = ($$0, $$1) -> SharedSuggestionProvider.suggestResource(
         $$0.getSource().getServer().getCustomBossEvents().getIds(), $$1
      );
                           ...
                           Commands.argument("name", ComponentArgument.textComponent($$1))
                              .executes(
                                 $$0x -> createBar(
                                       ...
                                       ResourceLocationArgument.getId($$0x, "id"),
                           ...
                           Commands.literal("name")
                              .then(
                                 Commands.argument("name", ComponentArgument.textComponent($$1))
                                    .executes(
                                       $$0x -> setName(
                                             (CommandSourceStack)$$0x.getSource(), getBossBar($$0x), ComponentArgument.getResolvedComponent($$0x, "name")
                                          )
                                    )
                              )
                        )
                           ...
                           Commands.literal("color")
                              .then(
                                 Commands.literal("pink")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.PINK))
                              )
                              .then(
                                 Commands.literal("blue")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.BLUE))
                              )
                              .then(
                                 Commands.literal("red")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.RED))
                              )
                              .then(
                                 Commands.literal("green")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.GREEN))
                              )
                              .then(
                                 Commands.literal("yellow")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.YELLOW))
                              )
                              .then(
                                 Commands.literal("purple")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.PURPLE))
                              )
                              .then(
                                 Commands.literal("white")
                                    .executes($$0x -> setColor((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarColor.WHITE))
                              )
                        )
                        .then(
                           Commands.literal("style")
                              .then(
                                 Commands.literal("progress")
                                    .executes($$0x -> setStyle((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarOverlay.PROGRESS))
                              )
                              .then(
                                 Commands.literal("notched_6")
                                    .executes($$0x -> setStyle((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarOverlay.NOTCHED_6))
                              )
                              .then(
                                 Commands.literal("notched_10")
                                    .executes($$0x -> setStyle((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarOverlay.NOTCHED_10))
                              )
                              .then(
                                 Commands.literal("notched_12")
                                    .executes($$0x -> setStyle((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarOverlay.NOTCHED_12))
                              )
                              .then(
                                 Commands.literal("notched_20")
                                    .executes($$0x -> setStyle((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BossEvent.BossBarOverlay.NOTCHED_20))
                              )
                        )
                        .then(
                           Commands.literal("value")
                              .then(
                                 Commands.argument("value", IntegerArgumentType.integer(0))
                                    .executes(
                                       $$0x -> setValue((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), IntegerArgumentType.getInteger($$0x, "value"))
                                    )
                              )
                        )
                        .then(
                           Commands.literal("max")
                              .then(
                                 Commands.argument("max", IntegerArgumentType.integer(1))
                                    .executes(
                                       $$0x -> setMax((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), IntegerArgumentType.getInteger($$0x, "max"))
                                    )
                              )
                        )
                        .then(
                           Commands.literal("visible")
                              .then(
                                 Commands.argument("visible", BoolArgumentType.bool())
                                    .executes(
                                       $$0x -> setVisible((CommandSourceStack)$$0x.getSource(), getBossBar($$0x), BoolArgumentType.getBool($$0x, "visible"))
                                    )
                              )
                        )
                        .then(
   ...
   private static int getValue(CommandSourceStack $$0, CustomBossEvent $$1) {
      $$0.sendSuccess(() -> Component.translatable("commands.bossbar.get.value", $$1.getDisplayName(), $$1.getValue()), true);
      return $$1.getValue();
   }

   private static int getMax(CommandSourceStack $$0, CustomBossEvent $$1) {
      $$0.sendSuccess(() -> Component.translatable("commands.bossbar.get.max", $$1.getDisplayName(), $$1.getMax()), true);
      return $$1.getMax();
   }

   private static int getVisible(CommandSourceStack $$0, CustomBossEvent $$1) {
      if ($$1.isVisible()) {
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.get.visible.visible", $$1.getDisplayName()), true);
         return 1;
      } else {
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.get.visible.hidden", $$1.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int getPlayers(CommandSourceStack $$0, CustomBossEvent $$1) {
      if ($$1.getPlayers().isEmpty()) {
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.get.players.none", $$1.getDisplayName()), true);
      } else {
         $$0.sendSuccess(
            () -> Component.translatable(
                  ...
                  $$1.getDisplayName(),
                  $$1.getPlayers().size(),
                  ComponentUtils.formatList($$1.getPlayers(), Player::getDisplayName)
               ),
            true
         );
      }
   ...
   private static int setVisible(CommandSourceStack $$0, CustomBossEvent $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.isVisible() == $$2) {
         ...
         $$1.setVisible($$2);
         if ($$2) {
            $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.visible.success.visible", $$1.getDisplayName()), true);
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.visible.success.hidden", $$1.getDisplayName()), true);
         }
   ...
   private static int setValue(CommandSourceStack $$0, CustomBossEvent $$1, int $$2) throws CommandSyntaxException {
      if ($$1.getValue() == $$2) {
         ...
         $$1.setValue($$2);
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.value.success", $$1.getDisplayName(), $$2), true);
         return $$2;
      }
   }
   ...
   private static int setMax(CommandSourceStack $$0, CustomBossEvent $$1, int $$2) throws CommandSyntaxException {
      if ($$1.getMax() == $$2) {
         ...
         $$1.setMax($$2);
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.max.success", $$1.getDisplayName(), $$2), true);
         return $$2;
      }
   }
   ...
   private static int setColor(CommandSourceStack $$0, CustomBossEvent $$1, BossEvent.BossBarColor $$2) throws CommandSyntaxException {
      if ($$1.getColor().equals($$2)) {
         ...
         $$1.setColor($$2);
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.color.success", $$1.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setStyle(CommandSourceStack $$0, CustomBossEvent $$1, BossEvent.BossBarOverlay $$2) throws CommandSyntaxException {
      if ($$1.getOverlay().equals($$2)) {
         ...
         $$1.setOverlay($$2);
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.style.success", $$1.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setName(CommandSourceStack $$0, CustomBossEvent $$1, Component $$2) throws CommandSyntaxException {
      ...
      if ($$1.getName().equals($$3)) {
         ...
         $$1.setName($$3);
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.name.success", $$1.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setPlayers(CommandSourceStack $$0, CustomBossEvent $$1, Collection<ServerPlayer> $$2) throws CommandSyntaxException {
      ...
      if (!$$3) {
         ...
         if ($$1.getPlayers().isEmpty()) {
            $$0.sendSuccess(() -> Component.translatable("commands.bossbar.set.players.success.none", $$1.getDisplayName()), true);
         } else {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.bossbar.set.players.success.some", $$1.getDisplayName(), $$2.size(), ComponentUtils.formatList($$2, Player::getDisplayName)
                  ),
               true
            );
         }
   ...
   private static int listBars(CommandSourceStack $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         $$0.sendSuccess(
            () -> Component.translatable("commands.bossbar.list.bars.some", $$1.size(), ComponentUtils.formatList($$1, CustomBossEvent::getDisplayName)),
            false
         );
      }
   ...
   private static int createBar(CommandSourceStack $$0, ResourceLocation $$1, Component $$2) throws CommandSyntaxException {
      ...
      if ($$3.get($$1) != null) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.bossbar.create.success", $$4.getDisplayName()), true);
   ...
   private static int removeBar(CommandSourceStack $$0, CustomBossEvent $$1) {
      ...
      $$1.removeAllPlayers();
      $$2.remove($$1);
      $$0.sendSuccess(() -> Component.translatable("commands.bossbar.remove.success", $$1.getDisplayName()), true);
   ...
   public static CustomBossEvent getBossBar(CommandContext<CommandSourceStack> $$0) throws CommandSyntaxException {
      ...
      CustomBossEvent $$2 = $$0.getSource().getServer().getCustomBossEvents().get($$1);
      if ($$2 == null) {
