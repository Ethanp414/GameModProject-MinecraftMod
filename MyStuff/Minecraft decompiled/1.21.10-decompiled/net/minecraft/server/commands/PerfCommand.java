...
public class PerfCommand {
   ...
   private static void saveResults(CommandSourceStack $$0, Path $$1, MinecraftServer $$2) {
      ...
      $$0.sendSuccess(() -> Component.translatable("commands.perf.reportSaved", $$4), false);
   }
      ...
      if ($$1 != EmptyProfileResults.EMPTY) {
         ...
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.perf.stopped", String.format(Locale.ROOT, "%.2f", $$3), $$2, String.format(Locale.ROOT, "%.2f", (double)$$2 / $$3)
               ),
            false
         );
      }
