...
public class StorageDataAccessor implements DataAccessor {
   ...
   public static final Function<String, DataCommands.DataProvider> PROVIDER = $$0 -> new DataCommands.DataProvider() {
         ...
         public DataAccessor access(CommandContext<CommandSourceStack> $$0x) {
            return new StorageDataAccessor(StorageDataAccessor.getGlobalTags($$0), ResourceLocationArgument.getId($$0, $$0));
         }
         ...
         public ArgumentBuilder<CommandSourceStack, ?> wrap(
            ...
            return $$0.then(
               Commands.literal("storage")
                  .then(
                     (ArgumentBuilder<CommandSourceStack, ?>)$$1.apply(
                        Commands.argument($$0, ResourceLocationArgument.id()).suggests(StorageDataAccessor.SUGGEST_STORAGE)
                     )
                  )
            );
         }
   ...
   static CommandStorage getGlobalTags(CommandContext<CommandSourceStack> $$0) {
      return $$0.getSource().getServer().getCommandStorage();
   }
   ...
   public Component getPrintSuccess(Tag $$0) {
      return Component.translatable("commands.data.storage.query", Component.translationArg(this.id), NbtUtils.toPrettyComponent($$0));
   }

   @Override
   public Component getPrintSuccess(NbtPathArgument.NbtPath $$0, double $$1, int $$2) {
      return Component.translatable(
         "commands.data.storage.get", $$0.asString(), Component.translationArg(this.id), String.format(Locale.ROOT, "%.2f", $$1), $$2
      );
   }
}
