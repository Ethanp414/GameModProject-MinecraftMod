...
public class WhitelistCommand {
                        ...
                        .suggests(
                           ($$0x, $$1) -> {
                              ...
                              return SharedSuggestionProvider.suggest(
                                 $$2.getPlayers().stream().map(Player::nameAndId).filter($$1x -> !$$2.getWhiteList().isWhiteListed($$1x)).map(NameAndId::name),
                                 $$1
                              );
                           }
                        )
   ...
   private static int showList(CommandSourceStack $$0) {
      ...
      if ($$1.length == 0) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.whitelist.list", $$1.length, String.join(", ", $$1)), false);
      }
