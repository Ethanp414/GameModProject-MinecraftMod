         ...
         Commands.literal("weather")
            ...
            .then(
               Commands.literal("clear")
                  .executes($$0x -> setClear((CommandSourceStack)$$0x.getSource(), -1))
                  .then(
            ...
            .then(
               Commands.literal("rain")
                  .executes($$0x -> setRain((CommandSourceStack)$$0x.getSource(), -1))
                  .then(
                     Commands.argument("duration", TimeArgument.time(1))
            ...
            .then(
               Commands.literal("thunder")
                  .executes($$0x -> setThunder((CommandSourceStack)$$0x.getSource(), -1))
                  .then(
                     Commands.argument("duration", TimeArgument.time(1))
