...
public class ScoreboardCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_NO_VALUE = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.scoreboard.players.get.null", $$0, $$1)
   );
                     ...
                     Commands.literal("setdisplay")
                        .then(
                           Commands.argument("slot", ScoreboardSlotArgument.displaySlot())
                              .executes($$0x -> clearDisplaySlot((CommandSourceStack)$$0x.getSource(), ScoreboardSlotArgument.getDisplaySlot($$0x, "slot")))
                              .then(
                                 Commands.argument("objective", ObjectiveArgument.objective())
                                    .executes(
                                       $$0x -> setDisplaySlot(
                     ...
                     Commands.literal("list")
                        ...
                        .then(
                           Commands.argument("target", ScoreHolderArgument.scoreHolder())
                              ...
                              .executes($$0x -> listTrackedPlayerScores((CommandSourceStack)$$0x.getSource(), ScoreHolderArgument.getName($$0x, "target")))
                        )
                  )
                  .then(
                     ...
                     Commands.literal("reset")
                        .then(
                           Commands.argument("targets", ScoreHolderArgument.scoreHolders())
                              .suggests(ScoreHolderArgument.SUGGEST_SCORE_HOLDERS)
                              .executes(
                                 $$0x -> resetScores((CommandSourceStack)$$0x.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard($$0x, "targets"))
                              )
                              .then(
                                 Commands.argument("objective", ObjectiveArgument.objective())
                                    .executes(
   ...
   private static ArgumentBuilder<CommandSourceStack, ?> addNumberFormats(
      ...
      return $$1.then(Commands.literal("blank").executes($$1x -> $$2.run($$1x, BlankFormat.INSTANCE)))
         .then(Commands.literal("fixed").then(Commands.argument("contents", ComponentArgument.textComponent($$0)).executes($$1x -> {
            Component $$2xx = ComponentArgument.getResolvedComponent($$1x, "contents");
            return $$2.run($$1x, new FixedFormat($$2xx));
         })))
         .then(Commands.literal("styled").then(Commands.argument("style", StyleArgument.style($$0)).executes($$1x -> {
            Style $$2xx = StyleArgument.getStyle($$1x, "style");
            return $$2.run($$1x, new StyledFormat($$2xx));
         })))
   ...
   private static int getScore(CommandSourceStack $$0, ScoreHolder $$1, Objective $$2) throws CommandSyntaxException {
      ...
      if ($$4 == null) {
         ...
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.get.success", $$1.getFeedbackDisplayName(), $$4.value(), $$2.getFormattedDisplayName()),
            false
         );
         return $$4.value();
      }
   ...
   private static Component getFirstTargetName(Collection<ScoreHolder> $$0) {
      return ((ScoreHolder)$$0.iterator().next()).getFeedbackDisplayName();
   }

   private static int performOperation(
      CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, OperationArgument.Operation $$3, Collection<ScoreHolder> $$4, Objective $$5
      ...
      if ($$1.size() == 1) {
         int $$12 = $$7;
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.operation.success.single", $$2.getFormattedDisplayName(), getFirstTargetName($$1), $$12),
            true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.operation.success.multiple", $$2.getFormattedDisplayName(), $$1.size()), true
         );
      }
   ...
   private static int enableTrigger(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2) throws CommandSyntaxException {
      if ($$2.getCriteria() != ObjectiveCriteria.TRIGGER) {
         ...
         if ($$4 == 0) {
            ...
            if ($$1.size() == 1) {
               $$0.sendSuccess(
                  () -> Component.translatable("commands.scoreboard.players.enable.success.single", $$2.getFormattedDisplayName(), getFirstTargetName($$1)),
                  true
               );
            } else {
               $$0.sendSuccess(
                  () -> Component.translatable("commands.scoreboard.players.enable.success.multiple", $$2.getFormattedDisplayName(), $$1.size()), true
               );
            }
   ...
   private static int resetScores(CommandSourceStack $$0, Collection<ScoreHolder> $$1) {
      ...
      if ($$1.size() == 1) {
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.players.reset.all.single", getFirstTargetName($$1)), true);
      } else {
   ...
   private static int resetScore(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2) {
      ...
      if ($$1.size() == 1) {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.reset.specific.single", $$2.getFormattedDisplayName(), getFirstTargetName($$1)), true
         );
      } else {
   ...
   private static int setScore(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, int $$3) {
      ...
      if ($$1.size() == 1) {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.set.success.single", $$2.getFormattedDisplayName(), getFirstTargetName($$1), $$3), true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.set.success.multiple", $$2.getFormattedDisplayName(), $$1.size(), $$3), true
         );
      }
   ...
   private static int setScoreDisplay(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, @Nullable Component $$3) {
      ...
      if ($$3 == null) {
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.scoreboard.players.display.name.clear.success.single", getFirstTargetName($$1), $$2.getFormattedDisplayName()
                  ),
               true
            );
         } else {
            $$0.sendSuccess(
               () -> Component.translatable("commands.scoreboard.players.display.name.clear.success.multiple", $$1.size(), $$2.getFormattedDisplayName()),
               true
            );
         }
      } else if ($$1.size() == 1) {
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.display.name.set.success.single", $$3, getFirstTargetName($$1), $$2.getFormattedDisplayName()
               ),
            true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.display.name.set.success.multiple", $$3, $$1.size(), $$2.getFormattedDisplayName()),
            true
         );
      }
   ...
   private static int setScoreNumberFormat(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, @Nullable NumberFormat $$3) {
      ...
      if ($$3 == null) {
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.scoreboard.players.display.numberFormat.clear.success.single", getFirstTargetName($$1), $$2.getFormattedDisplayName()
                  ),
               true
            );
         } else {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.scoreboard.players.display.numberFormat.clear.success.multiple", $$1.size(), $$2.getFormattedDisplayName()
                  ),
               true
            );
         }
         ...
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.display.numberFormat.set.success.single", getFirstTargetName($$1), $$2.getFormattedDisplayName()
               ),
            true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.multiple", $$1.size(), $$2.getFormattedDisplayName()),
            true
         );
      }
   ...
   private static int addScore(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, int $$3) {
      ...
      if ($$1.size() == 1) {
         int $$8 = $$5;
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.add.success.single", $$3, $$2.getFormattedDisplayName(), getFirstTargetName($$1), $$8),
            true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.add.success.multiple", $$3, $$2.getFormattedDisplayName(), $$1.size()), true
         );
      }
   ...
   private static int removeScore(CommandSourceStack $$0, Collection<ScoreHolder> $$1, Objective $$2, int $$3) {
      ...
      if ($$1.size() == 1) {
         int $$8 = $$5;
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.remove.success.single", $$3, $$2.getFormattedDisplayName(), getFirstTargetName($$1), $$8),
            true
         );
      } else {
         $$0.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.remove.success.multiple", $$3, $$2.getFormattedDisplayName(), $$1.size()), true
         );
      }
   ...
   private static int listTrackedPlayers(CommandSourceStack $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.players.list.success", $$1.size(), ComponentUtils.formatList($$1, ScoreHolder::getFeedbackDisplayName)
               ),
            false
         );
      }
   ...
   private static int listTrackedPlayerScores(CommandSourceStack $$0, ScoreHolder $$1) {
      ...
      if ($$2.isEmpty()) {
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.players.list.entity.empty", $$1.getFeedbackDisplayName()), false);
      } else {
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.players.list.entity.success", $$1.getFeedbackDisplayName(), $$2.size()), false);
         Object2IntMaps.fastForEach(
            $$2,
            $$1x -> $$0.sendSuccess(
                  () -> Component.translatable(
                        "commands.scoreboard.players.list.entity.entry", ((Objective)$$1x.getKey()).getFormattedDisplayName(), $$1x.getIntValue()
                     ),
                  false
               )
         );
   ...
   private static int clearDisplaySlot(CommandSourceStack $$0, DisplaySlot $$1) throws CommandSyntaxException {
      ...
      if ($$2.getDisplayObjective($$1) == null) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.objectives.display.cleared", $$1.getSerializedName()), true);
         return 0;
      }
   }
   ...
   private static int setDisplaySlot(CommandSourceStack $$0, DisplaySlot $$1, Objective $$2) throws CommandSyntaxException {
      ...
      if ($$3.getDisplayObjective($$1) == $$2) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.objectives.display.set", $$1.getSerializedName(), $$2.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setDisplayAutoUpdate(CommandSourceStack $$0, Objective $$1, boolean $$2) {
      if ($$1.displayAutoUpdate() != $$2) {
         ...
         if ($$2) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.scoreboard.objectives.modify.displayAutoUpdate.enable", $$1.getName(), $$1.getFormattedDisplayName()),
               true
            );
         } else {
            $$0.sendSuccess(
               () -> Component.translatable("commands.scoreboard.objectives.modify.displayAutoUpdate.disable", $$1.getName(), $$1.getFormattedDisplayName()),
               true
            );
         }
      }
   ...
   private static int setObjectiveFormat(CommandSourceStack $$0, Objective $$1, @Nullable NumberFormat $$2) {
      $$1.setNumberFormat($$2);
      if ($$2 != null) {
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.objectives.modify.objectiveFormat.set", $$1.getName()), true);
      } else {
         $$0.sendSuccess(() -> Component.translatable("commands.scoreboard.objectives.modify.objectiveFormat.clear", $$1.getName()), true);
      }
   ...
   private static int listObjectives(CommandSourceStack $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.scoreboard.objectives.list.success", $$1.size(), ComponentUtils.formatList($$1, Objective::getFormattedDisplayName)
               ),
            false
         );
      }
