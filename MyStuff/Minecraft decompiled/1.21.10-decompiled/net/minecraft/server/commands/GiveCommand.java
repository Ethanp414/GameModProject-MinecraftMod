...
public class GiveCommand {
   ...
   private static int giveItem(CommandSourceStack $$0, ItemInput $$1, Collection<ServerPlayer> $$2, int $$3) throws CommandSyntaxException {
      ...
      int $$6 = $$5 * 100;
      if ($$3 > $$6) {
         $$0.sendFailure(Component.translatable("commands.give.failed.toomanyitems", $$6, $$4.getDisplayName()));
         return 0;
      } else {
         ...
         if ($$2.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.give.success.single", $$3, $$4.getDisplayName(), ((ServerPlayer)$$2.iterator().next()).getDisplayName()),
               true
            );
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.give.success.single", $$3, $$4.getDisplayName(), $$2.size()), true);
         }
