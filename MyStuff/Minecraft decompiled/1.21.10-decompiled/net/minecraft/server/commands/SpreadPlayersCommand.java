...
public class SpreadPlayersCommand {
   ...
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_TEAMS = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> Component.translatableEscape("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType ERROR_FAILED_TO_SPREAD_ENTITIES = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> Component.translatableEscape("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType ERROR_INVALID_MAX_HEIGHT = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> Component.translatableEscape("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int spreadPlayers(CommandSourceStack $$0, Vec2 $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends Entity> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         double $$10 = (double)($$1.x - $$3);
         double $$11 = (double)($$1.y - $$3);
         double $$12 = (double)($$1.x + $$3);
         double $$13 = (double)($$1.y + $$3);
         SpreadPlayersCommand.Position[] $$14 = createInitialPositions($$9, $$5 ? getNumberOfTeams($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         spreadPositions($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = setPlayerPositions($$6, $$7, $$14, $$4, $$5);
         $$0.sendSuccess(
            () -> Component.translatable(
                  "commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.x, $$1.y, String.format(Locale.ROOT, "%.2f", $$15)
               ),
            true
         );
         return $$14.length;
   ...
   private static int getNumberOfTeams(Collection<? extends Entity> $$0) {
      Set<Team> $$1 = Sets.<Team>newHashSet();
   ...
   private static double setPlayerPositions(Collection<? extends Entity> $$0, ServerLevel $$1, SpreadPlayersCommand.Position[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<Team, SpreadPlayersCommand.Position> $$7 = Maps.<Team, SpreadPlayersCommand.Position>newHashMap();
      ...
      for(Entity $$8 : $$0) {
         ...
         $$8.teleportTo(
            $$1,
            (double)Mth.floor($$10.x) + 0.5,
            (double)$$10.getSpawnY($$1, $$3),
            (double)Mth.floor($$10.z) + 0.5,
            Set.of(),
            $$8.getYRot(),
            $$8.getXRot(),
            true
   ...
   static class Position {
      ...
      public int getSpawnY(BlockGetter $$0, int $$1) {
         ...
         boolean $$5;
         for(boolean $$4 = $$0.getBlockState($$2).isAir(); $$2.getY() > $$0.getMinY(); $$4 = $$5) {
            $$2.move(Direction.DOWN);
            $$5 = $$0.getBlockState($$2).isAir();
            if (!$$5 && $$4 && $$3) {
               return $$2.getY() + 1;
            }
      ...
      public boolean isSafe(BlockGetter $$0, int $$1) {
         BlockPos $$2 = BlockPos.containing(this.x, (double)(this.getSpawnY($$0, $$1) - 1), this.z);
