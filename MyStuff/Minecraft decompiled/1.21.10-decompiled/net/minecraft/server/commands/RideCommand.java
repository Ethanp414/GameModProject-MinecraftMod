...
public class RideCommand {
         ...
         Commands.literal("ride")
            ...
            .then(
               Commands.argument("target", EntityArgument.entity())
                  ...
                  .then(
                     Commands.literal("dismount").executes($$0x -> dismount((CommandSourceStack)$$0x.getSource(), EntityArgument.getEntity($$0x, "target")))
                  )
            )
      );
   }
   ...
   private static int mount(CommandSourceStack $$0, Entity $$1, Entity $$2) throws CommandSyntaxException {
      ...
      if ($$3 != null) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.ride.mount.success", $$1.getDisplayName(), $$2.getDisplayName()), true);
         return 1;
      }
   }
   ...
   private static int dismount(CommandSourceStack $$0, Entity $$1) throws CommandSyntaxException {
      ...
      if ($$2 == null) {
         ...
         $$1.stopRiding();
         $$0.sendSuccess(() -> Component.translatable("commands.ride.dismount.success", $$1.getDisplayName(), $$2.getDisplayName()), true);
         return 1;
      }
   }
}
