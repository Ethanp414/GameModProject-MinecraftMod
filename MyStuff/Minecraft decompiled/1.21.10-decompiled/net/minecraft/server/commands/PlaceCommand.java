...
public class PlaceCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType(
      $$0 -> Component.translatableEscape("commands.place.template.invalid", $$0)
   );
   ...
   private static final SuggestionProvider<CommandSourceStack> SUGGEST_TEMPLATES = ($$0, $$1) -> {
      StructureTemplateManager $$2 = $$0.getSource().getLevel().getStructureManager();
                                 ...
                                 ((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 20))
                                       .executes(
                                          $$0x -> placeJigsaw(
                                                ...
                                                ResourceLocationArgument.getId($$0x, "target"),
                  ...
                  .then(
                     Commands.argument("template", ResourceLocationArgument.id())
                        ...
                        .executes(
                           $$0x -> placeTemplate(
                                 (CommandSourceStack)$$0x.getSource(),
                                 ResourceLocationArgument.getId($$0x, "template"),
                                 BlockPos.containing(((CommandSourceStack)$$0x.getSource()).getPosition()),
                                 Rotation.NONE,
                                 Mirror.NONE,
                                 1.0F,
   ...
   public static int placeFeature(CommandSourceStack $$0, Holder.Reference<ConfiguredFeature<?, ?>> $$1, BlockPos $$2) throws CommandSyntaxException {
      ...
      if (!$$4.place($$3, $$3.getChunkSource().getGenerator(), $$3.getRandom(), $$2)) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.place.feature.success", $$6, $$2.getX(), $$2.getY(), $$2.getZ()), true);
         return 1;
      }
   }
   ...
   public static int placeJigsaw(CommandSourceStack $$0, Holder<StructureTemplatePool> $$1, ResourceLocation $$2, int $$3, BlockPos $$4) throws CommandSyntaxException {
      ...
      if (!JigsawPlacement.generateJigsaw($$5, $$1, $$2, $$3, $$4, false)) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.place.jigsaw.success", $$4.getX(), $$4.getY(), $$4.getZ()), true);
         return 1;
      }
   }
   ...
   public static int placeStructure(CommandSourceStack $$0, Holder.Reference<Structure> $$1, BlockPos $$2) throws CommandSyntaxException {
      ...
      if (!$$6.isValid()) {
         ...
         $$0.sendSuccess(() -> Component.translatable("commands.place.structure.success", $$10, $$2.getX(), $$2.getY(), $$2.getZ()), true);
         return 1;
      }
   }
   ...
   public static int placeTemplate(CommandSourceStack $$0, ResourceLocation $$1, BlockPos $$2, Rotation $$3, Mirror $$4, float $$5, int $$6, boolean $$7) throws CommandSyntaxException {
      ...
      if ($$10.isEmpty()) {
         ...
         StructureTemplate $$13 = (StructureTemplate)$$10.get();
         ...
         if ($$5 < 1.0F) {
            $$14.clearProcessors().addProcessor(new BlockRotProcessor($$5)).setRandom(StructureBlockEntity.createRandom((long)$$6));
         }

         boolean $$15 = $$13.placeInWorld($$8, $$2, $$2, $$14, StructureBlockEntity.createRandom((long)$$6), 2 | ($$7 ? 816 : 0));
         if (!$$15) {
            throw ERROR_TEMPLATE_FAILED.create();
         } else {
            $$0.sendSuccess(
               () -> Component.translatable("commands.place.template.success", Component.translationArg($$1), $$2.getX(), $$2.getY(), $$2.getZ()), true
            );
            return 1;
         }
      }
