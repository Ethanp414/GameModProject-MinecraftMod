...
public class EffectCommands {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.effect.give.success.single", $$6.getDisplayName(), ((Entity)$$1.iterator().next()).getDisplayName(), $$8 / 20
                  ),
               true
            );
         } else {
            $$0.sendSuccess(() -> Component.translatable("commands.effect.give.success.multiple", $$6.getDisplayName(), $$1.size(), $$8 / 20), true);
         }
   ...
   private static int clearEffects(CommandSourceStack $$0, Collection<? extends Entity> $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable("commands.effect.clear.everything.success.single", ((Entity)$$1.iterator().next()).getDisplayName()), true
            );
         } else {
   ...
   private static int clearEffect(CommandSourceStack $$0, Collection<? extends Entity> $$1, Holder<MobEffect> $$2) throws CommandSyntaxException {
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.sendSuccess(
               () -> Component.translatable(
                     "commands.effect.clear.specific.success.single", $$3.getDisplayName(), ((Entity)$$1.iterator().next()).getDisplayName()
                  ),
               true
            );
         } else {
