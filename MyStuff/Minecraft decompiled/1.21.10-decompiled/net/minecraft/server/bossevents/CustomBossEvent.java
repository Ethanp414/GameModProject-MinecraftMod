...
public class CustomBossEvent extends ServerBossEvent {
   ...
   public boolean setPlayers(Collection<ServerPlayer> $$0) {
      ...
      Set<ServerPlayer> $$2 = Sets.<ServerPlayer>newHashSet();
   ...
   public static CustomBossEvent load(ResourceLocation $$0, CustomBossEvent.Packed $$1) {
   ...
   public static record Packed(
      ...
      public static final Codec<CustomBossEvent.Packed> CODEC = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("Visible", Boolean.valueOf(false)).forGetter(CustomBossEvent.Packed::visible),
                  Codec.INT.optionalFieldOf("Value", Integer.valueOf(0)).forGetter(CustomBossEvent.Packed::value),
                  Codec.INT.optionalFieldOf("Max", Integer.valueOf(100)).forGetter(CustomBossEvent.Packed::max),
                  ...
                  Codec.BOOL.optionalFieldOf("DarkenScreen", Boolean.valueOf(false)).forGetter(CustomBossEvent.Packed::darkenScreen),
                  Codec.BOOL.optionalFieldOf("PlayBossMusic", Boolean.valueOf(false)).forGetter(CustomBossEvent.Packed::playBossMusic),
                  Codec.BOOL.optionalFieldOf("CreateWorldFog", Boolean.valueOf(false)).forGetter(CustomBossEvent.Packed::createWorldFog),
