...
public class PlayerAdvancements {
   ...
   public PlayerAdvancements(DataFixer $$0, PlayerList $$1, ServerAdvancementManager $$2, Path $$3, ServerPlayer $$4) {
      ...
      this.tree = $$2.tree();
      int $$5 = 1343;
      this.codec = DataFixTypes.ADVANCEMENTS.wrapCodec(PlayerAdvancements.Data.CODEC, $$0, 1343);
      this.load($$2);
   }
      ...
      if (Files.isRegularFile(this.playerSavePath, new LinkOption[0])) {
         try {
            ...
            try {
               ...
               PlayerAdvancements.Data $$3 = (PlayerAdvancements.Data)this.codec.parse(JsonOps.INSTANCE, $$2).getOrThrow(JsonParseException::new);
               this.applyFrom($$0, $$3);
   ...
   public void save() {
      JsonElement $$0 = this.codec.encodeStart(JsonOps.INSTANCE, this.asData()).getOrThrow();

      try {
         FileUtil.createDirectoriesSafe(this.playerSavePath.getParent());
         Writer $$1 = Files.newBufferedWriter(this.playerSavePath, StandardCharsets.UTF_8);
   ...
   private void applyFrom(ServerAdvancementManager $$0, PlayerAdvancements.Data $$1) {
      $$1.forEach(($$1x, $$2) -> {
   ...
   private PlayerAdvancements.Data asData() {
      ...
      return new PlayerAdvancements.Data($$0);
   }
      ...
      if ($$3.grantProgress($$1)) {
         ...
         if (!$$4 && $$3.isDone()) {
            ...
            $$0.value().display().ifPresent($$1x -> {
               if ($$1x.shouldAnnounceChat() && this.player.level().getGameRules().getBoolean(GameRules.RULE_ANNOUNCE_ADVANCEMENTS)) {
   ...
   private void registerListeners(AdvancementHolder $$0) {
      ...
      if (!$$1.isDone()) {
         for(Entry<String, Criterion<?>> $$2 : $$0.value().criteria().entrySet()) {
            ...
            if ($$3 != null && !$$3.isDone()) {
               this.registerListener($$0, (String)$$2.getKey(), (Criterion)$$2.getValue());
            }
         }
      }
   }
   ...
   private void unregisterListeners(AdvancementHolder $$0) {
      ...
      for(Entry<String, Criterion<?>> $$2 : $$0.value().criteria().entrySet()) {
         ...
         if ($$3 != null && ($$3.isDone() || $$1.isDone())) {
            this.removeListener($$0, (String)$$2.getKey(), (Criterion)$$2.getValue());
         }
      }
   }
   ...
   public void flushDirty(ServerPlayer $$0, boolean $$1) {
      if (this.isFirstPacket || !this.rootsToUpdate.isEmpty() || !this.progressChanged.isEmpty()) {
         Map<ResourceLocation, AdvancementProgress> $$2 = new HashMap();
         Set<AdvancementHolder> $$3 = new HashSet();
         Set<ResourceLocation> $$4 = new HashSet();
         ...
         for(AdvancementHolder $$6 : this.progressChanged) {
            if (this.visible.contains($$6)) {
               $$2.put($$6.id(), (AdvancementProgress)this.progress.get($$6));
            }
         }
   ...
   public AdvancementProgress getOrStartProgress(AdvancementHolder $$0) {
      AdvancementProgress $$1 = (AdvancementProgress)this.progress.get($$0);
      if ($$1 == null) {
   ...
   static record Data(Map<ResourceLocation, AdvancementProgress> map) {
      ...
      public void forEach(BiConsumer<ResourceLocation, AdvancementProgress> $$0) {
         this.map
            ...
            .forEach($$1 -> $$0.accept((ResourceLocation)$$1.getKey(), (AdvancementProgress)$$1.getValue()));
      }
   }
}
