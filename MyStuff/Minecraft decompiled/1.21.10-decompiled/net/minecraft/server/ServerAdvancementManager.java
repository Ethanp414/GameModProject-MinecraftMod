...
public class ServerAdvancementManager extends SimpleJsonResourceReloadListener<Advancement> {
   ...
   protected void apply(Map<ResourceLocation, Advancement> $$0, ResourceManager $$1, ProfilerFiller $$2) {
      Builder<ResourceLocation, AdvancementHolder> $$3 = ImmutableMap.builder();
      $$0.forEach(($$1x, $$2x) -> {
         this.validate($$1x, $$2x);
   ...
   public AdvancementHolder get(ResourceLocation $$0) {
      return (AdvancementHolder)this.advancements.get($$0);
   }
