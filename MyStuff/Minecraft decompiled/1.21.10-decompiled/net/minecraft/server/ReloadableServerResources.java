...
public class ReloadableServerResources {
   ...
   private ReloadableServerResources(
      ...
      FeatureFlagSet $$2,
      Commands.CommandSelection $$3,
      List<Registry.PendingTags<?>> $$4,
      int $$5
   ) {
   ...
   public static CompletableFuture<ReloadableServerResources> loadResources(
      ResourceManager $$0,
      LayeredRegistryAccess<RegistryLayer> $$1,
      List<Registry.PendingTags<?>> $$2,
      FeatureFlagSet $$3,
      Commands.CommandSelection $$4,
      int $$5,
      Executor $$6,
      Executor $$7
   ) {
      return ReloadableServerRegistries.reload($$1, $$2, $$0, $$6).thenCompose($$7x -> {
         ReloadableServerResources $$8 = new ReloadableServerResources($$7x.layers(), $$7x.lookupWithUpdatedTags(), $$3, $$4, $$2, $$5);
         return SimpleReloadInstance.create($$0, $$8.listeners(), $$6, $$7, DATA_RELOAD_INITIAL_TASK, LOGGER.isDebugEnabled()).done().thenApply($$1xx -> $$8);
      });
   }
