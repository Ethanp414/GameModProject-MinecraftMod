...
public class ServerChunkCache extends ChunkSource {
   ...
   public ServerChunkCache(
      ...
      this.dataStorage = new DimensionDataStorage(new SavedData.Context($$0), $$11, $$2, $$0.registryAccess());
   ...
   public ChunkAccess getChunk(int $$0, int $$1, ChunkStatus $$2, boolean $$3) {
      if (Thread.currentThread() != this.mainThread) {
         return (ChunkAccess)CompletableFuture.supplyAsync(() -> this.getChunk($$0, $$1, $$2, $$3), this.mainThreadProcessor).join();
      } else {
         ...
         ChunkResult<ChunkAccess> $$9 = (ChunkResult)$$8.join();
   ...
   public CompletableFuture<ChunkResult<ChunkAccess>> getChunkFuture(int $$0, int $$1, ChunkStatus $$2, boolean $$3) {
      ...
      if ($$4) {
         ...
         $$5 = CompletableFuture.supplyAsync(() -> this.getChunkFutureMainThread($$0, $$1, $$2, $$3), this.mainThreadProcessor).thenCompose($$0x -> $$0x);
      }
   ...
   public boolean isPositionTicking(long $$0) {
      if (!this.level.shouldTickBlocksAt($$0)) {
         ...
         return $$1 == null ? false : ((ChunkResult)$$1.getTickingChunkFuture().getNow(ChunkHolder.UNLOADED_LEVEL_CHUNK)).isSuccess();
      }
   }
   ...
   private void tickChunks(ProfilerFiller $$0, long $$1) {
      ...
      NaturalSpawner.SpawnState $$3 = NaturalSpawner.createState(
         $$2, this.level.getAllEntities(), this::getFullChunk, new LocalMobCapCalculator(this.chunkMap)
      );
   ...
   private void getFullChunk(long $$0, Consumer<LevelChunk> $$1) {
      ...
      if ($$2 != null) {
         ((ChunkResult)$$2.getFullChunkFuture().getNow(ChunkHolder.UNLOADED_LEVEL_CHUNK)).ifSuccess($$1);
      }
   }
