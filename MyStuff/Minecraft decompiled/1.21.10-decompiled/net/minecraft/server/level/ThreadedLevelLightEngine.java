...
public class ThreadedLevelLightEngine extends LevelLightEngine implements AutoCloseable {
   ...
   public void checkBlock(BlockPos $$0) {
      ...
      this.addTask(
         ...
         Util.name((Runnable)(() -> super.checkBlock($$1)), () -> "checkBlock " + $$1)
      );
   }

   protected void updateChunkStatus(ChunkPos $$0) {
      this.addTask($$0.x, $$0.z, () -> 0, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name((Runnable)(() -> {
   ...
   public void updateSectionStatus(SectionPos $$0, boolean $$1) {
      this.addTask(
         ...
         () -> 0,
         ThreadedLevelLightEngine.TaskType.PRE_UPDATE,
         Util.name((Runnable)(() -> super.updateSectionStatus($$0, $$1)), () -> "updateSectionStatus " + $$0 + " " + $$1)
      );
   }
   ...
   public void propagateLightSources(ChunkPos $$0) {
      this.addTask(
         ...
         $$0.z,
         ThreadedLevelLightEngine.TaskType.PRE_UPDATE,
         Util.name((Runnable)(() -> super.propagateLightSources($$0)), () -> "propagateLight " + $$0)
      );
   }
   ...
   public void setLightEnabled(ChunkPos $$0, boolean $$1) {
      this.addTask(
         ...
         $$0.z,
         ThreadedLevelLightEngine.TaskType.PRE_UPDATE,
         Util.name((Runnable)(() -> super.setLightEnabled($$0, $$1)), () -> "enableLight " + $$0 + " " + $$1)
      );
   }
   ...
   public void queueSectionData(LightLayer $$0, SectionPos $$1, @Nullable DataLayer $$2) {
      this.addTask(
         ...
         () -> 0,
         ThreadedLevelLightEngine.TaskType.PRE_UPDATE,
         Util.name((Runnable)(() -> super.queueSectionData($$0, $$1, $$2)), () -> "queueData " + $$1)
      );
   }
   ...
   public void retainData(ChunkPos $$0, boolean $$1) {
      this.addTask(
         ...
         () -> 0,
         ThreadedLevelLightEngine.TaskType.PRE_UPDATE,
         Util.name((Runnable)(() -> super.retainData($$0, $$1)), () -> "retainData " + $$0)
      );
   }
   ...
   public CompletableFuture<ChunkAccess> initializeLight(ChunkAccess $$0, boolean $$1) {
      ...
      this.addTask($$2.x, $$2.z, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name((Runnable)(() -> {
         LevelChunkSection[] $$2xx = $$0.getSections();

         for(int $$3 = 0; $$3 < $$0.getSectionsCount(); ++$$3) {
            LevelChunkSection $$4 = $$2xx[$$3];
            if (!$$4.hasOnlyAir()) {
   ...
   private void runUpdate() {
      ...
      for($$2 = 0; $$1.hasNext() && $$2 < $$0; ++$$2) {
         Pair<ThreadedLevelLightEngine.TaskType, Runnable> $$3 = (Pair)$$1.next();
      ...
      for(int var5 = 0; $$1.hasNext() && var5 < $$0; ++var5) {
         Pair<ThreadedLevelLightEngine.TaskType, Runnable> $$4 = (Pair)$$1.next();
   ...
   public CompletableFuture<?> waitForPendingTasks(int $$0, int $$1) {
      ...
      }, $$2 -> this.addTask($$0, $$1, ThreadedLevelLightEngine.TaskType.POST_UPDATE, $$2));
   }
