...
public abstract class DistanceManager {
   ...
   public boolean runAllUpdates(ChunkMap $$0) {
      ...
      if (!this.chunksToUpdateFutures.isEmpty()) {
         ...
         if (!this.ticketsToRelease.isEmpty()) {
            ...
            while($$5.hasNext()) {
               long $$6 = $$5.nextLong();
               if (this.ticketStorage.getTickets($$6).stream().anyMatch($$0x -> $$0x.getType() == TicketType.PLAYER_LOADING)) {
                  ...
                  $$8.thenAccept($$1x -> this.mainThreadExecutor.execute(() -> this.ticketDispatcher.release($$6, () -> {
                        }, false)));
               }
            }
   ...
   public void addPlayer(SectionPos $$0, ServerPlayer $$1) {
      ChunkPos $$2 = $$0.chunk();
      long $$3 = $$2.toLong();
      this.playersPerChunk.computeIfAbsent($$3, (Long2ObjectFunction<? extends ObjectOpenHashSet<ServerPlayer>>)($$0x -> new ObjectOpenHashSet())).add($$1);
   ...
   public void removePlayer(SectionPos $$0, ServerPlayer $$1) {
      ChunkPos $$2 = $$0.chunk();
      long $$3 = $$2.toLong();
      ObjectSet<ServerPlayer> $$4 = this.playersPerChunk.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
   ...
   public int getChunkLevel(long $$0, boolean $$1) {
      return $$1 ? this.simulationChunkTracker.getLevel($$0) : this.loadingChunkTracker.getLevel($$0);
   }
   ...
   public TriState hasPlayersNearby(long $$0) {
      ...
      if ($$1 <= NaturalSpawner.INSCRIBED_SQUARE_SPAWN_DISTANCE_CHUNK) {
         ...
         return $$1 > 8 ? TriState.FALSE : TriState.DEFAULT;
      }
   }

   public void forEachEntityTickingChunk(LongConsumer $$0) {
      for(Entry $$1 : Long2ByteMaps.fastIterable(this.simulationChunkTracker.chunks)) {
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      ...
      protected void setLevel(long $$0, int $$1) {
         ...
         if ($$1 > this.maxDistance) {
            $$2 = this.chunks.remove($$0);
         } else {
            $$2 = this.chunks.put($$0, (byte)$$1);
         }

         this.onLevelChange($$0, $$2, $$1);
      }
      ...
      private boolean havePlayer(long $$0) {
         ObjectSet<ServerPlayer> $$1 = DistanceManager.this.playersPerChunk.get($$0);
   ...
   class PlayerTicketTracker extends DistanceManager.FixedPlayerDistanceChunkTracker {
      ...
      public void updateViewDistance(int $$0) {
         for(Entry $$1 : this.chunks.long2ByteEntrySet()) {
            byte $$2 = $$1.getByteValue();
            long $$3 = $$1.getLongKey();
         ...
         if ($$2 != $$3) {
            ...
            if ($$3) {
               ...
               DistanceManager.this.ticketDispatcher
                  .release($$0, () -> DistanceManager.this.mainThreadExecutor.execute(() -> DistanceManager.this.ticketStorage.removeTicket($$0, $$4)), true);
            }
         }
      }
      ...
      public void runAllUpdates() {
         ...
         if (!this.toUpdate.isEmpty()) {
            ...
            while($$0.hasNext()) {
               ...
               int $$3 = this.getLevel($$1);
               if ($$2 != $$3) {
                  DistanceManager.this.ticketDispatcher.onLevelChange(new ChunkPos($$1), () -> this.queueLevels.get($$1), $$3, $$1x -> {
                     if ($$1x >= this.queueLevels.defaultReturnValue()) {
                        this.queueLevels.remove($$1);
                     } else {
                        this.queueLevels.put($$1, $$1x);
                     }
                  });
