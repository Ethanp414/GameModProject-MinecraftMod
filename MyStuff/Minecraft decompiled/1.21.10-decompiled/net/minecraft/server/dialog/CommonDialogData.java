...
public record CommonDialogData(
   ...
   public static final MapCodec<CommonDialogData> MAP_CODEC = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("can_close_with_escape", Boolean.valueOf(true)).forGetter(CommonDialogData::canCloseWithEscape),
                  Codec.BOOL.optionalFieldOf("pause", Boolean.valueOf(true)).forGetter(CommonDialogData::pause),
               ...
               .apply($$0, CommonDialogData::new)
      )
      .validate(
         $$0 -> $$0.pause && !$$0.afterAction.willUnpause()
