...
public record PlainMessage(Component contents, int width) implements DialogBody {
   ...
   public static final MapCodec<PlainMessage> MAP_CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
            ...
            .apply($$0, PlainMessage::new)
   );
   public static final Codec<PlainMessage> CODEC = Codec.withAlternative(MAP_CODEC.codec(), ComponentSerialization.CODEC, $$0 -> new PlainMessage($$0, 200));
