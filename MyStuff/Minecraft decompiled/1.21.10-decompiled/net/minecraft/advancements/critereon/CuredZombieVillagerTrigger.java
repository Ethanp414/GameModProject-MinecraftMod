...
public class CuredZombieVillagerTrigger extends SimpleCriterionTrigger<CuredZombieVillagerTrigger.TriggerInstance> {
   ...
   public static record TriggerInstance(
      ...
      public boolean matches(LootContext $$0, LootContext $$1) {
         if (this.zombie.isPresent() && !((ContextAwarePredicate)this.zombie.get()).matches($$0)) {
            return false;
         } else {
            return !this.villager.isPresent() || ((ContextAwarePredicate)this.villager.get()).matches($$1);
         }
      }
