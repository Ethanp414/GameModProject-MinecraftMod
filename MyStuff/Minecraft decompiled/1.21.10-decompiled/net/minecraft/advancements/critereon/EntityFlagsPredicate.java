   ...
   public boolean matches(Entity $$0) {
      if (this.isOnGround.isPresent() && $$0.onGround() != this.isOnGround.get()) {
         ...
         if (this.isFlying.isPresent()) {
            boolean var10000;
            label53: {
               if ($$0 instanceof LivingEntity $$1 && ($$1.isFallFlying() || $$1 instanceof Player $$2 && $$2.getAbilities().flying)) {
                  var10000 = true;
                  break label53;
               }
         ...
         if (this.isBaby.isPresent() && $$0 instanceof LivingEntity $$4 && $$4.isBaby() != this.isBaby.get()) {
            return false;
         }
