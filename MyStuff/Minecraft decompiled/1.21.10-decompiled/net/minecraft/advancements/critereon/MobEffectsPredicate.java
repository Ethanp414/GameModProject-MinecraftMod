...
public record MobEffectsPredicate(Map<Holder<MobEffect>, MobEffectsPredicate.MobEffectInstancePredicate> effectMap) {
   ...
   public boolean matches(Entity $$0) {
      if ($$0 instanceof LivingEntity $$1 && this.matches($$1.getActiveEffectsMap())) {
         return true;
      }
   ...
   public static record MobEffectInstancePredicate(
      ...
      public boolean matches(@Nullable MobEffectInstance $$0) {
         if ($$0 == null) {
            ...
            return false;
         } else if (this.ambient.isPresent() && this.ambient.get() != $$0.isAmbient()) {
            return false;
         } else {
            return !this.visible.isPresent() || this.visible.get() == $$0.isVisible();
         }
      }
   }
}
