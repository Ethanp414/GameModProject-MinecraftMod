...
public class InventoryChangeTrigger extends SimpleCriterionTrigger<InventoryChangeTrigger.TriggerInstance> {
   ...
   public static record TriggerInstance(Optional<ContextAwarePredicate> player, InventoryChangeTrigger.TriggerInstance.Slots slots, List<ItemPredicate> items)
      ...
      public static Criterion<InventoryChangeTrigger.TriggerInstance> hasItems(ItemPredicate.Builder... $$0) {
         return hasItems((ItemPredicate[])Stream.of($$0).map(ItemPredicate.Builder::build).toArray($$0x -> new ItemPredicate[$$0x]));
      }

      public static Criterion<InventoryChangeTrigger.TriggerInstance> hasItems(ItemPredicate... $$0) {
      ...
      public static Criterion<InventoryChangeTrigger.TriggerInstance> hasItems(ItemLike... $$0) {
         ItemPredicate[] $$1 = new ItemPredicate[$$0.length];

         for(int $$2 = 0; $$2 < $$0.length; ++$$2) {
            $$1[$$2] = new ItemPredicate(
               Optional.of(HolderSet.direct($$0[$$2].asItem().builtInRegistryHolder())), MinMaxBounds.Ints.ANY, DataComponentMatchers.ANY
            );
         }
      ...
      public boolean matches(Inventory $$0, ItemStack $$1, int $$2, int $$3, int $$4) {
         if (!this.slots.matches($$2, $$3, $$4)) {
            ...
            return !$$1.isEmpty() && ((ItemPredicate)this.items.get(0)).test($$1);
         }
      }
