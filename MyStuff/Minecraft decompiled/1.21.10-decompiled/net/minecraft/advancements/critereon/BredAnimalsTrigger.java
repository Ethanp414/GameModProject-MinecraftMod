...
public class BredAnimalsTrigger extends SimpleCriterionTrigger<BredAnimalsTrigger.TriggerInstance> {
   ...
   public static record TriggerInstance(
      ...
      public static Criterion<BredAnimalsTrigger.TriggerInstance> bredAnimals(EntityPredicate.Builder $$0) {
         return CriteriaTriggers.BRED_ANIMALS
            .createCriterion(
      ...
      public boolean matches(LootContext $$0, LootContext $$1, @Nullable LootContext $$2) {
         if (!this.child.isPresent() || $$2 != null && ((ContextAwarePredicate)this.child.get()).matches($$2)) {
            return matches(this.parent, $$0) && matches(this.partner, $$1) || matches(this.parent, $$1) && matches(this.partner, $$0);
         } else {
            return false;
         }
      }
      ...
      private static boolean matches(Optional<ContextAwarePredicate> $$0, LootContext $$1) {
         return $$0.isEmpty() || ((ContextAwarePredicate)$$0.get()).matches($$1);
      }
