...
public abstract class VoxelShape {
   ...
   public VoxelShape move(Vec3i $$0) {
      return this.move((double)$$0.getX(), (double)$$0.getY(), (double)$$0.getZ());
   }
   ...
   public VoxelShape move(double $$0, double $$1, double $$2) {
      return (VoxelShape)(this.isEmpty()
         ...
         : new ArrayVoxelShape(
            this.shape,
            new OffsetDoubleList(this.getCoords(Direction.Axis.X), $$0),
            new OffsetDoubleList(this.getCoords(Direction.Axis.Y), $$1),
            new OffsetDoubleList(this.getCoords(Direction.Axis.Z), $$2)
         ));
   }
      ...
      this.shape
         .forAllEdges(
            ($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.consume(
                  this.get(Direction.Axis.X, $$1),
                  this.get(Direction.Axis.Y, $$2),
                  this.get(Direction.Axis.Z, $$3),
                  this.get(Direction.Axis.X, $$4),
                  this.get(Direction.Axis.Y, $$5),
                  this.get(Direction.Axis.Z, $$6)
               ),
            true
         );
   }
   ...
   public List<AABB> toAabbs() {
      List<AABB> $$0 = Lists.<AABB>newArrayList();
   ...
   public BlockHitResult clip(Vec3 $$0, Vec3 $$1, BlockPos $$2) {
      if (this.isEmpty()) {
         ...
         if ($$3.lengthSqr() < 1.0E-7) {
            ...
            return this.shape
                  .isFullWide(
                     this.findIndex(Direction.Axis.X, $$4.x - (double)$$2.getX()),
                     this.findIndex(Direction.Axis.Y, $$4.y - (double)$$2.getY()),
                     this.findIndex(Direction.Axis.Z, $$4.z - (double)$$2.getZ())
                  )
               ? new BlockHitResult($$4, Direction.getApproximateNearest($$3.x, $$3.y, $$3.z).getOpposite(), $$2, true)
               : AABB.clip(this.toAabbs(), $$0, $$1, $$2);
         }
      }
   }
