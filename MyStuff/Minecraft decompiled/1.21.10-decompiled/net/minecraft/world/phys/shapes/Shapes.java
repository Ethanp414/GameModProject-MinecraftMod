...
public final class Shapes {
   ...
   public static VoxelShape or(VoxelShape $$0, VoxelShape... $$1) {
      return (VoxelShape)Arrays.stream($$1).reduce($$0, Shapes::or);
   }
   ...
   public static VoxelShape joinUnoptimized(VoxelShape $$0, VoxelShape $$1, BooleanOp $$2) {
      if ($$2.apply(false, false)) {
         ...
         if ($$0.isEmpty()) {
            ...
            IndexMerger $$5 = createIndexMerger(1, $$0.getCoords(Direction.Axis.X), $$1.getCoords(Direction.Axis.X), $$3, $$4);
            IndexMerger $$6 = createIndexMerger($$5.size() - 1, $$0.getCoords(Direction.Axis.Y), $$1.getCoords(Direction.Axis.Y), $$3, $$4);
            IndexMerger $$7 = createIndexMerger(
               ($$5.size() - 1) * ($$6.size() - 1), $$0.getCoords(Direction.Axis.Z), $$1.getCoords(Direction.Axis.Z), $$3, $$4
            );
      ...
      if ($$2.apply(false, false)) {
         ...
         if (!$$3 && !$$4) {
            if ($$0 == $$1) {
               ...
               IndexMerger $$8 = createIndexMerger(1, $$0.getCoords(Direction.Axis.X), $$1.getCoords(Direction.Axis.X), $$5, $$6);
               IndexMerger $$9 = createIndexMerger($$8.size() - 1, $$0.getCoords(Direction.Axis.Y), $$1.getCoords(Direction.Axis.Y), $$5, $$6);
               IndexMerger $$10 = createIndexMerger(
                  ($$8.size() - 1) * ($$9.size() - 1), $$0.getCoords(Direction.Axis.Z), $$1.getCoords(Direction.Axis.Z), $$5, $$6
               );
   ...
   public static boolean faceShapeOccludes(VoxelShape $$0, VoxelShape $$1) {
      if ($$0 == block() || $$1 == block()) {
         ...
         return !joinIsNotEmpty(block(), joinUnoptimized($$0, $$1, BooleanOp.OR), BooleanOp.ONLY_FIRST);
      }
   }
   ...
   public static VoxelShape rotate(VoxelShape $$0, OctahedralGroup $$1, Vec3 $$2) {
      if ($$1 == OctahedralGroup.IDENTITY) {
         ...
         if ($$0 instanceof CubeVoxelShape && BLOCK_CENTER.equals($$2)) {
            ...
            return new ArrayVoxelShape(
               $$3, makeAxis($$7, $$13, $$2.get($$4), $$2.x), makeAxis($$8, $$14, $$2.get($$5), $$2.y), makeAxis($$9, $$15, $$2.get($$6), $$2.z)
            );
         }
      }
   }
   ...
   public static Map<Direction.Axis, VoxelShape> rotateHorizontalAxis(VoxelShape $$0, Vec3 $$1) {
      return Maps.newEnumMap(Map.of(Direction.Axis.Z, $$0, Direction.Axis.X, rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R90), $$1)));
   }
   ...
   public static Map<Direction.Axis, VoxelShape> rotateAllAxis(VoxelShape $$0, Vec3 $$1) {
      return Maps.newEnumMap(
         Map.of(
            ...
            $$0,
            Direction.Axis.X,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R90), $$1),
            Direction.Axis.Y,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R90, Quadrant.R0), $$1)
         )
      );
   }

   public static Map<Direction, VoxelShape> rotateHorizontal(VoxelShape $$0) {
      return rotateHorizontal($$0, BLOCK_CENTER);
   }
   ...
   public static Map<Direction, VoxelShape> rotateHorizontal(VoxelShape $$0, Vec3 $$1) {
      return Maps.newEnumMap(
         Map.of(
            ...
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R90), $$1),
            Direction.SOUTH,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R180), $$1),
            Direction.WEST,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R270), $$1)
         )
      );
   }

   public static Map<Direction, VoxelShape> rotateAll(VoxelShape $$0) {
      return rotateAll($$0, BLOCK_CENTER);
   }
   ...
   public static Map<Direction, VoxelShape> rotateAll(VoxelShape $$0, Vec3 $$1) {
      return Maps.newEnumMap(
         Map.of(
            ...
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R0, Quadrant.R270), $$1),
            Direction.UP,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R270, Quadrant.R0), $$1),
            Direction.DOWN,
            rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R90, Quadrant.R0), $$1)
         )
      );
   ...
   public static Map<AttachFace, Map<Direction, VoxelShape>> rotateAttachFace(VoxelShape $$0) {
      return Map.of(
         ...
         rotateHorizontal($$0),
         AttachFace.FLOOR,
         rotateHorizontal(rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R270, Quadrant.R0))),
         AttachFace.CEILING,
         rotateHorizontal(rotate($$0, OctahedralGroup.fromXYAngles(Quadrant.R90, Quadrant.R180)))
      );
   }
