...
public final class BitSetDiscreteVoxelShape extends DiscreteVoxelShape {
   ...
   static BitSetDiscreteVoxelShape join(DiscreteVoxelShape $$0, DiscreteVoxelShape $$1, IndexMerger $$2, IndexMerger $$3, IndexMerger $$4, BooleanOp $$5) {
      ...
      $$2.forMergedIndexes(($$7x, $$8, $$9) -> {
         boolean[] $$10 = new boolean[]{false};
         $$3.forMergedIndexes(($$10x, $$11, $$12) -> {
            boolean[] $$13 = new boolean[]{false};
            $$4.forMergedIndexes(($$12x, $$13x, $$14) -> {
               if ($$5.apply($$0.isFullWide($$7x, $$10x, $$12x), $$1.isFullWide($$8, $$11, $$13x))) {
