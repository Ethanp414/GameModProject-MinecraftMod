...
public class SpawnPlacements {
   ...
   private static <T extends Mob> void register(EntityType<T> $$0, SpawnPlacementType $$1, Heightmap.Types $$2, SpawnPlacements.SpawnPredicate<T> $$3) {
      SpawnPlacements.Data $$4 = (SpawnPlacements.Data)DATA_BY_TYPE.put($$0, new SpawnPlacements.Data($$2, $$1, $$3));
      if ($$4 != null) {
   ...
   public static SpawnPlacementType getPlacementType(EntityType<?> $$0) {
      SpawnPlacements.Data $$1 = (SpawnPlacements.Data)DATA_BY_TYPE.get($$0);
   ...
   public static <T extends Entity> boolean checkSpawnRules(EntityType<T> $$0, ServerLevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      SpawnPlacements.Data $$5 = (SpawnPlacements.Data)DATA_BY_TYPE.get($$0);
