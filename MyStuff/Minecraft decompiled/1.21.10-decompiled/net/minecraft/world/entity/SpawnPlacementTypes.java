...
public interface SpawnPlacementTypes {
   SpawnPlacementType NO_RESTRICTIONS = ($$0, $$1, $$2) -> true;
   SpawnPlacementType IN_WATER = ($$0, $$1, $$2) -> {
   ...
   SpawnPlacementType IN_LAVA = ($$0, $$1, $$2) -> $$2 != null && $$0.getWorldBorder().isWithinBounds($$1) ? $$0.getFluidState($$1).is(FluidTags.LAVA) : false;
