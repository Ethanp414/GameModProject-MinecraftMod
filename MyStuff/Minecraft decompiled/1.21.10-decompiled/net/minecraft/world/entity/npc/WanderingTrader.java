...
public class WanderingTrader extends AbstractVillager implements Consumable.OverrideConsumeSound {
      ...
      this.goalSelector
         .addGoal(
            ...
            new UseItemGoal<>(
               ...
               $$0 -> this.level().isDarkOutside() && !$$0.isInvisible()
            )
         );
      this.goalSelector
         .addGoal(
            0,
            new UseItemGoal<>(
               this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, $$0 -> this.level().isBrightOutside() && $$0.isInvisible()
            )
         );
   ...
   protected void updateTrades() {
      ...
      for(Pair<VillagerTrades.ItemListing[], Integer> $$1 : VillagerTrades.WANDERING_TRADER_TRADES) {
         VillagerTrades.ItemListing[] $$2 = (VillagerTrades.ItemListing[])$$1.getLeft();
         this.addOffersFromItemListings($$0, $$2, $$1.getRight());
      }
   }
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.wanderTarget = (BlockPos)$$0.read("wander_target", BlockPos.CODEC).orElse(null);
   ...
   public SoundEvent getConsumeSound(ItemStack $$0) {
      return $$0.is(Items.MILK_BUCKET) ? SoundEvents.WANDERING_TRADER_DRINK_MILK : SoundEvents.WANDERING_TRADER_DRINK_POTION;
   }
      ...
      public void tick() {
         ...
         if ($$0 != null && WanderingTrader.this.navigation.isDone()) {
            if (this.isTooFarAway($$0, 10.0)) {
               Vec3 $$1 = new Vec3((double)$$0.getX() - this.trader.getX(), (double)$$0.getY() - this.trader.getY(), (double)$$0.getZ() - this.trader.getZ())
                  .normalize();
               ...
               WanderingTrader.this.navigation.moveTo((double)$$0.getX(), (double)$$0.getY(), (double)$$0.getZ(), this.speedModifier);
            }
         }
      }
