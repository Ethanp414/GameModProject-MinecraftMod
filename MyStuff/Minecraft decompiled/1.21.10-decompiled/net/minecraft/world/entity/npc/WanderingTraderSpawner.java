...
public class WanderingTraderSpawner implements CustomSpawner {
   ...
   private boolean spawn(ServerLevel $$0) {
      ...
      if ($$1 == null) {
         ...
         if ($$7 != null && this.hasEnoughSpace($$0, $$7)) {
            ...
            WanderingTrader $$8 = EntityType.WANDERING_TRADER.spawn($$0, $$7, EntitySpawnReason.EVENT);
            if ($$8 != null) {
               for(int $$9 = 0; $$9 < 2; ++$$9) {
   ...
   private BlockPos findSpawnPositionNear(LevelReader $$0, BlockPos $$1, int $$2) {
      ...
      for(int $$5 = 0; $$5 < 10; ++$$5) {
         ...
         int $$8 = $$0.getHeight(Heightmap.Types.WORLD_SURFACE, $$6, $$7);
         BlockPos $$9 = new BlockPos($$6, $$8, $$7);
         if ($$4.isSpawnPositionOk($$0, $$9, EntityType.WANDERING_TRADER)) {
            $$3 = $$9;
            break;
         }
      }
