...
public enum Relative {
   ...
   public static Set<Relative> union(Set<Relative>... $$0) {
      HashSet<Relative> $$1 = new HashSet();
   ...
   public static Set<Relative> rotation(boolean $$0, boolean $$1) {
      Set<Relative> $$2 = EnumSet.noneOf(Relative.class);
      if ($$0) {
         $$2.add(Y_ROT);
      }
   ...
   public static Set<Relative> position(boolean $$0, boolean $$1, boolean $$2) {
      Set<Relative> $$3 = EnumSet.noneOf(Relative.class);
      if ($$0) {
         $$3.add(X);
      }
   ...
   public static Set<Relative> unpack(int $$0) {
      Set<Relative> $$1 = EnumSet.noneOf(Relative.class);

      for(Relative $$2 : values()) {
         if ($$2.isSet($$0)) {
            $$1.add($$2);
         }
      }
