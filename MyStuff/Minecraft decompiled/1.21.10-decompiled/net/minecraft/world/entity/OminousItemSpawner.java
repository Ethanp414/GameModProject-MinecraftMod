...
public class OminousItemSpawner extends Entity {
   ...
   public static OminousItemSpawner create(Level $$0, ItemStack $$1) {
      OminousItemSpawner $$2 = new OminousItemSpawner(EntityType.OMINOUS_ITEM_SPAWNER, $$0);
      $$2.spawnItemAfterTicks = (long)$$0.random.nextIntBetweenInclusive(60, 120);
      $$2.setItem($$1);
      return $$2;
   }
   ...
   private void spawnItem() {
      ...
      if ($$2 instanceof ServerLevel $$0) {
         ItemStack $$2x = this.getItem();
         if (!$$2x.isEmpty()) {
            Item var5 = $$2x.getItem();
            Entity $$4;
            if (var5 instanceof ProjectileItem $$3) {
               $$4 = this.spawnProjectile($$0, $$3, $$2x);
            } else {
               $$4 = new ItemEntity($$0, this.getX(), this.getY(), this.getZ(), $$2x);
               $$0.addFreshEntity($$4);
            }
   ...
   private Entity spawnProjectile(ServerLevel $$0, ProjectileItem $$1, ItemStack $$2) {
      ProjectileItem.DispenseConfig $$3 = $$1.createDispenseConfig();
      ...
      Projectile $$5 = Projectile.spawnProjectileUsingShoot(
         $$1.asProjectile($$0, this.position(), $$2, $$4),
         $$0,
         $$2,
         (double)$$4.getStepX(),
         (double)$$4.getStepY(),
