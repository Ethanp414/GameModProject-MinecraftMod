...
public abstract class AgeableMob extends PathfinderMob {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      if ($$3 == null) {
         $$3 = new AgeableMob.AgeableMobGroupData(true);
      }

      AgeableMob.AgeableMobGroupData $$4 = (AgeableMob.AgeableMobGroupData)$$3;
      if ($$4.isShouldSpawnBaby() && $$4.getGroupSize() > 0 && $$0.getRandom().nextFloat() <= $$4.getBabySpawnChance()) {
         this.setAge(-24000);
      }
   ...
   protected void ageBoundaryReached() {
      if (!this.isBaby() && this.isPassenger()) {
         ...
         if (var2 instanceof AbstractBoat $$0 && !$$0.hasEnoughSpaceFor(this)) {
            this.stopRiding();
         }
      }
   }
