...
public class Silverfish extends Monster {
   ...
   public static boolean checkSilverfishSpawnRules(EntityType<Silverfish> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      if (!checkAnyLightMonsterSpawnRules($$0, $$1, $$2, $$3, $$4)) {
         return false;
      } else if (EntitySpawnReason.isSpawner($$2)) {
         return true;
      } else {
   ...
   static class SilverfishMergeWithStoneGoal extends RandomStrollGoal {
      ...
      public boolean canUse() {
         if (this.mob.getTarget() != null) {
            ...
            if (getServerLevel(this.mob).getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && $$0.nextInt(reducedTickDelay(10)) == 0) {
               ...
               for(int $$4 = 0; $$4 <= 10 && $$4 >= -10; $$4 = ($$4 <= 0 ? 1 : 0) - $$4) {
                  for(int $$5 = 0; $$5 <= 10 && $$5 >= -10; $$5 = ($$5 <= 0 ? 1 : 0) - $$5) {
                     ...
                     if ($$8 instanceof InfestedBlock) {
                        if (getServerLevel($$0).getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
