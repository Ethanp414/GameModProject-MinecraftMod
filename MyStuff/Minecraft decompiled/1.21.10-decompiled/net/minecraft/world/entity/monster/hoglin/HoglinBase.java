...
public interface HoglinBase {
   ...
   static boolean hurtAndThrowTarget(ServerLevel $$0, LivingEntity $$1, LivingEntity $$2) {
      float $$3 = (float)$$1.getAttributeValue(Attributes.ATTACK_DAMAGE);
      float $$4;
      if (!$$1.isBaby() && (int)$$3 > 0) {
         $$4 = $$3 / 2.0F + (float)$$0.random.nextInt((int)$$3);
      } else {
         $$4 = $$3;
      }
   ...
   static void throwTarget(LivingEntity $$0, LivingEntity $$1) {
      ...
      if (!($$4 <= 0.0)) {
         ...
         float $$7 = (float)($$0.level().random.nextInt(21) - 10);
