...
public class Phantom extends Mob implements Enemy {
   ...
   public void tick() {
      ...
      if (this.level().isClientSide()) {
         float $$0 = Mth.cos((float)(this.getUniqueFlapTickOffset() + this.tickCount) * 7.448451F * (float) (Math.PI / 180.0) + (float) Math.PI);
         float $$1 = Mth.cos((float)(this.getUniqueFlapTickOffset() + this.tickCount + 1) * 7.448451F * (float) (Math.PI / 180.0) + (float) Math.PI);
         if ($$0 > 0.0F && $$1 <= 0.0F) {
            this.level()
               .playLocalSound(
                  this.getX(),
         ...
         float $$3 = Mth.cos(this.getYRot() * (float) (Math.PI / 180.0)) * $$2;
         float $$4 = Mth.sin(this.getYRot() * (float) (Math.PI / 180.0)) * $$2;
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.anchorPoint = (BlockPos)$$0.read("anchor_pos", BlockPos.CODEC).orElse(null);
   ...
   class PhantomAttackPlayerTargetGoal extends Goal {
      ...
      public boolean canUse() {
         if (this.nextScanTick > 0) {
            ...
            ServerLevel $$0 = getServerLevel(Phantom.this.level());
            ...
            if (!$$1.isEmpty()) {
               ...
               for(Player $$2 : $$1) {
                  if (Phantom.this.canAttack($$0, $$2, TargetingConditions.DEFAULT)) {
      ...
      public boolean canContinueToUse() {
         ...
         return $$0 != null ? Phantom.this.canAttack(getServerLevel(Phantom.this.level()), $$0, TargetingConditions.DEFAULT) : false;
      }
   }
      ...
      public void tick() {
         ...
         if ($$0 != null) {
            ...
            if (Phantom.this.getBoundingBox().inflate(0.2F).intersects($$0.getBoundingBox())) {
               Phantom.this.doHurtTarget(getServerLevel(Phantom.this.level()), $$0);
               Phantom.this.attackPhase = Phantom.AttackPhase.CIRCLE;
