...
public class Spider extends Monster {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      ...
      if ($$4.nextInt(100) == 0) {
         Skeleton $$5 = EntityType.SKELETON.create(this.level(), EntitySpawnReason.JOCKEY);
         if ($$5 != null) {
   ...
   public Vec3 getVehicleAttachmentPoint(Entity $$0) {
      return $$0.getBbWidth() <= this.getBbWidth() ? new Vec3(0.0, 0.3125 * (double)this.getScale(), 0.0) : super.getVehicleAttachmentPoint($$0);
   }
