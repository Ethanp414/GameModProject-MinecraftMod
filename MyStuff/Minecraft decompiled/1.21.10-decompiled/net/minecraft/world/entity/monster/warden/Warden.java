...
public class Warden extends Monster implements VibrationSystem {
   ...
   public Packet<ClientGamePacketListener> getAddEntityPacket(ServerEntity $$0) {
      return new ClientboundAddEntityPacket(this, $$0, this.hasPose(Pose.EMERGING) ? 1 : 0);
   }
   ...
   public boolean isInvulnerableTo(ServerLevel $$0, DamageSource $$1) {
      return this.isDiggingOrEmerging() && !$$1.is(DamageTypeTags.BYPASSES_INVULNERABILITY) ? true : super.isInvulnerableTo($$0, $$1);
   }
   ...
   public float getTendrilAnimation(float $$0) {
      return Mth.lerp($$0, (float)this.tendrilAnimationO, (float)this.tendrilAnimation) / 10.0F;
   }

   public float getHeartAnimation(float $$0) {
      return Mth.lerp($$0, (float)this.heartAnimationO, (float)this.heartAnimation) / 10.0F;
   }

   private void clientDiggingParticles(AnimationState $$0) {
      if ((float)$$0.getTimeInMillis((float)this.tickCount) < 4500.0F) {
   ...
   public boolean canTargetEntity(@Nullable Entity $$0) {
      if ($$0 instanceof LivingEntity $$1
         && this.level() == $$0.level()
         && EntitySelector.NO_CREATIVE_OR_SPECTATOR.test($$0)
         && !this.isAlliedTo($$0)
         && $$1.getType() != EntityType.ARMOR_STAND
         && $$1.getType() != EntityType.WARDEN
         && !$$1.isInvulnerable()
         && !$$1.isDeadOrDying()
   ...
   public static void applyDarknessAround(ServerLevel $$0, Vec3 $$1, @Nullable Entity $$2, int $$3) {
      ...
      MobEffectUtil.addEffectToPlayersAround($$0, $$2, $$1, (double)$$3, $$4, 200);
   }
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.angerManagement = (AngerManagement)$$0.read("anger", AngerManagement.codec(this::canTargetEntity))
         .orElseGet(() -> new AngerManagement(this::canTargetEntity, Collections.emptyList()));
      this.syncClientAngerLevel();
      this.vibrationData = (VibrationSystem.Data)$$0.read("listener", VibrationSystem.Data.CODEC).orElseGet(VibrationSystem.Data::new);
   }
   ...
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      ...
      if (!this.isNoAi() && !this.isDiggingOrEmerging()) {
         ...
         if (this.brain.getMemory(MemoryModuleType.ATTACK_TARGET).isEmpty()
            && $$4 instanceof LivingEntity $$5
            && ($$1.isDirect() || this.closerThan($$5, 5.0))) {
   ...
   class VibrationUser implements VibrationSystem.User {
      ...
      public boolean canReceiveVibration(ServerLevel $$0, BlockPos $$1, Holder<GameEvent> $$2, GameEvent.Context $$3) {
         if (!Warden.this.isNoAi()
            ...
            && $$0.getWorldBorder().isWithinBounds($$1)) {
            Entity var6 = $$3.sourceEntity();
            if (var6 instanceof LivingEntity $$4 && !Warden.this.canTargetEntity($$4)) {
               return false;
            }
