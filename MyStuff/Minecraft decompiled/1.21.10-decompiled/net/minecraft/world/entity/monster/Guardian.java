...
public class Guardian extends Monster {
   ...
   public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      return ($$4.nextInt(20) == 0 || !$$1.canSeeSkyFromBelowWater($$3))
         ...
         && (EntitySpawnReason.isSpawner($$2) || $$1.getFluidState($$3).is(FluidTags.WATER))
         && $$1.getFluidState($$3.below()).is(FluidTags.WATER);
   }

   @Override
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      if (!this.isMoving() && !$$1.is(DamageTypeTags.AVOIDS_GUARDIAN_THORNS) && !$$1.is(DamageTypes.THORNS)) {
         Entity var5 = $$1.getDirectEntity();
         if (var5 instanceof LivingEntity $$3) {
   ...
   static class GuardianMoveControl extends MoveControl {
      ...
      public void tick() {
         if (this.operation == MoveControl.Operation.MOVE_TO && !this.guardian.getNavigation().isDone()) {
            ...
            double $$9 = Math.cos((double)(this.guardian.getYRot() * (float) (Math.PI / 180.0)));
            double $$10 = Math.sin((double)(this.guardian.getYRot() * (float) (Math.PI / 180.0)));
