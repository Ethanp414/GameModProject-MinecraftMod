...
public class HoglinAi {
   ...
   protected static void onHitTarget(Hoglin $$0, LivingEntity $$1) {
      if (!$$0.isBaby()) {
         if ($$1.getType() == EntityType.PIGLIN && piglinsOutnumberHoglins($$0)) {
            setAvoidTarget($$0, $$1);
   ...
   private static void retreatFromNearestTarget(Hoglin $$0, LivingEntity $$1) {
      ...
      LivingEntity $$2 = BehaviorUtils.getNearestTarget($$0, $$3.getMemory(MemoryModuleType.AVOID_TARGET), $$1);
   ...
   private static List<Hoglin> getVisibleAdultHoglins(Hoglin $$0) {
      return (List<Hoglin>)$$0.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_ADULT_HOGLINS).orElse(ImmutableList.of());
   }
