...
public abstract class Monster extends PathfinderMob implements Enemy {
   ...
   public static boolean checkMonsterSpawnRules(
      EntityType<? extends Monster> $$0, ServerLevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
      return $$1.getDifficulty() != Difficulty.PEACEFUL
         && (EntitySpawnReason.ignoresLightRequirements($$2) || isDarkEnoughToSpawn($$1, $$3, $$4))
         && checkMobSpawnRules($$0, $$1, $$2, $$3, $$4);
   }

   public static boolean checkAnyLightMonsterSpawnRules(
      EntityType<? extends Monster> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
      return $$1.getDifficulty() != Difficulty.PEACEFUL && checkMobSpawnRules($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected boolean shouldDropLoot(ServerLevel $$0) {
      return $$0.getGameRules().getBoolean(GameRules.RULE_DOMOBLOOT);
   }
