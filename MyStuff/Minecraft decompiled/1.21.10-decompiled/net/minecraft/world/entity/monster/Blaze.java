...
public class Blaze extends Monster {
   ...
   protected void customServerAiStep(ServerLevel $$0) {
      ...
      if ($$1 != null && $$1.getEyeY() > this.getEyeY() + (double)this.allowedHeightOffset && this.canAttack($$1)) {
         Vec3 $$2 = this.getDeltaMovement();
         this.setDeltaMovement(this.getDeltaMovement().add(0.0, (0.3F - $$2.y) * 0.3F, 0.0));
         ...
         if ($$0 != null) {
            ...
            if ($$2 < 4.0) {
               ...
               if (this.attackTime <= 0) {
                  this.attackTime = 20;
                  this.blaze.doHurtTarget(getServerLevel(this.blaze), $$0);
               }
