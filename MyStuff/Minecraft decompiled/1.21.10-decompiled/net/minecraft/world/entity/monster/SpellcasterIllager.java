...
public abstract class SpellcasterIllager extends AbstractIllager {
   ...
   public void setIsCastingSpell(SpellcasterIllager.IllagerSpell $$0) {
      this.currentSpell = $$0;
   ...
   public void tick() {
      ...
      if (this.level().isClientSide() && this.isCastingSpell()) {
         ...
         float $$4 = this.yBodyRot * (float) (Math.PI / 180.0) + Mth.cos((float)this.tickCount * 0.6662F) * 0.25F;
         float $$5 = Mth.cos($$4);
         float $$6 = Mth.sin($$4);
         ...
         this.level()
            .addParticle(
               ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, $$1, $$2, $$3),
               this.getX() + (double)$$5 * $$7,
               this.getY() + $$8,
               this.getZ() + (double)$$6 * $$7,
               0.0,
               0.0,
               0.0
            );
   ...
   protected static enum IllagerSpell {
      ...
      private static final IntFunction<SpellcasterIllager.IllagerSpell> BY_ID = ByIdMap.continuous($$0 -> $$0.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      final int id;
      ...
      public static SpellcasterIllager.IllagerSpell byId(int $$0) {
         return (SpellcasterIllager.IllagerSpell)BY_ID.apply($$0);
      }
   }
