      ...
      return BehaviorBuilder.create(
         $$0 -> $$0.<MemoryAccessor, MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
               ...
               .apply($$0, ($$1, $$2, $$3, $$4) -> ($$3x, $$4x, $$5) -> {
                     if (!$$4x.isBaby() && !$$0.tryGet($$4).map($$0xxx -> $$0xxx.stream().anyMatch(StartHuntingHoglin::hasHuntedRecently)).isPresent()) {
                        Hoglin $$6 = $$0.get($$1);
                        PiglinAi.setAngerTarget($$3x, $$4x, $$6);
                        PiglinAi.dontKillAnyMoreHoglinsForAWhile($$4x);
                        PiglinAi.broadcastAngerTarget($$3x, $$4x, $$6);
                        $$0.tryGet($$4).ifPresent($$0xxx -> $$0xxx.forEach(PiglinAi::dontKillAnyMoreHoglinsForAWhile));
                        return true;
                     } else {
                        return false;
                     }
