...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
      ...
      if (this.level().isClientSide() && this.isInvisible()) {
         ...
         if (this.hurtTime == 1 || this.tickCount % 1200 == 0) {
            ...
            for(int $$2 = 0; $$2 < 4; ++$$2) {
               ...
               this.clientSideIllusionOffsets[1][$$2] = new Vec3(
   ...
   public Vec3[] getIllusionOffsets(float $$0) {
      if (this.clientSideIllusionTicks <= 0) {
         ...
         double $$1 = (double)(((float)this.clientSideIllusionTicks - $$0) / 3.0F);
         $$1 = Math.pow($$1, 0.25);
         Vec3[] $$2 = new Vec3[4];
   ...
   public void performRangedAttack(LivingEntity $$0, float $$1) {
      ...
      if (var15 instanceof ServerLevel $$9) {
         Projectile.spawnProjectileUsingShoot($$4, $$9, $$3, $$5, $$6 + $$8 * 0.2F, $$7, 1.6F, (float)(14 - $$9.getDifficulty().getId() * 4));
      }
