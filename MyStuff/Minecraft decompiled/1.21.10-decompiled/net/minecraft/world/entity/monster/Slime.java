...
public class Slime extends Mob implements Enemy {
   ...
   public void setSize(int $$0, boolean $$1) {
      ...
      this.getAttribute(Attributes.MAX_HEALTH).setBaseValue((double)($$2 * $$2));
      this.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue((double)(0.2F + 0.1F * (float)$$2));
      this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue((double)$$2);
      if ($$1) {
   ...
   public void remove(Entity.RemovalReason $$0) {
      ...
      if (!this.level().isClientSide() && $$1 > 1 && this.isDeadOrDying()) {
         ...
         for(int $$7 = 0; $$7 < $$5; ++$$7) {
            ...
            this.convertTo(this.getType(), new ConversionParams(ConversionType.SPLIT_ON_DEATH, false, false, $$6), EntitySpawnReason.TRIGGERED, $$3x -> {
               $$3x.setSize($$4, true);
               $$3x.snapTo(this.getX() + (double)$$8, this.getY() + 0.5, this.getZ() + (double)$$9, this.random.nextFloat() * 360.0F, 0.0F);
            });
         }
      }
   ...
   protected void dealDamage(LivingEntity $$0) {
      Level $$2 = this.level();
      if ($$2 instanceof ServerLevel $$1 && this.isAlive() && this.isWithinMeleeAttackRange($$0) && this.hasLineOfSight($$0)) {
         DamageSource $$2x = this.damageSources().mobAttack(this);
         if ($$0.hurtServer($$1, $$2x, this.getAttackDamage())) {
            this.playSound(SoundEvents.SLIME_ATTACK, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
            EnchantmentHelper.doPostAttackEffects($$1, $$0, $$2x);
         }
      }
   }
   ...
   public static boolean checkSlimeSpawnRules(EntityType<Slime> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      if ($$1.getDifficulty() != Difficulty.PEACEFUL) {
         ...
         if ($$1.getBiome($$3).is(BiomeTags.ALLOWS_SURFACE_SLIME_SPAWNS)
            && $$3.getY() > 50
            && $$3.getY() < 70
            && $$4.nextFloat() < 0.5F
            && $$4.nextFloat() < $$1.getMoonBrightness()
            && $$1.getMaxLocalRawBrightness($$3) <= $$4.nextInt(8)) {
            return checkMobSpawnRules($$0, $$1, $$2, $$3, $$4);
         }
   ...
   public EntityDimensions getDefaultDimensions(Pose $$0) {
      return super.getDefaultDimensions($$0).scale((float)this.getSize());
   }
   ...
   static class SlimeAttackGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         if ($$0 == null) {
            return false;
         } else if (!this.slime.canAttack($$0)) {
            return false;
         } else {
      ...
      public void tick() {
         ...
         if (var3 instanceof Slime.SlimeMoveControl $$1) {
   ...
   static class SlimeFloatGoal extends Goal {
      ...
      public void tick() {
         ...
         if (var2 instanceof Slime.SlimeMoveControl $$0) {
