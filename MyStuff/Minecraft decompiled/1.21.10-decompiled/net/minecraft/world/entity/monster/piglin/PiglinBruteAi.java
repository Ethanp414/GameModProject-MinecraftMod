...
public class PiglinBruteAi {
   ...
   private static boolean isNearestValidAttackTarget(ServerLevel $$0, AbstractPiglin $$1, LivingEntity $$2) {
   ...
   private static Optional<? extends LivingEntity> findNearestValidAttackTarget(ServerLevel $$0, AbstractPiglin $$1) {
      ...
      if ($$2.isPresent() && Sensor.isEntityAttackableIgnoringLineOfSight($$0, $$1, (LivingEntity)$$2.get())) {
         return $$2;
      } else {
         Optional<? extends LivingEntity> $$3 = $$1.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_ATTACKABLE_PLAYER);
