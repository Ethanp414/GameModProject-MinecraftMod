...
public class MagmaCube extends Slime {
   ...
   public void setSize(int $$0, boolean $$1) {
      super.setSize($$0, $$1);
      this.getAttribute(Attributes.ARMOR).setBaseValue((double)($$0 * 3));
   }
   ...
   public void jumpFromGround() {
      ...
      this.setDeltaMovement($$0.x, (double)(this.getJumpPower() + $$1), $$0.z);
   ...
   protected void jumpInLiquid(TagKey<Fluid> $$0) {
      if ($$0 == FluidTags.LAVA) {
         ...
         this.setDeltaMovement($$1.x, (double)(0.22F + (float)this.getSize() * 0.05F), $$1.z);
         this.hasImpulse = true;
      } else {
