...
public class Ravager extends Raider {
   ...
   private static final Predicate<Entity> ROAR_TARGET_WITHOUT_GRIEFING = $$0 -> ROAR_TARGET_WITH_GRIEFING.test($$0)
         && !$$0.getType().equals(EntityType.ARMOR_STAND);
   private static final Predicate<LivingEntity> ROAR_TARGET_ON_CLIENT = $$0 -> !($$0 instanceof Ravager)
         && $$0.isAlive()
   ...
   public void aiStep() {
      ...
      if (this.isAlive()) {
         ...
         Level $$3 = this.level();
         if ($$3 instanceof ServerLevel $$2 && this.horizontalCollision && $$2.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
            boolean $$3x = false;
            ...
            for(BlockPos $$5 : BlockPos.betweenClosed(
               ...
               if ($$7 instanceof LeavesBlock) {
                  $$3x = $$2.destroyBlock($$5, true, this) || $$3x;
               }
            }
   ...
   private void roar() {
      if (this.isAlive()) {
         ...
         if ($$1 instanceof ServerLevel $$0) {
            Predicate<Entity> $$1x = $$0.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) ? ROAR_TARGET_WITH_GRIEFING : ROAR_TARGET_WITHOUT_GRIEFING;

            for(LivingEntity $$3 : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(4.0), $$1x)) {
   ...
   private void applyRoarKnockbackClient() {
      for(LivingEntity $$1 : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(4.0), ROAR_TARGET_ON_CLIENT)) {
