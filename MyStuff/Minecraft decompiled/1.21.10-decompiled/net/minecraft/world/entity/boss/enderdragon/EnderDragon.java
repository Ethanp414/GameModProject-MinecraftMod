...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.isDeadOrDying()) {
         ...
         this.level()
            .addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)$$2, this.getY() + 2.0 + (double)$$3, this.getZ() + (double)$$4, 0.0, 0.0, 0.0);
      } else {
         this.checkCrystals();
         ...
         if (this.isNoAi()) {
            ...
            Level $$27 = this.level();
            if ($$27 instanceof ServerLevel $$7) {
            ...
            float $$31 = Mth.sin($$30);
            float $$32 = Mth.cos($$30);
            this.tickPart(this.body, (double)($$31 * 0.5F), 0.0, (double)(-$$32 * 0.5F));
            this.tickPart(this.wing1, (double)($$32 * 4.5F), 2.0, (double)($$31 * 4.5F));
            this.tickPart(this.wing2, (double)($$32 * -4.5F), 2.0, (double)($$31 * -4.5F));
            Level $$35 = this.level();
            if ($$35 instanceof ServerLevel $$33 && this.hurtTime == 0) {
               this.knockBack(
                  $$33,
                  $$33.getEntities(this, this.wing1.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR)
               );
               this.knockBack(
                  $$33,
                  $$33.getEntities(this, this.wing2.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR)
               );
            ...
            this.tickPart(this.head, (double)($$34 * 6.5F * $$28), (double)($$36 + $$29 * 6.5F), (double)(-$$35 * 6.5F * $$28));
            this.tickPart(this.neck, (double)($$34 * 5.5F * $$28), (double)($$36 + $$29 * 5.5F), (double)(-$$35 * 5.5F * $$28));
            ...
            for(int $$38 = 0; $$38 < 3; ++$$38) {
               ...
               float $$41 = this.getYRot() * (float) (Math.PI / 180.0) + this.rotWrap((double)($$40.yRot() - $$37.yRot())) * (float) (Math.PI / 180.0);
               float $$42 = Mth.sin($$41);
               float $$43 = Mth.cos($$41);
               float $$44 = 1.5F;
               ...
               this.tickPart(
                  ...
                  $$40.y() - $$37.y() - (double)(($$45 + 1.5F) * $$29) + 1.5,
                  (double)(($$32 * 1.5F + $$43 * $$45) * $$28)
               );
            }

            Level var47 = this.level();
            if (var47 instanceof ServerLevel $$46) {
   ...
   protected void tickDeath() {
      ...
      if (this.dragonDeathTime >= 180 && this.dragonDeathTime <= 200) {
         ...
         float $$2 = (this.random.nextFloat() - 0.5F) * 8.0F;
         this.level()
            .addParticle(ParticleTypes.EXPLOSION_EMITTER, this.getX() + (double)$$0, this.getY() + 2.0 + (double)$$1, this.getZ() + (double)$$2, 0.0, 0.0, 0.0);
      }
      ...
      if (var10 instanceof ServerLevel $$4) {
      ...
      if (this.dragonDeathTime == 200) {
         ...
         if (var13 instanceof ServerLevel $$7) {
   ...
   public int findClosestNode() {
      if (this.nodes[0] == null) {
         for(int $$0 = 0; $$0 < 24; ++$$0) {
            ...
            int $$9 = Math.max(73, this.level().getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, new BlockPos($$3, 0, $$4)).getY() + $$1);
   ...
   private Path reconstructPath(Node $$0, Node $$1) {
      List<Node> $$2 = Lists.<Node>newArrayList();
      Node $$3 = $$1;
      $$2.add(0, $$1);
   ...
   public void onCrystalDestroyed(ServerLevel $$0, EndCrystal $$1, BlockPos $$2, DamageSource $$3) {
      Entity var7 = $$3.getEntity();
      Player $$5;
      if (var7 instanceof Player $$4) {
         $$5 = $$4;
      } else {
         $$5 = $$0.getNearestPlayer(CRYSTAL_DESTROY_TARGETING, (double)$$2.getX(), (double)$$2.getY(), (double)$$2.getZ());
      }
