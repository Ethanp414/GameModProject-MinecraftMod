...
public class DragonSittingScanningPhase extends AbstractDragonSittingPhase {
   ...
   public DragonSittingScanningPhase(EnderDragon $$0) {
      super($$0);
      this.scanTargeting = TargetingConditions.forCombat().range(20.0).selector(($$1, $$2) -> Math.abs($$1.getY() - $$0.getY()) <= 10.0);
   }

   @Override
   public void doServerTick(ServerLevel $$0) {
      ++this.scanningTime;
      LivingEntity $$1 = $$0.getNearestPlayer(this.scanTargeting, this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
      if ($$1 != null) {
         if (this.scanningTime > 25) {
            ...
            if ($$5 < 0.0F || $$5 > 10.0F) {
               ...
               double $$8 = Mth.clamp(Mth.wrapDegrees(180.0 - Mth.atan2($$6, $$7) * 180.0F / (float)Math.PI - (double)this.dragon.getYRot()), -100.0, 100.0);
