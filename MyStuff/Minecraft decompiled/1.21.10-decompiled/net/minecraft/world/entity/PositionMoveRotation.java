...
public record PositionMoveRotation(Vec3 position, Vec3 deltaMovement, float yRot, float xRot) {
   ...
   public static PositionMoveRotation of(Entity $$0) {
      return $$0.isInterpolating()
         ? new PositionMoveRotation($$0.getInterpolation().position(), $$0.getKnownMovement(), $$0.getInterpolation().yRot(), $$0.getInterpolation().xRot())
         : new PositionMoveRotation($$0.position(), $$0.getKnownMovement(), $$0.getYRot(), $$0.getXRot());
   }

   public PositionMoveRotation withRotation(float $$0, float $$1) {
      return new PositionMoveRotation(this.position(), this.deltaMovement(), $$0, $$1);
   }
   ...
   public static PositionMoveRotation calculateAbsolute(PositionMoveRotation $$0, PositionMoveRotation $$1, Set<Relative> $$2) {
      double $$3 = $$2.contains(Relative.X) ? $$0.position.x : 0.0;
      double $$4 = $$2.contains(Relative.Y) ? $$0.position.y : 0.0;
      double $$5 = $$2.contains(Relative.Z) ? $$0.position.z : 0.0;
      float $$6 = $$2.contains(Relative.Y_ROT) ? $$0.yRot : 0.0F;
      float $$7 = $$2.contains(Relative.X_ROT) ? $$0.xRot : 0.0F;
      ...
      if ($$2.contains(Relative.ROTATE_DELTA)) {
         float $$12 = $$0.yRot - $$9;
         float $$13 = $$0.xRot - $$10;
         $$11 = $$11.xRot((float)Math.toRadians((double)$$13));
         $$11 = $$11.yRot((float)Math.toRadians((double)$$12));
      }

      Vec3 $$14 = new Vec3(
         calculateDelta($$11.x, $$1.deltaMovement.x, $$2, Relative.DELTA_X),
         calculateDelta($$11.y, $$1.deltaMovement.y, $$2, Relative.DELTA_Y),
         calculateDelta($$11.z, $$1.deltaMovement.z, $$2, Relative.DELTA_Z)
      );
