...
public abstract class AbstractThrownPotion extends ThrowableItemProjectile {
   ...
   protected void onHit(HitResult $$0) {
      ...
      if ($$3 instanceof ServerLevel $$1) {
         ItemStack $$3x = this.getItem();
         PotionContents $$4 = $$3x.getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY);
         if ($$4.is(Potions.WATER)) {
            this.onHitAsWater($$1);
         } else if ($$4.hasEffects()) {
            this.onHitAsPotion($$1, $$3x, $$0);
         }
   ...
   private void onHitAsWater(ServerLevel $$0) {
      ...
      for(LivingEntity $$3 : this.level().getEntitiesOfClass(LivingEntity.class, $$1, WATER_SENSITIVE_OR_ON_FIRE)) {
