...
public class EvokerFangs extends Entity implements TraceableEntity {
   ...
   public EvokerFangs(Level $$0, double $$1, double $$2, double $$3, float $$4, int $$5, LivingEntity $$6) {
      this(EntityType.EVOKER_FANGS, $$0);
   ...
   public void tick() {
      ...
      if (this.level().isClientSide()) {
         ...
         if (this.warmupDelayTicks == -8) {
            for(LivingEntity $$8 : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(0.2, 0.0, 0.2))) {
               this.dealDamageTo($$8);
            }
         }
   ...
   private void dealDamageTo(LivingEntity $$0) {
      ...
      if ($$0.isAlive() && !$$0.isInvulnerable() && $$0 != $$1) {
         if ($$1 == null) {
            ...
            if (var5 instanceof ServerLevel $$3 && $$0.hurtServer($$3, $$2, 6.0F)) {
