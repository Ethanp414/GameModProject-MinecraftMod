...
public class LargeFireball extends Fireball {
   ...
   public LargeFireball(Level $$0, LivingEntity $$1, Vec3 $$2, int $$3) {
      super(EntityType.FIREBALL, $$1, $$2, $$0);
   ...
   protected void onHit(HitResult $$0) {
      ...
      if ($$2 instanceof ServerLevel $$1) {
         boolean $$2x = $$1.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING);
         this.level().explode(this, this.getX(), this.getY(), this.getZ(), (float)this.explosionPower, $$2x, Level.ExplosionInteraction.MOB);
         this.discard();
      }
   }
