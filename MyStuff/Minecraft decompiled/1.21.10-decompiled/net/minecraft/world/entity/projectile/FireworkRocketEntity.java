...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
   ...
   public FireworkRocketEntity(Level $$0, double $$1, double $$2, double $$3, ItemStack $$4) {
      super(EntityType.FIREWORK_ROCKET, $$0);
      this.life = 0;
      this.setPos($$1, $$2, $$3);
   ...
   public void tick() {
      ...
      if (this.isAttachedToEntity()) {
         if (this.attachedToEntity == null) {
            ((OptionalInt)this.entityData.get(DATA_ATTACHED_TO_TARGET)).ifPresent($$0x -> {
               Entity $$1xx = this.level().getEntity($$0x);
               if ($$1xx instanceof LivingEntity) {
                  this.attachedToEntity = (LivingEntity)$$1xx;
               }
            });
         }
      ...
      if (!this.noPhysics && this.isAlive() && $$6.getType() != HitResult.Type.MISS) {
      ...
      if (this.life > this.lifetime) {
         ...
         if (var12 instanceof ServerLevel $$10) {
            this.explode($$10);
         }
      }
   }
   ...
   protected void onHitBlock(BlockHitResult $$0) {
      ...
      this.level().getBlockState($$1).entityInside(this.level(), $$1, this, InsideBlockEffectApplier.NOOP, true);
      Level var4 = this.level();
      if (var4 instanceof ServerLevel $$2 && this.hasExplosion()) {
         this.explode($$2);
      }
   ...
   private void dealExplosionDamage(ServerLevel $$0) {
      ...
      if ($$1 > 0.0F) {
         ...
         for(LivingEntity $$6 : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(5.0))) {
            if ($$6 != this.attachedToEntity && !(this.distanceToSqr($$6) > 25.0)) {
               boolean $$7 = false;

               for(int $$8 = 0; $$8 < 2; ++$$8) {
                  Vec3 $$9 = new Vec3($$6.getX(), $$6.getY(0.5 * (double)$$8), $$6.getZ());
                  HitResult $$10 = this.level().clip(new ClipContext($$4, $$9, ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, this));
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.entityData.set(DATA_ID_FIREWORKS_ITEM, (ItemStack)$$0.read("FireworksItem", ItemStack.CODEC).orElse(getDefaultItem()));
