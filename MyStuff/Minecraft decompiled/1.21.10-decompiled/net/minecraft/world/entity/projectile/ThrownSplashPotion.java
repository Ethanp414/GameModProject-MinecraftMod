...
public class ThrownSplashPotion extends AbstractThrownPotion {
   ...
   public void onHitAsPotion(ServerLevel $$0, ItemStack $$1, HitResult $$2) {
      ...
      float $$4 = $$1.getOrDefault(DataComponents.POTION_DURATION_SCALE, Float.valueOf(1.0F));
      ...
      if (!$$8.isEmpty()) {
         ...
         for(LivingEntity $$11 : $$8) {
            if ($$11.isAffectedByPotions()) {
               double $$12 = $$6.distanceToSqr($$11.getBoundingBox().inflate((double)$$9));
               if ($$12 < 16.0) {
                  ...
                  for(MobEffectInstance $$14 : $$5) {
                     ...
                     if ($$15.value().isInstantenous()) {
                        ...
                        int $$16 = $$14.mapDuration($$2x -> (int)($$13 * (double)$$2x * (double)$$4 + 0.5));
