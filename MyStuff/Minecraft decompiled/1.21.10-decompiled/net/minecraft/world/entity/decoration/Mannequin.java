...
public class Mannequin extends Avatar {
   ...
   @Nullable
   public static Mannequin create(EntityType<Mannequin> $$0, Level $$1) {
   ...
   protected void addAdditionalSaveData(ValueOutput $$0) {
      ...
      $$0.store("main_hand", HumanoidArm.CODEC, this.getMainArm());
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.entityData.set(DATA_PLAYER_MODE_CUSTOMISATION, (Byte)$$0.read("hidden_layers", LAYERS_CODEC).orElse(ALL_LAYERS));
      this.setMainArm((HumanoidArm)$$0.read("main_hand", HumanoidArm.CODEC).orElse(DEFAULT_MAIN_HAND));
      this.setPose((Pose)$$0.read("pose", POSE_CODEC).orElse(Pose.STANDING));
      this.setImmovable($$0.getBooleanOr("immovable", false));
      this.setHideDescription($$0.getBooleanOr("hide_description", false));
      this.setDescription((Component)$$0.read("description", ComponentSerialization.CODEC).orElse(DEFAULT_DESCRIPTION));
   }

   @Nullable
   @Override
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.PROFILE ? castComponentValue($$0, this.getProfile()) : super.get($$0));
   }
