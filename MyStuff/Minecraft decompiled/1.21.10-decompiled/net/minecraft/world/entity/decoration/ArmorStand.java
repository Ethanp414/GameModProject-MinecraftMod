...
public class ArmorStand extends LivingEntity {
   ...
   private static final Predicate<Entity> RIDABLE_MINECARTS = $$0 -> {
      if ($$0 instanceof AbstractMinecart $$1 && $$1.isRideable()) {
         return true;
      }
   ...
   protected void pushEntities() {
      for(Entity $$1 : this.level().getEntities(this, this.getBoundingBox(), RIDABLE_MINECARTS)) {
   ...
   private EquipmentSlot getClickedSlot(Vec3 $$0) {
      ...
      } else if ($$3 >= 0.9 + ($$2 ? 0.3 : 0.0) && $$3 < 0.9 + ($$2 ? 1.0 : 0.7) && this.hasItemInSlot(EquipmentSlot.CHEST)) {
         $$1 = EquipmentSlot.CHEST;
      } else if ($$3 >= 0.4 && $$3 < 0.4 + ($$2 ? 1.0 : 0.8) && this.hasItemInSlot(EquipmentSlot.LEGS)) {
         $$1 = EquipmentSlot.LEGS;
      } else if ($$3 >= 1.6 && this.hasItemInSlot(EquipmentSlot.HEAD)) {
   ...
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      if (this.isRemoved()) {
         ...
         if (!$$3 && !$$4) {
            ...
            if (var7 instanceof Player $$5 && !$$5.getAbilities().mayBuild) {
               return false;
            }
   ...
   public boolean skipAttackInteraction(Entity $$0) {
      if ($$0 instanceof Player $$1 && !this.level().mayInteract($$1, this.blockPosition())) {
         return true;
      }
