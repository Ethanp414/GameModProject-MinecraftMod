   ...
   private static void register(BootstrapContext<PaintingVariant> $$0, ResourceKey<PaintingVariant> $$1, int $$2, int $$3, boolean $$4) {
      $$0.register(
         ...
         new PaintingVariant(
            ...
            $$3,
            $$1.location(),
            Optional.of(Component.translatable($$1.location().toLanguageKey("painting", "title")).withStyle(ChatFormatting.YELLOW)),
            $$4 ? Optional.of(Component.translatable($$1.location().toLanguageKey("painting", "author")).withStyle(ChatFormatting.GRAY)) : Optional.empty()
         )
      );
   }
