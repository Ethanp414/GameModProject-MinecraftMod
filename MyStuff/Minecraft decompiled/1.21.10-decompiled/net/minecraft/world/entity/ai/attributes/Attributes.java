...
public class Attributes {
   ...
   private static Holder<Attribute> register(String $$0, Attribute $$1) {
      return Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, ResourceLocation.withDefaultNamespace($$0), $$1);
   }

   public static Holder<Attribute> bootstrap(Registry<Attribute> $$0) {
      return MAX_HEALTH;
   }
}
