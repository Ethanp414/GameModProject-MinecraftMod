...
public class SetWalkTargetFromBlockMemory {
   public static OneShot<Villager> create(MemoryModuleType<GlobalPos> $$0, float $$1, int $$2, int $$3, int $$4) {
      return BehaviorBuilder.create(
         $$5 -> $$5.<MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
                  $$5.registered(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE), $$5.absent(MemoryModuleType.WALK_TARGET), $$5.present($$0)
               )
