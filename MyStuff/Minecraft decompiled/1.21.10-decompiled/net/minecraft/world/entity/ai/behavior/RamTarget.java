...
public class RamTarget extends Behavior<Goat> {
   ...
   public RamTarget(
      Function<Goat, UniformInt> $$0,
      TargetingConditions $$1,
      float $$2,
      ToDoubleFunction<Goat> $$3,
      Function<Goat, SoundEvent> $$4,
      Function<Goat, SoundEvent> $$5
   ) {
   ...
   protected void tick(ServerLevel $$0, Goat $$1, long $$2) {
      ...
      if (!$$3.isEmpty()) {
         ...
         DamageSource $$6 = $$0.damageSources().noAggroMobAttack($$1);
         float $$7 = (float)$$1.getAttributeValue(Attributes.ATTACK_DAMAGE);
         if ($$5.hurtServer($$0, $$6, $$7)) {
         ...
         this.finishRam($$0, $$1);
         $$0.playSound(null, $$1, (SoundEvent)this.getImpactSound.apply($$1), SoundSource.NEUTRAL, 1.0F, 1.0F);
      } else if (this.hasRammedHornBreakingBlock($$0, $$1)) {
         $$0.playSound(null, $$1, (SoundEvent)this.getImpactSound.apply($$1), SoundSource.NEUTRAL, 1.0F, 1.0F);
         boolean $$15 = $$1.dropHorn();
         if ($$15) {
            $$0.playSound(null, $$1, (SoundEvent)this.getHornBreakSound.apply($$1), SoundSource.NEUTRAL, 1.0F, 1.0F);
         }
         ...
         boolean $$18 = $$16.isEmpty() || $$17.isEmpty() || ((WalkTarget)$$16.get()).getTarget().currentPosition().closerThan((Position)$$17.get(), 0.25);
         if ($$18) {
            this.finishRam($$0, $$1);
         }
      }
   ...
   protected void finishRam(ServerLevel $$0, Goat $$1) {
      ...
      $$1.getBrain().setMemory(MemoryModuleType.RAM_COOLDOWN_TICKS, ((UniformInt)this.getTimeBetweenRams.apply($$1)).sample($$0.random));
