...
public class PlayTagWithOtherKids {
         ...
         $$0 -> $$0.<MemoryAccessor, MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
               ...
               .apply($$0, ($$1, $$2, $$3, $$4) -> ($$5, $$6, $$7) -> {
                     if ($$5.getRandom().nextInt(10) != 0) {
                        ...
                        List<LivingEntity> $$8 = $$0.get($$1);
                        Optional<LivingEntity> $$9 = $$8.stream().filter($$1xx -> isFriendChasingMe($$6, $$1xx)).findAny();
                        if (!$$9.isPresent()) {
                           Optional<LivingEntity> $$12 = findSomeoneBeingChased($$8);
                           if ($$12.isPresent()) {
                              chaseKid($$4, $$3, $$2, (LivingEntity)$$12.get());
                              return true;
                           } else {
   ...
   private static void chaseKid(
      MemoryAccessor<?, LivingEntity> $$0, MemoryAccessor<?, PositionTracker> $$1, MemoryAccessor<?, WalkTarget> $$2, LivingEntity $$3
   ) {
      $$0.set($$3);
   ...
   private static Optional<LivingEntity> findSomeoneBeingChased(List<LivingEntity> $$0) {
      Map<LivingEntity, Integer> $$1 = checkHowManyChasersEachFriendHas($$0);
      return $$1.entrySet()
         .stream()
