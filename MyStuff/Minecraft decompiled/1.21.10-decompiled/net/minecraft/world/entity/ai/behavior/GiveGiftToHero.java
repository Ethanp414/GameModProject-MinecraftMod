...
public class GiveGiftToHero extends Behavior<Villager> {
   ...
   private void throwGift(ServerLevel $$0, Villager $$1, LivingEntity $$2) {
   ...
   private static ResourceKey<LootTable> getLootTableToThrow(Villager $$0) {
      if ($$0.isBaby()) {
         ...
         return $$1.isEmpty() ? BuiltInLootTables.UNEMPLOYED_GIFT : (ResourceKey)GIFTS.getOrDefault($$1.get(), BuiltInLootTables.UNEMPLOYED_GIFT);
      }
   }
