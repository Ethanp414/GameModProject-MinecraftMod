...
public class AnimalPanic<E extends PathfinderMob> extends Behavior<E> {
   ...
   public AnimalPanic(float $$0, Function<PathfinderMob, TagKey<DamageType>> $$1) {
   ...
   protected boolean checkExtraStartConditions(ServerLevel $$0, E $$1) {
      return $$1.getBrain()
            ...
            .map($$1x -> $$1x.is((TagKey<DamageType>)this.panicCausingDamageTypes.apply($$1)))
            .orElse(false)
   ...
   private Vec3 getPanicPos(E $$0, ServerLevel $$1) {
      ...
      return (Vec3)this.positionGetter.apply($$0);
   }
