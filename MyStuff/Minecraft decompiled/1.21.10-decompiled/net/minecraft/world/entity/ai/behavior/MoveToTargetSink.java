...
public class MoveToTargetSink extends Behavior<Mob> {
   ...
   protected boolean canStillUse(ServerLevel $$0, Mob $$1, long $$2) {
      if (this.path != null && this.lastTargetPos != null) {
         ...
         return !$$5.isDone() && $$3.isPresent() && !this.reachedTarget($$1, (WalkTarget)$$3.get()) && !$$4;
      } else {
         return false;
      }
   }
   ...
   protected void stop(ServerLevel $$0, Mob $$1, long $$2) {
      if ($$1.getBrain().hasMemoryValue(MemoryModuleType.WALK_TARGET)
         && !this.reachedTarget($$1, (WalkTarget)$$1.getBrain().getMemory(MemoryModuleType.WALK_TARGET).get())
   ...
   private boolean tryComputePath(Mob $$0, WalkTarget $$1, long $$2) {
      ...
      if (this.reachedTarget($$0, $$1)) {
         ...
         Vec3 $$6 = DefaultRandomPos.getPosTowards((PathfinderMob)$$0, 10, 7, Vec3.atBottomCenterOf($$3), (float) (Math.PI / 2));
         if ($$6 != null) {
   ...
   private static boolean isWalkTargetSpectator(WalkTarget $$0) {
      ...
      return $$1 instanceof EntityTracker $$2 ? $$2.getEntity().isSpectator() : false;
   }
}
