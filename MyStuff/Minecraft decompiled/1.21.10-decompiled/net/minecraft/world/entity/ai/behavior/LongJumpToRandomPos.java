...
public class LongJumpToRandomPos<E extends Mob> extends Behavior<E> {
   ...
   private static final List<Integer> ALLOWED_ANGLES = Lists.newArrayList((E[])(65, 70, 75, 80));
   ...
   protected boolean canStillUse(ServerLevel $$0, Mob $$1, long $$2) {
      boolean $$3 = this.initialPosition.isPresent()
         && ((Vec3)this.initialPosition.get()).equals($$1.position())
   ...
   protected void start(ServerLevel $$0, E $$1, long $$2) {
      ...
      int $$5 = $$3.getY();
      int $$6 = $$3.getZ();
      this.jumpCandidates = (List)BlockPos.betweenClosedStream(
   ...
   protected void tick(ServerLevel $$0, E $$1, long $$2) {
      if (this.chosenJump != null) {
         if ($$2 - this.prepareJumpStart >= 40L) {
            ...
            double $$4 = $$3 + (double)$$1.getJumpBoostPower();
            $$1.setDeltaMovement(this.chosenJump.scale($$4 / $$3));
            $$1.getBrain().setMemory(MemoryModuleType.LONG_JUMP_MID_JUMP, true);
            $$0.playSound(null, $$1, (SoundEvent)this.getJumpSound.apply($$1), SoundSource.NEUTRAL, 1.0F, 1.0F);
         }
      } else {
         --this.findJumpTries;
   ...
   protected void pickCandidate(ServerLevel $$0, E $$1, long $$2) {
      while(!this.jumpCandidates.isEmpty()) {
         ...
         if (!$$3.isEmpty()) {
            LongJumpToRandomPos.PossibleJump $$4 = (LongJumpToRandomPos.PossibleJump)$$3.get();
