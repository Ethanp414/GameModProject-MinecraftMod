...
public class PoiSection {
   ...
   public Stream<PoiRecord> getRecords(Predicate<Holder<PoiType>> $$0, PoiManager.Occupancy $$1) {
      return this.byType
         .entrySet()
         .stream()
         .filter($$1x -> $$0.test((Holder)$$1x.getKey()))
   ...
   private boolean add(PoiRecord $$0) {
      ...
      PoiRecord $$4 = this.records.get($$3);
      if ($$4 != null) {
      ...
      ((Set)this.byType.computeIfAbsent($$2, $$0x -> Sets.newHashSet())).add($$0);
      return true;
   }

   public void remove(BlockPos $$0) {
      PoiRecord $$1 = this.records.remove(SectionPos.sectionRelativePos($$0));
      if ($$1 == null) {
   ...
   public boolean release(BlockPos $$0) {
      PoiRecord $$1 = this.records.get(SectionPos.sectionRelativePos($$0));
      if ($$1 == null) {
   ...
   private Optional<PoiRecord> getPoiRecord(BlockPos $$0) {
      return Optional.ofNullable(this.records.get(SectionPos.sectionRelativePos($$0)));
   }
   ...
   public void refresh(Consumer<BiConsumer<BlockPos, Holder<PoiType>>> $$0) {
      if (!this.isValid) {
         ...
         $$0.accept((BiConsumer)($$1x, $$2) -> {
            ...
            PoiRecord $$4 = $$1.computeIfAbsent($$3, (Short2ObjectFunction<? extends PoiRecord>)($$2x -> new PoiRecord($$1x, $$2, this.setDirty)));
            this.add($$4);
         });
         this.isValid = true;
         this.setDirty.run();
