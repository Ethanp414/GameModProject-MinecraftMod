...
public class HoglinSpecificSensor extends Sensor<Hoglin> {
   ...
   protected void doTick(ServerLevel $$0, Hoglin $$1) {
      Brain<?> $$2 = $$1.getBrain();
      $$2.setMemory(MemoryModuleType.NEAREST_REPELLENT, this.findNearestRepellent($$0, $$1));
      Optional<Piglin> $$3 = Optional.empty();
      int $$4 = 0;
      List<Hoglin> $$5 = Lists.<Hoglin>newArrayList();
      NearestVisibleLivingEntities $$6 = (NearestVisibleLivingEntities)$$2.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
         .orElse(NearestVisibleLivingEntities.empty());

      for(LivingEntity $$7 : $$6.findAll($$0x -> !$$0x.isBaby() && ($$0x instanceof Piglin || $$0x instanceof Hoglin))) {
   ...
   private Optional<BlockPos> findNearestRepellent(ServerLevel $$0, Hoglin $$1) {
      return BlockPos.findClosestMatch($$1.blockPosition(), 8, 4, $$1x -> $$0.getBlockState($$1x).is(BlockTags.HOGLIN_REPELLENTS));
   }
}
