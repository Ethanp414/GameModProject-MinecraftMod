...
public class StrollAroundPoi {
   ...
   public static OneShot<PathfinderMob> create(MemoryModuleType<GlobalPos> $$0, float $$1, int $$2) {
      ...
      return BehaviorBuilder.create(
         $$4 -> $$4.group($$4.registered(MemoryModuleType.WALK_TARGET), $$4.present($$0)).apply($$4, ($$4x, $$5) -> ($$6, $$7, $$8) -> {
                  GlobalPos $$9 = $$4.get($$5);
                  if ($$6.dimension() != $$9.dimension() || !$$9.pos().closerToCenterThan($$7.position(), (double)$$2)) {
                     return false;
                  } else if ($$8 <= $$3.getValue()) {
                     return true;
                  } else {
                     Optional<Vec3> $$10 = Optional.ofNullable(LandRandomPos.getPos($$7, 8, 6));
                     $$4x.setOrErase($$10.map($$1xxxx -> new WalkTarget($$1xxxx, $$1, 1)));
                     $$3.setValue($$8 + 180L);
                     return true;
                  }
               })
