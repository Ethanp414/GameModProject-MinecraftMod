...
public class TryFindLandNearWater {
   public static BehaviorControl<PathfinderMob> create(int $$0, float $$1) {
      ...
      return BehaviorBuilder.create(
         $$3 -> $$3.<MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
                  $$3.absent(MemoryModuleType.ATTACK_TARGET), $$3.absent(MemoryModuleType.WALK_TARGET), $$3.registered(MemoryModuleType.LOOK_TARGET)
               )
               .apply(
                  $$3,
                  ($$3x, $$4, $$5) -> ($$5x, $$6, $$7) -> {
