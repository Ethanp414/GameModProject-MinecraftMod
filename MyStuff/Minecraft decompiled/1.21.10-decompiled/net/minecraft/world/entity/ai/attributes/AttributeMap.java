...
public class AttributeMap {
   ...
   public Collection<AttributeInstance> getSyncableAttributes() {
      return (Collection<AttributeInstance>)this.attributes
         .values()
         .stream()
         .filter($$0 -> $$0.getAttribute().value().isClientSyncable())
         .collect(Collectors.toList());
   }

   @Nullable
   public AttributeInstance getInstance(Holder<Attribute> $$0) {
      return (AttributeInstance)this.attributes.computeIfAbsent($$0, $$0x -> this.supplier.createInstance(this::onAttributeModified, $$0x));
   }
   ...
   public double getValue(Holder<Attribute> $$0) {
      AttributeInstance $$1 = (AttributeInstance)this.attributes.get($$0);
   ...
   public void removeAttributeModifiers(Multimap<Holder<Attribute>, AttributeModifier> $$0) {
      $$0.asMap().forEach(($$0x, $$1) -> {
         AttributeInstance $$2 = (AttributeInstance)this.attributes.get($$0x);
         if ($$2 != null) {
