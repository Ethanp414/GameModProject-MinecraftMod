...
public class StartAttacking {
   public static <E extends Mob> BehaviorControl<E> create(StartAttacking.TargetFinder<E> $$0) {
      return create(($$0x, $$1) -> true, $$0);
   }

   public static <E extends Mob> BehaviorControl<E> create(StartAttacking.StartAttackingCondition<E> $$0, StartAttacking.TargetFinder<E> $$1) {
         ...
         $$2 -> $$2.group($$2.absent(MemoryModuleType.ATTACK_TARGET), $$2.registered(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE))
               .apply($$2, ($$2x, $$3) -> ($$4, $$5, $$6) -> {
                     if (!$$0.test($$4, (E)$$5)) {
                        ...
                        Optional<? extends LivingEntity> $$7 = $$1.get($$4, (E)$$5);
                        if ($$7.isEmpty()) {
                           return false;
                        } else {
