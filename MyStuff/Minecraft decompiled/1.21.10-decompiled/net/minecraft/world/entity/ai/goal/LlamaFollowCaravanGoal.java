...
public class LlamaFollowCaravanGoal extends Goal {
   ...
   public boolean canUse() {
      if (!this.llama.isLeashed() && !this.llama.inCaravan()) {
         List<Entity> $$0 = this.llama.level().getEntities(this.llama, this.llama.getBoundingBox().inflate(9.0, 4.0, 9.0), $$0x -> {
            EntityType<?> $$1xx = $$0x.getType();
            return $$1xx == EntityType.LLAMA || $$1xx == EntityType.TRADER_LLAMA;
         });
         Llama $$1 = null;
