...
public class PiglinBruteSpecificSensor extends Sensor<LivingEntity> {
   ...
   protected void doTick(ServerLevel $$0, LivingEntity $$1) {
      Brain<?> $$2 = $$1.getBrain();
      List<AbstractPiglin> $$3 = Lists.<AbstractPiglin>newArrayList();
      NearestVisibleLivingEntities $$4 = (NearestVisibleLivingEntities)$$2.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
         .orElse(NearestVisibleLivingEntities.empty());
      Optional<Mob> $$5 = $$4.findClosest($$0x -> $$0x instanceof WitherSkeleton || $$0x instanceof WitherBoss).map(Mob.class::cast);
