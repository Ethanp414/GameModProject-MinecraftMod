...
public class BehaviorBuilder<E extends LivingEntity, M> implements App<BehaviorBuilder.Mu<E>, M> {
   ...
   public static <E extends LivingEntity, M> BehaviorBuilder<E, M> unbox(App<BehaviorBuilder.Mu<E>, M> $$0) {
   ...
   public static <E extends LivingEntity> OneShot<E> create(Function<BehaviorBuilder.Instance<E>, ? extends App<BehaviorBuilder.Mu<E>, Trigger<E>>> $$0) {
   ...
   public static <E extends LivingEntity> OneShot<E> triggerIf(Predicate<E> $$0) {
      return create($$1 -> $$1.point((Trigger<LivingEntity>)($$1x, $$2, $$3) -> $$0.test($$2)));
   }

   public static <E extends LivingEntity> OneShot<E> triggerIf(BiPredicate<ServerLevel, E> $$0) {
      return create($$1 -> $$1.point((Trigger<LivingEntity>)($$1x, $$2, $$3) -> $$0.test($$1x, $$2)));
   }

   static <E extends LivingEntity, M> BehaviorBuilder.TriggerWithResult<E, M> get(App<BehaviorBuilder.Mu<E>, M> $$0) {
   ...
   static <E extends LivingEntity, M> BehaviorBuilder<E, M> create(BehaviorBuilder.TriggerWithResult<E, M> $$0) {
   ...
   public static final class Instance<E extends LivingEntity> implements Applicative<BehaviorBuilder.Mu<E>, BehaviorBuilder.Instance.Mu<E>> {
      ...
      public <A, R> Function<App<BehaviorBuilder.Mu<E>, A>, App<BehaviorBuilder.Mu<E>, R>> lift1(App<BehaviorBuilder.Mu<E>, Function<A, R>> $$0) {
         return $$1 -> {
            final BehaviorBuilder.TriggerWithResult<E, A> $$2 = BehaviorBuilder.get($$1);
            ...
            return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>(this) {
               @Override
               public R tryTrigger(ServerLevel $$0, E $$1, long $$2x) {
                  A $$3x = (A)$$2.tryTrigger($$0, $$1, $$2);
                  if ($$3x == null) {
                     return null;
                  } else {
                     Function<A, R> $$4 = (Function)$$3.tryTrigger($$0, $$1, $$2);
      ...
      public <T, R> BehaviorBuilder<E, R> map(final Function<? super T, ? extends R> $$0, App<BehaviorBuilder.Mu<E>, T> $$1) {
         final BehaviorBuilder.TriggerWithResult<E, T> $$2 = BehaviorBuilder.get($$1);
         return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>(this) {
            @Override
            public R tryTrigger(ServerLevel $$0x, E $$1, long $$2x) {
               T $$3 = $$2.tryTrigger($$0, $$1, $$2);
      ...
      public <A, B, R> BehaviorBuilder<E, R> ap2(
         ...
         final BehaviorBuilder.TriggerWithResult<E, A> $$3 = BehaviorBuilder.get($$1);
         final BehaviorBuilder.TriggerWithResult<E, B> $$4 = BehaviorBuilder.get($$2);
         ...
         return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>(this) {
            ...
            public R tryTrigger(ServerLevel $$0, E $$1, long $$2) {
               A $$3x = $$3.tryTrigger($$0, $$1, $$2);
               if ($$3x == null) {
                  return null;
               } else {
                  B $$4x = $$4.tryTrigger($$0, $$1, $$2);
                  if ($$4x == null) {
                     return null;
                  } else {
                     BiFunction<A, B, R> $$5x = (BiFunction)$$5.tryTrigger($$0, $$1, $$2);
                     return (R)($$5x == null ? null : $$5x.apply($$3x, $$4x));
                  }
               }
            }
      ...
      public <T1, T2, T3, R> BehaviorBuilder<E, R> ap3(
         ...
         final BehaviorBuilder.TriggerWithResult<E, T1> $$4 = BehaviorBuilder.get($$1);
         final BehaviorBuilder.TriggerWithResult<E, T2> $$5 = BehaviorBuilder.get($$2);
         final BehaviorBuilder.TriggerWithResult<E, T3> $$6 = BehaviorBuilder.get($$3);
         final BehaviorBuilder.TriggerWithResult<E, Function3<T1, T2, T3, R>> $$7 = BehaviorBuilder.get($$0);
         return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>(this) {
            @Override
            public R tryTrigger(ServerLevel $$0, E $$1, long $$2) {
               T1 $$3 = $$4.tryTrigger($$0, $$1, $$2);
               if ($$3 == null) {
                  return null;
               } else {
                  T2 $$4x = $$5.tryTrigger($$0, $$1, $$2);
                  if ($$4x == null) {
                     return null;
                  } else {
                     T3 $$5x = $$6.tryTrigger($$0, $$1, $$2);
                     if ($$5x == null) {
                        return null;
                     } else {
                        Function3<T1, T2, T3, R> $$6x = $$7.tryTrigger($$0, $$1, $$2);
      ...
      public <T1, T2, T3, T4, R> BehaviorBuilder<E, R> ap4(
         ...
         final BehaviorBuilder.TriggerWithResult<E, T1> $$5 = BehaviorBuilder.get($$1);
         final BehaviorBuilder.TriggerWithResult<E, T2> $$6 = BehaviorBuilder.get($$2);
         final BehaviorBuilder.TriggerWithResult<E, T3> $$7 = BehaviorBuilder.get($$3);
         final BehaviorBuilder.TriggerWithResult<E, T4> $$8 = BehaviorBuilder.get($$4);
         final BehaviorBuilder.TriggerWithResult<E, Function4<T1, T2, T3, T4, R>> $$9 = BehaviorBuilder.get($$0);
         return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>(this) {
            @Override
            public R tryTrigger(ServerLevel $$0, E $$1, long $$2) {
               T1 $$3 = $$5.tryTrigger($$0, $$1, $$2);
               if ($$3 == null) {
                  return null;
               } else {
                  T2 $$4 = $$6.tryTrigger($$0, $$1, $$2);
                  if ($$4 == null) {
                     return null;
                  } else {
                     T3 $$5x = $$7.tryTrigger($$0, $$1, $$2);
                     if ($$5x == null) {
                        return null;
                     } else {
                        T4 $$6x = $$8.tryTrigger($$0, $$1, $$2);
                        if ($$6x == null) {
                           return null;
                        } else {
                           Function4<T1, T2, T3, T4, R> $$7x = $$9.tryTrigger($$0, $$1, $$2);
