   ...
   public static BehaviorControl<LivingEntity> create(Block $$0) {
      return BehaviorBuilder.create(
         $$1 -> $$1.<MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
                  $$1.absent(MemoryModuleType.ATTACK_TARGET), $$1.present(MemoryModuleType.WALK_TARGET), $$1.present(MemoryModuleType.IS_PREGNANT)
               )
               .apply(
                  $$1,
                  ($$1x, $$2, $$3) -> ($$2x, $$3x, $$4) -> {
                        if (!$$3x.isInWater() && $$3x.onGround()) {
                           ...
                           for(Direction $$6 : Direction.Plane.HORIZONTAL) {
                              ...
                              if ($$2x.getBlockState($$7).getCollisionShape($$2x, $$7).getFaceShape(Direction.UP).isEmpty()
                                 && $$2x.getFluidState($$7).is(Fluids.WATER)) {
                                 BlockPos $$8 = $$7.above();
                                 if ($$2x.getBlockState($$8).isAir()) {
                                    BlockState $$9 = $$0.defaultBlockState();
                                    $$2x.setBlock($$8, $$9, 3);
                                    $$2x.gameEvent(GameEvent.BLOCK_PLACE, $$8, GameEvent.Context.of($$3x, $$9));
