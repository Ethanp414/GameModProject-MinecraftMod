...
public class MemoryModuleType<U> {
   ...
   public MemoryModuleType(Optional<Codec<U>> $$0) {
      this.codec = $$0.map(ExpirableValue::codec);
   }
   ...
   private static <U> MemoryModuleType<U> register(String $$0, Codec<U> $$1) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace($$0), new MemoryModuleType<>(Optional.of($$1)));
   }

   private static <U> MemoryModuleType<U> register(String $$0) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace($$0), new MemoryModuleType<>(Optional.empty()));
   }
}
