...
public class GolemRandomStrollInVillageGoal extends RandomStrollGoal {
   ...
   private SectionPos getRandomVillageSection() {
      ServerLevel $$0 = (ServerLevel)this.mob.level();
      List<SectionPos> $$1 = (List)SectionPos.cube(SectionPos.of(this.mob), 2).filter($$1x -> $$0.sectionsToVillage($$1x) == 0).collect(Collectors.toList());
   ...
   private BlockPos getRandomPoiWithinSection(SectionPos $$0) {
      ...
      List<BlockPos> $$3 = (List)$$2.getInRange($$0x -> true, $$0.center(), 8, PoiManager.Occupancy.IS_OCCUPIED)
