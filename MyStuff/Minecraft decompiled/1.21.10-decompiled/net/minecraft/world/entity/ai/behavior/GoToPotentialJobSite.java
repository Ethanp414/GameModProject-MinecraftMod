...
public class GoToPotentialJobSite extends Behavior<Villager> {
   ...
   protected void tick(ServerLevel $$0, Villager $$1, long $$2) {
      BehaviorUtils.setWalkAndLookTargetMemories(
         $$1, ((GlobalPos)$$1.getBrain().getMemory(MemoryModuleType.POTENTIAL_JOB_SITE).get()).pos(), this.speedModifier, 1
      );
   }
   ...
   protected void stop(ServerLevel $$0, Villager $$1, long $$2) {
      ...
      $$3.ifPresent($$1x -> {
         BlockPos $$2xx = $$1x.pos();
         ServerLevel $$3xx = $$0.getServer().getLevel($$1x.dimension());
         if ($$3xx != null) {
            PoiManager $$4 = $$3xx.getPoiManager();
            if ($$4.exists($$2xx, $$0xx -> true)) {
               $$4.release($$2xx);
            }

            $$0.debugSynchronizers().updatePoi($$2xx);
         }
      });
