...
public class InteractWith {
   ...
   public static <E extends LivingEntity, T extends LivingEntity> BehaviorControl<E> of(
      EntityType<? extends T> $$0, int $$1, Predicate<E> $$2, Predicate<T> $$3, MemoryModuleType<T> $$4, float $$5, int $$6
   ) {
      int $$7 = $$1 * $$1;
      Predicate<LivingEntity> $$8 = $$2x -> $$0.equals($$2x.getType()) && $$3.test($$2x);
      return BehaviorBuilder.create(
         $$6x -> $$6x.<MemoryAccessor, MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
                  $$6x.registered($$4),
               ...
               .apply($$6x, ($$6xx, $$7x, $$8x, $$9) -> ($$10, $$11, $$12) -> {
                     ...
                     if ($$2.test($$11) && $$13.contains($$8)) {
                        Optional<LivingEntity> $$14 = $$13.findClosest($$3xxxx -> $$3xxxx.distanceToSqr($$11) <= (double)$$7 && $$8.test($$3xxxx));
                        $$14.ifPresent($$5xxxx -> {
                           $$6xx.set($$5xxxx);
