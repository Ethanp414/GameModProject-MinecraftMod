...
public final class LongJumpUtil {
         ...
         if ($$22 > (double)$$2) {
            ...
            if ($$4) {
               ...
               for(int $$29 = 0; $$29 < $$25 - 1; ++$$29) {
                  ...
                  if ($$27 != null && !isClearTransition($$0, $$28, $$27, $$33)) {
                     return Optional.empty();
                  }
   ...
   private static boolean isClearTransition(Mob $$0, EntityDimensions $$1, Vec3 $$2, Vec3 $$3) {
      Vec3 $$4 = $$3.subtract($$2);
      double $$5 = (double)Math.min($$1.width(), $$1.height());
      int $$6 = Mth.ceil($$4.length() / $$5);
      Vec3 $$7 = $$4.normalize();
      Vec3 $$8 = $$2;

      for(int $$9 = 0; $$9 < $$6; ++$$9) {
         $$8 = $$9 == $$6 - 1 ? $$3 : $$8.add($$7.scale($$5 * 0.9F));
         if (!$$0.level().noCollision($$0, $$1.makeBoundingBox($$8))) {
            return false;
         }
      }
