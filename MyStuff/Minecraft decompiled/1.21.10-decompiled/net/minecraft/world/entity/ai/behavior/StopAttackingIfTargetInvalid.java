...
public class StopAttackingIfTargetInvalid {
   ...
   public static <E extends Mob> BehaviorControl<E> create(StopAttackingIfTargetInvalid.TargetErasedCallback<E> $$0) {
      return create(($$0x, $$1) -> false, $$0, true);
   }

   public static <E extends Mob> BehaviorControl<E> create(StopAttackingIfTargetInvalid.StopAttackCondition $$0) {
      return create($$0, ($$0x, $$1, $$2) -> {
      }, true);
   }

   public static <E extends Mob> BehaviorControl<E> create() {
      return create(($$0, $$1) -> false, ($$0, $$1, $$2) -> {
      }, true);
   }
