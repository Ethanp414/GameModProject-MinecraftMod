...
public class DefaultRandomPos {
   ...
   public static Vec3 getPosTowards(PathfinderMob $$0, int $$1, int $$2, Vec3 $$3, double $$4) {
      ...
      return RandomPos.generateRandomPos($$0, () -> {
         BlockPos $$6xx = RandomPos.generateRandomDirectionWithinRadians($$0.getRandom(), $$1, $$2, 0, $$5.x, $$5.z, $$4);
         return $$6xx == null ? null : generateRandomPosTowardDirection($$0, $$1, $$6, $$6xx);
      });
   }
   ...
   public static Vec3 getPosAway(PathfinderMob $$0, int $$1, int $$2, Vec3 $$3) {
      ...
      return RandomPos.generateRandomPos($$0, () -> {
         BlockPos $$5xx = RandomPos.generateRandomDirectionWithinRadians($$0.getRandom(), $$1, $$2, 0, $$4.x, $$4.z, (float) (Math.PI / 2));
         return $$5xx == null ? null : generateRandomPosTowardDirection($$0, $$1, $$5, $$5xx);
      });
   }
