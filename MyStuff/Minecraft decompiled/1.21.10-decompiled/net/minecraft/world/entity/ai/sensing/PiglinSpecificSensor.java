...
public class PiglinSpecificSensor extends Sensor<LivingEntity> {
   ...
   protected void doTick(ServerLevel $$0, LivingEntity $$1) {
      ...
      int $$10 = 0;
      List<AbstractPiglin> $$11 = Lists.<AbstractPiglin>newArrayList();
      List<AbstractPiglin> $$12 = Lists.<AbstractPiglin>newArrayList();
      NearestVisibleLivingEntities $$13 = (NearestVisibleLivingEntities)$$2.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
         .orElse(NearestVisibleLivingEntities.empty());

      for(LivingEntity $$14 : $$13.findAll($$0x -> true)) {
