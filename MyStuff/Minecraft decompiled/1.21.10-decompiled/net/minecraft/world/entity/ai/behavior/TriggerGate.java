...
public class TriggerGate {
   ...
   public static <E extends LivingEntity> OneShot<E> triggerGate(
      ...
      $$0.forEach($$1x -> $$3.add((Trigger<? super E>)$$1x.getFirst(), $$1x.getSecond()));
      return BehaviorBuilder.create($$3x -> $$3x.point((Trigger<LivingEntity>)($$3xx, $$4, $$5) -> {
            if ($$1 == GateBehavior.OrderPolicy.SHUFFLED) {
               $$3.shuffle();
            }

            for(Trigger<? super E> $$6 : $$3) {
               if ($$6.trigger($$3xx, (E)$$4, $$5) && $$2 == GateBehavior.RunningPolicy.RUN_ONE) {
                  break;
               }
            }
