               ...
               Vec3 $$2 = LandRandomPos.getPos(
                  ...
                  $$2x -> {
                     if (!$$0.isVillage($$2x)) {
                        ...
                        Optional<BlockPos> $$3xx = $$0.getPoiManager()
                           .find($$0xx -> $$0xx.is(PoiTypeTags.VILLAGE), this::hasNotVisited, $$2x, 10, PoiManager.Occupancy.IS_OCCUPIED);
                        return $$3xx.map($$1xx -> -$$1xx.distSqr($$1)).orElse(Double.NEGATIVE_INFINITY);
                     }
                  }
               );
               if ($$2 == null) {
                  ...
                  if ($$3.isEmpty()) {
                     ...
                     for(int $$6 = 0; $$6 < this.path.getNodeCount(); ++$$6) {
                        ...
                        if (DoorBlock.isWoodenDoor(this.mob.level(), $$8)) {
                           this.path = this.mob.getNavigation().createPath((double)$$7.x, (double)$$7.y, (double)$$7.z, 0);
                           break;
                        }
                     }
