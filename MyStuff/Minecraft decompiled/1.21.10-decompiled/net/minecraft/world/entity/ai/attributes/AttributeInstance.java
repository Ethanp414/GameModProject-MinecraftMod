...
public class AttributeInstance {
   ...
   @VisibleForTesting
   Map<ResourceLocation, AttributeModifier> getModifiers(AttributeModifier.Operation $$0) {
      return (Map<ResourceLocation, AttributeModifier>)this.modifiersByOperation.computeIfAbsent($$0, $$0x -> new Object2ObjectOpenHashMap());
   }
   ...
   public AttributeModifier getModifier(ResourceLocation $$0) {
      return (AttributeModifier)this.modifierById.get($$0);
   }
   ...
   private void addModifier(AttributeModifier $$0) {
      AttributeModifier $$1 = (AttributeModifier)this.modifierById.putIfAbsent($$0.id(), $$0);
      if ($$1 != null) {
   ...
   public void addOrUpdateTransientModifier(AttributeModifier $$0) {
      AttributeModifier $$1 = (AttributeModifier)this.modifierById.put($$0.id(), $$0);
      if ($$0 != $$1) {
         this.getModifiers($$0.operation()).put($$0.id(), $$0);
         this.setDirty();
      }
   ...
   public boolean removeModifier(ResourceLocation $$0) {
      AttributeModifier $$1 = (AttributeModifier)this.modifierById.remove($$0);
      if ($$1 == null) {
         return false;
      } else {
   ...
   private Collection<AttributeModifier> getModifiersOrEmpty(AttributeModifier.Operation $$0) {
      return ((Map)this.modifiersByOperation.getOrDefault($$0, Map.of())).values();
   }
   ...
   public void replaceFrom(AttributeInstance $$0) {
      ...
      $$0.modifiersByOperation.forEach(($$0x, $$1) -> this.getModifiers($$0x).putAll($$1));
      this.setDirty();
   }
