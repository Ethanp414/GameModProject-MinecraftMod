      ...
      return BehaviorBuilder.create(
         $$3 -> $$3.group($$3.absent(MemoryModuleType.WALK_TARGET), $$3.absent(MemoryModuleType.HOME))
               .apply(
                  $$3,
                  ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                        if ($$4x.getGameTime() - $$2.getValue() < 20L) {
                           return false;
                        } else {
                           ...
                           if (!$$8.isEmpty() && !(((BlockPos)$$8.get()).distSqr($$5.blockPosition()) <= 4.0)) {
                              MutableInt $$9 = new MutableInt(0);
                              $$2.setValue($$4x.getGameTime() + (long)$$4x.getRandom().nextInt(20));
                              Predicate<BlockPos> $$10 = $$3xxx -> {
                                 long $$4xxx = $$3xxx.asLong();
                                 if ($$1.containsKey($$4xxx)) {
                                    return false;
                                 } else if ($$9.incrementAndGet() >= 5) {
                                    return false;
                                 } else {
                                    $$1.put($$4xxx, $$2.getValue() + 40L);
                                    return true;
                                 }
                              };
                              Set<Pair<Holder<PoiType>, BlockPos>> $$11 = (Set)$$7.findAllWithType(
