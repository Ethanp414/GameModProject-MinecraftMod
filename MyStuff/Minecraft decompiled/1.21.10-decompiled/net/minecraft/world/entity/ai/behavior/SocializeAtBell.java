               ...
               .apply(
                  ...
                  ($$1, $$2, $$3, $$4, $$5) -> ($$6, $$7, $$8) -> {
                        ...
                        if ($$6.getRandom().nextInt(100) == 0
                           ...
                           && $$10.contains($$0xxx -> EntityType.VILLAGER.equals($$0xxx.getType()))) {
                           $$10.findClosest($$1xx -> EntityType.VILLAGER.equals($$1xx.getType()) && $$1xx.distanceToSqr($$7) <= 32.0).ifPresent($$3xx -> {
                              $$5.set($$3xx);
