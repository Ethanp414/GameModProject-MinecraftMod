...
public abstract class PathNavigation {
   ...
   public Path createPath(Stream<BlockPos> $$0, int $$1) {
      return this.createPath((Set<BlockPos>)$$0.collect(Collectors.toSet()), 8, false, $$1);
   }
   ...
   public Path createPath(BlockPos $$0, int $$1, int $$2) {
      return this.createPath(ImmutableSet.of($$0), 8, false, $$1, (float)$$2);
   }
   ...
   protected void doStuckDetection(Vec3 $$0) {
      ...
      if (this.path != null && !this.path.isDone()) {
         ...
         if ($$3.equals(this.timeoutCachedNode)) {
            ...
            this.timeoutLimit = this.mob.getSpeed() > 0.0F ? $$5 / (double)this.mob.getSpeed() * 20.0 : 0.0;
         }
   ...
   protected static boolean isClearForMovementBetween(Mob $$0, Vec3 $$1, Vec3 $$2, boolean $$3) {
      ...
      return $$0.level().clip(new ClipContext($$1, $$4, ClipContext.Block.COLLIDER, $$3 ? ClipContext.Fluid.ANY : ClipContext.Fluid.NONE, $$0)).getType()
         == HitResult.Type.MISS;
   }
