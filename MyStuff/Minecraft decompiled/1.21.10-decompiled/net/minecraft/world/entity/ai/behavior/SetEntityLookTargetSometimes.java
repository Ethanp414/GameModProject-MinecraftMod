      ...
      return BehaviorBuilder.create(
         $$3x -> $$3x.group($$3x.absent(MemoryModuleType.LOOK_TARGET), $$3x.present(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES))
               .apply(
                  $$3x,
                  ($$4x, $$5) -> ($$6, $$7, $$8) -> {
                        Optional<LivingEntity> $$9 = $$3x.<NearestVisibleLivingEntities>get($$5)
                           .findClosest($$2.and($$2xxxx -> $$2xxxx.distanceToSqr($$7) <= (double)$$3));
                        if ($$9.isEmpty()) {
                           return false;
                        } else if (!$$4.tickDownAndCheck($$6.random)) {
                           return false;
                        } else {
                           $$4x.set(new EntityTracker((Entity)$$9.get(), true));
                           return true;
                        }
                     }
               )
