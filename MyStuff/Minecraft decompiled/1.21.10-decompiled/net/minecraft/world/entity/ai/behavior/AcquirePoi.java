...
public class AcquirePoi {
   ...
   public static BehaviorControl<PathfinderMob> create(
      ...
      OneShot<PathfinderMob> $$10 = BehaviorBuilder.create(
               ...
               .apply(
                  ...
                  $$6xx -> ($$7xx, $$8x, $$9x) -> {
                        if ($$3 && $$8x.isBaby()) {
                           ...
                           $$8.setValue($$7xx.getGameTime() + (long)$$7xx.random.nextInt(20));
                           return false;
                        } else if ($$7xx.getGameTime() < $$8.getValue()) {
                           return false;
                        } else {
                           $$8.setValue($$9x + 20L + (long)$$7xx.getRandom().nextInt(20));
                           PoiManager $$10xx = $$7xx.getPoiManager();
                           ...
                           Predicate<BlockPos> $$11 = $$2xxxx -> {
                              AcquirePoi.JitteredLinearRetry $$3xxxxx = $$9.get($$2xxxx.asLong());
                              if ($$3xxxxx == null) {
                                 return true;
                              } else if (!$$3xxxxx.shouldRetry($$9x)) {
                                 return false;
                              } else {
                                 $$3xxxxx.markAttempt($$9x);
                                 return true;
                              }
                           };
                           ...
                           if ($$13 != null && $$13.canReach()) {
                              ...
                              for(Pair<Holder<PoiType>, BlockPos> $$15 : $$12) {
                                 $$9.computeIfAbsent(
                                    $$15.getSecond().asLong(),
                                    (Long2ObjectFunction<? extends AcquirePoi.JitteredLinearRetry>)($$2xxxx -> new AcquirePoi.JitteredLinearRetry(
                                          $$7xx.random, $$9x
                                       ))
                                 );
                              }
   ...
   public static Path findPathToPois(Mob $$0, Set<Pair<Holder<PoiType>, BlockPos>> $$1) {
      if ($$1.isEmpty()) {
         ...
         for(Pair<Holder<PoiType>, BlockPos> $$4 : $$1) {
            $$3 = Math.max($$3, ((PoiType)$$4.getFirst().value()).validRange());
            $$2.add($$4.getSecond());
         }
