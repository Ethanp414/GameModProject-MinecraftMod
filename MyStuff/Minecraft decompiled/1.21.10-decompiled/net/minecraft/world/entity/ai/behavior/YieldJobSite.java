...
public class YieldJobSite {
   public static BehaviorControl<Villager> create(float $$0) {
      return BehaviorBuilder.create(
         $$1 -> $$1.<MemoryAccessor, MemoryAccessor, MemoryAccessor, MemoryAccessor, MemoryAccessor>group(
                        ...
                        if ($$7.isBaby()) {
                           ...
                           if ($$10.isEmpty()) {
                              ...
                              ((List)$$1.get($$4))
                                 ...
                                 .filter($$2xx -> nearbyWantsJobsite((Holder<PoiType>)$$10.get(), $$2xx, $$9))
                                 .findFirst()
                                 .ifPresent($$6xx -> {
                                    $$5.erase();
                                    $$6.erase();
   ...
   private static boolean nearbyWantsJobsite(Holder<PoiType> $$0, Villager $$1, BlockPos $$2) {
      ...
      if ($$3) {
         ...
         if (((VillagerProfession)$$5.value()).heldJobSite().test($$0)) {
            return $$4.isEmpty() ? canReachPos($$1, $$2, (PoiType)$$0.value()) : ((GlobalPos)$$4.get()).pos().equals($$2);
         } else {
            return false;
         }
      }
