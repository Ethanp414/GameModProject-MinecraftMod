...
public class BehaviorUtils {
   ...
   public static boolean entityIsVisible(Brain<?> $$0, LivingEntity $$1) {
      ...
      return $$2.isPresent() && ((NearestVisibleLivingEntities)$$2.get()).contains($$1);
   }
   ...
   private static boolean targetIsValid(Brain<?> $$0, MemoryModuleType<? extends LivingEntity> $$1, Predicate<LivingEntity> $$2) {
      return $$0.getMemory($$1).filter($$2).filter(LivingEntity::isAlive).filter($$1x -> entityIsVisible($$0, $$1x)).isPresent();
   }
   ...
   public static SectionPos findSectionClosestToVillage(ServerLevel $$0, SectionPos $$1, int $$2) {
      ...
      return (SectionPos)SectionPos.cube($$1, $$2)
         .filter($$2x -> $$0.sectionsToVillage($$2x) < $$3)
         .min(Comparator.comparingInt($$0::sectionsToVillage))
         .orElse($$1);
   }

   public static boolean isWithinAttackRange(Mob $$0, LivingEntity $$1, int $$2) {
      Item $$4 = $$0.getMainHandItem().getItem();
      if ($$4 instanceof ProjectileWeaponItem $$3 && $$0.canFireProjectileWeapon($$3)) {
         int $$4x = $$3.getDefaultProjectileRange() - $$2;
         return $$0.closerThan($$1, (double)$$4x);
      }
   ...
   public static boolean isOtherTargetMuchFurtherAwayThanCurrentAttackTarget(LivingEntity $$0, LivingEntity $$1, double $$2) {
      ...
      if ($$3.isEmpty()) {
         ...
         double $$4 = $$0.distanceToSqr(((LivingEntity)$$3.get()).position());
   ...
   public static boolean canSee(LivingEntity $$0, LivingEntity $$1) {
      ...
      return !$$2.hasMemoryValue(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
         ? false
         : ((NearestVisibleLivingEntities)$$2.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get()).contains($$1);
   }

   public static LivingEntity getNearestTarget(LivingEntity $$0, Optional<LivingEntity> $$1, LivingEntity $$2) {
      return $$1.isEmpty() ? $$2 : getTargetNearestMe($$0, (LivingEntity)$$1.get(), $$2);
   }
   ...
   public static Optional<LivingEntity> getLivingEntityFromUUIDMemory(LivingEntity $$0, MemoryModuleType<UUID> $$1) {
      ...
      return $$2.map($$1x -> ((ServerLevel)$$0.level()).getEntity($$1x)).map($$0x -> $$0x instanceof LivingEntity $$1xx ? $$1xx : null);
   }
