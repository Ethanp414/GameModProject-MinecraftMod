...
public class Brain<E extends LivingEntity> {
         ...
         (new MapCodec<Brain<E>>() {
               ...
               public <T> Stream<T> keys(DynamicOps<T> $$0x) {
                  return $$0.stream()
                     ...
                     .map($$1xx -> $$0.createString($$1xx.toString()));
               }
               ...
               public <T> DataResult<Brain<E>> decode(DynamicOps<T> $$0x, MapLike<T> $$1x) {
                  ...
                  $$1.entries().forEach($$2xxx -> {
                     DataResult<MemoryModuleType<?>> $$3xx = BuiltInRegistries.MEMORY_MODULE_TYPE.byNameCodec().parse($$0, (T)$$2xxx.getFirst());
                     DataResult<? extends Brain.MemoryValue<?>> $$4 = $$3xx.flatMap($$2xxxxx -> this.captureRead($$2xxxxx, $$0, (T)$$2xxx.getSecond()));
                     $$2.setValue($$2.getValue().apply2(Builder::add, $$4));
                  });
                  ImmutableList<Brain.MemoryValue<?>> $$3 = (ImmutableList)$$2x.getValue()
               ...
               private <T, U> DataResult<Brain.MemoryValue<U>> captureRead(MemoryModuleType<U> $$0x, DynamicOps<T> $$1x, T $$2x) {
                  return ((DataResult)$$0.getCodec().map(DataResult::success).orElseGet(() -> DataResult.error(() -> "No codec for memory: " + $$0)))
   ...
   Stream<Brain.MemoryValue<?>> memories() {
      return this.memories
         .entrySet()
         .stream()
         .map($$0 -> Brain.MemoryValue.createUnchecked((MemoryModuleType)$$0.getKey(), (Optional<? extends ExpirableValue<?>>)$$0.getValue()));
   }
   ...
   public void clearMemories() {
      this.memories.keySet().forEach($$0 -> this.memories.put($$0, Optional.empty()));
   }
   ...
   public <U> Optional<U> getMemory(MemoryModuleType<U> $$0) {
      Optional<? extends ExpirableValue<?>> $$1 = (Optional)this.memories.get($$0);
      if ($$1 == null) {
   ...
   public boolean checkMemory(MemoryModuleType<?> $$0, MemoryStatus $$1) {
      Optional<? extends ExpirableValue<?>> $$2 = (Optional)this.memories.get($$0);
      if ($$2 == null) {
         return false;
      } else {
   ...
   private void eraseMemoriesForOtherActivitesThan(Activity $$0) {
      for(Activity $$1 : this.activeActivities) {
         if ($$1 != $$0) {
            Set<MemoryModuleType<?>> $$2 = (Set)this.activityMemoriesToEraseWhenStopped.get($$1);
            if ($$2 != null) {
   ...
   public void addActivity(Activity $$0, ImmutableList<? extends Pair<Integer, ? extends BehaviorControl<? super E>>> $$1) {
      this.addActivityAndRemoveMemoriesWhenStopped($$0, $$1, ImmutableSet.of(), Sets.<MemoryModuleType<?>>newHashSet());
   }
   ...
   public void addActivityWithConditions(
      ...
      this.addActivityAndRemoveMemoriesWhenStopped($$0, $$1, $$2, Sets.<MemoryModuleType<?>>newHashSet());
   }
   ...
   public void addActivityAndRemoveMemoriesWhenStopped(
      ...
      for(Pair<Integer, ? extends BehaviorControl<? super E>> $$4 : $$1) {
         ((Set)((Map)this.availableBehaviorsByPriority.computeIfAbsent((Integer)$$4.getFirst(), $$0x -> Maps.newHashMap()))
   ...
   private boolean activityRequirementsAreMet(Activity $$0) {
      if (!this.activityRequirements.containsKey($$0)) {
         ...
         for(Pair<MemoryModuleType<?>, MemoryStatus> $$1 : (Set)this.activityRequirements.get($$0)) {
            MemoryModuleType<?> $$2 = $$1.getFirst();
   ...
   ImmutableList<? extends Pair<Integer, ? extends BehaviorControl<? super E>>> createPriorityPairs(
      ...
      for(BehaviorControl<? super E> $$4 : $$1) {
         $$3.add(Pair.of($$2++, $$4));
      }
   ...
   static final class MemoryValue<U> {
      ...
      static <U> Brain.MemoryValue<U> createUnchecked(MemoryModuleType<U> $$0, Optional<? extends ExpirableValue<?>> $$1) {
         return new Brain.MemoryValue<>($$0, $$1);
      }
