...
public class StayCloseToTarget {
   public static BehaviorControl<LivingEntity> create(
      Function<LivingEntity, Optional<PositionTracker>> $$0, Predicate<LivingEntity> $$1, int $$2, int $$3, float $$4
   ) {
      return BehaviorBuilder.create(
         $$5 -> $$5.group($$5.registered(MemoryModuleType.LOOK_TARGET), $$5.registered(MemoryModuleType.WALK_TARGET))
               .apply($$5, ($$5x, $$6) -> ($$7, $$8, $$9) -> {
                     Optional<PositionTracker> $$10 = (Optional)$$0.apply($$8);
                     if (!$$10.isEmpty() && $$1.test($$8)) {
                        PositionTracker $$11 = (PositionTracker)$$10.get();
                        if ($$8.position().closerThan($$11.currentPosition(), (double)$$3)) {
                           return false;
                        } else {
