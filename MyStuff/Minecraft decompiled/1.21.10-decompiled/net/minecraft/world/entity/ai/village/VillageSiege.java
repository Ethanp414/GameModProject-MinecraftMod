...
public class VillageSiege implements CustomSpawner {
   ...
   private Vec3 findRandomSpawnPos(ServerLevel $$0, BlockPos $$1) {
      for(int $$2 = 0; $$2 < 10; ++$$2) {
         ...
         int $$5 = $$0.getHeight(Heightmap.Types.WORLD_SURFACE, $$3, $$4);
         BlockPos $$6 = new BlockPos($$3, $$5, $$4);
         if ($$0.isVillage($$6) && Monster.checkMonsterSpawnRules(EntityType.ZOMBIE, $$0, EntitySpawnReason.EVENT, $$6, $$0.random)) {
