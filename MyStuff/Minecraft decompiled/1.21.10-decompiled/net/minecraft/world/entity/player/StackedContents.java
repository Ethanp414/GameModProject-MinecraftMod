...
public class StackedContents<T> {
   ...
   List<T> getUniqueAvailableIngredientItems(Iterable<? extends StackedContents.IngredientInfo<T>> $$0) {
      ...
      for(Entry<T> $$2 : Reference2IntMaps.fastIterable(this.amounts)) {
         if ($$2.getIntValue() > 0 && anyIngredientMatches($$0, $$2.getKey())) {
            $$1.add($$2.getKey());
         }
      }
   ...
   class RecipePicker {
      ...
      private void setInitialConnections() {
         for(int $$0 = 0; $$0 < this.ingredientCount; ++$$0) {
            StackedContents.IngredientInfo<T> $$1 = (StackedContents.IngredientInfo)this.ingredients.get($$0);

            for(int $$2 = 0; $$2 < this.itemCount; ++$$2) {
               if ($$1.acceptsItem((T)this.items.get($$2))) {
      ...
      public boolean tryPick(int $$0, @Nullable StackedContents.Output<T> $$1) {
         if ($$0 <= 0) {
            ...
            while(true) {
                  ...
                  for(int $$13 = 0; $$13 < this.ingredientCount; ++$$13) {
                     for(int $$14 = 0; $$14 < this.itemCount; ++$$14) {
                        if (this.isAssigned($$14, $$13)) {
                           this.unassign($$14, $$13);
                           StackedContents.this.put((T)this.items.get($$14), $$0);
                           if ($$12) {
                              $$1.accept((T)this.items.get($$14));
                           }
                           break;
                        }
                     }
               ...
               int $$4 = $$3.getInt(0);
               StackedContents.this.take((T)this.items.get($$4), $$0);
               int $$5 = $$3.size() - 1;
      ...
      private IntList tryAssigningNewItem(int $$0) {
         ...
         for(int $$1 = 0; $$1 < this.itemCount; ++$$1) {
            if (StackedContents.this.hasAtLeast((T)this.items.get($$1), $$0)) {
