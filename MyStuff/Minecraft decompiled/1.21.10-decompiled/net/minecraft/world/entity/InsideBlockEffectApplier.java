...
public interface InsideBlockEffectApplier {
   ...
   public static class StepBasedCollector implements InsideBlockEffectApplier {
      ...
      private final Map<InsideBlockEffectType, List<Consumer<Entity>>> beforeEffectsInStep = Util.makeEnumMap(
         InsideBlockEffectType.class, $$0 -> new ArrayList()
      );
      ...
      private void flushStep() {
         for(InsideBlockEffectType $$0 : APPLY_ORDER) {
            List<Consumer<Entity>> $$1 = (List)this.beforeEffectsInStep.get($$0);
            ...
            List<Consumer<Entity>> $$2 = (List)this.afterEffectsInStep.get($$0);
      ...
      @Override
      public void runBefore(InsideBlockEffectType $$0, Consumer<Entity> $$1) {
         ((List)this.beforeEffectsInStep.get($$0)).add($$1);
      }

      @Override
      public void runAfter(InsideBlockEffectType $$0, Consumer<Entity> $$1) {
         ((List)this.afterEffectsInStep.get($$0)).add($$1);
      }
   }
}
