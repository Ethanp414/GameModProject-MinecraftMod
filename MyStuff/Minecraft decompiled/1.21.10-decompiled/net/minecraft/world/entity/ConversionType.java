...
public enum ConversionType {
   SINGLE(true) {
      ...
      void convert(Mob $$0, Mob $$1, ConversionParams $$2) {
         ...
         if ($$3 != null) {
            ...
            for(Entity $$4 : $$1.getPassengers()) {
               $$4.stopRiding();
               $$4.remove(Entity.RemovalReason.DISCARDED);
            }

            $$3.startRiding($$1);
         }

         Entity $$5 = $$0.getVehicle();
         if ($$5 != null) {
            $$0.stopRiding();
   ...
   ConversionType(final boolean param3) {
   ...
   void convertCommon(Mob $$0, Mob $$1, ConversionParams $$2) {
      ...
      if ($$0 instanceof AgeableMob $$4 && $$1 instanceof AgeableMob $$5) {
         $$5.setAge($$4.getAge());
