...
public abstract class Raider extends PatrollingMonster {
   ...
   public void aiStep() {
      Level $$1 = this.level();
      if ($$1 instanceof ServerLevel $$0 && this.isAlive()) {
         Raid $$1x = this.getCurrentRaid();
         if (this.canJoinRaid()) {
            if ($$1x == null) {
   ...
   public void die(DamageSource $$0) {
      ...
      if ($$2 instanceof ServerLevel $$1) {
         ...
         if ($$3 != null) {
            ...
            if ($$2x != null && $$2x.getType() == EntityType.PLAYER) {
               $$3.addHeroOfTheVillage($$2x);
            }
   ...
   public boolean hasRaid() {
      ...
      if (!(var2 instanceof ServerLevel)) {
         ...
         ServerLevel $$0 = (ServerLevel)var2;
         return this.getCurrentRaid() != null || $$0.getRaidAt(this.blockPosition()) != null;
      }
   }
   ...
   protected void pickUpItem(ServerLevel $$0, ItemEntity $$1) {
      ...
      if (this.hasActiveRaid()
         && !$$3
         && ItemStack.matches($$2, Raid.getOminousBannerInstance(this.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)))) {
         EquipmentSlot $$4 = EquipmentSlot.HEAD;
         ItemStack $$5 = this.getItemBySlot($$4);
         double $$6 = (double)this.getDropChances().byEquipment($$4);
   ...
   protected static class HoldGroundAttackGoal extends Goal {
      ...
      public boolean canUse() {
         ...
         return this.mob.getCurrentRaid() == null
            ...
            && ($$0 == null || $$0.getType() != EntityType.PLAYER);
      }
