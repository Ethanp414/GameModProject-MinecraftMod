...
public class PrimedTnt extends Entity implements TraceableEntity {
   ...
   public PrimedTnt(Level $$0, double $$1, double $$2, double $$3, @Nullable LivingEntity $$4) {
      ...
      this.yo = $$2;
      this.zo = $$3;
      this.owner = EntityReference.of($$4);
   }
   ...
   private void explode() {
      ...
      if (var2 instanceof ServerLevel $$0 && $$0.getGameRules().getBoolean(GameRules.RULE_TNT_EXPLODES)) {
         this.level()
            .explode(
               this,
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setBlockState((BlockState)$$0.read("block_state", BlockState.CODEC).orElse(DEFAULT_BLOCK_STATE));
