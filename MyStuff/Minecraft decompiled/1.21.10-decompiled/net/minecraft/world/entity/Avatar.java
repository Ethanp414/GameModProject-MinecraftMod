...
public class Avatar extends LivingEntity {
   ...
   protected static final Map<Pose, EntityDimensions> POSES = ImmutableMap.builder()
      ...
      .build();
   protected static final EntityDataAccessor<Byte> DATA_PLAYER_MAIN_HAND = SynchedEntityData.defineId(Avatar.class, EntityDataSerializers.BYTE);
   ...
   protected Avatar(EntityType<? extends LivingEntity> $$0, Level $$1) {
      super($$0, $$1);
   }
   ...
   public void setMainArm(HumanoidArm $$0) {
      this.entityData.set(DATA_PLAYER_MAIN_HAND, (byte)($$0 == HumanoidArm.LEFT ? 0 : 1));
   }
   ...
   public EntityDimensions getDefaultDimensions(Pose $$0) {
      return (EntityDimensions)POSES.getOrDefault($$0, STANDING_DIMENSIONS);
   }
}
