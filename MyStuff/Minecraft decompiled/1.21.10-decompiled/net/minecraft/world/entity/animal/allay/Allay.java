...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
   ...
   public boolean wantsToPickUp(ServerLevel $$0, ItemStack $$1) {
      ...
      return !$$2.isEmpty()
         && $$0.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)
   ...
   private boolean hasNonMatchingPotion(ItemStack $$0, ItemStack $$1) {
      ...
      PotionContents $$3 = $$1.get(DataComponents.POTION_CONTENTS);
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setDuplicationCooldown((long)$$0.getIntOr("DuplicationCooldown", 0));
   }
