...
public record ChickenVariant(ModelAndTexture<ChickenVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions)
   ...
   public static final Codec<ChickenVariant> NETWORK_CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(ModelAndTexture.codec(ChickenVariant.ModelType.CODEC, ChickenVariant.ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture))
            .apply($$0, ChickenVariant::new)
   );
   ...
   private ChickenVariant(ModelAndTexture<ChickenVariant.ModelType> $$0) {
