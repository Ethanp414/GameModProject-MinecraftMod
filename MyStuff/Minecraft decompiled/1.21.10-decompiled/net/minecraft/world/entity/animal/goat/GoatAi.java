         ...
         ImmutableList.of(
            ...
            Pair.of(
               ...
               new LongJumpToRandomPos<>(
                  ...
                  5,
                  3.5714288F,
                  $$0x -> $$0x.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_LONG_JUMP : SoundEvents.GOAT_LONG_JUMP
               )
            )
         ),
         ImmutableSet.of(
      ...
      $$0.addActivityWithConditions(
         ...
         ImmutableList.of(
            Pair.of(
               0,
               new RamTarget(
                  $$0x -> $$0x.isScreamingGoat() ? TIME_BETWEEN_RAMS_SCREAMER : TIME_BETWEEN_RAMS,
                  RAM_TARGET_CONDITIONS,
                  3.0F,
                  $$0x -> $$0x.isBaby() ? 1.0 : 2.5,
                  $$0x -> $$0x.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_RAM_IMPACT : SoundEvents.GOAT_RAM_IMPACT,
                  $$0x -> SoundEvents.GOAT_HORN_BREAK
               )
            ),
            Pair.of(
               1,
               new PrepareRamNearestTarget<>(
                  $$0x -> $$0x.isScreamingGoat() ? TIME_BETWEEN_RAMS_SCREAMER.getMinValue() : TIME_BETWEEN_RAMS.getMinValue(),
                  4,
                  7,
                  1.25F,
                  RAM_TARGET_CONDITIONS,
                  20,
                  $$0x -> $$0x.isScreamingGoat() ? SoundEvents.GOAT_SCREAMING_PREPARE_RAM : SoundEvents.GOAT_PREPARE_RAM
               )
            )
         ),
         ImmutableSet.of(
