...
public class Cow extends AbstractCow {
   ...
   protected void defineSynchedData(SynchedEntityData.Builder $$0) {
      ...
      $$0.define(DATA_VARIANT_ID, VariantUtils.<CowVariant>getDefaultOrAny(this.registryAccess(), CowVariants.TEMPERATE));
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.COW_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
