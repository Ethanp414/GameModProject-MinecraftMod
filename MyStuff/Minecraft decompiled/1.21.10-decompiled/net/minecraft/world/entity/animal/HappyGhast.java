...
public class HappyGhast extends Animal {
   ...
   private void setServerStillTimeout(int $$0) {
      if (this.serverStillTimeout <= 0 && $$0 > 0) {
      ...
      this.goalSelector
         .addGoal(
            ...
            new TemptGoal.ForNonPathfinders(
               this, 1.0, $$0 -> !this.isWearingBodyArmor() && !this.isBaby() ? $$0.is(ItemTags.HAPPY_GHAST_TEMPT_ITEMS) : IS_FOOD.test($$0), false, 7.0
            )
         );
   ...
   public LivingEntity getControllingPassenger() {
      ...
      return (LivingEntity)(this.isWearingBodyArmor() && !this.isOnStillTimeout() && $$0 instanceof Player ? (Player)$$0 : super.getControllingPassenger());
   }
   ...
   protected Vec3 getRiddenInput(Player $$0, Vec3 $$1) {
      ...
      return new Vec3((double)$$2, (double)$$4, (double)$$3).scale(3.9F * this.getAttributeValue(Attributes.FLYING_SPEED));
   }
   ...
   private void checkRestriction() {
      if (!this.isLeashed() && !this.isVehicle()) {
         ...
         if (!this.hasHome() || !this.getHomePosition().closerThan(this.blockPosition(), (double)($$0 + 16)) || $$0 != this.getHomeRadius()) {
   ...
   private void continuousHeal() {
      Level $$2 = this.level();
      if ($$2 instanceof ServerLevel $$0 && this.isAlive() && this.deathTime == 0 && this.getMaxHealth() != this.getHealth()) {
         boolean $$2x = $$0.dimensionType().natural() && (this.isInClouds() || $$0.precipitationAt(this.blockPosition()) != Biome.Precipitation.NONE);
         if (this.tickCount % ($$2x ? 20 : 600) == 0) {
            this.heal(1.0F);
         }
