...
public class IronGolem extends AbstractGolem implements NeutralMob {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector
         .addGoal(3, new NearestAttackableTargetGoal(this, Mob.class, 5, false, false, ($$0, $$1) -> $$0 instanceof Enemy && !($$0 instanceof Creeper)));
   ...
   public boolean canAttackType(EntityType<?> $$0) {
      if (this.isPlayerCreated() && $$0 == EntityType.PLAYER) {
         ...
         return $$0 == EntityType.CREEPER ? false : super.canAttackType($$0);
      }
   }
   ...
   public boolean doHurtTarget(ServerLevel $$0, Entity $$1) {
      ...
      if ($$5) {
         double $$7 = $$1 instanceof LivingEntity $$6 ? $$6.getAttributeValue(Attributes.KNOCKBACK_RESISTANCE) : 0.0;
         double $$8 = Math.max(0.0, 1.0 - $$7);
         $$1.setDeltaMovement($$1.getDeltaMovement().add(0.0, 0.4F * $$8, 0.0));
   ...
   public boolean checkSpawnObstruction(LevelReader $$0) {
      ...
      if (!$$3.entityCanStandOn($$0, $$2, this)) {
         ...
         for(int $$4 = 1; $$4 < 3; ++$$4) {
            ...
            if (!NaturalSpawner.isValidEmptySpawnBlock($$0, $$5, $$6, $$6.getFluidState(), EntityType.IRON_GOLEM)) {
               return false;
            }
         }

         return NaturalSpawner.isValidEmptySpawnBlock($$0, $$1, $$0.getBlockState($$1), Fluids.EMPTY.defaultFluidState(), EntityType.IRON_GOLEM)
            && $$0.isUnobstructed(this);
      }
   }
