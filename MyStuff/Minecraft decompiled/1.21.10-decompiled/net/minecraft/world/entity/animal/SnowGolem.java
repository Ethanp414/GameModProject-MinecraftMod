...
public class SnowGolem extends AbstractGolem implements Shearable, RangedAttackMob {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, Mob.class, 10, true, false, ($$0, $$1) -> $$0 instanceof Enemy));
   }
   ...
   public void aiStep() {
      ...
      if ($$1 instanceof ServerLevel $$0) {
         ...
         BlockState $$1x = Blocks.SNOW.defaultBlockState();
         ...
         for(int $$2 = 0; $$2 < 4; ++$$2) {
            ...
            if (this.level().getBlockState($$6).isAir() && $$1x.canSurvive(this.level(), $$6)) {
               this.level().setBlockAndUpdate($$6, $$1x);
               this.level().gameEvent(GameEvent.BLOCK_PLACE, $$6, GameEvent.Context.of(this, $$1x));
            }
         }
      }
   }
   ...
   public void performRangedAttack(LivingEntity $$0, float $$1) {
      ...
      Level $$7 = this.level();
      if ($$7 instanceof ServerLevel $$6) {
         ItemStack $$7x = new ItemStack(Items.SNOWBALL);
         Projectile.spawnProjectile(new Snowball($$6, this, $$7x), $$6, $$7x, $$4x -> $$4x.shoot($$2, $$3 + $$5 - $$4x.getY(), $$4, 1.6F, 12.0F));
      }
