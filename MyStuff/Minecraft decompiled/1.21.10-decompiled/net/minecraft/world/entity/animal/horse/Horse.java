...
public class Horse extends AbstractHorse {
   ...
   protected void randomizeAttributes(RandomSource $$0) {
      this.getAttribute(Attributes.MAX_HEALTH).setBaseValue((double)generateMaxHealth($$0::nextInt));
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.HORSE_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
   ...
   public boolean canMate(Animal $$0) {
      if ($$0 == this) {
         return false;
      } else if (!($$0 instanceof Donkey) && !($$0 instanceof Horse)) {
         return false;
      } else {
      ...
      if ($$1 instanceof Donkey) {
         ...
         if ($$4 != null) {
            ...
            if ($$5 < 4) {
               ...
               $$6 = Util.getRandom(Variant.values(), this.random);
            }
            ...
            if ($$9 < 2) {
               ...
               $$10 = Util.getRandom((Markings[])Markings.values(), this.random);
            }
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      ...
      if ($$3 instanceof Horse.HorseGroupData) {
         ...
         $$5 = Util.getRandom(Variant.values(), $$4);
         $$3 = new Horse.HorseGroupData($$5);
      }

      this.setVariantAndMarkings($$5, Util.getRandom((Markings[])Markings.values(), $$4));
