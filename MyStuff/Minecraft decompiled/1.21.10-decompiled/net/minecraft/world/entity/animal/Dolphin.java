...
public class Dolphin extends AgeableWaterCreature {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      ...
      this.setXRot(0.0F);
      SpawnGroupData $$4 = (SpawnGroupData)Objects.requireNonNullElseGet($$3, () -> new AgeableMob.AgeableMobGroupData(0.1F));
            ...
            for(int $$4 = 0; $$4 < 2; ++$$4) {
               this.level()
                  .addParticle(
                     ...
                     this.getX() - $$0.x * (double)$$3 + (double)$$1,
                     this.getY() - $$0.y,
                     this.getZ() - $$0.z * (double)$$3 + (double)$$2,
                     0.0,
                     0.0,
                     0.0
                  );
   ...
   static class DolphinSwimToTreasureGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         if ($$0 == null) {
            ...
            return !BlockPos.containing((double)$$0.getX(), this.dolphin.getY(), (double)$$0.getZ()).closerToCenterThan(this.dolphin.position(), 4.0)
               && !this.stuck
      ...
      public void stop() {
         BlockPos $$0 = this.dolphin.treasurePos;
         if ($$0 == null
            || BlockPos.containing((double)$$0.getX(), this.dolphin.getY(), (double)$$0.getZ()).closerToCenterThan(this.dolphin.position(), 4.0)
            || this.stuck) {
   ...
   class PlayWithItemsGoal extends Goal {
      ...
      public void start() {
         List<ItemEntity> $$0 = Dolphin.this.level()
            .getEntitiesOfClass(ItemEntity.class, Dolphin.this.getBoundingBox().inflate(8.0, 8.0, 8.0), Dolphin.ALLOWED_ITEMS);
         if (!$$0.isEmpty()) {
            Dolphin.this.getNavigation().moveTo((Entity)$$0.get(0), 1.2F);
