...
public class Sheep extends Animal implements Shearable {
   ...
   public float getHeadEatPositionScale(float $$0) {
      if (this.eatAnimationTick <= 0) {
         ...
         return this.eatAnimationTick < 4 ? ((float)this.eatAnimationTick - $$0) / 4.0F : -((float)(this.eatAnimationTick - 40) - $$0) / 4.0F;
      }
   }
   ...
   public InteractionResult mobInteract(Player $$0, InteractionHand $$1) {
      ...
      if ($$2.is(Items.SHEARS)) {
         ...
         if (var5 instanceof ServerLevel $$3 && this.readyForShearing()) {
   ...
   public void shear(ServerLevel $$0, SoundSource $$1, ItemStack $$2) {
      ...
      this.dropFromShearingLootTable(
         ...
         $$2,
         ($$0x, $$1x) -> {
            for(int $$2xx = 0; $$2xx < $$1x.getCount(); ++$$2xx) {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setColor((DyeColor)$$0.read("Color", DyeColor.LEGACY_ID_CODEC).orElse(DEFAULT_COLOR));
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.SHEEP_COLOR ? castComponentValue($$0, this.getColor()) : super.get($$0));
   }
