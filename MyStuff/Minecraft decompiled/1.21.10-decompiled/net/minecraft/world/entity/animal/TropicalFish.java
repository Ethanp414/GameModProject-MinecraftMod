...
public class TropicalFish extends AbstractSchoolingFish {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      TropicalFish.Variant $$1 = (TropicalFish.Variant)$$0.read("Variant", TropicalFish.Variant.CODEC).orElse(DEFAULT_VARIANT);
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      if ($$0 == DataComponents.TROPICAL_FISH_PATTERN) {
         return castComponentValue($$0, this.getPattern());
      } else if ($$0 == DataComponents.TROPICAL_FISH_BASE_COLOR) {
         return castComponentValue($$0, this.getBaseColor());
      } else {
         return (T)($$0 == DataComponents.TROPICAL_FISH_PATTERN_COLOR ? castComponentValue($$0, this.getPatternColor()) : super.get($$0));
      }
   }
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      ...
      if ($$3 instanceof TropicalFish.TropicalFishGroupData $$5) {
         ...
         $$6 = Util.getRandom(COMMON_VARIANTS, $$4);
         ...
         TropicalFish.Pattern $$10 = Util.getRandom($$8, $$4);
   ...
   public static boolean checkTropicalFishSpawnRules(EntityType<TropicalFish> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      return $$1.getFluidState($$3.below()).is(FluidTags.WATER)
         ...
         && (
            $$1.getBiome($$3).is(BiomeTags.ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT)
               || WaterAnimal.checkSurfaceWaterAnimalSpawnRules($$0, $$1, $$2, $$3, $$4)
         );
   }
   ...
   public static enum Pattern implements StringRepresentable, TooltipProvider {
      ...
      public static TropicalFish.Pattern byId(int $$0) {
         return (TropicalFish.Pattern)BY_ID.apply($$0);
      }
      ...
      public void addToTooltip(Item.TooltipContext $$0, Consumer<Component> $$1, TooltipFlag $$2, DataComponentGetter $$3) {
         DyeColor $$4 = $$3.getOrDefault(DataComponents.TROPICAL_FISH_BASE_COLOR, TropicalFish.DEFAULT_VARIANT.baseColor());
         DyeColor $$5 = $$3.getOrDefault(DataComponents.TROPICAL_FISH_PATTERN_COLOR, TropicalFish.DEFAULT_VARIANT.patternColor());
