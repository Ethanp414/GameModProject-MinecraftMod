...
public class Llama extends AbstractChestedHorse implements RangedAttackMob {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setVariant((Llama.Variant)$$0.read("Variant", Llama.Variant.LEGACY_CODEC).orElse(Llama.Variant.DEFAULT));
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.LLAMA_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      ...
      if ($$3 instanceof Llama.LlamaGroupData) {
         ...
         $$5 = Util.getRandom(Llama.Variant.values(), $$4);
   ...
   private void spit(LivingEntity $$0) {
      ...
      if (var12 instanceof ServerLevel $$6) {
   ...
   static class LlamaHurtByTargetGoal extends HurtByTargetGoal {
      ...
      public boolean canContinueToUse() {
         Mob var2 = this.mob;
         if (var2 instanceof Llama $$0 && $$0.didSpit) {
            $$0.setDidSpit(false);
            return false;
         }
   ...
   public static enum Variant implements StringRepresentable {
      ...
      public static Llama.Variant byId(int $$0) {
         return (Llama.Variant)BY_ID.apply($$0);
      }
