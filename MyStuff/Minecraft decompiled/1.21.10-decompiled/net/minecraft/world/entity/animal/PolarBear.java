...
public class PolarBear extends Animal implements NeutralMob {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new PanicGoal(this, 2.0, $$0 -> $$0.isBaby() ? DamageTypeTags.PANIC_CAUSES : DamageTypeTags.PANIC_ENVIRONMENTAL_CAUSES));
   ...
   public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      ...
      if (!$$5.is(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS)) {
         return checkAnimalSpawnRules($$0, $$1, $$2, $$3, $$4);
      } else {
         return isBrightEnoughToSpawn($$1, $$3) && $$1.getBlockState($$3.below()).is(BlockTags.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE);
      }
   }
   ...
   class PolarBearAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {
      ...
      public boolean canUse() {
         if (PolarBear.this.isBaby()) {
            ...
            if (super.canUse()) {
               for(PolarBear $$1 : PolarBear.this.level().getEntitiesOfClass(PolarBear.class, PolarBear.this.getBoundingBox().inflate(8.0, 4.0, 8.0))) {
                  if ($$1.isBaby()) {
                     return true;
                  }
               }
