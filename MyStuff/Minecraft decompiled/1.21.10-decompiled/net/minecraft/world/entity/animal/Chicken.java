...
public class Chicken extends Animal {
   ...
   public void aiStep() {
      ...
      if (var3 instanceof ServerLevel $$1 && this.isAlive() && !this.isBaby() && !this.isChickenJockey() && --this.eggTime <= 0) {
   ...
   protected int getBaseExperienceReward(ServerLevel $$0) {
      return this.isChickenJockey() ? 10 : super.getBaseExperienceReward($$0);
   }

   @Override
   protected void defineSynchedData(SynchedEntityData.Builder $$0) {
      super.defineSynchedData($$0);
      $$0.define(DATA_VARIANT_ID, VariantUtils.<ChickenVariant>getDefaultOrAny(this.registryAccess(), ChickenVariants.TEMPERATE));
   }

   @Override
   protected void readAdditionalSaveData(ValueInput $$0) {
      super.readAdditionalSaveData($$0);
      this.isChickenJockey = $$0.getBooleanOr("IsChickenJockey", false);
      $$0.getInt("EggLayTime").ifPresent($$0x -> this.eggTime = $$0x);
      VariantUtils.readVariant($$0, Registries.CHICKEN_VARIANT).ifPresent(this::setVariant);
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.CHICKEN_VARIANT ? castComponentValue($$0, new EitherHolder<ChickenVariant>(this.getVariant())) : super.get($$0));
   }
   ...
   protected <T> boolean applyImplicitComponent(DataComponentType<T> $$0, T $$1) {
      if ($$0 == DataComponents.CHICKEN_VARIANT) {
         Optional<Holder<ChickenVariant>> $$2 = ((EitherHolder)castComponentValue(DataComponents.CHICKEN_VARIANT, $$1)).unwrap(this.registryAccess());
         if ($$2.isPresent()) {
            this.setVariant((Holder<ChickenVariant>)$$2.get());
            return true;
         } else {
            return false;
         }
