...
public class HappyGhastAi {
   ...
   private static final ImmutableList<SensorType<? extends Sensor<? super HappyGhast>>> SENSOR_TYPES = ImmutableList.of(
      ...
      SensorType.HURT_BY,
      SensorType.HAPPY_GHAST_TEMPTATIONS,
   ...
   private static void initIdleActivity(Brain<HappyGhast> $$0) {
      $$0.addActivity(
         Activity.IDLE,
         ImmutableList.of(
            Pair.of(1, new FollowTemptation($$0x -> 1.25F, $$0x -> 3.0, true)),
            Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, $$0x -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)),
            Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, $$0x -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_ADULT, true)),
   ...
   private static void initPanicActivity(Brain<HappyGhast> $$0) {
      $$0.addActivityWithConditions(Activity.PANIC, ImmutableList.of(), Set.of(Pair.of(MemoryModuleType.IS_PANICKING, MemoryStatus.VALUE_PRESENT)));
   }
