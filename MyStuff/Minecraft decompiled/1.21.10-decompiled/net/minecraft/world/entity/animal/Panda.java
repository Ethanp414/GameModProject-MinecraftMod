...
public class Panda extends Animal {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setMainGene((Panda.Gene)$$0.read("MainGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
      this.setHiddenGene((Panda.Gene)$$0.read("HiddenGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
   }
   ...
   private void addEatingParticles() {
      if (this.getEatCounter() % 5 == 0) {
         ...
         for(int $$0 = 0; $$0 < 6; ++$$0) {
            ...
            this.level()
               .addParticle(
                  new ItemParticleOption(ParticleTypes.ITEM, this.getItemBySlot(EquipmentSlot.MAINHAND)), $$3.x, $$3.y, $$3.z, $$1.x, $$1.y + 0.05, $$1.z
               );
         }
      }
   }
   ...
   private void afterSneeze() {
      ...
      if (var7 instanceof ServerLevel $$4 && $$4.getGameRules().getBoolean(GameRules.RULE_DOMOBLOOT)) {
   ...
   protected void pickUpItem(ServerLevel $$0, ItemEntity $$1) {
      if (this.getItemBySlot(EquipmentSlot.MAINHAND).isEmpty() && canPickUpAndEat($$1)) {
         this.onItemPickup($$1);
   ...
   public static enum Gene implements StringRepresentable {
      ...
      public static Panda.Gene byId(int $$0) {
         return (Panda.Gene)BY_ID.apply($$0);
      }
      ...
      public boolean canUse() {
         if ((this.panda.isBaby() || this.panda.isPlayful()) && this.panda.onGround()) {
            if (!this.panda.canPerformAction()) {
               ...
               float $$1 = -Mth.sin($$0);
               float $$2 = Mth.cos($$0);
               int $$3 = (double)Math.abs($$1) > 0.5 ? Mth.sign((double)$$1) : 0;
               int $$4 = (double)Math.abs($$2) > 0.5 ? Mth.sign((double)$$2) : 0;
   ...
   class PandaSitGoal extends Goal {
      ...
      public void start() {
         if (Panda.this.getItemBySlot(EquipmentSlot.MAINHAND).isEmpty()) {
            ...
            if (!$$0.isEmpty()) {
               Panda.this.getNavigation().moveTo((Entity)$$0.getFirst(), 1.2F);
            }
         } else {
            Panda.this.tryToSit();
         }
