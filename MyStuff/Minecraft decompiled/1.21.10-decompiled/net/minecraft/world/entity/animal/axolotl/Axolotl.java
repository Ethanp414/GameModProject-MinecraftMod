...
public class Axolotl extends Animal implements Bucketable {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setVariant((Axolotl.Variant)$$0.read("Variant", Axolotl.Variant.LEGACY_CODEC).orElse(Axolotl.Variant.DEFAULT));
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.AXOLOTL_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
   ...
   public boolean hurtServer(ServerLevel $$0, DamageSource $$1, float $$2) {
      ...
      if (!this.isNoAi()
         ...
         && ((float)this.level().random.nextInt(3) < $$2 || $$3 / this.getMaxHealth() < 0.5F)
         && $$2 < $$3
         && this.isInWater()
   ...
   public static void onStopAttacking(ServerLevel $$0, Axolotl $$1, LivingEntity $$2) {
      if ($$2.isDeadOrDying()) {
         ...
         if ($$3 != null) {
            ...
            if ($$4 != null && $$4.getType() == EntityType.PLAYER) {
               Player $$5 = (Player)$$4;
   ...
   public static boolean checkAxolotlSpawnRules(
      EntityType<? extends LivingEntity> $$0, ServerLevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4
   ) {
   ...
   public static enum Variant implements StringRepresentable {
      ...
      public static Axolotl.Variant byId(int $$0) {
         return (Axolotl.Variant)BY_ID.apply($$0);
      }
      ...
      private static Axolotl.Variant getSpawnVariant(RandomSource $$0, boolean $$1) {
         Axolotl.Variant[] $$2 = (Axolotl.Variant[])Arrays.stream(values()).filter($$1x -> $$1x.common == $$1).toArray($$0x -> new Axolotl.Variant[$$0x]);
