...
public class Armadillo extends Animal {
   ...
   protected void defineSynchedData(SynchedEntityData.Builder $$0) {
      ...
      $$0.define(ARMADILLO_STATE, Armadillo.ArmadilloState.IDLE);
   }
   ...
   public void switchToState(Armadillo.ArmadilloState $$0) {
   ...
   public static boolean checkArmadilloSpawnRules(EntityType<Armadillo> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      return $$1.getBlockState($$3.below()).is(BlockTags.ARMADILLO_SPAWNABLE_ON) && isBrightEnoughToSpawn($$1, $$3);
   }

   public boolean isScaredBy(LivingEntity $$0) {
      if (!this.getBoundingBox().inflate(7.0, 2.0, 7.0).intersects($$0.getBoundingBox())) {
         return false;
      } else if ($$0.getType().is(EntityTypeTags.UNDEAD)) {
         return true;
      } else if (this.getLastHurtByMob() == $$0) {
         return true;
      } else if ($$0 instanceof Player $$1) {
         if ($$1.isSpectator()) {
            return false;
         } else {
   ...
   protected void addAdditionalSaveData(ValueOutput $$0) {
      ...
      $$0.store("state", Armadillo.ArmadilloState.CODEC, this.getState());
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.switchToState((Armadillo.ArmadilloState)$$0.read("state", Armadillo.ArmadilloState.CODEC).orElse(Armadillo.ArmadilloState.IDLE));
      $$0.getInt("scute_time").ifPresent($$0x -> this.scuteTime = $$0x);
   }
   ...
   public InteractionResult mobInteract(Player $$0, InteractionHand $$1) {
      ...
      if ($$2.is(Items.BRUSH) && this.brushOffScute($$0, $$2)) {
         $$2.hurtAndBreak(16, $$0, $$1.asEquipmentSlot());
         return InteractionResult.SUCCESS;
      } else {
         return (InteractionResult)(this.isScared() ? InteractionResult.FAIL : super.mobInteract($$0, $$1));
      }
   }

   public boolean brushOffScute(@Nullable Entity $$0, ItemStack $$1) {
      if (this.isBaby()) {
         return false;
      } else {
         Level var4 = this.level();
         if (var4 instanceof ServerLevel $$2) {
            this.dropFromEntityInteractLootTable($$2, BuiltInLootTables.ARMADILLO_BRUSH, $$0, $$1, this::spawnAtLocation);
