...
public class Squid extends AgeableWaterCreature {
   ...
   public void aiStep() {
      ...
      if (this.isInWater()) {
         ...
         this.yBodyRot += (-((float)Mth.atan2($$1.x, $$1.z)) * (180.0F / (float)Math.PI) - this.yBodyRot) * 0.1F;
         this.setYRot(this.yBodyRot);
         this.zBodyRot += (float) Math.PI * this.rotateSpeed * 1.5F;
         this.xBodyRot += (-((float)Mth.atan2($$2, $$1.y)) * (180.0F / (float)Math.PI) - this.xBodyRot) * 0.1F;
      } else {
   ...
   private void spawnInk() {
      ...
      for(int $$1 = 0; $$1 < 30; ++$$1) {
         ...
         Vec3 $$4 = $$2.scale((double)($$3 + this.random.nextFloat() * 2.0F));
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor $$0, DifficultyInstance $$1, EntitySpawnReason $$2, @Nullable SpawnGroupData $$3) {
      SpawnGroupData $$4 = (SpawnGroupData)Objects.requireNonNullElseGet($$3, () -> new AgeableMob.AgeableMobGroupData(0.05F));
      ...
      public void tick() {
         ...
         if ($$0 > 100) {
            ...
            this.squid.movementVector = new Vec3(
               (double)(Mth.cos($$1) * 0.2F), (double)(-0.1F + this.squid.getRandom().nextFloat() * 0.2F), (double)(Mth.sin($$1) * 0.2F)
            );
         }
      }
   }
