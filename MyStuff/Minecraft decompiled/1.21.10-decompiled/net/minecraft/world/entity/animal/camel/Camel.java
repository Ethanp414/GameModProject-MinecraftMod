...
public class Camel extends AbstractHorse {
   ...
   protected void executeRidersJump(float $$0, Vec3 $$1) {
      double $$2 = (double)this.getJumpPower();
      this.addDeltaMovement(
         this.getLookAngle()
            .multiply(1.0, 0.0, 1.0)
            .normalize()
            .scale((double)(22.2222F * $$0) * this.getAttributeValue(Attributes.MOVEMENT_SPEED) * (double)this.getBlockSpeedFactor())
            .add(0.0, (double)(1.4285F * $$0) * $$2, 0.0)
      );
   ...
   public boolean canMate(Animal $$0) {
      if ($$0 != this && $$0 instanceof Camel $$1 && this.canParent() && $$1.canParent()) {
         return true;
      }
   ...
   protected Vec3 getPassengerAttachmentPoint(Entity $$0, EntityDimensions $$1, float $$2) {
      ...
      return new Vec3(0.0, (double)$$6, (double)($$5 * $$2)).yRot(-this.getYRot() * (float) (Math.PI / 180.0));
   }
   ...
   private double getBodyAnchorAnimationYOffset(boolean $$0, float $$1, EntityDimensions $$2, float $$3) {
      double $$4 = (double)($$2.height() - 0.375F * $$3);
      float $$5 = $$3 * 1.43F;
      float $$6 = $$5 - $$3 * 0.2F;
      float $$7 = $$5 - $$6;
      ...
      if ($$8) {
         ...
         float $$18 = $$5 - $$12 * $$6;
         $$4 += $$9
            ? (double)Mth.lerp($$17, $$16 ? $$5 : $$18, $$16 ? $$18 : $$7)
            : (double)Mth.lerp($$17, $$16 ? $$7 - $$5 : $$7 - $$18, $$16 ? $$7 - $$18 : 0.0F);
      }
   ...
   public Vec3 getLeashOffset(float $$0) {
      ...
      return new Vec3(0.0, this.getBodyAnchorAnimationYOffset(true, $$0, $$1, $$2) - (double)(0.2F * $$2), (double)($$1.width() * 0.56F));
   }
   ...
   protected Holder<SoundEvent> getEquipSound(EquipmentSlot $$0, ItemStack $$1, Equippable $$2) {
      return (Holder<SoundEvent>)($$0 == EquipmentSlot.SADDLE ? SoundEvents.CAMEL_SADDLE : super.getEquipSound($$0, $$1, $$2));
   }
