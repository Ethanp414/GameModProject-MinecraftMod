...
public class Frog extends Animal {
   ...
   protected void defineSynchedData(SynchedEntityData.Builder $$0) {
      ...
      Registry<FrogVariant> $$1 = this.registryAccess().lookupOrThrow(Registries.FROG_VARIANT);
      $$0.define(DATA_VARIANT_ID, VariantUtils.<FrogVariant>getDefaultOrAny(this.registryAccess(), DEFAULT_VARIANT));
   ...
   public Optional<Entity> getTongueTarget() {
      return ((OptionalInt)this.entityData.get(DATA_TONGUE_TARGET_ID)).stream().mapToObj(this.level()::getEntity).filter(Objects::nonNull).findFirst();
   }
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.FROG_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
   ...
   protected <T> boolean applyImplicitComponent(DataComponentType<T> $$0, T $$1) {
      if ($$0 == DataComponents.FROG_VARIANT) {
         this.setVariant(castComponentValue(DataComponents.FROG_VARIANT, $$1));
         return true;
      } else {
   ...
   public static boolean canEat(LivingEntity $$0) {
      if ($$0 instanceof Slime $$1 && $$1.getSize() != 1) {
         return false;
      }
   ...
   public static boolean checkFrogSpawnRules(EntityType<? extends Animal> $$0, LevelAccessor $$1, EntitySpawnReason $$2, BlockPos $$3, RandomSource $$4) {
      return $$1.getBlockState($$3.below()).is(BlockTags.FROGS_SPAWNABLE_ON) && isBrightEnoughToSpawn($$1, $$3);
   }
   ...
   static class FrogNodeEvaluator extends AmphibiousNodeEvaluator {
      ...
      public PathType getPathType(PathfindingContext $$0, int $$1, int $$2, int $$3) {
         ...
         return $$4.is(BlockTags.FROG_PREFER_JUMP_TO) ? PathType.OPEN : super.getPathType($$0, $$1, $$2, $$3);
      }
   }
