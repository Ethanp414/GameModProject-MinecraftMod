...
public class MushroomCow extends AbstractCow implements Shearable {
   ...
   public InteractionResult mobInteract(Player $$0, InteractionHand $$1) {
      ...
      if ($$2.is(Items.BOWL) && !this.isBaby()) {
         ...
         if (var11 instanceof ServerLevel $$9) {
         ...
         if ($$10.isEmpty()) {
            ...
            if (this.stewEffects != null) {
               ...
               this.stewEffects = (SuspiciousStewEffects)$$10.get();
   ...
   public void shear(ServerLevel $$0, SoundSource $$1, ItemStack $$2) {
      ...
      this.convertTo(EntityType.COW, ConversionParams.single(this, false, false), $$2x -> {
         ...
         this.dropFromShearingLootTable($$0, BuiltInLootTables.SHEAR_MOOSHROOM, $$2, ($$0xx, $$1xx) -> {
            for(int $$2xxx = 0; $$2xxx < $$1xx.getCount(); ++$$2xxx) {
   ...
   protected void readAdditionalSaveData(ValueInput $$0) {
      ...
      this.setVariant((MushroomCow.Variant)$$0.read("Type", MushroomCow.Variant.CODEC).orElse(MushroomCow.Variant.DEFAULT));
   ...
   public <T> T get(DataComponentType<? extends T> $$0) {
      return (T)($$0 == DataComponents.MOOSHROOM_VARIANT ? castComponentValue($$0, this.getVariant()) : super.get($$0));
   }
   ...
   public static enum Variant implements StringRepresentable {
      ...
      static MushroomCow.Variant byId(int $$0) {
         return (MushroomCow.Variant)BY_ID.apply($$0);
      }
   }
}
