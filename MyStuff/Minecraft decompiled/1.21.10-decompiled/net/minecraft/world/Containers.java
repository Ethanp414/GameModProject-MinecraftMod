...
public class Containers {
   ...
   public static void dropItemStack(Level $$0, double $$1, double $$2, double $$3, ItemStack $$4) {
      ...
      while(!$$4.isEmpty()) {
         ...
         float $$12 = 0.05F;
         $$11.setDeltaMovement(
            $$0.random.triangle(0.0, 0.11485000171139836), $$0.random.triangle(0.2, 0.11485000171139836), $$0.random.triangle(0.0, 0.11485000171139836)
         );
         $$0.addFreshEntity($$11);
      }
   }
