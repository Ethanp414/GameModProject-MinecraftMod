...
public class ObjectiveCriteria {
   ...
   public static final Codec<ObjectiveCriteria> CODEC = Codec.STRING
      .comapFlatMap(
         $$0 -> (DataResult)byName($$0).map(DataResult::success).orElse(DataResult.error(() -> "No scoreboard criteria with name: " + $$0)),
   ...
   public static Optional<ObjectiveCriteria> byName(String $$0) {
      ObjectiveCriteria $$1 = (ObjectiveCriteria)CRITERIA_CACHE.get($$0);
      if ($$1 != null) {
         ...
         return $$2 < 0
            ...
            : BuiltInRegistries.STAT_TYPE
               .getOptional(ResourceLocation.bySeparator($$0.substring(0, $$2), '.'))
               .flatMap($$2x -> getStat($$2x, ResourceLocation.bySeparator($$0.substring($$2 + 1), '.')));
      }
   }
