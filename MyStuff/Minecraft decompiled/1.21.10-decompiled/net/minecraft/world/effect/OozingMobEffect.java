...
class OozingMobEffect extends MobEffect {
   ...
   @VisibleForTesting
   protected static int numberOfSlimesToSpawn(int $$0, OozingMobEffect.NearbySlimes $$1, int $$2) {
   ...
   public void onMobRemoved(ServerLevel $$0, LivingEntity $$1, int $$2, Entity.RemovalReason $$3) {
      if ($$3 == Entity.RemovalReason.KILLED) {
         ...
         int $$6 = numberOfSlimesToSpawn($$5, OozingMobEffect.NearbySlimes.closeTo($$1), $$4);
   ...
   protected interface NearbySlimes {
      ...
      static OozingMobEffect.NearbySlimes closeTo(LivingEntity $$0) {
         return $$1 -> {
