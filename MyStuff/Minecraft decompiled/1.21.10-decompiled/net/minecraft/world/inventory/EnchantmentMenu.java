...
public class EnchantmentMenu extends AbstractContainerMenu {
            ...
            this.access.execute(($$1x, $$2x) -> {
               ...
               for(int $$7 = 0; $$7 < 3; ++$$7) {
                  if (this.costs[$$7] > 0) {
                     ...
                     if ($$8 != null && !$$8.isEmpty()) {
                        EnchantmentInstance $$9 = (EnchantmentInstance)$$8.get(this.random.nextInt($$8.size()));
   ...
   private List<EnchantmentInstance> getEnchantmentList(RegistryAccess $$0, ItemStack $$1, int $$2, int $$3) {
      this.random.setSeed((long)(this.enchantmentSeed.get() + $$2));
      Optional<HolderSet.Named<Enchantment>> $$4 = $$0.lookupOrThrow(Registries.ENCHANTMENT).get(EnchantmentTags.IN_ENCHANTING_TABLE);
      if ($$4.isEmpty()) {
         return List.of();
      } else {
   ...
   public ItemStack quickMoveStack(Player $$0, int $$1) {
      ...
      if ($$3 != null && $$3.hasItem()) {
         ...
         if ($$1 == 0) {
            ...
            if (this.slots.get(0).hasItem() || !this.slots.get(0).mayPlace($$4)) {
               return ItemStack.EMPTY;
            }

            ItemStack $$5 = $$4.copyWithCount(1);
            $$4.shrink(1);
            this.slots.get(0).setByPlayer($$5);
         }
