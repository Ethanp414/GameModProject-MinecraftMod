...
public abstract class AbstractFurnaceMenu extends RecipeBookMenu {
   ...
   protected AbstractFurnaceMenu(
      MenuType<?> $$0, RecipeType<? extends AbstractCookingRecipe> $$1, ResourceKey<RecipePropertySet> $$2, RecipeBookType $$3, int $$4, Inventory $$5
   ) {
   ...
   public void fillCraftSlotsStackedContents(StackedItemContents $$0) {
      if (this.container instanceof StackedContentsCompatible) {
         ((StackedContentsCompatible)this.container).fillStackedContents($$0);
      }
   }
   ...
   public float getBurnProgress() {
      ...
      return $$1 != 0 && $$0 != 0 ? Mth.clamp((float)$$0 / (float)$$1, 0.0F, 1.0F) : 0.0F;
   }
   ...
   public RecipeBookMenu.PostPlaceAction handlePlacement(boolean $$0, boolean $$1, RecipeHolder<?> $$2, final ServerLevel $$3, Inventory $$4) {
      final List<Slot> $$5 = List.of(this.getSlot(0), this.getSlot(2));
      return ServerPlaceRecipe.placeRecipe(new ServerPlaceRecipe.CraftingMenuAccess<AbstractCookingRecipe>() {
         ...
         public boolean recipeMatches(RecipeHolder<AbstractCookingRecipe> $$0) {
            return $$0.value().matches(new SingleRecipeInput(AbstractFurnaceMenu.this.container.getItem(0)), $$3);
         }
