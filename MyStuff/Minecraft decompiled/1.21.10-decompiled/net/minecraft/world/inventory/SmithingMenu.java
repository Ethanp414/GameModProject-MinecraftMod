...
public class SmithingMenu extends ItemCombinerMenu {
   ...
   private SmithingMenu(int $$0, Inventory $$1, ContainerLevelAccess $$2, Level $$3) {
      super(MenuType.SMITHING, $$0, $$1, $$2, createInputSlotDefinitions($$3.recipeAccess()));
      this.level = $$3;
   ...
   public void createResult() {
      ...
      if (var4 instanceof ServerLevel $$1) {
      ...
      $$2.ifPresentOrElse($$1x -> {
         ItemStack $$2 = ((SmithingRecipe)$$1x.value()).assemble($$0, this.level.registryAccess());
   ...
   public boolean canMoveIntoInputSlots(ItemStack $$0) {
      if (this.templateItemTest.test($$0) && !this.getSlot(0).hasItem()) {
         return true;
      } else if (this.baseItemTest.test($$0) && !this.getSlot(1).hasItem()) {
         return true;
      } else {
