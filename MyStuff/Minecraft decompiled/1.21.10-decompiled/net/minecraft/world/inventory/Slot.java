...
public class Slot {
   ...
   public Optional<ItemStack> tryRemove(int $$0, int $$1, Player $$2) {
      ...
      } else if (!this.allowModification($$2) && $$1 < this.getItem().getCount()) {
         return Optional.empty();
      } else {
         $$0 = Math.min($$0, $$1);
         ItemStack $$3 = this.remove($$0);
         if ($$3.isEmpty()) {
            return Optional.empty();
         } else {
   ...
   public ItemStack safeTake(int $$0, int $$1, Player $$2) {
      Optional<ItemStack> $$3 = this.tryRemove($$0, $$1, $$2);
      $$3.ifPresent($$1x -> this.onTake($$2, $$1x));
