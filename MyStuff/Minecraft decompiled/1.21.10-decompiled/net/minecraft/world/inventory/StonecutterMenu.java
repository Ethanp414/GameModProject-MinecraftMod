...
public class StonecutterMenu extends AbstractContainerMenu {
   ...
   public StonecutterMenu(int $$0, Inventory $$1, final ContainerLevelAccess $$2) {
      ...
      this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
         ...
         public void onTake(Player $$0, ItemStack $$1) {
            ...
            $$2.execute(($$0x, $$1x) -> {
               long $$2xxxx = $$0x.getGameTime();
               if (StonecutterMenu.this.lastSoundTime != $$2xxxx) {
                  $$0x.playSound(null, $$1x, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                  StonecutterMenu.this.lastSoundTime = $$2xxxx;
               }
            });
            super.onTake($$0, $$1);
         }
   ...
   void setupResultSlot(int $$0) {
      ...
      if (!this.recipesForInput.isEmpty() && this.isValidRecipeIndex($$0)) {
         SelectableRecipe.SingleInputEntry<StonecutterRecipe> $$1 = (SelectableRecipe.SingleInputEntry)this.recipesForInput.entries().get($$0);
         $$2 = $$1.recipe().recipe();
      } else {
         $$2 = Optional.empty();
      }
