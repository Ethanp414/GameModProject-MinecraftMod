...
public class BrewingStandMenu extends AbstractContainerMenu {
   ...
   public BrewingStandMenu(int $$0, Inventory $$1, Container $$2, ContainerData $$3) {
      ...
      this.addSlot(new BrewingStandMenu.PotionSlot($$2, 0, 56, 51));
      this.addSlot(new BrewingStandMenu.PotionSlot($$2, 1, 79, 58));
      this.addSlot(new BrewingStandMenu.PotionSlot($$2, 2, 102, 51));
      this.ingredientSlot = this.addSlot(new BrewingStandMenu.IngredientsSlot($$4, $$2, 3, 79, 17));
      this.addSlot(new BrewingStandMenu.FuelSlot($$2, 4, 17, 17));
      this.addDataSlots($$3);
   ...
   public ItemStack quickMoveStack(Player $$0, int $$1) {
      ...
      if ($$3 != null && $$3.hasItem()) {
         ...
         if (($$1 < 0 || $$1 > 2) && $$1 != 3 && $$1 != 4) {
            ...
            } else if (BrewingStandMenu.PotionSlot.mayPlaceItem($$2)) {
   ...
   static class PotionSlot extends Slot {
      ...
      public void onTake(Player $$0, ItemStack $$1) {
         ...
         if ($$2.isPresent() && $$0 instanceof ServerPlayer $$3) {
            CriteriaTriggers.BREWED_POTION.trigger($$3, (Holder<Potion>)$$2.get());
         }
