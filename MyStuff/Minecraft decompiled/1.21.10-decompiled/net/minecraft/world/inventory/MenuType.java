...
public class MenuType<T extends AbstractContainerMenu> implements FeatureElement {
   ...
   public static final MenuType<LecternMenu> LECTERN = register("lectern", ($$0, $$1) -> new LecternMenu($$0));
   ...
   private static <T extends AbstractContainerMenu> MenuType<T> register(String $$0, MenuType.MenuSupplier<T> $$1) {
      return Registry.register(BuiltInRegistries.MENU, $$0, new MenuType<>($$1, FeatureFlags.VANILLA_SET));
   }

   private static <T extends AbstractContainerMenu> MenuType<T> register(String $$0, MenuType.MenuSupplier<T> $$1, FeatureFlag... $$2) {
      return Registry.register(BuiltInRegistries.MENU, $$0, new MenuType<>($$1, FeatureFlags.REGISTRY.subset($$2)));
   }

   private MenuType(MenuType.MenuSupplier<T> $$0, FeatureFlagSet $$1) {
      this.constructor = $$0;
