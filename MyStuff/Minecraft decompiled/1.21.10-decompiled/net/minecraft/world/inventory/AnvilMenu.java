...
public class AnvilMenu extends ItemCombinerMenu {
   ...
   public AnvilMenu(int $$0, Inventory $$1, ContainerLevelAccess $$2) {
      super(MenuType.ANVIL, $$0, $$1, $$2, createInputSlotDefinitions());
   ...
   protected void onTake(Player $$0, ItemStack $$1) {
      ...
      this.access.execute(($$1x, $$2) -> {
         BlockState $$3xx = $$1x.getBlockState($$2);
         if (!$$0.hasInfiniteMaterials() && $$3xx.is(BlockTags.ANVIL) && $$0.getRandom().nextFloat() < 0.12F) {
            BlockState $$4 = AnvilBlock.damage($$3xx);
            if ($$4 == null) {
   ...
   public void createResult() {
      ...
      if (!$$0.isEmpty() && EnchantmentHelper.canStoreEnchantments($$0)) {
         ...
         $$2 += (long)((Integer)$$0.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue()
            + (long)((Integer)$$5.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue();
         ...
         if (!$$5.isEmpty()) {
            ...
            if ($$4.isDamageableItem() && $$0.isValidRepairItem($$5)) {
               ...
               for(Entry<Holder<Enchantment>> $$19 : $$16.entrySet()) {
                  Holder<Enchantment> $$20 = (Holder)$$19.getKey();
         ...
         int $$27 = $$1 <= 0 ? 0 : (int)Mth.clamp($$2 + (long)$$1, 0L, 2147483647L);
         this.cost.set($$27);
         if ($$1 <= 0) {
            $$4 = ItemStack.EMPTY;
         }
         ...
         if (!$$4.isEmpty()) {
            int $$28 = $$4.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0));
            if ($$28 < $$5.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))) {
               $$28 = $$5.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0));
            }
