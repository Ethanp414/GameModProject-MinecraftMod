...
public class SlotRanges {
   ...
   public static final Codec<SlotRange> CODEC = StringRepresentable.fromValues(() -> (SlotRange[])SLOTS.toArray($$0 -> new SlotRange[$$0]));
   private static final Function<String, SlotRange> NAME_LOOKUP = StringRepresentable.createNameLookup((SlotRange[])SLOTS.toArray($$0 -> new SlotRange[$$0]));
   ...
   public static SlotRange nameToIds(String $$0) {
      return (SlotRange)NAME_LOOKUP.apply($$0);
   }
