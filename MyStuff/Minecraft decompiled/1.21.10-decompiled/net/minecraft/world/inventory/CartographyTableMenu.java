   ...
   public CartographyTableMenu(int $$0, Inventory $$1, final ContainerLevelAccess $$2) {
      ...
      this.addSlot(new Slot(this.resultContainer, 2, 145, 39) {
         ...
         public void onTake(Player $$0, ItemStack $$1) {
            ...
            $$1.getItem().onCraftedBy($$1, $$0);
            $$2.execute(($$0x, $$1x) -> {
               long $$2xxx = $$0x.getGameTime();
               if (CartographyTableMenu.this.lastSoundTime != $$2xxx) {
                  $$0x.playSound(null, $$1x, SoundEvents.UI_CARTOGRAPHY_TABLE_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                  CartographyTableMenu.this.lastSoundTime = $$2xxx;
               }
            });
            super.onTake($$0, $$1);
         }
