...
public class DamageSource {
   ...
   public Component getLocalizedDeathMessage(LivingEntity $$0) {
      ...
      if (this.causingEntity == null && this.directEntity == null) {
         ...
         String $$6 = $$1 + ".player";
         return $$5 != null ? Component.translatable($$6, $$0.getDisplayName(), $$5.getDisplayName()) : Component.translatable($$1, $$0.getDisplayName());
      } else {
         ...
         ItemStack $$4 = var6 instanceof LivingEntity $$3 ? $$3.getMainHandItem() : ItemStack.EMPTY;
         return !$$4.isEmpty() && $$4.has(DataComponents.CUSTOM_NAME)
            ? Component.translatable($$1 + ".item", $$0.getDisplayName(), $$2, $$4.getDisplayName())
            : Component.translatable($$1, $$0.getDisplayName(), $$2);
      }
   }
   ...
   public boolean isCreativePlayer() {
      ...
      if (var2 instanceof Player $$0 && $$0.getAbilities().instabuild) {
         return true;
      }
