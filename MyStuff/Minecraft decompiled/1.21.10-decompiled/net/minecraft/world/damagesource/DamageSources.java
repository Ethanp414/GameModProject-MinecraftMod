...
public class DamageSources {
   ...
   private DamageSource source(ResourceKey<DamageType> $$0, @Nullable Entity $$1) {
      return new DamageSource(this.damageTypes.getOrThrow($$0), $$1);
   }
   ...
   public DamageSource fireball(Fireball $$0, @Nullable Entity $$1) {
      return $$1 == null ? this.source(DamageTypes.UNATTRIBUTED_FIREBALL, $$0) : this.source(DamageTypes.FIREBALL, $$0, $$1);
   }
   ...
   public DamageSource badRespawnPointExplosion(Vec3 $$0) {
      return new DamageSource(this.damageTypes.getOrThrow(DamageTypes.BAD_RESPAWN_POINT), $$0);
   }
