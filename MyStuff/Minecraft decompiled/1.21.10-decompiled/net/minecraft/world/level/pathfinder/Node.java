...
public class Node {
   ...
   public float distanceTo(Node $$0) {
      float $$1 = (float)($$0.x - this.x);
      float $$2 = (float)($$0.y - this.y);
      float $$3 = (float)($$0.z - this.z);
      return Mth.sqrt($$1 * $$1 + $$2 * $$2 + $$3 * $$3);
   }

   public float distanceToXZ(Node $$0) {
      float $$1 = (float)($$0.x - this.x);
      float $$2 = (float)($$0.z - this.z);
      return Mth.sqrt($$1 * $$1 + $$2 * $$2);
   }

   public float distanceTo(BlockPos $$0) {
      float $$1 = (float)($$0.getX() - this.x);
      float $$2 = (float)($$0.getY() - this.y);
      float $$3 = (float)($$0.getZ() - this.z);
      return Mth.sqrt($$1 * $$1 + $$2 * $$2 + $$3 * $$3);
   }
   ...
   public float distanceManhattan(Node $$0) {
      float $$1 = (float)Math.abs($$0.x - this.x);
      float $$2 = (float)Math.abs($$0.y - this.y);
      float $$3 = (float)Math.abs($$0.z - this.z);
      return $$1 + $$2 + $$3;
   }

   public float distanceManhattan(BlockPos $$0) {
      float $$1 = (float)Math.abs($$0.getX() - this.x);
      float $$2 = (float)Math.abs($$0.getY() - this.y);
      float $$3 = (float)Math.abs($$0.getZ() - this.z);
      return $$1 + $$2 + $$3;
   }
