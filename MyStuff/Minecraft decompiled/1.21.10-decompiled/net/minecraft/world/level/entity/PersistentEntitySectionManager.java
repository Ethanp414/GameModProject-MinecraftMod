...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
   ...
   public void updateChunkStatus(ChunkPos $$0, Visibility $$1) {
      ...
      this.sectionStorage.getExistingSectionsInChunk($$2).forEach($$1x -> {
         Visibility $$2xx = $$1x.updateChunkStatus($$1);
         boolean $$3 = $$2xx.isAccessible();
         boolean $$4 = $$1.isAccessible();
         boolean $$5 = $$2xx.isTicking();
   ...
   private boolean storeChunkSections(long $$0, Consumer<T> $$1) {
      ...
      if ($$2 == PersistentEntitySectionManager.ChunkLoadStatus.PENDING) {
         ...
         List<T> $$3 = (List)this.sectionStorage
         ...
         if ($$3.isEmpty()) {
            if ($$2 == PersistentEntitySectionManager.ChunkLoadStatus.LOADED) {
               this.permanentStorage.storeEntities(new ChunkEntities<>(new ChunkPos($$0), ImmutableList.of()));
            }
            ...
            this.permanentStorage.storeEntities(new ChunkEntities<>(new ChunkPos($$0), $$3));
            $$3.forEach($$1);
            return true;
         }
      }
   ...
   public void processPendingLoads() {
      ChunkEntities<T> $$0;
      while(($$0 = (ChunkEntities)this.loadingInbox.poll()) != null) {
   ...
   private LongSet getAllChunksToSave() {
      ...
      for(Entry<PersistentEntitySectionManager.ChunkLoadStatus> $$1 : Long2ObjectMaps.fastIterable(this.chunkLoadStatuses)) {
   ...
   public boolean canPositionTick(BlockPos $$0) {
      return ((Visibility)this.chunkVisibility.get(ChunkPos.asLong($$0))).isTicking();
   }
   ...
   public void dumpSections(Writer $$0) throws IOException {
      ...
      this.sectionStorage.getAllChunksWithExistingSections().forEach($$1x -> {
         ...
         this.sectionStorage.getExistingSectionPositionsInChunk($$1x).forEach($$2x -> {
            ...
            if ($$3 != null) {
               try {
                  $$1.writeRow(SectionPos.x($$2x), SectionPos.y($$2x), SectionPos.z($$2x), $$3.getStatus(), $$2, $$3.size());
   ...
   class Callback implements EntityInLevelCallback {
         ...
         if ($$1 != this.currentSectionKey) {
            ...
            if (!this.currentSection.remove(this.entity)) {
               PersistentEntitySectionManager.LOGGER
                  .warn("Entity {} wasn't found in section {} (moving to {})", this.entity, SectionPos.of(this.currentSectionKey), $$1);
            }
      ...
      public void onRemove(Entity.RemovalReason $$0) {
         if (!this.currentSection.remove(this.entity)) {
            PersistentEntitySectionManager.LOGGER
               .warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, SectionPos.of(this.currentSectionKey), $$0);
         }
