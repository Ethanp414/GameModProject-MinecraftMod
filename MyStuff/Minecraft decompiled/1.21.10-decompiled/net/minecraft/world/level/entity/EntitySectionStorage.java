...
public class EntitySectionStorage<T extends EntityAccess> {
      ...
      for(int $$8 = $$2; $$8 <= $$5; ++$$8) {
         ...
         while($$11.hasNext()) {
            ...
            if ($$13 >= $$3 && $$13 <= $$6 && $$14 >= $$4 && $$14 <= $$7) {
               EntitySection<T> $$15 = this.sections.get($$12);
   ...
   public Stream<EntitySection<T>> getExistingSectionsInChunk(long $$0) {
      return this.getExistingSectionPositionsInChunk($$0).mapToObj(this.sections::get).filter(Objects::nonNull);
   }
   ...
   public EntitySection<T> getOrCreateSection(long $$0) {
      return this.sections.computeIfAbsent($$0, this::createSection);
   }
