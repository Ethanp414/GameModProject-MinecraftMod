...
public class ClipContext {
   ...
   public ClipContext(Vec3 $$0, Vec3 $$1, ClipContext.Block $$2, ClipContext.Fluid $$3, Entity $$4) {
      this($$0, $$1, $$2, $$3, CollisionContext.of($$4));
   }

   public ClipContext(Vec3 $$0, Vec3 $$1, ClipContext.Block $$2, ClipContext.Fluid $$3, CollisionContext $$4) {
      this.from = $$0;
      this.to = $$1;
      this.block = $$2;
      this.fluid = $$3;
            ...
            if ($$0.is(BlockTags.FALL_DAMAGE_RESETTING)) {
               ...
               if ($$3 instanceof EntityCollisionContext $$4 && $$4.getEntity() != null && $$4.getEntity().getType() == EntityType.PLAYER) {
                  ...
                  if ($$1 instanceof ServerLevel $$5
                     ...
                     && $$5.getGameRules().getInt(GameRules.RULE_PLAYERS_NETHER_PORTAL_DEFAULT_DELAY) == 0) {
                     return Shapes.block();
                  }
               }
