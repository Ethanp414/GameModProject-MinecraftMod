      ...
      $$0 -> commonFields($$0)
            .and(
               $$0.group(
                  ...
                  Codec.BYTE.optionalFieldOf("zoom", Byte.valueOf((byte)2)).forGetter($$0x -> $$0x.zoom),
                  Codec.INT.optionalFieldOf("search_radius", Integer.valueOf(50)).forGetter($$0x -> $$0x.searchRadius),
                  Codec.BOOL.optionalFieldOf("skip_existing_chunks", Boolean.valueOf(true)).forGetter($$0x -> $$0x.skipKnownStructures)
               )
            )
