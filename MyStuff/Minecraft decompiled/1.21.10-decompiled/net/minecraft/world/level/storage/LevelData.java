...
public interface LevelData {
   ...
   default void fillCrashReportCategory(CrashReportCategory $$0, LevelHeightAccessor $$1) {
      $$0.setDetail("Level spawn location", (CrashReportDetail<String>)(() -> CrashReportCategory.formatLocation($$1, this.getRespawnData().pos())));
      $$0.setDetail(
   ...
   public static record RespawnData(GlobalPos globalPos, float yaw, float pitch) {
      ...
      public static LevelData.RespawnData of(ResourceKey<Level> $$0, BlockPos $$1, float $$2, float $$3) {
         return new LevelData.RespawnData(GlobalPos.of($$0, $$1.immutable()), $$2, $$3);
      }
