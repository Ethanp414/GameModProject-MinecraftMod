...
public class CommandStorage {
   ...
   private CommandStorage.Container getContainer(String $$0) {
      CommandStorage.Container $$1 = (CommandStorage.Container)this.namespaces.get($$0);
      if ($$1 != null) {
         return $$1;
      } else {
   ...
   public Stream<ResourceLocation> keys() {
      return this.namespaces.entrySet().stream().flatMap($$0 -> ((CommandStorage.Container)$$0.getValue()).getKeys((String)$$0.getKey()));
   }
   ...
   static class Container extends SavedData {
      ...
      public CompoundTag get(String $$0) {
         CompoundTag $$1 = (CompoundTag)this.storage.get($$0);
