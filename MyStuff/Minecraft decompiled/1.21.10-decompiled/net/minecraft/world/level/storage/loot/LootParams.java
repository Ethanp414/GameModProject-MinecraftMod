...
public class LootParams {
   ...
   public LootParams(ServerLevel $$0, ContextMap $$1, Map<ResourceLocation, LootParams.DynamicDrop> $$2, float $$3) {
      this.level = $$0;
      this.params = $$1;
      this.dynamicDrops = $$2;
      this.luck = $$3;
   ...
   public void addDynamicDrops(ResourceLocation $$0, Consumer<ItemStack> $$1) {
      LootParams.DynamicDrop $$2 = (LootParams.DynamicDrop)this.dynamicDrops.get($$0);
      if ($$2 != null) {
         $$2.add($$1);
      }
   }
   ...
   public static class Builder {
      ...
      public LootParams.Builder withDynamicDrop(ResourceLocation $$0, LootParams.DynamicDrop $$1) {
         LootParams.DynamicDrop $$2 = (LootParams.DynamicDrop)this.dynamicDrops.put($$0, $$1);
         if ($$2 != null) {
