...
public class SetLoreFunction extends LootItemConditionalFunction {
   ...
   public Set<ContextKey<?>> getReferencedContextParams() {
      return (Set<ContextKey<?>>)this.resolutionContext.map($$0 -> Set.of($$0.getParam())).orElseGet(Set::of);
   }
   ...
   private List<Component> updateLore(@Nullable ItemLore $$0, LootContext $$1) {
      if ($$0 == null && this.lore.isEmpty()) {
         ...
         UnaryOperator<Component> $$2 = SetNameFunction.createResolver($$1, (LootContext.EntityTarget)this.resolutionContext.orElse(null));
