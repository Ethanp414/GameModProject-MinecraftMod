...
public class SetContainerContents extends LootItemConditionalFunction {
   ...
   public ItemStack run(ItemStack $$0, LootContext $$1) {
      if ($$0.isEmpty()) {
         ...
         java.util.stream.Stream.Builder<ItemStack> $$2 = Stream.builder();
   ...
   public void validate(ValidationContext $$0) {
      ...
      for(int $$1 = 0; $$1 < this.entries.size(); ++$$1) {
         ((LootPoolEntryContainer)this.entries.get($$1)).validate($$0.forChild(new ProblemReporter.IndexedFieldPathElement("entries", $$1)));
      }
   }
