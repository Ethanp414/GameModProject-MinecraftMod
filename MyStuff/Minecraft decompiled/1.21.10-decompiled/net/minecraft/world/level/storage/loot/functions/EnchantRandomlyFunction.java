...
public class EnchantRandomlyFunction extends LootItemConditionalFunction {
      ...
      $$0 -> commonFields($$0)
            .and(
               $$0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("only_compatible", Boolean.valueOf(true)).forGetter($$0x -> $$0x.onlyCompatible)
               )
            )
   ...
   public ItemStack run(ItemStack $$0, LootContext $$1) {
      ...
      Stream<Holder<Enchantment>> $$5 = ((Stream)this.options
      ...
      if ($$7.isEmpty()) {
         ...
         return enchantItem($$0, (Holder<Enchantment>)$$7.get(), $$2);
      }
   }
   ...
   public static EnchantRandomlyFunction.Builder randomApplicableEnchantment(HolderLookup.Provider $$0) {
   ...
   public static class Builder extends LootItemConditionalFunction.Builder<EnchantRandomlyFunction.Builder> {
      ...
      public EnchantRandomlyFunction.Builder withEnchantment(Holder<Enchantment> $$0) {
         this.options = Optional.of(HolderSet.direct($$0));
         return this;
      }
