...
public class ApplyBonusCount extends LootItemConditionalFunction {
   ...
   private static final Codec<ApplyBonusCount.FormulaType> FORMULA_TYPE_CODEC = ResourceLocation.CODEC.comapFlatMap($$0 -> {
      ApplyBonusCount.FormulaType $$1 = (ApplyBonusCount.FormulaType)FORMULAS.get($$0);
   ...
   public static final MapCodec<ApplyBonusCount> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> commonFields($$0)
            .<Holder<Enchantment>, ApplyBonusCount.Formula>and(
               $$0.group(Enchantment.CODEC.fieldOf("enchantment").forGetter($$0x -> $$0x.enchantment), FORMULA_CODEC.forGetter($$0x -> $$0x.formula))
            )
   ...
   public static LootItemConditionalFunction.Builder<?> addOreBonusCount(Holder<Enchantment> $$0) {
      return simpleBuilder($$1 -> new ApplyBonusCount($$1, $$0, new ApplyBonusCount.OreDrops()));
   }
