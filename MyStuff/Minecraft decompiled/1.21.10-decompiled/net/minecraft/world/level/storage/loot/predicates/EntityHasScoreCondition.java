...
public record EntityHasScoreCondition(Map<String, IntRange> scores, LootContext.EntityTarget entityTarget) implements LootItemCondition {
   ...
   public Set<ContextKey<?>> getReferencedContextParams() {
      return (Set<ContextKey<?>>)Stream.concat(
            Stream.of(this.entityTarget.getParam()), this.scores.values().stream().flatMap($$0 -> $$0.getReferencedContextParams().stream())
         )
   ...
   public boolean test(LootContext $$0) {
      ...
      if ($$1 == null) {
         ...
         for(Entry<String, IntRange> $$3 : this.scores.entrySet()) {
            if (!this.hasScore($$0, $$1, $$2, (String)$$3.getKey(), (IntRange)$$3.getValue())) {
               return false;
            }
         }
