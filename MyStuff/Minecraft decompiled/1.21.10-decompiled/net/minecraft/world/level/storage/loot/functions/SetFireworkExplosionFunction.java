...
public class SetFireworkExplosionFunction extends LootItemConditionalFunction {
   public static final MapCodec<SetFireworkExplosionFunction> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> commonFields($$0)
            .and(
               $$0.group(
                  FireworkExplosion.Shape.CODEC.optionalFieldOf("shape").forGetter($$0x -> $$0x.shape),
   ...
   public SetFireworkExplosionFunction(
      ...
      Optional<FireworkExplosion.Shape> $$1,
      Optional<IntList> $$2,
      Optional<IntList> $$3,
      Optional<Boolean> $$4,
      Optional<Boolean> $$5
   ...
   private FireworkExplosion apply(FireworkExplosion $$0) {
      return new FireworkExplosion(
         (FireworkExplosion.Shape)this.shape.orElseGet($$0::shape),
         (IntList)this.colors.orElseGet($$0::colors),
         (IntList)this.fadeColors.orElseGet($$0::fadeColors),
