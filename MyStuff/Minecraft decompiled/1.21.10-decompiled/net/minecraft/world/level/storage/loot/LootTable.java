...
public class LootTable {
   ...
   public static final Codec<LootTable> DIRECT_CODEC = Codec.lazyInitialized(
      () -> RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     ...
                     ResourceLocation.CODEC.optionalFieldOf("random_sequence").forGetter($$0x -> $$0x.randomSequence),
   ...
   public void validate(ValidationContext $$0) {
      for(int $$1 = 0; $$1 < this.pools.size(); ++$$1) {
         ((LootPool)this.pools.get($$1)).validate($$0.forChild(new ProblemReporter.IndexedFieldPathElement("pools", $$1)));
      }
   ...
   private void shuffleAndSplitItems(ObjectArrayList<ItemStack> $$0, int $$1, RandomSource $$2) {
      List<ItemStack> $$3 = Lists.<ItemStack>newArrayList();
   ...
   public static class Builder implements FunctionUserBuilder<LootTable.Builder> {
      ...
      public LootTable.Builder setRandomSequence(ResourceLocation $$0) {
