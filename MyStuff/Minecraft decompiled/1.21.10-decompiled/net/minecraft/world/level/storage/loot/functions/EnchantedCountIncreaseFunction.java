...
public class EnchantedCountIncreaseFunction extends LootItemConditionalFunction {
      ...
      $$0 -> commonFields($$0)
            .<Holder<Enchantment>, NumberProvider, int>and(
               $$0.group(
                  ...
                  Codec.INT.optionalFieldOf("limit", Integer.valueOf(0)).forGetter($$0x -> $$0x.limit)
               )
            )
   ...
   public static EnchantedCountIncreaseFunction.Builder lootingMultiplier(HolderLookup.Provider $$0, NumberProvider $$1) {
      HolderLookup.RegistryLookup<Enchantment> $$2 = $$0.lookupOrThrow(Registries.ENCHANTMENT);
