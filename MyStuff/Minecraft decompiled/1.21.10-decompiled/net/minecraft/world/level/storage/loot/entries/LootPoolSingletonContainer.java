...
public abstract class LootPoolSingletonContainer extends LootPoolEntryContainer {
   ...
   protected static <T extends LootPoolSingletonContainer> P4<Mu<T>, Integer, Integer, List<LootItemCondition>, List<LootItemFunction>> singletonFields(
      ...
      return $$0.group(
            Codec.INT.optionalFieldOf("weight", Integer.valueOf(1)).forGetter($$0x -> $$0x.weight),
            Codec.INT.optionalFieldOf("quality", Integer.valueOf(0)).forGetter($$0x -> $$0x.quality)
         )
   ...
   public void validate(ValidationContext $$0) {
      ...
      for(int $$1 = 0; $$1 < this.functions.size(); ++$$1) {
         ((LootItemFunction)this.functions.get($$1)).validate($$0.forChild(new ProblemReporter.IndexedFieldPathElement("functions", $$1)));
      }
   }
