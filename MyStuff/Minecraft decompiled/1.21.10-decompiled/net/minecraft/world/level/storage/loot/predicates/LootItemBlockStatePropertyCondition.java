...
public record LootItemBlockStatePropertyCondition(Holder<Block> block, Optional<StatePropertiesPredicate> properties) implements LootItemCondition {
   ...
   private static DataResult<LootItemBlockStatePropertyCondition> validate(LootItemBlockStatePropertyCondition $$0) {
      return (DataResult<LootItemBlockStatePropertyCondition>)$$0.properties()
         .flatMap($$1 -> $$1.checkState($$0.block().value().getStateDefinition()))
   ...
   public boolean test(LootContext $$0) {
      ...
      return $$1 != null && $$1.is(this.block) && (this.properties.isEmpty() || ((StatePropertiesPredicate)this.properties.get()).matches($$1));
   }
   ...
   public static class Builder implements LootItemCondition.Builder {
      ...
      public LootItemBlockStatePropertyCondition.Builder setProperties(StatePropertiesPredicate.Builder $$0) {
