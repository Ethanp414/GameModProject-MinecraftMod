...
public record LootItemRandomChanceWithEnchantedBonusCondition(float unenchantedChance, LevelBasedValue enchantedChance, Holder<Enchantment> enchantment)
   ...
   public static LootItemCondition.Builder randomChanceAndLootingBoost(HolderLookup.Provider $$0, float $$1, float $$2) {
      HolderLookup.RegistryLookup<Enchantment> $$3 = $$0.lookupOrThrow(Registries.ENCHANTMENT);
      return () -> new LootItemRandomChanceWithEnchantedBonusCondition($$1, new LevelBasedValue.Linear($$1 + $$2, $$2), $$3.getOrThrow(Enchantments.LOOTING));
   }
}
