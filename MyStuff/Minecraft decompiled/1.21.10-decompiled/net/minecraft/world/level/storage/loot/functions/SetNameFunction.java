...
public class SetNameFunction extends LootItemConditionalFunction {
   ...
   public Set<ContextKey<?>> getReferencedContextParams() {
      return (Set<ContextKey<?>>)this.resolutionContext.map($$0 -> Set.of($$0.getParam())).orElse(Set.of());
   }

   public static UnaryOperator<Component> createResolver(LootContext $$0, @Nullable LootContext.EntityTarget $$1) {
      if ($$1 != null) {
         Entity $$2 = $$0.getOptionalParameter($$1.getParam());
         if ($$2 != null) {
            CommandSourceStack $$3 = $$2.createCommandSourceStackForNameResolution($$0.getLevel()).withPermission(2);
            return $$2x -> {
               try {
   ...
   public ItemStack run(ItemStack $$0, LootContext $$1) {
      this.name
         .ifPresent(
            $$2 -> $$0.set(this.target.component(), (Component)createResolver($$1, (LootContext.EntityTarget)this.resolutionContext.orElse(null)).apply($$2))
         );
      return $$0;
   }
