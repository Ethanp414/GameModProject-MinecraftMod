...
public class NestedLootTable extends LootPoolSingletonContainer {
   ...
   public void createItemStack(Consumer<ItemStack> $$0, LootContext $$1) {
      this.contents
         .<LootTable>map($$1x -> (LootTable)$$1.getResolver().get($$1x).map(Holder::value).orElse(LootTable.EMPTY), $$0x -> $$0x)
   ...
   public void validate(ValidationContext $$0) {
      ...
      if ($$1.isPresent()) {
         ResourceKey<LootTable> $$2 = (ResourceKey)$$1.get();
      ...
      this.contents
         .ifLeft(
            $$1x -> $$0.resolver()
                  .get($$1x)
                  .ifPresentOrElse(
                     $$2x -> ((LootTable)$$2x.value()).validate($$0.enterElement(new ProblemReporter.ElementReferencePathElement($$1x), $$1x)),
