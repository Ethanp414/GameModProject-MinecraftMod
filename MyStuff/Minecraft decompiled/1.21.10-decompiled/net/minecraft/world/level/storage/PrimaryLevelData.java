...
public class PrimaryLevelData implements ServerLevelData, WorldData {
   ...
   public PrimaryLevelData(LevelSettings $$0, WorldOptions $$1, PrimaryLevelData.SpecialWorldProperty $$2, Lifecycle $$3) {
      this(
         null,
         false,
   ...
   public static <T> PrimaryLevelData parse(Dynamic<T> $$0, LevelSettings $$1, PrimaryLevelData.SpecialWorldProperty $$2, WorldOptions $$3, Lifecycle $$4) {
      ...
      return new PrimaryLevelData(
         ...
         (LevelData.RespawnData)$$0.get("spawn").read(LevelData.RespawnData.CODEC).result().orElse(LevelData.RespawnData.DEFAULT),
         $$5,
         ...
         (Set<String>)$$0.get("removed_features").asStream().flatMap($$0x -> $$0x.asString().result().stream()).collect(Collectors.toSet()),
         ...
         (EndDragonFight.Data)$$0.get("DragonFight").read(EndDragonFight.Data.CODEC).resultOrPartial(LOGGER::error).orElse(EndDragonFight.Data.DEFAULT),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void setTagData(RegistryAccess $$0, CompoundTag $$1, @Nullable CompoundTag $$2) {
      ...
      $$1.put("GameRules", this.settings.gameRules().createTag());
      $$1.store("DragonFight", EndDragonFight.Data.CODEC, this.endDragonFightData);
      if ($$2 != null) {
         $$1.put("Player", $$2);
      }

      $$1.store(WorldDataConfiguration.MAP_CODEC, this.settings.getDataConfiguration());
