...
public class LootItemFunctions {
   ...
   private static <T extends LootItemFunction> LootItemFunctionType<T> register(String $$0, MapCodec<T> $$1) {
      return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, ResourceLocation.withDefaultNamespace($$0), new LootItemFunctionType<>($$1));
   }
   ...
   public static BiFunction<ItemStack, LootContext, ItemStack> compose(List<? extends BiFunction<ItemStack, LootContext, ItemStack>> $$0) {
      List<BiFunction<ItemStack, LootContext, ItemStack>> $$1 = List.copyOf($$0);

      return switch($$1.size()) {
         case 0 -> IDENTITY;
         case 1 -> (BiFunction)$$1.get(0);
         case 2 -> {
            BiFunction<ItemStack, LootContext, ItemStack> $$2 = (BiFunction)$$1.get(0);
            BiFunction<ItemStack, LootContext, ItemStack> $$3 = (BiFunction)$$1.get(1);
            yield ($$2x, $$3x) -> (ItemStack)$$3.apply((ItemStack)$$2.apply($$2x, $$3x), $$3x);
         }
         default -> ($$1x, $$2x) -> {
         for(BiFunction<ItemStack, LootContext, ItemStack> $$3xx : $$1) {
            $$1x = (ItemStack)$$3xx.apply($$1x, $$2x);
         }
