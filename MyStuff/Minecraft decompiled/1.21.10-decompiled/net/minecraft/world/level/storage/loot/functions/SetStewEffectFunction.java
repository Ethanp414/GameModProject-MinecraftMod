...
public class SetStewEffectFunction extends LootItemConditionalFunction {
   ...
   public Set<ContextKey<?>> getReferencedContextParams() {
      return (Set<ContextKey<?>>)this.effects
         .stream()
         .flatMap($$0 -> $$0.duration().getReferencedContextParams().stream())
   ...
   public ItemStack run(ItemStack $$0, LootContext $$1) {
      if ($$0.is(Items.SUSPICIOUS_STEW) && !this.effects.isEmpty()) {
         SetStewEffectFunction.EffectEntry $$2 = Util.getRandom(this.effects, $$1.getRandom());
