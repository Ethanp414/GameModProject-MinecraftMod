...
public interface ListOperation {
   ...
   static MapCodec<ListOperation> codec(int $$0) {
      return ListOperation.Type.CODEC.<ListOperation>dispatchMap("mode", ListOperation::mode, $$0x -> $$0x.mapCodec).validate($$1 -> {
   ...
   public static record StandAlone<T>(List<T> value, ListOperation operation) {
      public static <T> Codec<ListOperation.StandAlone<T>> codec(Codec<T> $$0, int $$1) {
         return RecordCodecBuilder.create(
            $$2 -> $$2.group(
                     $$0.sizeLimitedListOf($$1).fieldOf("values").forGetter($$0xx -> $$0xx.value),
                     ListOperation.codec($$1).forGetter($$0xx -> $$0xx.operation)
                  )
