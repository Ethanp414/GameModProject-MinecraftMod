...
public interface WorldData {
   ...
   default void fillCrashReportCategory(CrashReportCategory $$0) {
      $$0.setDetail("Known server brands", (CrashReportDetail<String>)(() -> String.join(", ", this.getKnownServerBrands())));
      $$0.setDetail("Removed feature flags", (CrashReportDetail<String>)(() -> String.join(", ", this.getRemovedFeatureFlags())));
      $$0.setDetail("Level was modded", (CrashReportDetail<String>)(() -> Boolean.toString(this.wasModded())));
      $$0.setDetail("Level storage version", (CrashReportDetail<String>)(() -> {
         int $$0xx = this.getVersion();
         return String.format(Locale.ROOT, "0x%05X - %s", $$0xx, this.getStorageVersionName($$0xx));
      }));
   }
