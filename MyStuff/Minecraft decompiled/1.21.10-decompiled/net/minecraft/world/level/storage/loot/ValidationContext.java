...
public class ValidationContext {
   ...
   public ValidationContext enterElement(ProblemReporter.PathElement $$0, ResourceKey<?> $$1) {
      Set<ResourceKey<?>> $$2 = ImmutableSet.<ResourceKey<?>>builder().addAll(this.visitedElements).add($$1).build();
   ...
   public void validateContextUsage(LootContextUser $$0) {
      ...
      Set<ContextKey<?>> $$2 = Sets.<ContextKey<?>>difference($$1, this.contextKeySet.allowed());
      if (!$$2.isEmpty()) {
