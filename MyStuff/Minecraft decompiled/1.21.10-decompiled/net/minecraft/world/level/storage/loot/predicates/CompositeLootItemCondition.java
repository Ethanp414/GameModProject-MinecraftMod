...
public abstract class CompositeLootItemCondition implements LootItemCondition {
   ...
   protected static <T extends CompositeLootItemCondition> MapCodec<T> createCodec(Function<List<LootItemCondition>, T> $$0) {
      return RecordCodecBuilder.mapCodec(
         $$1 -> $$1.group(LootItemCondition.DIRECT_CODEC.listOf().fieldOf("terms").forGetter($$0xx -> $$0xx.terms)).apply($$1, $$0)
      );
   }

   protected static <T extends CompositeLootItemCondition> Codec<T> createInlineCodec(Function<List<LootItemCondition>, T> $$0) {
      return LootItemCondition.DIRECT_CODEC.listOf().xmap($$0, $$0x -> $$0x.terms);
   }
   ...
   public void validate(ValidationContext $$0) {
      ...
      for(int $$1 = 0; $$1 < this.terms.size(); ++$$1) {
         ((LootItemCondition)this.terms.get($$1)).validate($$0.forChild(new ProblemReporter.IndexedFieldPathElement("terms", $$1)));
      }
   }
