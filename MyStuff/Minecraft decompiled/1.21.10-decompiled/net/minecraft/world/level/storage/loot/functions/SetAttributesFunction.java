...
public class SetAttributesFunction extends LootItemConditionalFunction {
      ...
      $$0 -> commonFields($$0)
            .and(
               $$0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("replace", Boolean.valueOf(true)).forGetter($$0x -> $$0x.replace)
               )
            )
   ...
   public Set<ContextKey<?>> getReferencedContextParams() {
      return (Set<ContextKey<?>>)this.modifiers
         .stream()
         .flatMap($$0 -> $$0.amount.getReferencedContextParams().stream())
   ...
   private ItemAttributeModifiers updateModifiers(LootContext $$0, ItemAttributeModifiers $$1) {
      ...
      for(SetAttributesFunction.Modifier $$3 : this.modifiers) {
         ...
         $$1 = $$1.withModifierAdded($$3.attribute, new AttributeModifier($$3.id, (double)$$3.amount.getFloat($$0), $$3.operation), $$4);
      }
   ...
   public static SetAttributesFunction.ModifierBuilder modifier(
      ResourceLocation $$0, Holder<Attribute> $$1, AttributeModifier.Operation $$2, NumberProvider $$3
   ) {
