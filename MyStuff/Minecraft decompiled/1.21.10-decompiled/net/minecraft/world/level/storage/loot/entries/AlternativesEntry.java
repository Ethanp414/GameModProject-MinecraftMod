...
public class AlternativesEntry extends CompositeEntryBase {
   ...
   protected ComposableEntryContainer compose(List<? extends ComposableEntryContainer> $$0) {
      return switch($$0.size()) {
         ...
         case 2 -> ((ComposableEntryContainer)$$0.get(0)).or((ComposableEntryContainer)$$0.get(1));
         default -> ($$1, $$2) -> {
   ...
   public void validate(ValidationContext $$0) {
      ...
      for(int $$1 = 0; $$1 < this.children.size() - 1; ++$$1) {
         if (((LootPoolEntryContainer)this.children.get($$1)).conditions.isEmpty()) {
   ...
   public static <E> AlternativesEntry.Builder alternatives(Collection<E> $$0, Function<E, LootPoolEntryContainer.Builder<?>> $$1) {
      return new AlternativesEntry.Builder(
         (LootPoolEntryContainer.Builder<?>[])$$0.stream().map($$1::apply).toArray($$0x -> new LootPoolEntryContainer.Builder[$$0x])
      );
   }
