...
public record StructureSet(List<StructureSet.StructureSelectionEntry> structures, StructurePlacement placement) {
   ...
   public StructureSet(Holder<Structure> $$0, StructurePlacement $$1) {
      this(List.of(new StructureSet.StructureSelectionEntry($$0, 1)), $$1);
   }

   public static StructureSet.StructureSelectionEntry entry(Holder<Structure> $$0, int $$1) {
      return new StructureSet.StructureSelectionEntry($$0, $$1);
   }

   public static StructureSet.StructureSelectionEntry entry(Holder<Structure> $$0) {
      return new StructureSet.StructureSelectionEntry($$0, 1);
   }
   ...
   public static record StructureSelectionEntry(Holder<Structure> structure, int weight) {
      public static final Codec<StructureSet.StructureSelectionEntry> CODEC = RecordCodecBuilder.create(
         $$0 -> $$0.group(
               ...
               .apply($$0, StructureSet.StructureSelectionEntry::new)
      );
   }
}
