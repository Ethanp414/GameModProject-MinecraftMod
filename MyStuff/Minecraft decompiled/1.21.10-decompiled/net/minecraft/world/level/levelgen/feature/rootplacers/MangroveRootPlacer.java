...
public class MangroveRootPlacer extends RootPlacer {
   ...
   public boolean placeRoots(
      LevelSimulatedReader $$0, BiConsumer<BlockPos, BlockState> $$1, RandomSource $$2, BlockPos $$3, BlockPos $$4, TreeConfiguration $$5
   ) {
      List<BlockPos> $$6 = Lists.<BlockPos>newArrayList();
      ...
      for(Direction $$8 : Direction.Plane.HORIZONTAL) {
         ...
         List<BlockPos> $$10 = Lists.<BlockPos>newArrayList();
