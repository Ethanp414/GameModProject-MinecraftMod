...
public class NoiseRouterData {
   ...
   public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> $$0) {
      ...
      $$0.register(Y, DensityFunctions.yClampedGradient($$3, $$4, (double)$$3, (double)$$4));
   ...
   private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> $$0, HolderGetter<NormalNoise.NoiseParameters> $$1) {
      ...
      DensityFunction $$4 = DensityFunctions.mappedNoise($$1.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0, (double)Math.floorDiv(-64, 8), 8.0);
   ...
   private static DensityFunction yLimitedInterpolatable(DensityFunction $$0, DensityFunction $$1, int $$2, int $$3, int $$4) {
      return DensityFunctions.interpolated(DensityFunctions.rangeChoice($$0, (double)$$2, (double)($$3 + 1), $$1, DensityFunctions.constant((double)$$4)));
   }
