...
public class ProcessorRule {
   ...
   public static final Codec<ProcessorRule> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               RuleTest.CODEC.fieldOf("input_predicate").forGetter($$0x -> $$0x.inputPredicate),
               RuleTest.CODEC.fieldOf("location_predicate").forGetter($$0x -> $$0x.locPredicate),
               PosRuleTest.CODEC.lenientOptionalFieldOf("position_predicate", PosAlwaysTrueTest.INSTANCE).forGetter($$0x -> $$0x.posPredicate),
               BlockState.CODEC.fieldOf("output_state").forGetter($$0x -> $$0x.outputState),
               RuleBlockEntityModifier.CODEC
                  .lenientOptionalFieldOf("block_entity_modifier", DEFAULT_BLOCK_ENTITY_MODIFIER)
                  .forGetter($$0x -> $$0x.blockEntityModifier)
            )
