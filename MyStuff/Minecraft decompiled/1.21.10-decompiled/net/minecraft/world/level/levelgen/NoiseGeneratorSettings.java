...
public record NoiseGeneratorSettings(
   ...
   public static final Codec<NoiseGeneratorSettings> DIRECT_CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ...
            .apply($$0, NoiseGeneratorSettings::new)
   );
   ...
   public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> $$0) {
      $$0.register(OVERWORLD, overworld($$0, false, false));
      $$0.register(LARGE_BIOMES, overworld($$0, false, true));
      $$0.register(AMPLIFIED, overworld($$0, true, false));
      $$0.register(NETHER, nether($$0));
      $$0.register(END, end($$0));
      $$0.register(CAVES, caves($$0));
      $$0.register(FLOATING_ISLANDS, floatingIslands($$0));
   }
   ...
   private static NoiseGeneratorSettings end(BootstrapContext<?> $$0) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.end($$0.lookup(Registries.DENSITY_FUNCTION)),
         SurfaceRuleData.end(),
         List.of(),
         0,
         true,
   ...
   private static NoiseGeneratorSettings nether(BootstrapContext<?> $$0) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.nether($$0.lookup(Registries.DENSITY_FUNCTION), $$0.lookup(Registries.NOISE)),
   ...
   private static NoiseGeneratorSettings overworld(BootstrapContext<?> $$0, boolean $$1, boolean $$2) {
      return new NoiseGeneratorSettings(
         ...
         NoiseRouterData.overworld($$0.lookup(Registries.DENSITY_FUNCTION), $$0.lookup(Registries.NOISE), $$2, $$1),
   ...
   private static NoiseGeneratorSettings caves(BootstrapContext<?> $$0) {
      return new NoiseGeneratorSettings(
         ...
         Blocks.STONE.defaultBlockState(),
         Blocks.WATER.defaultBlockState(),
         NoiseRouterData.caves($$0.lookup(Registries.DENSITY_FUNCTION), $$0.lookup(Registries.NOISE)),
   ...
   private static NoiseGeneratorSettings floatingIslands(BootstrapContext<?> $$0) {
      return new NoiseGeneratorSettings(
         ...
         Blocks.STONE.defaultBlockState(),
         Blocks.WATER.defaultBlockState(),
         NoiseRouterData.floatingIslands($$0.lookup(Registries.DENSITY_FUNCTION), $$0.lookup(Registries.NOISE)),
