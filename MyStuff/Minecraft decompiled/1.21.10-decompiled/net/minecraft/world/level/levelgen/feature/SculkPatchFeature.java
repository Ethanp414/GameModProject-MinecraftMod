      ...
      if (!this.canSpreadFrom($$1, $$2)) {
         ...
         for(int $$13 = 0; $$13 < $$12; ++$$13) {
            ...
            if ($$1.getBlockState($$14).isAir() && $$1.getBlockState($$14.below()).isFaceSturdy($$1, $$14.below(), Direction.UP)) {
               $$1.setBlock($$14, Blocks.SCULK_SHRIEKER.defaultBlockState().setValue(SculkShriekerBlock.CAN_SUMMON, Boolean.valueOf(true)), 3);
            }
         }
   ...
   private boolean canSpreadFrom(LevelAccessor $$0, BlockPos $$1) {
      ...
      if ($$2.getBlock() instanceof SculkBehaviour) {
         ...
         return !$$2.isAir() && (!$$2.is(Blocks.WATER) || !$$2.getFluidState().isSource())
            ? false
            : Direction.stream().map($$1::relative).anyMatch($$1x -> $$0.getBlockState($$1x).isCollisionShapeFullBlock($$0, $$1x));
      }
   }
}
