...
public class FancyTrunkPlacer extends TrunkPlacer {
   ...
   public List<FoliagePlacer.FoliageAttachment> placeTrunk(
      ...
      int $$11 = $$4.getY() + $$8;
      int $$12 = $$7 - 5;
      List<FancyTrunkPlacer.FoliageCoords> $$13 = Lists.<FancyTrunkPlacer.FoliageCoords>newArrayList();
      ...
      List<FoliagePlacer.FoliageAttachment> $$28 = Lists.<FoliagePlacer.FoliageAttachment>newArrayList();
   ...
   private boolean makeLimb(
      LevelSimulatedReader $$0, BiConsumer<BlockPos, BlockState> $$1, RandomSource $$2, BlockPos $$3, BlockPos $$4, boolean $$5, TreeConfiguration $$6
   ) {
