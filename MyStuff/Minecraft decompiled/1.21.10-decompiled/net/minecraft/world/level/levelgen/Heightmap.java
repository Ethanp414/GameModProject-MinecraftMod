...
public class Heightmap {
   ...
   public void setRawData(ChunkAccess $$0, Heightmap.Types $$1, long[] $$2) {
      ...
      if ($$3.length == $$2.length) {
         ...
         LOGGER.warn("Ignoring heightmap data for chunk {}, size does not match; expected: {}, got: {}", $$0.getPos(), $$3.length, $$2.length);
   ...
   public static enum Types implements StringRepresentable {
      ...
      private static final IntFunction<Heightmap.Types> BY_ID = ByIdMap.continuous($$0 -> $$0.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      ...
      private Types(final int param3, final String param4, final Heightmap.Usage param5, final Predicate<BlockState> param6) {
         this.id = $$0;
