...
public class SinglePoolElement extends StructurePoolElement {
   ...
   private static <T> DataResult<T> encodeTemplate(Either<ResourceLocation, StructureTemplate> $$0, DynamicOps<T> $$1, T $$2) {
      Optional<ResourceLocation> $$3 = $$0.left();
      return $$3.isEmpty()
         ? DataResult.error(() -> "Can not serialize a runtime pool element")
         : ResourceLocation.CODEC.encode((ResourceLocation)$$3.get(), $$1, $$2);
   }
   ...
   protected SinglePoolElement(
      Either<ResourceLocation, StructureTemplate> $$0, Holder<StructureProcessorList> $$1, StructureTemplatePool.Projection $$2, Optional<LiquidSettings> $$3
   ) {
      super($$2);
      this.template = $$0;
      this.processors = $$1;
   ...
   private StructureTemplate getTemplate(StructureTemplateManager $$0) {
      return this.template.map($$0::getOrCreate, Function.identity());
   }
   ...
   protected StructurePlaceSettings getSettings(Rotation $$0, BoundingBox $$1, LiquidSettings $$2, boolean $$3) {
      ...
      $$4.setLiquidSettings((LiquidSettings)this.overrideLiquidSettings.orElse($$2));
      if (!$$3) {
