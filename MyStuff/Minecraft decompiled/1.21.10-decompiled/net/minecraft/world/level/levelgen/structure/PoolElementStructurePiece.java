...
public class PoolElementStructurePiece extends StructurePiece {
   ...
   public PoolElementStructurePiece(StructurePieceSerializationContext $$0, CompoundTag $$1) {
      ...
      this.liquidSettings = (LiquidSettings)$$1.read("liquid_settings", LiquidSettings.CODEC).orElse(JigsawStructure.DEFAULT_LIQUID_SETTINGS);
   }
