...
public class VegetationPatchFeature extends Feature<VegetationPatchConfiguration> {
   ...
   protected Set<BlockPos> placeGroundPatch(
      WorldGenLevel $$0, VegetationPatchConfiguration $$1, RandomSource $$2, BlockPos $$3, Predicate<BlockState> $$4, int $$5, int $$6
   ) {
   ...
   protected boolean placeGround(
      WorldGenLevel $$0, VegetationPatchConfiguration $$1, Predicate<BlockState> $$2, RandomSource $$3, BlockPos.MutableBlockPos $$4, int $$5
   ) {
      for(int $$6 = 0; $$6 < $$5; ++$$6) {
