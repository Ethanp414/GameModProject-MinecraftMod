...
public class AxisAlignedLinearPosTest extends PosRuleTest {
   public static final MapCodec<AxisAlignedLinearPosTest> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               Direction.Axis.CODEC.fieldOf("axis").orElse(Direction.Axis.Y).forGetter($$0x -> $$0x.axis)
            )
   ...
   public boolean test(BlockPos $$0, BlockPos $$1, BlockPos $$2, RandomSource $$3) {
      ...
      float $$5 = (float)Math.abs(($$1.getX() - $$2.getX()) * $$4.getStepX());
      float $$6 = (float)Math.abs(($$1.getY() - $$2.getY()) * $$4.getStepY());
      float $$7 = (float)Math.abs(($$1.getZ() - $$2.getZ()) * $$4.getStepZ());
      int $$8 = (int)($$5 + $$6 + $$7);
      float $$9 = $$3.nextFloat();
