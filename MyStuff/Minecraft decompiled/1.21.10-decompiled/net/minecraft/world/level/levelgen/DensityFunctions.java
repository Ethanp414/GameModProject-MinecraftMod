...
public final class DensityFunctions {
   ...
   public static final Codec<DensityFunction> DIRECT_CODEC = Codec.either(NOISE_VALUE_CODEC, CODEC)
      .xmap(
         $$0 -> $$0.map(DensityFunctions::constant, Function.identity()),
   ...
   static record Ap2(
      ...
      public double compute(DensityFunction.FunctionContext $$0) {
         ...
         return switch(this.type.ordinal()) {
            ...
            case 1 -> $$1 == 0.0 ? 0.0 : $$1 * this.argument2.compute($$0);
            case 2 -> $$1 < this.argument2.minValue() ? $$1 : Math.min($$1, this.argument2.compute($$0));
   ...
   protected static final class EndIslandDensityFunction implements DensityFunction.SimpleFunction {
      ...
      private static float getHeightValue(SimplexNoise $$0, int $$1, int $$2) {
         ...
         int $$5 = $$1 % 2;
         int $$6 = $$2 % 2;
         float $$7 = 100.0F - Mth.sqrt((float)($$1 * $$1 + $$2 * $$2)) * 8.0F;
         ...
         for(int $$8 = -12; $$8 <= 12; ++$$8) {
            for(int $$9 = -12; $$9 <= 12; ++$$9) {
               long $$10 = (long)($$3 + $$8);
               long $$11 = (long)($$4 + $$9);
               if ($$10 * $$10 + $$11 * $$11 > 4096L && $$0.getValue((double)$$10, (double)$$11) < -0.9F) {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         return ((double)getHeightValue(this.islandNoise, $$0.blockX() / 8, $$0.blockZ() / 8) - 8.0) / 128.0;
      }
   ...
   static record FindTopSurface(DensityFunction density, DensityFunction upperBound, int lowerBound, int cellHeight) implements DensityFunction {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         int $$1 = Mth.floor(this.upperBound.compute($$0) / (double)this.cellHeight) * this.cellHeight;
   ...
   public static record HolderHolder(Holder<DensityFunction> function) implements DensityFunction {
      ...
      @Override
      public void fillArray(double[] $$0, DensityFunction.ContextProvider $$1) {
         this.function.value().fillArray($$0, $$1);
      }

      @Override
      public DensityFunction mapAll(DensityFunction.Visitor $$0) {
         return $$0.apply(new DensityFunctions.HolderHolder(new Holder.Direct<>(this.function.value().mapAll($$0))));
      }
   ...
   protected static record Mapped(DensityFunctions.Mapped.Type type, DensityFunction input, double minValue, double maxValue)
      ...
      private static double transform(DensityFunctions.Mapped.Type $$0, double $$1) {
         return switch($$0.ordinal()) {
            ...
            case 1 -> $$1 * $$1;
            case 2 -> $$1 * $$1 * $$1;
            case 3 -> $$1 > 0.0 ? $$1 : $$1 * 0.5;
            case 4 -> $$1 > 0.0 ? $$1 : $$1 * 0.25;
            case 5 -> 1.0 / $$1;
            case 6 -> {
   ...
   protected static record Shift(DensityFunction.NoiseHolder offsetNoise) implements DensityFunctions.ShiftNoise {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         return this.compute((double)$$0.blockX(), (double)$$0.blockY(), (double)$$0.blockZ());
      }
   ...
   protected static record ShiftA(DensityFunction.NoiseHolder offsetNoise) implements DensityFunctions.ShiftNoise {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         return this.compute((double)$$0.blockX(), 0.0, (double)$$0.blockZ());
      }
   ...
   protected static record ShiftB(DensityFunction.NoiseHolder offsetNoise) implements DensityFunctions.ShiftNoise {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         return this.compute((double)$$0.blockZ(), (double)$$0.blockX(), 0.0);
      }
   ...
   public static record Spline(CubicSpline<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> spline) implements DensityFunction {
      ...
      @Override
      public double compute(DensityFunction.FunctionContext $$0) {
         return (double)this.spline.apply(new DensityFunctions.Spline.Point($$0));
      }
      ...
      public static record Coordinate(Holder<DensityFunction> function) implements BoundedFloatFunction<DensityFunctions.Spline.Point> {
         ...
         public DensityFunctions.Spline.Coordinate mapAll(DensityFunction.Visitor $$0) {
            return new DensityFunctions.Spline.Coordinate(new Holder.Direct<>(this.function.value().mapAll($$0)));
         }
      }
   ...
   interface TwoArgumentSimpleFunction extends DensityFunction {
      ...
      static DensityFunctions.TwoArgumentSimpleFunction create(DensityFunctions.TwoArgumentSimpleFunction.Type $$0, DensityFunction $$1, DensityFunction $$2) {
         ...
         if ($$0 == DensityFunctions.TwoArgumentSimpleFunction.Type.MIN || $$0 == DensityFunctions.TwoArgumentSimpleFunction.Type.MAX) {
            ...
            boolean $$8 = $$4 >= $$5;
            if ($$7 || $$8) {
               LOGGER.warn("Creating a {} function between two non-overlapping inputs: {} and {}", $$0, $$1, $$2);
            }
         }
         ...
         double $$10 = switch($$0.ordinal()) {
            case 0 -> $$5 + $$6;
            case 1 -> $$3 > 0.0 && $$4 > 0.0 ? $$5 * $$6 : ($$5 < 0.0 && $$6 < 0.0 ? $$3 * $$4 : Math.max($$3 * $$4, $$5 * $$6));
            case 2 -> Math.min($$5, $$6);
            case 3 -> Math.max($$5, $$6);
            default -> throw new MatchException(null, null);
         };
