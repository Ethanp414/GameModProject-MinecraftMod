...
public class DualNoiseProvider extends NoiseProvider {
   ...
   public BlockState getState(RandomSource $$0, BlockPos $$1) {
      ...
      int $$3 = (int)Mth.clampedMap($$2, -1.0, 1.0, (double)((Integer)this.variety.minInclusive()).intValue(), (double)(this.variety.maxInclusive() + 1));
      List<BlockState> $$4 = Lists.<BlockState>newArrayListWithCapacity($$3);

      for(int $$5 = 0; $$5 < $$3; ++$$5) {
         $$4.add(this.getRandomState(this.states, this.getSlowNoiseValue($$1.offset($$5 * 54545, 0, $$5 * 34234))));
      }

      return this.getRandomState($$4, $$1, (double)this.scale);
   }

   protected double getSlowNoiseValue(BlockPos $$0) {
      return this.slowNoise
         .getValue((double)((float)$$0.getX() * this.slowScale), (double)((float)$$0.getY() * this.slowScale), (double)((float)$$0.getZ() * this.slowScale));
   }
}
