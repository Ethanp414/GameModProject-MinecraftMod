...
public class FossilFeatureConfiguration implements FeatureConfiguration {
   public static final Codec<FossilFeatureConfiguration> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ResourceLocation.CODEC.listOf().fieldOf("fossil_structures").forGetter($$0x -> $$0x.fossilStructures),
               ResourceLocation.CODEC.listOf().fieldOf("overlay_structures").forGetter($$0x -> $$0x.overlayStructures),
   ...
   public FossilFeatureConfiguration(
      List<ResourceLocation> $$0, List<ResourceLocation> $$1, Holder<StructureProcessorList> $$2, Holder<StructureProcessorList> $$3, int $$4
   ) {
      if ($$0.isEmpty()) {
