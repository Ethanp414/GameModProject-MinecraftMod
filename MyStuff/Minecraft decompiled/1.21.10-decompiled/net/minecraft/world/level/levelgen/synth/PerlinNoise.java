...
public class PerlinNoise {
   ...
   public static PerlinNoise createLegacyForBlendedNoise(RandomSource $$0, IntStream $$1) {
      return new PerlinNoise($$0, makeAmplitudes(new IntRBTreeSet((Collection<? extends Integer>)$$1.boxed().collect(ImmutableList.toImmutableList()))), false);
   }
   ...
   protected PerlinNoise(RandomSource $$0, Pair<Integer, DoubleList> $$1, boolean $$2) {
      this.firstOctave = $$1.getFirst();
      this.amplitudes = $$1.getSecond();
