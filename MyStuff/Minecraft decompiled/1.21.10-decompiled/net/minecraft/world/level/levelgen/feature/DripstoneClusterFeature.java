...
public class DripstoneClusterFeature extends Feature<DripstoneClusterConfiguration> {
   ...
   private void placeColumn(
      WorldGenLevel $$0, RandomSource $$1, BlockPos $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, DripstoneClusterConfiguration $$9
   ) {
   ...
   private int getDripstoneHeight(RandomSource $$0, int $$1, int $$2, float $$3, int $$4, DripstoneClusterConfiguration $$5) {
      if ($$0.nextFloat() > $$3) {
         ...
         return (int)randomBetweenBiased($$0, 0.0F, (float)$$4, $$7, (float)$$5.heightDeviation);
      }
   }
   ...
   private double getChanceOfStalagmiteOrStalactite(int $$0, int $$1, int $$2, int $$3, DripstoneClusterConfiguration $$4) {
      ...
      return (double)Mth.clampedMap(
         (float)$$7, 0.0F, (float)$$4.maxDistanceFromEdgeAffectingChanceOfDripstoneColumn, $$4.chanceOfDripstoneColumnAtMaxDistanceFromCenter, 1.0F
      );
   }
