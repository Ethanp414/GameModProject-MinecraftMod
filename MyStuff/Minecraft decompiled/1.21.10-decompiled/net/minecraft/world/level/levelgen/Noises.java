...
public class Noises {
   ...
   private static ResourceKey<NormalNoise.NoiseParameters> createKey(String $$0) {
      return ResourceKey.create(Registries.NOISE, ResourceLocation.withDefaultNamespace($$0));
   }

   public static NormalNoise instantiate(
      HolderGetter<NormalNoise.NoiseParameters> $$0, PositionalRandomFactory $$1, ResourceKey<NormalNoise.NoiseParameters> $$2
   ) {
      Holder<NormalNoise.NoiseParameters> $$3 = $$0.getOrThrow($$2);
      return NormalNoise.create($$1.fromHashOf(((ResourceKey)$$3.unwrapKey().orElseThrow()).location()), (NormalNoise.NoiseParameters)$$3.value());
   }
}
