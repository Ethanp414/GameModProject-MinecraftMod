      ...
      if ($$2.getBlockState($$6).is(Blocks.WATER)) {
         ...
         for(int $$10 = 0; $$10 <= $$9; ++$$10) {
            if ($$2.getBlockState($$6).is(Blocks.WATER) && $$2.getBlockState($$6.above()).is(Blocks.WATER) && $$8.canSurvive($$2, $$6)) {
               if ($$10 == $$9) {
                  $$2.setBlock($$6, $$7.setValue(KelpBlock.AGE, Integer.valueOf($$4.nextInt(4) + 20)), 2);
                  ++$$1;
               } else {
                  $$2.setBlock($$6, $$8, 2);
               }
               ...
               BlockPos $$11 = $$6.below();
               if ($$7.canSurvive($$2, $$11) && !$$2.getBlockState($$11.below()).is(Blocks.KELP)) {
                  $$2.setBlock($$11, $$7.setValue(KelpBlock.AGE, Integer.valueOf($$4.nextInt(4) + 20)), 2);
                  ++$$1;
               }
               break;
            }
