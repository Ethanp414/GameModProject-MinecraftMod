...
public class FlatLevelGeneratorPresets {
   ...
   public static void bootstrap(BootstrapContext<FlatLevelGeneratorPreset> $$0) {
      new FlatLevelGeneratorPresets.Bootstrap($$0).run();
   }
   ...
   static class Bootstrap {
      ...
      private void register(
         ResourceKey<FlatLevelGeneratorPreset> $$0,
         ItemLike $$1,
         ResourceKey<Biome> $$2,
         Set<ResourceKey<StructureSet>> $$3,
         boolean $$4,
         boolean $$5,
         FlatLayerInfo... $$6
      ) {
         ...
         HolderSet.Direct<StructureSet> $$10 = HolderSet.direct((List)$$3.stream().map($$7::getOrThrow).collect(Collectors.toList()));
         FlatLevelGeneratorSettings $$11 = new FlatLevelGeneratorSettings(
            Optional.of($$10), $$9.getOrThrow($$2), FlatLevelGeneratorSettings.createLakesList($$8)
         );
         if ($$4) {
            $$11.setDecoration();
         }
