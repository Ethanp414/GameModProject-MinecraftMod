...
public class SurfaceRelativeThresholdFilter extends PlacementFilter {
   public static final MapCodec<SurfaceRelativeThresholdFilter> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               Codec.INT.optionalFieldOf("min_inclusive", Integer.valueOf(Integer.MIN_VALUE)).forGetter($$0x -> $$0x.minInclusive),
               Codec.INT.optionalFieldOf("max_inclusive", Integer.valueOf(Integer.MAX_VALUE)).forGetter($$0x -> $$0x.maxInclusive)
            )
   ...
   protected boolean shouldPlace(PlacementContext $$0, RandomSource $$1, BlockPos $$2) {
      long $$3 = (long)$$0.getHeight(this.heightmap, $$2.getX(), $$2.getZ());
