...
public class OceanMonumentPieces {
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public MonumentBuilding(RandomSource $$0, int $$1, int $$2, Direction $$3) {
         ...
         List<OceanMonumentPieces.MonumentRoomFitter> $$5 = Lists.<OceanMonumentPieces.MonumentRoomFitter>newArrayList();
      ...
      private List<OceanMonumentPieces.RoomDefinition> generateRoomGraph(RandomSource $$0) {
         ...
         for(OceanMonumentPieces.RoomDefinition $$29 : $$26) {
            int $$30 = 0;
            int $$31 = 0;
   ...
   protected abstract static class OceanMonumentPiece extends StructurePiece {
      ...
      protected void spawnElder(WorldGenLevel $$0, BoundingBox $$1, int $$2, int $$3, int $$4) {
         ...
         if ($$1.isInside($$5)) {
            ElderGuardian $$6 = EntityType.ELDER_GUARDIAN.create($$0.getLevel(), EntitySpawnReason.STRUCTURE);
            if ($$6 != null) {
               $$6.heal($$6.getMaxHealth());
               $$6.snapTo((double)$$5.getX() + 0.5, (double)$$5.getY(), (double)$$5.getZ() + 0.5, 0.0F, 0.0F);
