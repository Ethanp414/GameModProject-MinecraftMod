...
public class SpikeFeature extends Feature<SpikeConfiguration> {
   ...
   public static List<SpikeFeature.EndSpike> getSpikesForLevel(WorldGenLevel $$0) {
   ...
   private void placeSpike(ServerLevelAccessor $$0, RandomSource $$1, SpikeConfiguration $$2, SpikeFeature.EndSpike $$3) {
      int $$4 = $$3.getRadius();
      ...
      for(BlockPos $$5 : BlockPos.betweenClosed(
         ...
         if ($$5.distToLowCornerSqr((double)$$3.getCenterX(), (double)$$5.getY(), (double)$$3.getCenterZ()) <= (double)($$4 * $$4 + 1)
            && $$5.getY() < $$3.getHeight()) {
               ...
               for(int $$12 = 0; $$12 <= 3; ++$$12) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     BlockState $$18 = Blocks.IRON_BARS
                        .defaultBlockState()
                        .setValue(IronBarsBlock.NORTH, Boolean.valueOf($$16 && $$11 != -2))
                        .setValue(IronBarsBlock.SOUTH, Boolean.valueOf($$16 && $$11 != 2))
                        .setValue(IronBarsBlock.WEST, Boolean.valueOf($$17 && $$10 != -2))
                        .setValue(IronBarsBlock.EAST, Boolean.valueOf($$17 && $$10 != 2));
      ...
      EndCrystal $$19 = EntityType.END_CRYSTAL.create($$0.getLevel(), EntitySpawnReason.STRUCTURE);
      if ($$19 != null) {
         $$19.setBeamTarget($$2.getCrystalBeamTarget());
         $$19.setInvulnerable($$2.isCrystalInvulnerable());
         $$19.snapTo((double)$$3.getCenterX() + 0.5, (double)($$3.getHeight() + 1), (double)$$3.getCenterZ() + 0.5, $$1.nextFloat() * 360.0F, 0.0F);
         $$0.addFreshEntity($$19);
   ...
   public static class EndSpike {
      ...
      public EndSpike(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.topBoundingBox = new AABB(
            (double)($$0 - $$2), (double)DimensionType.MIN_Y, (double)($$1 - $$2), (double)($$0 + $$2), (double)DimensionType.MAX_Y, (double)($$1 + $$2)
         );
      }
   ...
   static class SpikeCacheLoader extends CacheLoader<Long, List<SpikeFeature.EndSpike>> {
      public List<SpikeFeature.EndSpike> load(Long $$0) {
         ...
         List<SpikeFeature.EndSpike> $$2 = Lists.<SpikeFeature.EndSpike>newArrayList();
