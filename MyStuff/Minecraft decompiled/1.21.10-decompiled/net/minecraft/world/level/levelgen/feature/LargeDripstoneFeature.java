...
public class LargeDripstoneFeature extends Feature<LargeDripstoneConfiguration> {
   ...
   public boolean place(FeaturePlaceContext<LargeDripstoneConfiguration> $$0) {
      ...
      if (!DripstoneUtils.isEmptyOrWater($$1, $$2)) {
         ...
         if (!$$5.isEmpty() && $$5.get() instanceof Column.Range $$6) {
            if ($$6.height() < 4) {
               return false;
            } else {
   ...
   private static LargeDripstoneFeature.LargeDripstone makeDripstone(
      BlockPos $$0, boolean $$1, RandomSource $$2, int $$3, FloatProvider $$4, FloatProvider $$5
   ) {
      return new LargeDripstoneFeature.LargeDripstone($$0, $$1, $$3, (double)$$4.sample($$2), (double)$$5.sample($$2));
   }

   private void placeDebugMarkers(WorldGenLevel $$0, BlockPos $$1, Column.Range $$2, LargeDripstoneFeature.WindOffsetter $$3) {
      ...
      for(BlockPos.MutableBlockPos $$4 = $$1.atY($$2.floor() + 2).mutable(); $$4.getY() < $$2.ceiling() - 1; $$4.move(Direction.UP)) {
   ...
   static final class LargeDripstone {
      ...
      private int getHeightAtRadius(float $$0) {
         return (int)DripstoneUtils.getDripstoneHeight((double)$$0, (double)this.radius, this.scale, this.bluntness);
      }
