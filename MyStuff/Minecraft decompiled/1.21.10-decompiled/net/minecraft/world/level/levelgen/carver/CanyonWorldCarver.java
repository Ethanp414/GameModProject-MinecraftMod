...
public class CanyonWorldCarver extends WorldCarver<CanyonCarverConfiguration> {
   ...
   public boolean carve(
      ...
      double $$9 = (double)$$6.getBlockX($$4.nextInt(16));
      int $$10 = $$1.y.sample($$4, $$0);
      double $$11 = (double)$$6.getBlockZ($$4.nextInt(16));
      float $$12 = $$4.nextFloat() * (float) (Math.PI * 2);
      float $$13 = $$1.verticalRotation.sample($$4);
      double $$14 = (double)$$1.yScale.sample($$4);
      float $$15 = $$1.shape.thickness.sample($$4);
      int $$16 = (int)((float)$$8 * $$1.shape.distanceFactor.sample($$4));
      int $$17 = 0;
      this.doCarve($$0, $$1, $$2, $$3, $$4.nextLong(), $$5, $$9, (double)$$10, $$11, $$15, $$12, $$13, 0, $$16, $$14, $$7);
      return true;
   }
   ...
   private void doCarve(
      ...
      for(int $$20 = $$12; $$20 < $$13; ++$$20) {
         ...
         double $$22 = $$21 * $$14;
         $$21 *= (double)$$1.shape.horizontalRadiusFactor.sample($$16);
         $$22 = this.updateVerticalRadius($$1, $$16, $$22, (float)$$13, (float)$$20);
         float $$23 = Mth.cos($$11);
         float $$24 = Mth.sin($$11);
