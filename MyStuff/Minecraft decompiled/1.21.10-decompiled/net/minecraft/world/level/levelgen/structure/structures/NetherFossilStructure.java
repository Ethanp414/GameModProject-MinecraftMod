...
public class NetherFossilStructure extends Structure {
   ...
   public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext $$0) {
      ...
      NoiseColumn $$7 = $$0.chunkGenerator().getBaseColumn($$2, $$3, $$0.heightAccessor(), $$0.randomState());
      ...
      if ($$6 <= $$4) {
         ...
         return Optional.of(new Structure.GenerationStub($$11, $$3x -> NetherFossilPieces.addPieces($$0.structureTemplateManager(), $$3x, $$1, $$11)));
      }
   }
