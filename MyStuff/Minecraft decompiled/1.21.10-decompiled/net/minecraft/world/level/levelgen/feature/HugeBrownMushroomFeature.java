      ...
      for(int $$7 = -$$6; $$7 <= $$6; ++$$7) {
         for(int $$8 = -$$6; $$8 <= $$6; ++$$8) {
            ...
            if (!$$13 || !$$14) {
               ...
               if ($$19.hasProperty(HugeMushroomBlock.WEST)
                  && $$19.hasProperty(HugeMushroomBlock.EAST)
                  && $$19.hasProperty(HugeMushroomBlock.NORTH)
                  && $$19.hasProperty(HugeMushroomBlock.SOUTH)) {
                  $$19 = $$19.setValue(HugeMushroomBlock.WEST, Boolean.valueOf($$15))
                     .setValue(HugeMushroomBlock.EAST, Boolean.valueOf($$16))
                     .setValue(HugeMushroomBlock.NORTH, Boolean.valueOf($$17))
                     .setValue(HugeMushroomBlock.SOUTH, Boolean.valueOf($$18));
               }
