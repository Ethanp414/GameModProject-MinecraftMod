...
public class IcebergFeature extends Feature<BlockStateConfiguration> {
   ...
   private void generateIcebergBlock(
      ...
      if ($$14 < 0.0) {
         ...
         double $$16 = $$9 ? -0.5 : (double)(-6 - $$1.nextInt(3));
   ...
   private double signedDistanceCircle(int $$0, int $$1, BlockPos $$2, int $$3, RandomSource $$4) {
      ...
      return (double)$$5 + Math.pow((double)($$0 - $$2.getX()), 2.0) + Math.pow((double)($$1 - $$2.getZ()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double signedDistanceEllipse(int $$0, int $$1, BlockPos $$2, int $$3, int $$4, double $$5) {
      return Math.pow(((double)($$0 - $$2.getX()) * Math.cos($$5) - (double)($$1 - $$2.getZ()) * Math.sin($$5)) / (double)$$3, 2.0)
         + Math.pow(((double)($$0 - $$2.getX()) * Math.sin($$5) + (double)($$1 - $$2.getZ()) * Math.cos($$5)) / (double)$$4, 2.0)
         - 1.0;
   }
