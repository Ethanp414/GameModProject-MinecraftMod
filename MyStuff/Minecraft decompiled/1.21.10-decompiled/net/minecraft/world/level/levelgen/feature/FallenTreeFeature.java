...
public class FallenTreeFeature extends Feature<FallenTreeConfiguration> {
   ...
   private void placeStump(FallenTreeConfiguration $$0, WorldGenLevel $$1, RandomSource $$2, BlockPos.MutableBlockPos $$3) {
      ...
      this.decorateLogs($$1, $$2, Set.of($$4), $$0.stumpDecorators);
   }
   ...
   private void placeFallenLog(FallenTreeConfiguration $$0, WorldGenLevel $$1, RandomSource $$2, int $$3, BlockPos.MutableBlockPos $$4, Direction $$5) {
      Set<BlockPos> $$6 = new HashSet();

      for(int $$7 = 0; $$7 < $$3; ++$$7) {
         $$6.add(this.placeLogBlock($$0, $$1, $$2, $$4, getSidewaysStateModifier($$5)));
         $$4.move($$5);
      }
   ...
   private BlockPos placeLogBlock(
      FallenTreeConfiguration $$0, WorldGenLevel $$1, RandomSource $$2, BlockPos.MutableBlockPos $$3, Function<BlockState, BlockState> $$4
   ) {
      $$1.setBlock($$3, (BlockState)$$4.apply($$0.trunkProvider.getState($$2, $$3)), 3);
      this.markAboveForPostProcessing($$1, $$3);
      return $$3.immutable();
   }

   private void decorateLogs(WorldGenLevel $$0, RandomSource $$1, Set<BlockPos> $$2, List<TreeDecorator> $$3) {
      if (!$$3.isEmpty()) {
         TreeDecorator.Context $$4 = new TreeDecorator.Context($$0, this.getDecorationSetter($$0), $$1, $$2, Set.of(), Set.of());
         $$3.forEach($$1x -> $$1x.place($$4));
      }
   }

   private BiConsumer<BlockPos, BlockState> getDecorationSetter(WorldGenLevel $$0) {
      return ($$1, $$2) -> $$0.setBlock($$1, $$2, 19);
   }

   private static Function<BlockState, BlockState> getSidewaysStateModifier(Direction $$0) {
      return $$1 -> $$1.trySetValue(RotatedPillarBlock.AXIS, $$0.getAxis());
   }
}
