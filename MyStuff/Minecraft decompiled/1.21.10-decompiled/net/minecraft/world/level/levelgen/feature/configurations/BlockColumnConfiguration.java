...
public record BlockColumnConfiguration(List<BlockColumnConfiguration.Layer> layers, Direction direction, BlockPredicate allowedPlacement, boolean prioritizeTip)
   ...
   public static final Codec<BlockColumnConfiguration> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ...
            .apply($$0, BlockColumnConfiguration::new)
   );

   public static BlockColumnConfiguration.Layer layer(IntProvider $$0, BlockStateProvider $$1) {
      return new BlockColumnConfiguration.Layer($$0, $$1);
   }

   public static BlockColumnConfiguration simple(IntProvider $$0, BlockStateProvider $$1) {
      return new BlockColumnConfiguration(List.of(layer($$0, $$1)), Direction.UP, BlockPredicate.ONLY_IN_AIR_PREDICATE, false);
   }
   ...
   public static record Layer(IntProvider height, BlockStateProvider state) {
      public static final Codec<BlockColumnConfiguration.Layer> CODEC = RecordCodecBuilder.create(
         $$0 -> $$0.group(
               ...
               .apply($$0, BlockColumnConfiguration.Layer::new)
      );
   }
}
