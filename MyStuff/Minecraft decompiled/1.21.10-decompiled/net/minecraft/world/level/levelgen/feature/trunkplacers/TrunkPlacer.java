...
public abstract class TrunkPlacer {
   ...
   protected boolean placeLog(
      ...
      if (this.validTreePos($$0, $$3)) {
         $$1.accept($$3, (BlockState)$$5.apply($$4.trunkProvider.getState($$2, $$3)));
         return true;
      } else {
         return false;
      }
   ...
   protected void placeLogIfFree(
      LevelSimulatedReader $$0, BiConsumer<BlockPos, BlockState> $$1, RandomSource $$2, BlockPos.MutableBlockPos $$3, TreeConfiguration $$4
   ) {
      if (this.isFree($$0, $$3)) {
