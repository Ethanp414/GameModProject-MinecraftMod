...
public class CaveWorldCarver extends WorldCarver<CaveCarverConfiguration> {
   ...
   public boolean carve(
      ...
      for(int $$10 = 0; $$10 < $$9; ++$$10) {
         double $$11 = (double)$$6.getBlockX($$4.nextInt(16));
         double $$12 = (double)$$1.y.sample($$4, $$0);
         double $$13 = (double)$$6.getBlockZ($$4.nextInt(16));
         double $$14 = (double)$$1.horizontalRadiusMultiplier.sample($$4);
         double $$15 = (double)$$1.verticalRadiusMultiplier.sample($$4);
         double $$16 = (double)$$1.floorLevel.sample($$4);
         WorldCarver.CarveSkipChecker $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> shouldSkip($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.nextInt(4) == 0) {
            double $$19 = (double)$$1.yScale.sample($$4);
   ...
   protected void createRoom(
      ...
      double $$12 = 1.5 + (double)(Mth.sin((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
