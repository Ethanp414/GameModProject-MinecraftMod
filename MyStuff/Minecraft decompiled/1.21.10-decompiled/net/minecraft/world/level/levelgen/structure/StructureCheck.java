...
public class StructureCheck {
   ...
   public StructureCheckResult checkStart(ChunkPos $$0, Structure $$1, StructurePlacement $$2, boolean $$3) {
      long $$4 = $$0.toLong();
      Object2IntMap<Structure> $$5 = this.loadedChunks.get($$4);
      if ($$5 != null) {
         ...
         if ($$6 != null) {
            ...
            boolean $$7 = ((Long2BooleanMap)this.featureChecks.computeIfAbsent($$1, $$0x -> new Long2BooleanOpenHashMap()))
               .computeIfAbsent($$4, (Long2BooleanFunction)($$2x -> this.canCreateStructure($$0, $$1)));
   ...
   private Object2IntMap<Structure> loadStructures(CompoundTag $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         if ($$2.isEmpty()) {
            ...
            $$2.forEach(($$2x, $$3x) -> {
               ResourceLocation $$4xx = ResourceLocation.tryParse($$2x);
               if ($$4xx != null) {
                  Structure $$5 = $$4.getValue($$4xx);
                  if ($$5 != null) {
                     $$3x.asCompound().ifPresent($$2xx -> {
                        String $$3xxx = $$2xx.getStringOr("id", "");
                        if (!"INVALID".equals($$3xxx)) {
                           int $$4xxx = $$2xx.getIntOr("references", 0);
                           $$3.put($$5, $$4xxx);
                        }
                     });
                  }
