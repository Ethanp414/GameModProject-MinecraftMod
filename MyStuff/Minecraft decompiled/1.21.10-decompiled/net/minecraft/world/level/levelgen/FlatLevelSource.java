...
public class FlatLevelSource extends ChunkGenerator {
   ...
   public ChunkGeneratorStructureState createState(HolderLookup<StructureSet> $$0, RandomState $$1, long $$2) {
      Stream<Holder<StructureSet>> $$3 = (Stream)this.settings
         .structureOverrides()
   ...
   public CompletableFuture<ChunkAccess> fillFromNoise(Blender $$0, RandomState $$1, StructureManager $$2, ChunkAccess $$3) {
      ...
      for(int $$8 = 0; $$8 < Math.min($$3.getHeight(), $$4.size()); ++$$8) {
         BlockState $$9 = (BlockState)$$4.get($$8);
         if ($$9 != null) {
            int $$10 = $$3.getMinY() + $$8;
   ...
   public NoiseColumn getBaseColumn(int $$0, int $$1, LevelHeightAccessor $$2, RandomState $$3) {
      return new NoiseColumn(
         ...
         (BlockState[])this.settings
            .getLayers()
            .stream()
            .limit((long)$$2.getHeight())
            .map($$0x -> $$0x == null ? Blocks.AIR.defaultBlockState() : $$0x)
            .toArray($$0x -> new BlockState[$$0x])
      );
   }
