...
public class SurfaceRules {
   ...
   public static SurfaceRules.ConditionSource verticalGradient(String $$0, VerticalAnchor $$1, VerticalAnchor $$2) {
      return new SurfaceRules.VerticalGradientConditionSource(ResourceLocation.parse($$0), $$1, $$2);
   }
   ...
   protected static final class Context {
      ...
      protected void updateY(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
         ++this.lastUpdateY;
         this.biome = Suppliers.memoize(() -> (Holder<Biome>)this.biomeGetter.apply(this.pos.set($$3, $$4, $$5)));
         this.blockY = $$4;
         this.waterHeight = $$2;
   ...
   static record NoiseThresholdConditionSource(ResourceKey<NormalNoise.NoiseParameters> noise, double minThreshold, double maxThreshold)
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context $$0) {
         ...
         class NoiseThresholdCondition extends SurfaceRules.LazyXZCondition {
            ...
            @Override
            protected boolean compute() {
               double $$0x = $$1.getValue((double)this.context.blockX, 0.0, (double)this.context.blockZ);
               return $$0x >= NoiseThresholdConditionSource.this.minThreshold && $$0x <= NoiseThresholdConditionSource.this.maxThreshold;
            }
         }
   ...
   static record NotConditionSource(SurfaceRules.ConditionSource target) implements SurfaceRules.ConditionSource {
      ...
      public SurfaceRules.Condition apply(SurfaceRules.Context $$0) {
         return new SurfaceRules.NotCondition((SurfaceRules.Condition)this.target.apply($$0));
      }
   }
   ...
   static record SequenceRuleSource(List<SurfaceRules.RuleSource> sequence) implements SurfaceRules.RuleSource {
      ...
      public SurfaceRules.SurfaceRule apply(SurfaceRules.Context $$0) {
         if (this.sequence.size() == 1) {
            return (SurfaceRules.SurfaceRule)((SurfaceRules.RuleSource)this.sequence.get(0)).apply($$0);
         } else {
            Builder<SurfaceRules.SurfaceRule> $$1 = ImmutableList.builder();

            for(SurfaceRules.RuleSource $$2 : this.sequence) {
               $$1.add((SurfaceRules.SurfaceRule)$$2.apply($$0));
            }
   ...
   static record StoneDepthCheck(int offset, boolean addSurfaceDepth, int secondaryDepthRange, CaveSurface surfaceType)
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context $$0) {
         ...
         class StoneDepthCondition extends SurfaceRules.LazyYCondition {
            ...
            @Override
            protected boolean compute() {
               int $$0x = $$1 ? this.context.stoneDepthBelow : this.context.stoneDepthAbove;
               ...
               return $$0x <= 1 + StoneDepthCheck.this.offset + $$1x + $$2;
            }
         }
   ...
   static record TestRuleSource(SurfaceRules.ConditionSource ifTrue, SurfaceRules.RuleSource thenRun) implements SurfaceRules.RuleSource {
      ...
      public SurfaceRules.SurfaceRule apply(SurfaceRules.Context $$0) {
         return new SurfaceRules.TestRule((SurfaceRules.Condition)this.ifTrue.apply($$0), (SurfaceRules.SurfaceRule)this.thenRun.apply($$0));
      }
   }
   ...
   static record VerticalGradientConditionSource(ResourceLocation randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove)
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context $$0) {
         ...
         class VerticalGradientCondition extends SurfaceRules.LazyYCondition {
            VerticalGradientCondition(final SurfaceRules.VerticalGradientConditionSource param1) {
               super($$0);
            }

            @Override
            protected boolean compute() {
               int $$0x = this.context.blockY;
               if ($$0x <= $$1) {
                  return true;
               } else if ($$0x >= $$2) {
                  return false;
               } else {
                  double $$1x = Mth.map((double)$$0x, (double)$$1, (double)$$2, 1.0, 0.0);
                  RandomSource $$2x = $$3.at(this.context.blockX, $$0x, this.context.blockZ);
