...
public abstract class LayerLightSectionStorage<M extends DataLayerStorageMap<M>> {
   ...
   protected DataLayer getDataLayer(long $$0, boolean $$1) {
      return this.getDataLayer((M)($$1 ? this.updatingSectionData : this.visibleSectionData), $$0);
   }
   ...
   public DataLayer getDataLayerData(long $$0) {
      DataLayer $$1 = this.queuedSections.get($$0);
   ...
   protected void markNewInconsistencies(LightEngine<M, ?> $$0) {
      if (this.hasInconsistencies) {
         ...
         while($$5.hasNext()) {
            long $$1 = $$5.next();
            DataLayer $$2 = this.queuedSections.remove($$1);
         ...
         while($$5x.hasNext()) {
            Entry<DataLayer> $$6 = (Entry)$$5x.next();
            long $$7 = $$6.getLongKey();
