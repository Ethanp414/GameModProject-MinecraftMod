   ...
   public void addToTooltip(Item.TooltipContext $$0, Consumer<Component> $$1, TooltipFlag $$2, DataComponentGetter $$3) {
      ...
      if ($$4 == null) {
         ...
         if ($$3.get(DataComponents.CUSTOM_NAME) == null && $$5 == null) {
            $$1.accept(Component.translatable("filled_map.id", this.id).withStyle(ChatFormatting.GRAY));
         }
         ...
         if ($$2.isAdvanced()) {
            ...
            $$1.accept(Component.translatable("filled_map.scale", 1 << $$7).withStyle(ChatFormatting.GRAY));
            $$1.accept(Component.translatable("filled_map.level", $$7, 4).withStyle(ChatFormatting.GRAY));
         }
      }
   }
}
