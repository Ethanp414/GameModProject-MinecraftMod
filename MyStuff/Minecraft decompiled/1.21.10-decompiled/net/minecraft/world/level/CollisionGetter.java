...
public interface CollisionGetter extends BlockGetter {
   ...
   private Iterable<VoxelShape> getBlockCollisionsFromContext(CollisionContext $$0, AABB $$1) {
      return () -> new BlockCollisions(this, $$0, $$1, false, ($$0xx, $$1xx) -> $$1xx);
   }
   ...
   default BlockHitResult clipIncludingBorder(ClipContext $$0) {
   ...
   default boolean collidesWithSuffocatingBlock(@Nullable Entity $$0, AABB $$1) {
      BlockCollisions<VoxelShape> $$2 = new BlockCollisions<>(this, $$0, $$1, true, ($$0x, $$1x) -> $$1x);
   ...
   default Optional<BlockPos> findSupportingBlock(Entity $$0, AABB $$1) {
      ...
      BlockCollisions<BlockPos> $$4 = new BlockCollisions<>(this, $$0, $$1, false, ($$0x, $$1x) -> $$0x);
   ...
   default Optional<Vec3> findFreePosition(@Nullable Entity $$0, VoxelShape $$1, Vec3 $$2, double $$3, double $$4, double $$5) {
      if ($$1.isEmpty()) {
         ...
         VoxelShape $$7 = (VoxelShape)StreamSupport.stream(this.getBlockCollisions($$0, $$6).spliterator(), false)
