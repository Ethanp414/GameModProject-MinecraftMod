...
public class ServerExplosion implements Explosion {
   ...
   public ServerExplosion(
      ...
      @Nullable ExplosionDamageCalculator $$3,
      Vec3 $$4,
      float $$5,
      boolean $$6,
      Explosion.BlockInteraction $$7
   ) {
      this.level = $$0;
      this.source = $$1;
      this.radius = $$5;
   ...
   private void hurtEntities() {
      ...
      for(Entity $$8 : this.level.getEntities(this.source, new AABB((double)$$1, (double)$$3, (double)$$5, (double)$$2, (double)$$4, (double)$$6))) {
         if (!$$8.ignoreExplosion(this)) {
            double $$9 = Math.sqrt($$8.distanceToSqr(this.center)) / (double)$$0;
            if (!($$9 > 1.0)) {
   ...
   private void interactWithBlocks(List<BlockPos> $$0) {
      List<ServerExplosion.StackCollector> $$1 = new ArrayList();
      Util.shuffle($$0, this.level.random);

      for(BlockPos $$2 : $$0) {
         this.level.getBlockState($$2).onExplosionHit(this.level, $$2, this, ($$1x, $$2) -> addOrAppendStack($$1, $$1x, $$2));
      }

      for(ServerExplosion.StackCollector $$3 : $$1) {
   ...
   private static void addOrAppendStack(List<ServerExplosion.StackCollector> $$0, ItemStack $$1, BlockPos $$2) {
      for(ServerExplosion.StackCollector $$3 : $$0) {
         $$3.tryMerge($$1);
         if ($$1.isEmpty()) {
            return;
         }
      ...
      $$0.add(new ServerExplosion.StackCollector($$2, $$1));
   }
