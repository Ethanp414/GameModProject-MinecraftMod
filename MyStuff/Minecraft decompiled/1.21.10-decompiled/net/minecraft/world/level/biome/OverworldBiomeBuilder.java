...
public final class OverworldBiomeBuilder {
   ...
   private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> $$0) {
      HolderLookup.Provider $$1 = new RegistrySetBuilder()
      ...
      CubicSpline<?, ?> $$6 = TerrainProvider.buildErosionOffsetSpline(
         $$4, $$5, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, BoundedFloatFunction.IDENTITY
      );
   ...
   public static String getDebugStringForPeaksAndValleys(double $$0) {
      if ($$0 < (double)NoiseRouterData.peaksAndValleys(0.05F)) {
         return "Valley";
      } else if ($$0 < (double)NoiseRouterData.peaksAndValleys(0.26666668F)) {
         return "Low";
      } else if ($$0 < (double)NoiseRouterData.peaksAndValleys(0.4F)) {
         return "Mid";
      } else {
         return $$0 < (double)NoiseRouterData.peaksAndValleys(0.56666666F) ? "High" : "Peak";
      }
   }

   public String getDebugStringForContinentalness(double $$0) {
      double $$1 = (double)Climate.quantizeCoord((float)$$0);
   ...
   private static String getDebugStringForNoiseValue(double $$0, Climate.Parameter[] $$1) {
      double $$2 = (double)Climate.quantizeCoord((float)$$0);
