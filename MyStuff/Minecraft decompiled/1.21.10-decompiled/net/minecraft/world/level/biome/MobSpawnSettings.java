...
public class MobSpawnSettings {
   ...
   public WeightedList<MobSpawnSettings.SpawnerData> getMobs(MobCategory $$0) {
      return (WeightedList<MobSpawnSettings.SpawnerData>)this.spawners.getOrDefault($$0, EMPTY_MOB_LIST);
   }

   @Nullable
   public MobSpawnSettings.MobSpawnCost getMobSpawnCost(EntityType<?> $$0) {
      return (MobSpawnSettings.MobSpawnCost)this.mobSpawnCosts.get($$0);
   }
   ...
   public static class Builder {
      ...
      public MobSpawnSettings.Builder addSpawn(MobCategory $$0, int $$1, MobSpawnSettings.SpawnerData $$2) {
         ((WeightedList.Builder)this.spawners.get($$0)).add((int)$$2, $$1);
         return this;
      }
      ...
      public MobSpawnSettings build() {
         return new MobSpawnSettings(
            ...
            (Map<MobCategory, WeightedList<MobSpawnSettings.SpawnerData>>)this.spawners
               .entrySet()
               .stream()
               .collect(ImmutableMap.toImmutableMap(Entry::getKey, $$0 -> ((WeightedList.Builder)$$0.getValue()).build())),
