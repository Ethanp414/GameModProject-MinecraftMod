...
public abstract class BiomeSource implements BiomeResolver {
   ...
   private final Supplier<Set<Holder<Biome>>> possibleBiomes = Suppliers.memoize(
      () -> (Set)this.collectPossibleBiomes().distinct().collect(ImmutableSet.toImmutableSet())
   );
   ...
   public Set<Holder<Biome>> getBiomesWithin(int $$0, int $$1, int $$2, int $$3, Climate.Sampler $$4) {
      ...
      int $$12 = $$9 - $$6 + 1;
      int $$13 = $$10 - $$7 + 1;
      Set<Holder<Biome>> $$14 = Sets.<Holder<Biome>>newHashSet();
   ...
   public Pair<BlockPos, Holder<Biome>> findClosestBiome3d(
      ...
      Set<Holder<Biome>> $$7 = (Set)this.possibleBiomes().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
