...
public class FeatureSorter {
   public static <T> List<FeatureSorter.StepFeatureData> buildFeaturesPerStep(List<T> $$0, Function<T, List<HolderSet<PlacedFeature>>> $$1, boolean $$2) {
      ...
      for(T $$8 : $$0) {
         ...
         List<HolderSet<PlacedFeature>> $$10 = (List)$$1.apply($$8);
         ...
         for(int $$14 = 0; $$14 < $$9.size(); ++$$14) {
            Set<FeatureData> $$15 = (Set)$$6.computeIfAbsent((FeatureData)$$9.get($$14), $$1x -> new TreeSet($$5));
            if ($$14 < $$9.size() - 1) {
      ...
      for(FeatureData $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && Graph.depthFirstSearch($$6, $$16, $$17, $$18::add, (T)$$19)) {
            if (!$$2) {
      ...
      for(int $$26 = 0; $$26 < $$7; ++$$26) {
         int $$27 = $$26;
         List<PlacedFeature> $$28 = (List)$$18.stream().filter($$1x -> $$1x.step() == $$27).map(FeatureData::feature).collect(Collectors.toList());
