...
public class TicketStorage extends SavedData {
   ...
   public static final Codec<TicketStorage> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(TICKET_ENTRY.listOf().optionalFieldOf("tickets", List.of()).forGetter(TicketStorage::packTickets))
   ...
   private static TicketStorage fromPacked(List<Pair<ChunkPos, Ticket>> $$0) {
      ...
      for(Pair<ChunkPos, Ticket> $$2 : $$0) {
         ChunkPos $$3 = $$2.getFirst();
         List<Ticket> $$4 = (List)$$1.computeIfAbsent($$3.toLong(), (Long2ObjectFunction)($$0x -> new ObjectArrayList(4)));
         $$4.add($$2.getSecond());
      }
   ...
   private static void forEachTicket(BiConsumer<ChunkPos, Ticket> $$0, Long2ObjectOpenHashMap<List<Ticket>> $$1) {
      for(Entry<List<Ticket>> $$2 : Long2ObjectMaps.fastIterable($$1)) {
   ...
   public void activateAllDeactivatedTickets() {
      for(Entry<List<Ticket>> $$0 : Long2ObjectMaps.fastIterable(this.deactivatedTickets)) {
   ...
   public void setLoadingChunkUpdatedListener(@Nullable TicketStorage.ChunkUpdated $$0) {
      this.loadingChunkUpdatedListener = $$0;
   }

   public void setSimulationChunkUpdatedListener(@Nullable TicketStorage.ChunkUpdated $$0) {
   ...
   public boolean shouldKeepDimensionActive() {
      for(List<Ticket> $$0 : this.tickets.values()) {
         for(Ticket $$1 : $$0) {
   ...
   private List<Ticket> getOrCreateTickets(long $$0) {
      return (List<Ticket>)this.tickets.computeIfAbsent($$0, (Long2ObjectFunction)($$0x -> new ObjectArrayList(4)));
   }
   ...
   public void removeTicketIf(TicketStorage.TicketPredicate $$0, @Nullable Long2ObjectOpenHashMap<List<Ticket>> $$1) {
      ObjectIterator<Entry<List<Ticket>>> $$2 = this.tickets.long2ObjectEntrySet().fastIterator();
      boolean $$3 = false;

      while($$2.hasNext()) {
         Entry<List<Ticket>> $$4 = (Entry)$$2.next();
         ...
         while($$5.hasNext()) {
            ...
            if ($$0.test($$9, $$6)) {
               if ($$1 != null) {
                  List<Ticket> $$10 = (List)$$1.computeIfAbsent($$6, (Long2ObjectFunction)($$1x -> new ObjectArrayList(((List)$$4.getValue()).size())));
                  $$10.add($$9);
               }
   ...
   public void replaceTicketLevelOfType(int $$0, TicketType $$1) {
      ...
      for(Entry<List<Ticket>> $$3 : this.tickets.long2ObjectEntrySet()) {
   ...
   private LongSet getAllChunksWithTicketThat(Predicate<Ticket> $$0) {
      ...
      for(Entry<List<Ticket>> $$2 : Long2ObjectMaps.fastIterable(this.tickets)) {
