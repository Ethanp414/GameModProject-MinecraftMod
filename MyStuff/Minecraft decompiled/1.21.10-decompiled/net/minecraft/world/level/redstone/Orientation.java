...
public class Orientation {
   ...
   private static final Orientation[] ORIENTATIONS = Util.make(() -> {
      ...
      generateContext(new Orientation(Direction.UP, Direction.NORTH, Orientation.SideBias.LEFT), $$0);
      return $$0;
   });
   ...
   private Orientation(Direction $$0, Direction $$1, Orientation.SideBias $$2) {
      this.up = $$0;
      this.front = $$1;
      this.sideBias = $$2;
      ...
      this.horizontalNeighbors = this.neighbors.stream().filter($$0x -> $$0x.getAxis() != this.up.getAxis()).toList();
      this.verticalNeighbors = this.neighbors.stream().filter($$0x -> $$0x.getAxis() == this.up.getAxis()).toList();
   }

   public static Orientation of(Direction $$0, Direction $$1, Orientation.SideBias $$2) {
      return ORIENTATIONS[generateIndex($$0, $$1, $$2)];
   }

   public Orientation withUp(Direction $$0) {
      return (Orientation)this.withUp.get($$0);
   }

   public Orientation withFront(Direction $$0) {
      return (Orientation)this.withFront.get($$0);
   }

   public Orientation withFrontPreserveUp(Direction $$0) {
      return $$0.getAxis() == this.up.getAxis() ? this : (Orientation)this.withFront.get($$0);
   }

   public Orientation withFrontAdjustSideBias(Direction $$0) {
      Orientation $$1 = this.withFront($$0);
      return this.front == $$1.side ? $$1.withMirror() : $$1;
   }

   public Orientation withSideBias(Orientation.SideBias $$0) {
      return (Orientation)this.withSideBias.get($$0);
   }
   ...
   public static Orientation random(RandomSource $$0) {
      return Util.getRandom(ORIENTATIONS, $$0);
   }
   ...
   private static Orientation generateContext(Orientation $$0, Orientation[] $$1) {
      if ($$1[$$0.getIndex()] != null) {
         ...
         for(Orientation.SideBias $$2 : Orientation.SideBias.values()) {
   ...
   @VisibleForTesting
   protected static int generateIndex(Direction $$0, Direction $$1, Orientation.SideBias $$2) {
      if ($$0.getAxis() == $$1.getAxis()) {
         throw new IllegalStateException("Up-vector and front-vector can not be on the same axis");
      } else {
         int $$3;
         if ($$0.getAxis() == Direction.Axis.Y) {
            $$3 = $$1.getAxis() == Direction.Axis.X ? 1 : 0;
         } else {
            $$3 = $$1.getAxis() == Direction.Axis.Y ? 1 : 0;
         }

         int $$5 = $$3 << 1 | $$1.getAxisDirection().ordinal();
   ...
   public static enum SideBias {
      ...
      private SideBias(final String param3) {
         this.name = $$0;
      }
