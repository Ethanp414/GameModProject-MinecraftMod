...
public class MapColor {
   ...
   private MapColor(int $$0, int $$1) {
      if ($$0 >= 0 && $$0 <= 63) {
         this.id = $$0;
         this.col = $$1;
         MATERIAL_COLORS[$$0] = this;
      } else {
         throw new IndexOutOfBoundsException("Map colour ID must be between 0 and 63 (inclusive)");
      }
   }

   public int calculateARGBColor(MapColor.Brightness $$0) {
      return this == NONE ? 0 : ARGB.scaleRGB(ARGB.opaque(this.col), $$0.modifier);
   }
   ...
   public static int getColorFromPackedId(int $$0) {
      int $$1 = $$0 & 0xFF;
      return byIdUnsafe($$1 >> 2).calculateARGBColor(MapColor.Brightness.byIdUnsafe($$1 & 3));
   }

   public byte getPackedId(MapColor.Brightness $$0) {
   ...
   public static enum Brightness {
      ...
      public static MapColor.Brightness byId(int $$0) {
         Preconditions.checkPositionIndex($$0, VALUES.length, "brightness id");
         return byIdUnsafe($$0);
      }

      static MapColor.Brightness byIdUnsafe(int $$0) {
         return VALUES[$$0];
      }
   }
}
