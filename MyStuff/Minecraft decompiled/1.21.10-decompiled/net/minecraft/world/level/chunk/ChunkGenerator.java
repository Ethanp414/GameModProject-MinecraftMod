...
public abstract class ChunkGenerator {
   ...
   public ChunkGenerator(BiomeSource $$0, Function<Holder<Biome>, BiomeGenerationSettings> $$1) {
      ...
      this.featuresPerStep = Suppliers.memoize(
         () -> FeatureSorter.buildFeaturesPerStep(List.copyOf($$0.possibleBiomes()), $$1xx -> ((BiomeGenerationSettings)$$1.apply($$1xx)).features(), true)
      );
   }
      ...
      if (SharedConstants.DEBUG_DISABLE_FEATURES) {
         ...
         for(Holder<Structure> $$7 : $$1) {
            for(StructurePlacement $$8 : $$5.getPlacementsForStructure($$7)) {
               ((Set)$$6.computeIfAbsent($$8, $$0x -> new ObjectArraySet())).add($$7);
            }
         }
         ...
         if ($$6.isEmpty()) {
            ...
            for(Entry<StructurePlacement, Set<Holder<Structure>>> $$13 : $$6.entrySet()) {
               ...
               if ($$14 instanceof ConcentricRingsStructurePlacement $$15) {
                  Pair<BlockPos, Holder<Structure>> $$16 = this.getNearestGeneratedStructure(
                     (Set<Holder<Structure>>)$$13.getValue(), $$0, $$11, $$2, $$4, $$15
                  );
                  if ($$16 != null) {
                     BlockPos $$17 = $$16.getFirst();
               ...
               for(int $$21 = 0; $$21 <= $$3; ++$$21) {
                  ...
                  for(Entry<StructurePlacement, Set<Holder<Structure>>> $$23 : $$12) {
                     ...
                     Pair<BlockPos, Holder<Structure>> $$25 = getNearestGeneratedStructure(
                        (Set<Holder<Structure>>)$$23.getValue(), $$0, $$11, $$19, $$20, $$21, $$4, $$5.getLevelSeed(), $$24
                     );
                     if ($$25 != null) {
                        $$22 = true;
                        double $$26 = $$2.distSqr($$25.getFirst());
                        if ($$26 < $$10) {
                           $$10 = $$26;
                           $$9 = $$25;
                        }
   ...
   private Pair<BlockPos, Holder<Structure>> getNearestGeneratedStructure(
      Set<Holder<Structure>> $$0, ServerLevel $$1, StructureManager $$2, BlockPos $$3, boolean $$4, ConcentricRingsStructurePlacement $$5
   ) {
   ...
   private static Pair<BlockPos, Holder<Structure>> getNearestGeneratedStructure(
      Set<Holder<Structure>> $$0, LevelReader $$1, StructureManager $$2, int $$3, int $$4, int $$5, boolean $$6, long $$7, RandomSpreadStructurePlacement $$8
   ) {
      int $$9 = $$8.spacing();
   ...
   private static Pair<BlockPos, Holder<Structure>> getStructureGeneratingAt(
      Set<Holder<Structure>> $$0, LevelReader $$1, StructureManager $$2, boolean $$3, StructurePlacement $$4, ChunkPos $$5
   ) {
   ...
   public void applyBiomeDecoration(WorldGenLevel $$0, ChunkAccess $$1, StructureManager $$2) {
      ...
      if (!SharedConstants.debugVoidTerrain($$3)) {
         ...
         Map<Integer, List<Structure>> $$7 = (Map)$$6.stream().collect(Collectors.groupingBy($$0x -> $$0x.step().ordinal()));
         ...
         ChunkPos.rangeClosed($$4.chunk(), 1).forEach($$2x -> {
            ChunkAccess $$3xx = $$0.getChunk($$2x.x, $$2x.z);

            for(LevelChunkSection $$4xx : $$3xx.getSections()) {
               $$4xx.getBiomes().getAll($$11::add);
            }
         });
         ...
         try {
            ...
            for(int $$15 = 0; $$15 < $$14; ++$$15) {
               ...
               if ($$2.shouldGenerateStructures()) {
                  for(Structure $$18 : (List)$$7.getOrDefault($$15, Collections.emptyList())) {
                     $$9.setFeatureSeed($$10, $$16, $$15);
                     Supplier<String> $$19 = () -> (String)$$6.getResourceKey($$18).map(Object::toString).orElseGet($$18::toString);
               ...
               if ($$15 < $$12) {
                  ...
                  for(Holder<Biome> $$23 : $$11) {
                     ...
                     if ($$15 < $$24.size()) {
                        ...
                        $$25.stream().map(Holder::value).forEach($$2x -> $$22.add($$26.indexMapping().applyAsInt($$2x)));
                     }
                  }
                  ...
                  for(int $$30 = 0; $$30 < $$27; ++$$30) {
                     ...
                     Supplier<String> $$33 = () -> (String)$$13.getResourceKey($$32).map(Object::toString).orElseGet($$32::toString);
   ...
   public void createStructures(
      RegistryAccess $$0, ChunkGeneratorStructureState $$1, StructureManager $$2, ChunkAccess $$3, StructureTemplateManager $$4, ResourceKey<Level> $$5
   ) {
      if (!SharedConstants.DEBUG_DISABLE_STRUCTURES) {
         ...
         $$1.possibleStructureSets().forEach($$9 -> {
            ...
            if ($$10.isStructureChunk($$1, $$6.x, $$6.z)) {
               if ($$11.size() == 1) {
                  this.tryGenerateStructure((StructureSet.StructureSelectionEntry)$$11.get(0), $$2, $$0, $$8, $$4, $$1.getLevelSeed(), $$3, $$6, $$7, $$5);
               } else {
                  ...
                  while(!$$14.isEmpty()) {
                     ...
                     StructureSet.StructureSelectionEntry $$21 = (StructureSet.StructureSelectionEntry)$$14.get($$19);
         ...
         for(int $$11 = $$6 - 8; $$11 <= $$6 + 8; ++$$11) {
            ...
            for(StructureStart $$13 : $$0.getChunk($$10, $$11).getAllStarts().values()) {
               try {
                  ...
                  $$16.setDetail(
                     "Id", (CrashReportDetail<String>)(() -> (String)$$17.map($$1xx -> $$1xx.getKey($$13.getStructure()).toString()).orElse("UNKNOWN"))
                  );
                  $$16.setDetail("Name", (CrashReportDetail<String>)(() -> BuiltInRegistries.STRUCTURE_TYPE.getKey($$13.getStructure().type()).toString()));
                  $$16.setDetail("Class", (CrashReportDetail<String>)(() -> $$13.getStructure().getClass().getCanonicalName()));
