...
public class LinearPalette<T> implements Palette<T> {
   ...
   private LinearPalette(int $$0, List<T> $$1) {
      ...
      this.bits = $$0;
      Validate.isTrue($$1.size() <= this.values.length, "Can't initialize LinearPalette of size %d with %d entries", this.values.length, $$1.size());

      for(int $$2 = 0; $$2 < $$1.size(); ++$$2) {
         this.values[$$2] = (T)$$1.get($$2);
      }
   ...
   public void read(FriendlyByteBuf $$0, IdMap<T> $$1) {
      ...
      for(int $$2 = 0; $$2 < this.size; ++$$2) {
         this.values[$$2] = $$1.byIdOrThrow($$0.readVarInt());
      }
   }
