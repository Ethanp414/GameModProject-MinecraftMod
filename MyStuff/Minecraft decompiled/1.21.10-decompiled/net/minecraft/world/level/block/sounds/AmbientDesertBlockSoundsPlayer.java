   ...
   public static void playAmbientSandSounds(Level $$0, BlockPos $$1, RandomSource $$2) {
      if ($$0.getBlockState($$1.above()).is(Blocks.AIR)) {
         if ($$2.nextInt(2100) == 0 && shouldPlayAmbientSandSound($$0, $$1)) {
            $$0.playLocalSound((double)$$1.getX(), (double)$$1.getY(), (double)$$1.getZ(), SoundEvents.SAND_IDLE, SoundSource.AMBIENT, 1.0F, 1.0F, false);
         }
      }
   }
   ...
   public static void playAmbientDeadBushSounds(Level $$0, BlockPos $$1, RandomSource $$2) {
      if ($$2.nextInt(130) == 0) {
         ...
         if (shouldPlayDesertDryVegetationBlockSounds($$0, $$1.below())) {
            $$0.playLocalSound((double)$$1.getX(), (double)$$1.getY(), (double)$$1.getZ(), SoundEvents.DEAD_BUSH_IDLE, SoundSource.AMBIENT, 1.0F, 1.0F, false);
         }
      }
   }
