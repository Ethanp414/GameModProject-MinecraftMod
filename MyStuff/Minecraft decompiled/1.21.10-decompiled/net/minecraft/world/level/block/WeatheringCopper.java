...
public interface WeatheringCopper extends ChangeOverTimeBlock<WeatheringCopper.WeatherState> {
   ...
   static Optional<Block> getPrevious(Block $$0) {
      return Optional.ofNullable((Block)((BiMap)PREVIOUS_BY_BLOCK.get()).get($$0));
   }

   static Block getFirst(Block $$0) {
      Block $$1 = $$0;

      for(Block $$2 = (Block)((BiMap)PREVIOUS_BY_BLOCK.get()).get($$0); $$2 != null; $$2 = (Block)((BiMap)PREVIOUS_BY_BLOCK.get()).get($$2)) {
         $$1 = $$2;
      }
   ...
   static Optional<Block> getNext(Block $$0) {
      return Optional.ofNullable((Block)((BiMap)NEXT_BY_BLOCK.get()).get($$0));
   }
