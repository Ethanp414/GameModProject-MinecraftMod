...
public class JigsawBlockEntity extends BlockEntity {
   ...
   protected void loadAdditional(ValueInput $$0) {
      ...
      this.name = (ResourceLocation)$$0.read("name", ResourceLocation.CODEC).orElse(EMPTY_ID);
      this.target = (ResourceLocation)$$0.read("target", ResourceLocation.CODEC).orElse(EMPTY_ID);
      this.pool = (ResourceKey)$$0.read("pool", POOL_CODEC).orElse(Pools.EMPTY);
      this.finalState = $$0.getStringOr("final_state", "minecraft:air");
      this.joint = (JigsawBlockEntity.JointType)$$0.read("joint", JigsawBlockEntity.JointType.CODEC)
