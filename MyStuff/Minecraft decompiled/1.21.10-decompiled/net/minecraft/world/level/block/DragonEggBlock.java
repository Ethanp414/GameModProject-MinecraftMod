...
public class DragonEggBlock extends FallingBlock {
   ...
   private void teleport(BlockState $$0, Level $$1, BlockPos $$2) {
      ...
      for(int $$4 = 0; $$4 < 1000; ++$$4) {
         BlockPos $$5 = $$2.offset(
            $$1.random.nextInt(16) - $$1.random.nextInt(16), $$1.random.nextInt(8) - $$1.random.nextInt(8), $$1.random.nextInt(16) - $$1.random.nextInt(16)
         );
         if ($$1.getBlockState($$5).isAir() && $$3.isWithinBounds($$5) && !$$1.isOutsideBuildHeight($$5)) {
            if ($$1.isClientSide()) {
               for(int $$6 = 0; $$6 < 128; ++$$6) {
                  ...
                  $$1.addParticle(ParticleTypes.PORTAL, $$11, $$12, $$13, (double)$$8, (double)$$9, (double)$$10);
               }
            } else {
               $$1.setBlock($$5, $$0, 2);
