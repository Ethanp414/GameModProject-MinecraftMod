...
public class CoralPlantBlock extends BaseCoralPlantTypeBlock {
   public static final MapCodec<CoralPlantBlock> CODEC = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(CoralBlock.DEAD_CORAL_FIELD.forGetter($$0x -> $$0x.deadBlock), propertiesCodec()).apply($$0, CoralPlantBlock::new)
   );
   ...
   protected void tick(BlockState $$0, ServerLevel $$1, BlockPos $$2, RandomSource $$3) {
      if (!scanForWater($$0, $$1, $$2)) {
         $$1.setBlock($$2, this.deadBlock.defaultBlockState().setValue(WATERLOGGED, Boolean.valueOf(false)), 2);
      }
   }
