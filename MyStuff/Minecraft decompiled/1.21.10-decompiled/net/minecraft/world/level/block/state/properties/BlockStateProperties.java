...
public class BlockStateProperties {
   ...
   public static final EnumProperty<Direction> FACING_HOPPER = EnumProperty.create("facing", Direction.class, (Predicate)($$0 -> $$0 != Direction.UP));
   ...
   public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create(
      "shape",
      RailShape.class,
      (Predicate)($$0 -> $$0 != RailShape.NORTH_EAST && $$0 != RailShape.NORTH_WEST && $$0 != RailShape.SOUTH_EAST && $$0 != RailShape.SOUTH_WEST)
   );
