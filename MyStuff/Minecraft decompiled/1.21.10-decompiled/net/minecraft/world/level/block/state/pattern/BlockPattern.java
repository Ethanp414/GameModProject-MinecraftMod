...
public class BlockPattern {
   ...
   @Nullable
   @VisibleForTesting
   public BlockPattern.BlockPatternMatch matches(LevelReader $$0, BlockPos $$1, Direction $$2, Direction $$3) {
      ...
      for(int $$4 = 0; $$4 < this.width; ++$$4) {
         for(int $$5 = 0; $$5 < this.height; ++$$5) {
            for(int $$6 = 0; $$6 < this.depth; ++$$6) {
               if (!this.pattern[$$6][$$5][$$4].test($$3.getUnchecked(translateAndRotate($$0, $$1, $$2, $$4, $$5, $$6)))) {
                  return null;
               }
            }
         }
   ...
   @Nullable
   public BlockPattern.BlockPatternMatch find(LevelReader $$0, BlockPos $$1) {
   ...
   public static LoadingCache<BlockPos, BlockInWorld> createLevelCache(LevelReader $$0, boolean $$1) {
      return CacheBuilder.newBuilder().build(new BlockPattern.BlockCacheLoader($$0, $$1));
   }
   ...
   protected static BlockPos translateAndRotate(BlockPos $$0, Direction $$1, Direction $$2, int $$3, int $$4, int $$5) {
      if ($$1 != $$2 && $$1 != $$2.getOpposite()) {
         ...
         Vec3i $$8 = $$6.cross($$7);
         return $$0.offset(
            $$7.getX() * -$$4 + $$8.getX() * $$3 + $$6.getX() * $$5,
            $$7.getY() * -$$4 + $$8.getY() * $$3 + $$6.getY() * $$5,
            $$7.getZ() * -$$4 + $$8.getZ() * $$3 + $$6.getZ() * $$5
         );
      } else {
