...
public class CopperGolemStatueBlockEntity extends BlockEntity {
   ...
   public CopperGolem removeStatue(BlockState $$0) {
      CopperGolem $$1 = EntityType.COPPER_GOLEM.create(this.level, EntitySpawnReason.TRIGGERED);
      if ($$1 != null) {
         $$1.setCustomName(this.components().get(DataComponents.CUSTOM_NAME));
   ...
   private CopperGolem initCopperGolem(BlockState $$0, CopperGolem $$1) {
      ...
      $$1.snapTo($$2.getCenter().x, (double)$$2.getY(), $$2.getCenter().z, ((Direction)$$0.getValue(CopperGolemStatueBlock.FACING)).toYRot(), 0.0F);
