...
public record TrialSpawnerConfig(
   ...
   public int calculateTargetTotalMobs(int $$0) {
      return (int)Math.floor((double)(this.totalMobs + this.totalMobsAddedPerPlayer * (float)$$0));
   }

   public int calculateTargetSimultaneousMobs(int $$0) {
      return (int)Math.floor((double)(this.simultaneousMobs + this.simultaneousMobsAddedPerPlayer * (float)$$0));
   }
   ...
   public static class Builder {
      ...
      public TrialSpawnerConfig.Builder spawnPotentialsDefinition(WeightedList<SpawnData> $$0) {
