...
public record BannerPatternLayers(List<BannerPatternLayers.Layer> layers) implements TooltipProvider {
   ...
   public void addToTooltip(Item.TooltipContext $$0, Consumer<Component> $$1, TooltipFlag $$2, DataComponentGetter $$3) {
      for(int $$4 = 0; $$4 < Math.min(this.layers().size(), 6); ++$$4) {
         $$1.accept(((BannerPatternLayers.Layer)this.layers().get($$4)).description().withStyle(ChatFormatting.GRAY));
      }
   }
   ...
   public static class Builder {
      ...
      public BannerPatternLayers.Builder addIfRegistered(HolderGetter<BannerPattern> $$0, ResourceKey<BannerPattern> $$1, DyeColor $$2) {
         ...
         if ($$3.isEmpty()) {
            BannerPatternLayers.LOGGER.warn("Unable to find banner pattern with id: '{}'", $$1.location());
            return this;
         } else {
