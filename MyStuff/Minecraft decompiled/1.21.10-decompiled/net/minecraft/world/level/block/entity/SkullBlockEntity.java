...
public class SkullBlockEntity extends BlockEntity {
   ...
   protected void saveAdditional(ValueOutput $$0) {
      ...
      $$0.storeNullable("note_block_sound", ResourceLocation.CODEC, this.noteBlockSound);
   ...
   protected void loadAdditional(ValueInput $$0) {
      ...
      this.owner = (ResolvableProfile)$$0.read("profile", ResolvableProfile.CODEC).orElse(null);
      this.noteBlockSound = (ResourceLocation)$$0.read("note_block_sound", ResourceLocation.CODEC).orElse(null);
   ...
   protected void applyImplicitComponents(DataComponentGetter $$0) {
      ...
      this.owner = $$0.get(DataComponents.PROFILE);
