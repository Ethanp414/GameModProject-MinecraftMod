...
public class JukeboxBlockEntity extends BlockEntity implements ContainerSingleItem.BlockContainerSingleItem {
   ...
   private void notifyItemChangedInJukebox(boolean $$0) {
      if (this.level != null && this.level.getBlockState(this.getBlockPos()) == this.getBlockState()) {
         this.level.setBlock(this.getBlockPos(), this.getBlockState().setValue(JukeboxBlock.HAS_RECORD, Boolean.valueOf($$0)), 2);
   ...
   protected void loadAdditional(ValueInput $$0) {
      ...
      ItemStack $$1 = (ItemStack)$$0.read("RecordItem", ItemStack.CODEC).orElse(ItemStack.EMPTY);
   ...
   public void setTheItem(ItemStack $$0) {
      ...
      if ($$1 && $$2.isPresent()) {
         this.jukeboxSongPlayer.play(this.level, (Holder<JukeboxSong>)$$2.get());
      } else {
         this.jukeboxSongPlayer.stop(this.level, this.getBlockState());
      }
   }
