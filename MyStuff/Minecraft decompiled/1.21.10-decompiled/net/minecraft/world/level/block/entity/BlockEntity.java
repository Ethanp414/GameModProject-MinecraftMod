...
public abstract class BlockEntity implements DebugValueSource {
   ...
   public static BlockEntity loadStatic(BlockPos $$0, BlockState $$1, CompoundTag $$2, HolderLookup.Provider $$3) {
      ...
      if ($$4 == null) {
         ...
         try {
            ...
            LOGGER.error("Failed to create block entity {} for block {} at position {} ", $$4, $$0, $$1, var12);
            return null;
         }

         try {
            BlockEntity var7;
            try (ProblemReporter.ScopedCollector $$8 = new ProblemReporter.ScopedCollector($$5.problemPath(), LOGGER)) {
            ...
            LOGGER.error("Failed to load data for block entity {} for block {} at position {}", $$4, $$0, $$1, var11);
            return null;
         }
      }
   }
   ...
   public void fillCrashReportCategory(CrashReportCategory $$0) {
      ...
      if (this.level == null) {
         $$0.setDetail("Block location", (CrashReportDetail<String>)(() -> this.worldPosition + " (world missing)"));
      } else {
