...
public class DecoratedPotPatterns {
   ...
   public static ResourceKey<DecoratedPotPattern> getPatternFromItem(Item $$0) {
      return (ResourceKey<DecoratedPotPattern>)ITEM_TO_POT_TEXTURE.get($$0);
   }
   ...
   public static DecoratedPotPattern bootstrap(Registry<DecoratedPotPattern> $$0) {
      register($$0, ANGLER, "angler_pottery_pattern");
      register($$0, ARCHER, "archer_pottery_pattern");
      register($$0, ARMS_UP, "arms_up_pottery_pattern");
      register($$0, BLADE, "blade_pottery_pattern");
      register($$0, BREWER, "brewer_pottery_pattern");
      register($$0, BURN, "burn_pottery_pattern");
      register($$0, DANGER, "danger_pottery_pattern");
      register($$0, EXPLORER, "explorer_pottery_pattern");
      register($$0, FLOW, "flow_pottery_pattern");
      register($$0, FRIEND, "friend_pottery_pattern");
      register($$0, GUSTER, "guster_pottery_pattern");
      register($$0, HEART, "heart_pottery_pattern");
      register($$0, HEARTBREAK, "heartbreak_pottery_pattern");
      register($$0, HOWL, "howl_pottery_pattern");
      register($$0, MINER, "miner_pottery_pattern");
      register($$0, MOURNER, "mourner_pottery_pattern");
      register($$0, PLENTY, "plenty_pottery_pattern");
      register($$0, PRIZE, "prize_pottery_pattern");
      register($$0, SCRAPE, "scrape_pottery_pattern");
      register($$0, SHEAF, "sheaf_pottery_pattern");
      register($$0, SHELTER, "shelter_pottery_pattern");
      register($$0, SKULL, "skull_pottery_pattern");
      register($$0, SNORT, "snort_pottery_pattern");
      return register($$0, BLANK, "decorated_pot_side");
   }
