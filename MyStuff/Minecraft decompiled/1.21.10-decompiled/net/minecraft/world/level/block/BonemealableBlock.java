...
public interface BonemealableBlock {
   ...
   static boolean hasSpreadableNeighbourPos(LevelReader $$0, BlockPos $$1, BlockState $$2) {
      return getSpreadableNeighbourPos(Direction.Plane.HORIZONTAL.stream().toList(), $$0, $$1, $$2).isPresent();
   }

   static Optional<BlockPos> findSpreadableNeighbourPos(Level $$0, BlockPos $$1, BlockState $$2) {
      return getSpreadableNeighbourPos(Direction.Plane.HORIZONTAL.shuffledCopy($$0.random), $$0, $$1, $$2);
   }
