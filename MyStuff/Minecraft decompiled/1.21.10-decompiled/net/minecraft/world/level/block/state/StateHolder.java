...
public abstract class StateHolder<O, S> {
   ...
   public void populateNeighbours(Map<Map<Property<?>, Comparable<?>>, S> $$0) {
      if (this.neighbours != null) {
         ...
         for(Entry<Property<?>, Comparable<?>> $$2 : this.values.entrySet()) {
      ...
      return $$0.dispatch(
         ...
         $$1x -> {
            ...
            return $$2.getValues().isEmpty()
               ? MapCodec.unit($$2)
               : $$2.propertiesCodec.codec().lenientOptionalFieldOf("Properties").xmap($$1xx -> (StateHolder)$$1xx.orElse($$2), Optional::of);
         }
      );
   }
}
