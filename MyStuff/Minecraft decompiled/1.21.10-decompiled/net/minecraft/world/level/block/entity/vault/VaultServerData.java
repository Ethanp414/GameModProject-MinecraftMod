...
public class VaultServerData {
   ...
   static Codec<VaultServerData> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               Codec.LONG.lenientOptionalFieldOf("state_updating_resumes_at", Long.valueOf(0L)).forGetter($$0x -> $$0x.stateUpdatingResumesAt),
               ItemStack.CODEC.listOf().lenientOptionalFieldOf("items_to_eject", List.of()).forGetter($$0x -> $$0x.itemsToEject),
               Codec.INT.lenientOptionalFieldOf("total_ejections_needed", Integer.valueOf(0)).forGetter($$0x -> $$0x.totalEjectionsNeeded)
            )
