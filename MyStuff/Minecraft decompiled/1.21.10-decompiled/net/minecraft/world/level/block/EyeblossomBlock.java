...
public class EyeblossomBlock extends FlowerBlock {
   ...
   public void animateTick(BlockState $$0, Level $$1, BlockPos $$2, RandomSource $$3) {
      if (this.type.emitSounds() && $$3.nextInt(700) == 0) {
         ...
         if ($$4.is(Blocks.PALE_MOSS_BLOCK)) {
            $$1.playLocalSound((double)$$2.getX(), (double)$$2.getY(), (double)$$2.getZ(), SoundEvents.EYEBLOSSOM_IDLE, SoundSource.AMBIENT, 1.0F, 1.0F, false);
         }
      }
   }
   ...
   private boolean tryChangingState(BlockState $$0, ServerLevel $$1, BlockPos $$2, RandomSource $$3) {
      if (!$$1.dimensionType().natural()) {
         return false;
      } else if (CreakingHeartBlock.isNaturalNight($$1) == this.type.open) {
         return false;
      } else {
         EyeblossomBlock.Type $$4 = this.type.transform();
         $$1.setBlock($$2, $$4.state(), 3);
         $$1.gameEvent(GameEvent.BLOCK_CHANGE, $$2, GameEvent.Context.of($$0));
         $$4.spawnTransformParticle($$1, $$2, $$3);
         BlockPos.betweenClosed($$2.offset(-3, -2, -3), $$2.offset(3, 2, 3)).forEach($$4x -> {
            BlockState $$5 = $$1.getBlockState($$4x);
            if ($$5 == $$0) {
   ...
   public static enum Type {
      ...
      private Type(
         final boolean param3, final Holder<MobEffect> param4, final float param5, final SoundEvent param6, final SoundEvent param7, final int param8
      ) {
         this.open = $$0;
         this.effect = $$1;
