...
public class PumpkinBlock extends Block {
   ...
   protected InteractionResult useItemOn(ItemStack $$0, BlockState $$1, Level $$2, BlockPos $$3, Player $$4, InteractionHand $$5, BlockHitResult $$6) {
      if (!$$0.is(Items.SHEARS)) {
         ...
         Direction $$10 = $$9.getAxis() == Direction.Axis.Y ? $$4.getDirection().getOpposite() : $$9;
         dropFromBlockInteractLootTable(
            ...
            $$4,
            ($$3x, $$4x) -> {
               ItemEntity $$5xx = new ItemEntity(
                  $$2,
                  (double)$$3.getX() + 0.5 + (double)$$10.getStepX() * 0.65,
                  (double)$$3.getY() + 0.1,
                  (double)$$3.getZ() + 0.5 + (double)$$10.getStepZ() * 0.65,
                  $$4x
               );
               $$5xx.setDeltaMovement(
                  0.05 * (double)$$10.getStepX() + $$2.random.nextDouble() * 0.02, 0.05, 0.05 * (double)$$10.getStepZ() + $$2.random.nextDouble() * 0.02
               );
               $$2.addFreshEntity($$5xx);
            }
         );
