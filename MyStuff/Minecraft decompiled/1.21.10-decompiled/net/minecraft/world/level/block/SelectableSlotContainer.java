...
public interface SelectableSlotContainer {
   ...
   default OptionalInt getHitSlot(BlockHitResult $$0, Direction $$1) {
      return (OptionalInt)getRelativeHitCoordinatesForBlockFace($$0, $$1).map($$0x -> {
         int $$1xx = getSection(1.0F - $$0x.y, this.getRows());
         int $$2 = getSection($$0x.x, this.getColumns());
         return OptionalInt.of($$2 + $$1xx * this.getColumns());
   ...
   private static Optional<Vec2> getRelativeHitCoordinatesForBlockFace(BlockHitResult $$0, Direction $$1) {
      ...
      if ($$1 != $$2) {
         ...
         Vec3 $$4 = $$0.getLocation().subtract((double)$$3.getX(), (double)$$3.getY(), (double)$$3.getZ());
         double $$5 = $$4.x();
         double $$6 = $$4.y();
         double $$7 = $$4.z();
