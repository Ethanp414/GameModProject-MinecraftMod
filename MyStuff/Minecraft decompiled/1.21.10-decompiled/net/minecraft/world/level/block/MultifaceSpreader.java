...
public class MultifaceSpreader {
   ...
   public Optional<MultifaceSpreader.SpreadPos> spreadFromRandomFaceTowardRandomDirection(BlockState $$0, LevelAccessor $$1, BlockPos $$2, RandomSource $$3) {
      return (Optional<MultifaceSpreader.SpreadPos>)Direction.allShuffled($$3)
         .stream()
   ...
   public Optional<MultifaceSpreader.SpreadPos> spreadFromFaceTowardRandomDirection(
      BlockState $$0, LevelAccessor $$1, BlockPos $$2, Direction $$3, RandomSource $$4, boolean $$5
   ) {
      return (Optional<MultifaceSpreader.SpreadPos>)Direction.allShuffled($$4)
         .stream()
   ...
   public Optional<MultifaceSpreader.SpreadPos> spreadFromFaceTowardDirection(
      BlockState $$0, LevelAccessor $$1, BlockPos $$2, Direction $$3, Direction $$4, boolean $$5
   ) {
   ...
   public Optional<MultifaceSpreader.SpreadPos> getSpreadFromFaceTowardDirection(
      BlockState $$0, BlockGetter $$1, BlockPos $$2, Direction $$3, Direction $$4, MultifaceSpreader.SpreadPredicate $$5
   ) {
   ...
   public Optional<MultifaceSpreader.SpreadPos> spreadToFace(LevelAccessor $$0, MultifaceSpreader.SpreadPos $$1, boolean $$2) {
