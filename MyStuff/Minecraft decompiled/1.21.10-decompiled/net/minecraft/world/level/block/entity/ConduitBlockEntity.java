...
public class ConduitBlockEntity extends BlockEntity {
   ...
   private static void applyEffects(Level $$0, BlockPos $$1, List<BlockPos> $$2) {
      ...
      int $$6 = $$1.getY();
      int $$7 = $$1.getZ();
      AABB $$8 = new AABB((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1))
         .inflate((double)$$4)
         .expandTowards(0.0, (double)$$0.getHeight(), 0.0);
      List<Player> $$9 = $$0.getEntitiesOfClass(Player.class, $$8);
      if (!$$9.isEmpty()) {
         for(Player $$10 : $$9) {
            if ($$1.closerThan($$10.blockPosition(), (double)$$4) && $$10.isInWaterOrRain()) {
   ...
   private static EntityReference<LivingEntity> selectNewTarget(ServerLevel $$0, BlockPos $$1) {
      ...
      return $$2.isEmpty() ? null : EntityReference.of(Util.getRandom($$2, $$0.random));
   }
   ...
   private static void animationTick(Level $$0, BlockPos $$1, List<BlockPos> $$2, @Nullable Entity $$3, int $$4) {
      ...
      double $$6 = (double)(Mth.sin((float)($$4 + 35) * 0.1F) / 2.0F + 0.5F);
      $$6 = ($$6 * $$6 + $$6) * 0.3F;
      ...
      for(BlockPos $$8 : $$2) {
         if ($$5.nextInt(50) == 0) {
            ...
            $$0.addParticle(ParticleTypes.NAUTILUS, $$7.x, $$7.y, $$7.z, (double)$$10, (double)$$11, (double)$$12);
         }
      }
