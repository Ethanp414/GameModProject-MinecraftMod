...
public record WeatheringCopperBlocks(
   ...
   public static <WaxedBlock extends Block, WeatheringBlock extends Block & WeatheringCopper> WeatheringCopperBlocks create(
      ...
      return new WeatheringCopperBlocks(
         $$1.apply(
            $$0,
            (Function)$$1x -> (Block)$$3.apply(WeatheringCopper.WeatherState.UNAFFECTED, $$1x),
            (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.UNAFFECTED)
         ),
         $$1.apply(
            "exposed_" + $$0,
            (Function)$$1x -> (Block)$$3.apply(WeatheringCopper.WeatherState.EXPOSED, $$1x),
            (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.EXPOSED)
         ),
         $$1.apply(
            "weathered_" + $$0,
            (Function)$$1x -> (Block)$$3.apply(WeatheringCopper.WeatherState.WEATHERED, $$1x),
            (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.WEATHERED)
         ),
         $$1.apply(
            "oxidized_" + $$0,
            (Function)$$1x -> (Block)$$3.apply(WeatheringCopper.WeatherState.OXIDIZED, $$1x),
            (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.OXIDIZED)
         ),
         $$1.apply("waxed_" + $$0, $$2::apply, (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.UNAFFECTED)),
         $$1.apply("waxed_exposed_" + $$0, $$2::apply, (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.EXPOSED)),
         $$1.apply("waxed_weathered_" + $$0, $$2::apply, (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.WEATHERED)),
         $$1.apply("waxed_oxidized_" + $$0, $$2::apply, (BlockBehaviour.Properties)$$4.apply(WeatheringCopper.WeatherState.OXIDIZED))
      );
   }
