...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider, Nameable, BeaconBeamOwner {
   ...
   public static void tick(Level $$0, BlockPos $$1, BlockState $$2, BeaconBlockEntity $$3) {
      ...
      if ($$3.lastCheckY < $$5) {
         $$7 = $$1;
         $$3.checkingBeamSections = Lists.<BeaconBeamOwner.Section>newArrayList();
         $$3.lastCheckY = $$1.getY() - 1;
      } else {
         $$7 = new BlockPos($$4, $$3.lastCheckY + 1, $$6);
      }

      BeaconBeamOwner.Section $$9 = $$3.checkingBeamSections.isEmpty()
         ? null
         : (BeaconBeamOwner.Section)$$3.checkingBeamSections.get($$3.checkingBeamSections.size() - 1);
      ...
      for(int $$11 = 0; $$11 < 10 && $$7.getY() <= $$10; ++$$11) {
         ...
         if ($$13 instanceof BeaconBeamBlock $$14) {
      ...
      if ($$3.lastCheckY >= $$10) {
         ...
         if (!$$0.isClientSide()) {
            ...
            if (!$$17 && $$18) {
               ...
               for(ServerPlayer $$19 : $$0.getEntitiesOfClass(
                  ServerPlayer.class, new AABB((double)$$4, (double)$$5, (double)$$6, (double)$$4, (double)($$5 - 4), (double)$$6).inflate(10.0, 5.0, 10.0)
               )) {
   ...
   private static void applyEffects(Level $$0, BlockPos $$1, int $$2, @Nullable Holder<MobEffect> $$3, @Nullable Holder<MobEffect> $$4) {
      if (!$$0.isClientSide() && $$3 != null) {
         ...
         int $$7 = (9 + $$2 * 2) * 20;
         AABB $$8 = new AABB($$1).inflate($$5).expandTowards(0.0, (double)$$0.getHeight(), 0.0);
   ...
   private static void storeEffect(ValueOutput $$0, String $$1, @Nullable Holder<MobEffect> $$2) {
      if ($$2 != null) {
         $$2.unwrapKey().ifPresent($$2x -> $$0.putString($$1, $$2x.location().toString()));
      }
   }

   @Nullable
   private static Holder<MobEffect> loadEffect(ValueInput $$0, String $$1) {
      return (Holder<MobEffect>)$$0.read($$1, BuiltInRegistries.MOB_EFFECT.holderByNameCodec()).filter(VALID_EFFECTS::contains).orElse(null);
   }
   ...
   public AbstractContainerMenu createMenu(int $$0, Inventory $$1, Player $$2) {
      return BaseContainerBlockEntity.canUnlock($$2, this.lockKey, this.getDisplayName())
         ? new BeaconMenu($$0, $$1, this.dataAccess, ContainerLevelAccess.create(this.level, this.getBlockPos()))
         : null;
   }
