...
public class TrialSpawnerConfigs {
   ...
   private static <T extends Entity> SpawnData spawnData(EntityType<T> $$0) {
      return customSpawnDataWithEquipment($$0, $$0x -> {
      }, null);
   }
   ...
   private static <T extends Entity> SpawnData spawnDataWithEquipment(EntityType<T> $$0, ResourceKey<LootTable> $$1) {
      return customSpawnDataWithEquipment($$0, $$0x -> {
      }, $$1);
   }

   private static <T extends Entity> SpawnData customSpawnDataWithEquipment(EntityType<T> $$0, Consumer<CompoundTag> $$1, @Nullable ResourceKey<LootTable> $$2) {
