...
public final class TreeGrower {
   ...
   private ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource $$0, boolean $$1) {
      ...
      return $$1 && this.flowers.isPresent() ? (ResourceKey)this.flowers.get() : (ResourceKey)this.tree.orElse(null);
   }
   ...
   public boolean growTree(ServerLevel $$0, ChunkGenerator $$1, BlockPos $$2, BlockState $$3, RandomSource $$4) {
      ...
      if ($$5 != null) {
         Holder<ConfiguredFeature<?, ?>> $$6 = (Holder)$$0.registryAccess().lookupOrThrow(Registries.CONFIGURED_FEATURE).get($$5).orElse(null);
         if ($$6 != null) {
            for(int $$7 = 0; $$7 >= -1; --$$7) {
               for(int $$8 = 0; $$8 >= -1; --$$8) {
      ...
      if ($$11 == null) {
         ...
         Holder<ConfiguredFeature<?, ?>> $$12 = (Holder)$$0.registryAccess().lookupOrThrow(Registries.CONFIGURED_FEATURE).get($$11).orElse(null);
         if ($$12 == null) {
            return false;
         } else {
