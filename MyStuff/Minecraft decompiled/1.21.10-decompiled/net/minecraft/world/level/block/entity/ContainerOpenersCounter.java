...
public abstract class ContainerOpenersCounter {
   ...
   public void incrementOpeners(LivingEntity $$0, Level $$1, BlockPos $$2, BlockState $$3, double $$4) {
   ...
   public void decrementOpeners(LivingEntity $$0, Level $$1, BlockPos $$2, BlockState $$3) {
   ...
   public List<ContainerUser> getEntitiesWithContainerOpen(Level $$0, BlockPos $$1) {
      double $$2 = this.maxInteractionRange + 4.0;
      AABB $$3 = new AABB($$1).inflate($$2);
      return (List<ContainerUser>)$$0.getEntities((Entity)null, $$3, $$1x -> this.hasContainerOpen($$1x, $$1))
         .stream()
   ...
   private boolean hasContainerOpen(Entity $$0, BlockPos $$1) {
      if ($$0 instanceof ContainerUser $$2 && !$$2.getLivingEntity().isSpectator()) {
         return $$2.hasContainerOpen(this, $$1);
      }
