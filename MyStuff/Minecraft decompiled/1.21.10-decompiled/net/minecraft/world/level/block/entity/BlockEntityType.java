...
public class BlockEntityType<T extends BlockEntity> {
   ...
   private static <T extends BlockEntity> BlockEntityType<T> register(String $$0, BlockEntityType.BlockEntitySupplier<? extends T> $$1, Block... $$2) {
      if ($$2.length == 0) {
      ...
      return Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, $$0, new BlockEntityType<>($$1, Set.of($$2)));
   }

   private BlockEntityType(BlockEntityType.BlockEntitySupplier<? extends T> $$0, Set<Block> $$1) {
      this.factory = $$0;
      this.validBlocks = $$1;
   }
