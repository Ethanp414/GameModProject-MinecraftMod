...
public class CreativeModeTabs {
      ...
      Registry.register(
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
            ...
            .displayItems(($$0x, $$1) -> {
               ...
               $$1.accept(Items.COPPER_BARS.waxedExposed());
               ...
               $$1.accept(Items.COPPER_CHAIN.waxedExposed());
               ...
               $$1.accept(Items.COPPER_BARS.waxedWeathered());
               ...
               $$1.accept(Items.COPPER_CHAIN.waxedWeathered());
               ...
               $$1.accept(Items.COPPER_BARS.waxedOxidized());
               ...
               $$1.accept(Items.COPPER_CHAIN.waxedOxidized());
            })
            .build()
      );
      Registry.register(
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3)
            ...
            .displayItems(
               ($$0x, $$1) -> {
                  ...
                  $$1.accept(Items.COPPER_TORCH);
                  $$1.accept(Items.REDSTONE_TORCH);
                  $$1.accept(Items.LANTERN);
                  $$1.accept(Items.SOUL_LANTERN);
                  Items.COPPER_LANTERN.forEach($$1::accept);
                  $$1.accept(Items.IRON_CHAIN);
                  Items.COPPER_CHAIN.forEach($$1::accept);
                  ...
                  $$1.accept(Items.EXPOSED_LIGHTNING_ROD);
                  $$1.accept(Items.WEATHERED_LIGHTNING_ROD);
                  $$1.accept(Items.OXIDIZED_LIGHTNING_ROD);
                  $$1.accept(Items.WAXED_LIGHTNING_ROD);
                  $$1.accept(Items.WAXED_EXPOSED_LIGHTNING_ROD);
                  $$1.accept(Items.WAXED_WEATHERED_LIGHTNING_ROD);
                  $$1.accept(Items.WAXED_OXIDIZED_LIGHTNING_ROD);
                  ...
                  $$1.accept(Items.OAK_SHELF);
                  $$1.accept(Items.SPRUCE_SHELF);
                  $$1.accept(Items.BIRCH_SHELF);
                  $$1.accept(Items.JUNGLE_SHELF);
                  $$1.accept(Items.ACACIA_SHELF);
                  $$1.accept(Items.DARK_OAK_SHELF);
                  $$1.accept(Items.MANGROVE_SHELF);
                  $$1.accept(Items.CHERRY_SHELF);
                  $$1.accept(Items.PALE_OAK_SHELF);
                  $$1.accept(Items.BAMBOO_SHELF);
                  $$1.accept(Items.CRIMSON_SHELF);
                  $$1.accept(Items.WARPED_SHELF);
                  ...
                  $$1.accept(Items.COPPER_CHEST);
                  $$1.accept(Items.EXPOSED_COPPER_CHEST);
                  $$1.accept(Items.WEATHERED_COPPER_CHEST);
                  $$1.accept(Items.OXIDIZED_COPPER_CHEST);
                  $$1.accept(Items.WAXED_COPPER_CHEST);
                  $$1.accept(Items.WAXED_EXPOSED_COPPER_CHEST);
                  $$1.accept(Items.WAXED_WEATHERED_COPPER_CHEST);
                  $$1.accept(Items.WAXED_OXIDIZED_COPPER_CHEST);
                  ...
                  $$1.accept(Items.COPPER_GOLEM_STATUE);
                  $$1.accept(Items.EXPOSED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.WEATHERED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.OXIDIZED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.WAXED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.WAXED_EXPOSED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.WAXED_WEATHERED_COPPER_GOLEM_STATUE);
                  $$1.accept(Items.WAXED_OXIDIZED_COPPER_GOLEM_STATUE);
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 0)
            ...
            .displayItems(
               ($$0x, $$1) -> {
                  ...
                  $$1.accept(Items.COPPER_SHOVEL);
                  $$1.accept(Items.COPPER_PICKAXE);
                  $$1.accept(Items.COPPER_AXE);
                  $$1.accept(Items.COPPER_HOE);
                  ...
                  $$1.accept(Items.WHITE_BUNDLE);
                  $$1.accept(Items.LIGHT_GRAY_BUNDLE);
                  $$1.accept(Items.GRAY_BUNDLE);
                  $$1.accept(Items.BLACK_BUNDLE);
                  $$1.accept(Items.BROWN_BUNDLE);
                  $$1.accept(Items.RED_BUNDLE);
                  $$1.accept(Items.ORANGE_BUNDLE);
                  $$1.accept(Items.YELLOW_BUNDLE);
                  $$1.accept(Items.LIME_BUNDLE);
                  $$1.accept(Items.GREEN_BUNDLE);
                  $$1.accept(Items.CYAN_BUNDLE);
                  $$1.accept(Items.LIGHT_BLUE_BUNDLE);
                  $$1.accept(Items.BLUE_BUNDLE);
                  $$1.accept(Items.PURPLE_BUNDLE);
                  $$1.accept(Items.MAGENTA_BUNDLE);
                  $$1.accept(Items.PINK_BUNDLE);
                  ...
                  $$1.accept(Items.WHITE_HARNESS);
                  $$1.accept(Items.LIGHT_GRAY_HARNESS);
                  $$1.accept(Items.GRAY_HARNESS);
                  $$1.accept(Items.BLACK_HARNESS);
                  $$1.accept(Items.BROWN_HARNESS);
                  $$1.accept(Items.RED_HARNESS);
                  $$1.accept(Items.ORANGE_HARNESS);
                  $$1.accept(Items.YELLOW_HARNESS);
                  $$1.accept(Items.LIME_HARNESS);
                  $$1.accept(Items.GREEN_HARNESS);
                  $$1.accept(Items.CYAN_HARNESS);
                  $$1.accept(Items.LIGHT_BLUE_HARNESS);
                  $$1.accept(Items.BLUE_HARNESS);
                  $$1.accept(Items.PURPLE_HARNESS);
                  $$1.accept(Items.MAGENTA_HARNESS);
                  $$1.accept(Items.PINK_HARNESS);
                  ...
                  $$1.accept(Items.PALE_OAK_BOAT);
                  $$1.accept(Items.PALE_OAK_CHEST_BOAT);
                  ...
                  $$0x.holders()
                     ...
                     .ifPresent(
                        $$1x -> generateInstrumentTypes(
                              $$1, $$1x, Items.GOAT_HORN, InstrumentTags.GOAT_HORNS, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS
                           )
                     );
                  ...
                  $$1.accept(Items.MUSIC_DISC_CREATOR_MUSIC_BOX);
                  $$1.accept(Items.MUSIC_DISC_WAIT);
                  $$1.accept(Items.MUSIC_DISC_CREATOR);
                  $$1.accept(Items.MUSIC_DISC_PRECIPICE);
                  ...
                  $$1.accept(Items.MUSIC_DISC_TEARS);
                  $$1.accept(Items.MUSIC_DISC_LAVA_CHICKEN);
               }
            )
            .build()
      );
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1)
            ...
            .displayItems(
               ($$0x, $$1) -> {
                  ...
                  $$1.accept(Items.COPPER_HELMET);
                  $$1.accept(Items.COPPER_CHESTPLATE);
                  $$1.accept(Items.COPPER_LEGGINGS);
                  $$1.accept(Items.COPPER_BOOTS);
                  ...
                  $$1.accept(Items.COPPER_HORSE_ARMOR);
                  ...
                  $$0x.holders()
                     ...
                     .ifPresent(
                        $$2 -> generatePotionEffectTypes(
                              $$1, $$2, Items.TIPPED_ARROW, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, $$0x.enabledFeatures()
                           )
                     );
               }
            )
      ...
      Registry.register(
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 2)
            ...
            .displayItems(($$0x, $$1) -> {
               ...
               generateOminousBottles($$1, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
               $$0x.holders().lookup(Registries.POTION).ifPresent($$2 -> {
                  generatePotionEffectTypes($$1, $$2, Items.POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, $$0x.enabledFeatures());
                  generatePotionEffectTypes($$1, $$2, Items.SPLASH_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, $$0x.enabledFeatures());
                  generatePotionEffectTypes($$1, $$2, Items.LINGERING_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, $$0x.enabledFeatures());
               });
            })
            .build()
      );
      Registry.register(
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3)
            ...
            .displayItems(($$0x, $$1) -> {
               ...
               $$1.accept(Items.RESIN_CLUMP);
               $$1.accept(Items.INK_SAC);
               $$1.accept(Items.GLOW_INK_SAC);
               $$1.accept(Items.TURTLE_SCUTE);
               $$1.accept(Items.ARMADILLO_SCUTE);
               ...
               $$1.accept(Items.BREEZE_ROD);
               $$1.accept(Items.HEAVY_CORE);
               ...
               $$1.accept(Items.FIELD_MASONED_BANNER_PATTERN);
               $$1.accept(Items.BORDURE_INDENTED_BANNER_PATTERN);
               ...
               $$1.accept(Items.FLOW_BANNER_PATTERN);
               $$1.accept(Items.GUSTER_BANNER_PATTERN);
               ...
               $$1.accept(Items.FLOW_POTTERY_SHERD);
               $$1.accept(Items.FRIEND_POTTERY_SHERD);
               $$1.accept(Items.GUSTER_POTTERY_SHERD);
               ...
               $$1.accept(Items.SCRAPE_POTTERY_SHERD);
               ...
               $$1.accept(Items.FLOW_ARMOR_TRIM_SMITHING_TEMPLATE);
               $$1.accept(Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE);
               $$1.accept(Items.EXPERIENCE_BOTTLE);
               $$1.accept(Items.TRIAL_KEY);
               $$1.accept(Items.OMINOUS_TRIAL_KEY);
               $$0x.holders().lookup(Registries.ENCHANTMENT).ifPresent($$1x -> {
                  generateEnchantmentBookTypesOnlyMaxLevel($$1, $$1x, CreativeModeTab.TabVisibility.PARENT_TAB_ONLY);
                  generateEnchantmentBookTypesAllLevels($$1, $$1x, CreativeModeTab.TabVisibility.SEARCH_TAB_ONLY);
               });
            })
            .build()
      );
      Registry.register(
         ...
         CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4)
            ...
            .displayItems(($$0x, $$1) -> {
               ...
               $$1.accept(Items.COPPER_GOLEM_SPAWN_EGG);
               ...
               ($$0x, $$1) -> {
                  if ($$0x.hasPermissions()) {
                     ...
                     for(TestBlockMode $$2 : TestBlockMode.values()) {
                        $$1.accept(TestBlock.setModeOnStack(new ItemStack(Items.TEST_BLOCK), $$2));
                     }
   ...
   private static void generatePotionEffectTypes(
      CreativeModeTab.Output $$0, HolderLookup<Potion> $$1, Item $$2, CreativeModeTab.TabVisibility $$3, FeatureFlagSet $$4
   ) {
      $$1.listElements()
   ...
   private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output $$0, HolderLookup<Enchantment> $$1, CreativeModeTab.TabVisibility $$2) {
      $$1.listElements()
         .map($$0x -> EnchantmentHelper.createBook(new EnchantmentInstance($$0x, ((Enchantment)$$0x.value()).getMaxLevel())))
         .forEach($$2x -> $$0.accept($$2x, $$2));
   }

   private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output $$0, HolderLookup<Enchantment> $$1, CreativeModeTab.TabVisibility $$2) {
      $$1.listElements()
         .flatMap(
   ...
   private static void generateInstrumentTypes(
      CreativeModeTab.Output $$0, HolderLookup<Instrument> $$1, Item $$2, TagKey<Instrument> $$3, CreativeModeTab.TabVisibility $$4
   ) {
      $$1.get($$3).ifPresent($$3x -> $$3x.stream().map($$1xx -> InstrumentItem.create($$2, $$1xx)).forEach($$2xx -> $$0.accept($$2xx, $$4)));
   }
   ...
   private static void generatePresetPaintings(
      CreativeModeTab.Output $$0,
      HolderLookup.Provider $$1,
      HolderLookup.RegistryLookup<PaintingVariant> $$2,
      Predicate<Holder<PaintingVariant>> $$3,
      CreativeModeTab.TabVisibility $$4
   ) {
      ...
      $$2.listElements().filter($$3).sorted(PAINTING_COMPARATOR).forEach($$2x -> {
         ItemStack $$3xx = new ItemStack(Items.PAINTING);
         $$3xx.set(DataComponents.PAINTING_VARIANT, $$2x);
         $$0.accept($$3xx, $$4);
      });
   }
   ...
   private static void buildAllTabContents(CreativeModeTab.ItemDisplayParameters $$0) {
      streamAllTabs().filter($$0x -> $$0x.getType() == CreativeModeTab.Type.CATEGORY).forEach($$1 -> $$1.buildContents($$0));
      streamAllTabs().filter($$0x -> $$0x.getType() != CreativeModeTab.Type.CATEGORY).forEach($$1 -> $$1.buildContents($$0));
   }
