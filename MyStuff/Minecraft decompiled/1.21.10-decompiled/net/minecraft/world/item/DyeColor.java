...
public enum DyeColor implements StringRepresentable {
   ...
   private static final Int2ObjectOpenHashMap<DyeColor> BY_FIREWORK_COLOR = new Int2ObjectOpenHashMap<>(
      (Map<? extends Integer, ? extends DyeColor>)Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.fireworkColor, $$0 -> $$0))
   );
   ...
   @Deprecated
   public static final Codec<DyeColor> LEGACY_ID_CODEC = Codec.BYTE.xmap(DyeColor::byId, $$0 -> (byte)$$0.id);
   ...
   public static DyeColor byFireworkColor(int $$0) {
      return BY_FIREWORK_COLOR.get($$0);
   }
   ...
   public static DyeColor getMixedColor(ServerLevel $$0, DyeColor $$1, DyeColor $$2) {
      ...
      return (DyeColor)$$0.recipeAccess()
