...
public class BottleItem extends Item {
   ...
   public InteractionResult use(Level $$0, Player $$1, InteractionHand $$2) {
      List<AreaEffectCloud> $$3 = $$0.getEntitiesOfClass(
         AreaEffectCloud.class, $$1.getBoundingBox().inflate(2.0), $$0x -> $$0x != null && $$0x.isAlive() && $$0x.getOwner() instanceof EnderDragon
      );
      ...
      if (!$$3.isEmpty()) {
         ...
         BlockHitResult $$7 = getPlayerPOVHitResult($$0, $$1, ClipContext.Fluid.SOURCE_ONLY);
            ...
            if ($$7.getType() == HitResult.Type.BLOCK) {
               ...
               if ($$0.getFluidState($$8).is(FluidTags.WATER)) {
                  ...
                  return InteractionResult.SUCCESS
                     .heldItemTransformedTo(this.turnBottleIntoItem($$4, $$1, PotionContents.createItemStack(Items.POTION, Potions.WATER)));
               }
            }
