...
public final class BundleContents implements TooltipComponent {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         return true;
      } else if (!($$0 instanceof BundleContents)) {
         return false;
      } else {
   ...
   public static class Mutable {
      ...
      private int findStackIndex(ItemStack $$0) {
         if (!$$0.isStackable()) {
            ...
            for(int $$1 = 0; $$1 < this.items.size(); ++$$1) {
               if (ItemStack.isSameItemSameComponents((ItemStack)this.items.get($$1), $$0)) {
                  return $$1;
               }
            }
      ...
      public int tryInsert(ItemStack $$0) {
         if (!BundleContents.canItemBeInBundle($$0)) {
            ...
            if ($$1 == 0) {
               ...
               if ($$2 != -1) {
                  ItemStack $$3 = (ItemStack)this.items.remove($$2);
      ...
      public ItemStack removeOne() {
         if (this.items.isEmpty()) {
            ...
            ItemStack $$1 = ((ItemStack)this.items.remove($$0)).copy();
