...
public abstract sealed class ResolvableProfile implements TooltipProvider permits ResolvableProfile.Static, ResolvableProfile.Dynamic {
   ...
   private static ResolvableProfile create(Either<GameProfile, ResolvableProfile.Partial> $$0, PlayerSkin.Patch $$1) {
      return $$0.map(
         ...
         $$1x -> (ResolvableProfile)($$1x.properties.isEmpty() && $$1x.id.isPresent() != $$1x.name.isPresent()
               ? (ResolvableProfile)$$1x.name
                  .map($$1xx -> new ResolvableProfile.Dynamic(Either.left($$1xx), $$1))
                  .orElseGet(() -> new ResolvableProfile.Dynamic(Either.right((UUID)$$1x.id.get()), $$1))
               : new ResolvableProfile.Static(Either.right($$1x), $$1))
      );
   }

   public static ResolvableProfile createResolved(GameProfile $$0) {
      return new ResolvableProfile.Static(Either.left($$0), PlayerSkin.Patch.EMPTY);
   }

   public static ResolvableProfile createUnresolved(String $$0) {
      return new ResolvableProfile.Dynamic(Either.left($$0), PlayerSkin.Patch.EMPTY);
   }

   public static ResolvableProfile createUnresolved(UUID $$0) {
      return new ResolvableProfile.Dynamic(Either.right($$0), PlayerSkin.Patch.EMPTY);
   }
   ...
   static GameProfile createPartialProfile(Optional<String> $$0, Optional<UUID> $$1, PropertyMap $$2) {
      String $$3 = (String)$$0.orElse("");
      UUID $$4 = (UUID)$$1.orElseGet(() -> (UUID)$$0.map(UUIDUtil::createOfflinePlayerUUID).orElse(Util.NIL_UUID));
   ...
   public static final class Dynamic extends ResolvableProfile {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            if ($$0 instanceof ResolvableProfile.Dynamic $$1 && this.nameOrId.equals($$1.nameOrId) && this.skinPatch.equals($$1.skinPatch)) {
               return true;
            }
      ...
      public CompletableFuture<GameProfile> resolveProfile(ProfileResolver $$0) {
         return CompletableFuture.supplyAsync(() -> (GameProfile)$$0.fetchByNameOrId(this.nameOrId).orElse(this.partialProfile), Util.nonCriticalIoPool());
      }
   ...
   public static final class Static extends ResolvableProfile {
      ...
      Static(Either<GameProfile, ResolvableProfile.Partial> $$0, PlayerSkin.Patch $$1) {
         super($$0.map($$0x -> $$0x, ResolvableProfile.Partial::createProfile), $$1);
         this.contents = $$0;
      }
      ...
      @Override
      public Optional<String> name() {
         return this.contents.map($$0 -> Optional.of($$0.name()), $$0 -> $$0.name);
      }
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            if ($$0 instanceof ResolvableProfile.Static $$1 && this.contents.equals($$1.contents) && this.skinPatch.equals($$1.skinPatch)) {
               return true;
            }
