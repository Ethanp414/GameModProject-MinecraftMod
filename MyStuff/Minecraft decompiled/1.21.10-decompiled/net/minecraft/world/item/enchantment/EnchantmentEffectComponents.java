...
public interface EnchantmentEffectComponents {
   ...
   DataComponentType<List<CrossbowItem.ChargingSounds>> CROSSBOW_CHARGING_SOUNDS = register(
      "crossbow_charging_sounds", $$0 -> $$0.persistent(CrossbowItem.ChargingSounds.CODEC.listOf())
   );
   ...
   private static <T> DataComponentType<T> register(String $$0, UnaryOperator<DataComponentType.Builder<T>> $$1) {
      return Registry.register(
         BuiltInRegistries.ENCHANTMENT_EFFECT_COMPONENT_TYPE, $$0, ((DataComponentType.Builder)$$1.apply(DataComponentType.builder())).build()
      );
   }
}
