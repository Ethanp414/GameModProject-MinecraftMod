...
public class ItemEnchantments implements TooltipProvider {
   ...
   ItemEnchantments(Object2IntOpenHashMap<Holder<Enchantment>> $$0) {
      ...
      for(Entry<Holder<Enchantment>> $$1 : $$0.object2IntEntrySet()) {
         int $$2 = $$1.getIntValue();
         if ($$2 < 0 || $$2 > 255) {
   ...
   public void addToTooltip(Item.TooltipContext $$0, Consumer<Component> $$1, TooltipFlag $$2, DataComponentGetter $$3) {
      ...
      for(Entry<Holder<Enchantment>> $$8 : this.enchantments.object2IntEntrySet()) {
         Holder<Enchantment> $$9 = (Holder)$$8.getKey();
         if (!$$5.contains($$9)) {
   ...
   private static <T> HolderSet<T> getTagOrEmpty(@Nullable HolderLookup.Provider $$0, ResourceKey<Registry<T>> $$1, TagKey<T> $$2) {
      if ($$0 != null) {
         Optional<HolderSet.Named<T>> $$3 = $$0.<T>lookupOrThrow($$1).get($$2);
         if ($$3.isPresent()) {
