...
public record SpawnParticlesEffect(
   ...
   public void apply(ServerLevel $$0, int $$1, EnchantedItemInUse $$2, Entity $$3, Vec3 $$4) {
      ...
      $$0.sendParticles(
         ...
         this.verticalPosition.getCoordinate($$4.y(), $$4.y() + (double)($$8 / 2.0F), $$8, $$5),
   ...
   public static enum PositionSourceType implements StringRepresentable {
      ...
      BOUNDING_BOX("in_bounding_box", ($$0, $$1, $$2, $$3) -> $$1 + ($$3.nextDouble() - 0.5) * (double)$$2);
      ...
      private PositionSourceType(final String param3, final SpawnParticlesEffect.PositionSourceType.CoordinateSource param4) {
         this.id = $$0;
         this.source = $$1;
      }
