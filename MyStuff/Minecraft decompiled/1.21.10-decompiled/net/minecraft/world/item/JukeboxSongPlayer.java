...
public class JukeboxSongPlayer {
   ...
   public JukeboxSongPlayer(JukeboxSongPlayer.OnSongChanged $$0, BlockPos $$1) {
   ...
   public void setSongWithoutPlaying(Holder<JukeboxSong> $$0, long $$1) {
      if (!((JukeboxSong)$$0.value()).hasFinished($$1)) {
         this.song = $$0;
   ...
   public void play(LevelAccessor $$0, Holder<JukeboxSong> $$1) {
      ...
      int $$2 = $$0.registryAccess().lookupOrThrow(Registries.JUKEBOX_SONG).getId((JukeboxSong)this.song.value());
