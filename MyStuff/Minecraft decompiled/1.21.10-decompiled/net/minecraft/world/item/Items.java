...
public class Items {
   ...
   public static final Item ACACIA_SHELF = registerBlock(
      Blocks.ACACIA_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item BAMBOO_SHELF = registerBlock(
      Blocks.BAMBOO_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item BIRCH_SHELF = registerBlock(
      Blocks.BIRCH_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item CHERRY_SHELF = registerBlock(
      Blocks.CHERRY_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item CRIMSON_SHELF = registerBlock(
      Blocks.CRIMSON_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item DARK_OAK_SHELF = registerBlock(
      Blocks.DARK_OAK_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item JUNGLE_SHELF = registerBlock(
      Blocks.JUNGLE_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item MANGROVE_SHELF = registerBlock(
      Blocks.MANGROVE_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item OAK_SHELF = registerBlock(
      Blocks.OAK_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item PALE_OAK_SHELF = registerBlock(
      Blocks.PALE_OAK_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item SPRUCE_SHELF = registerBlock(
      Blocks.SPRUCE_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item WARPED_SHELF = registerBlock(
      Blocks.WARPED_SHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item CHISELED_BOOKSHELF = registerBlock(
      Blocks.CHISELED_BOOKSHELF, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item TORCH = registerBlock(
      Blocks.TORCH, (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.WALL_TORCH, Direction.DOWN, $$1))
   );
   ...
   public static final Item CHEST = registerBlock(
      Blocks.CHEST, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item FURNACE = registerBlock(
      Blocks.FURNACE, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item CARVED_PUMPKIN = registerBlock(
      ...
      (UnaryOperator<Item.Properties>)($$0 -> Waypoint.addHideAttribute($$0)
            .component(
   ...
   public static final Item SOUL_TORCH = registerBlock(
      Blocks.SOUL_TORCH,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.SOUL_WALL_TORCH, Direction.DOWN, $$1))
   );
   public static final Item COPPER_TORCH = registerBlock(
      Blocks.COPPER_TORCH,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.COPPER_WALL_TORCH, Direction.DOWN, $$1))
   );
   ...
   public static final Item LIGHT = registerBlock(
      Blocks.LIGHT,
      (UnaryOperator<Item.Properties>)($$0 -> $$0.rarity(Rarity.EPIC)
   ...
   public static final Item WHITE_CARPET = registerBlock(
      Blocks.WHITE_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE)))
   );
   public static final Item ORANGE_CARPET = registerBlock(
      Blocks.ORANGE_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE)))
   );
   public static final Item MAGENTA_CARPET = registerBlock(
      Blocks.MAGENTA_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA)))
   );
   public static final Item LIGHT_BLUE_CARPET = registerBlock(
      Blocks.LIGHT_BLUE_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE)))
   );
   public static final Item YELLOW_CARPET = registerBlock(
      Blocks.YELLOW_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW)))
   );
   public static final Item LIME_CARPET = registerBlock(
      Blocks.LIME_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)))
   );
   public static final Item PINK_CARPET = registerBlock(
      Blocks.PINK_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)))
   );
   public static final Item GRAY_CARPET = registerBlock(
      Blocks.GRAY_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)))
   );
   public static final Item LIGHT_GRAY_CARPET = registerBlock(
      Blocks.LIGHT_GRAY_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY)))
   );
   public static final Item CYAN_CARPET = registerBlock(
      Blocks.CYAN_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)))
   );
   public static final Item PURPLE_CARPET = registerBlock(
      Blocks.PURPLE_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE)))
   );
   public static final Item BLUE_CARPET = registerBlock(
      Blocks.BLUE_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)))
   );
   public static final Item BROWN_CARPET = registerBlock(
      Blocks.BROWN_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)))
   );
   public static final Item GREEN_CARPET = registerBlock(
      Blocks.GREEN_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)))
   );
   public static final Item RED_CARPET = registerBlock(
      Blocks.RED_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)))
   );
   public static final Item BLACK_CARPET = registerBlock(
      Blocks.BLACK_CARPET, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK)))
   );
   ...
   public static final Item SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, (UnaryOperator<Item.Properties>)($$0 -> $$0.rarity(Rarity.UNCOMMON)));
   ...
   public static final Item TUBE_CORAL_FAN = registerBlock(
      ...
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item BRAIN_CORAL_FAN = registerBlock(
      Blocks.BRAIN_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item BUBBLE_CORAL_FAN = registerBlock(
      Blocks.BUBBLE_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item FIRE_CORAL_FAN = registerBlock(
      Blocks.FIRE_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item HORN_CORAL_FAN = registerBlock(
      Blocks.HORN_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
      Blocks.DEAD_TUBE_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(
      Blocks.DEAD_BRAIN_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(
      Blocks.DEAD_BUBBLE_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
      Blocks.DEAD_FIRE_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
      Blocks.DEAD_HORN_CORAL_FAN,
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, $$1))
   );
   ...
   public static final Item REDSTONE_TORCH = registerBlock(
      ...
      (BiFunction<Block, Item.Properties, Item>)(($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, $$1))
   );
   ...
   public static final Item HOPPER = registerBlock(
      Blocks.HOPPER, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item DISPENSER = registerBlock(
      Blocks.DISPENSER, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item DROPPER = registerBlock(
      Blocks.DROPPER, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item TRAPPED_CHEST = registerBlock(
      Blocks.TRAPPED_CHEST, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item MINECART = registerItem("minecart", $$0 -> new MinecartItem(EntityType.MINECART, $$0), new Item.Properties().stacksTo(1));
   public static final Item CHEST_MINECART = registerItem(
      "chest_minecart", $$0 -> new MinecartItem(EntityType.CHEST_MINECART, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item FURNACE_MINECART = registerItem(
      "furnace_minecart", $$0 -> new MinecartItem(EntityType.FURNACE_MINECART, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item TNT_MINECART = registerItem(
      "tnt_minecart", $$0 -> new MinecartItem(EntityType.TNT_MINECART, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item HOPPER_MINECART = registerItem(
      "hopper_minecart", $$0 -> new MinecartItem(EntityType.HOPPER_MINECART, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item CARROT_ON_A_STICK = registerItem(
      "carrot_on_a_stick", $$0 -> new FoodOnAStickItem<>(EntityType.PIG, 7, $$0), new Item.Properties().durability(25)
   );
   public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem(
      "warped_fungus_on_a_stick", $$0 -> new FoodOnAStickItem<>(EntityType.STRIDER, 1, $$0), new Item.Properties().durability(100)
   );
   ...
   public static final Item OAK_BOAT = registerItem("oak_boat", $$0 -> new BoatItem(EntityType.OAK_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item OAK_CHEST_BOAT = registerItem(
      "oak_chest_boat", $$0 -> new BoatItem(EntityType.OAK_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item SPRUCE_BOAT = registerItem("spruce_boat", $$0 -> new BoatItem(EntityType.SPRUCE_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item SPRUCE_CHEST_BOAT = registerItem(
      "spruce_chest_boat", $$0 -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item BIRCH_BOAT = registerItem("birch_boat", $$0 -> new BoatItem(EntityType.BIRCH_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item BIRCH_CHEST_BOAT = registerItem(
      "birch_chest_boat", $$0 -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item JUNGLE_BOAT = registerItem("jungle_boat", $$0 -> new BoatItem(EntityType.JUNGLE_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item JUNGLE_CHEST_BOAT = registerItem(
      "jungle_chest_boat", $$0 -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item ACACIA_BOAT = registerItem("acacia_boat", $$0 -> new BoatItem(EntityType.ACACIA_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item ACACIA_CHEST_BOAT = registerItem(
      "acacia_chest_boat", $$0 -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item CHERRY_BOAT = registerItem("cherry_boat", $$0 -> new BoatItem(EntityType.CHERRY_BOAT, $$0), new Item.Properties().stacksTo(1));
   public static final Item CHERRY_CHEST_BOAT = registerItem(
      "cherry_chest_boat", $$0 -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item DARK_OAK_BOAT = registerItem(
      "dark_oak_boat", $$0 -> new BoatItem(EntityType.DARK_OAK_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item DARK_OAK_CHEST_BOAT = registerItem(
      "dark_oak_chest_boat", $$0 -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item PALE_OAK_BOAT = registerItem(
      "pale_oak_boat", $$0 -> new BoatItem(EntityType.PALE_OAK_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item PALE_OAK_CHEST_BOAT = registerItem(
      "pale_oak_chest_boat", $$0 -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item MANGROVE_BOAT = registerItem(
      "mangrove_boat", $$0 -> new BoatItem(EntityType.MANGROVE_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item MANGROVE_CHEST_BOAT = registerItem(
      "mangrove_chest_boat", $$0 -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, $$0), new Item.Properties().stacksTo(1)
   );
   public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", $$0 -> new BoatItem(EntityType.BAMBOO_RAFT, $$0), new Item.Properties().stacksTo(1));
   public static final Item BAMBOO_CHEST_RAFT = registerItem(
      "bamboo_chest_raft", $$0 -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, $$0), new Item.Properties().stacksTo(1)
   );
   ...
   public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", $$0 -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, $$0));
   ...
   public static final Item WOODEN_AXE = registerItem("wooden_axe", $$0 -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, $$0));
   public static final Item WOODEN_HOE = registerItem("wooden_hoe", $$0 -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, $$0));
   public static final Item COPPER_SWORD = registerItem("copper_sword", new Item.Properties().sword(ToolMaterial.COPPER, 3.0F, -2.4F));
   public static final Item COPPER_SHOVEL = registerItem("copper_shovel", $$0 -> new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, $$0));
   ...
   public static final Item COPPER_AXE = registerItem("copper_axe", $$0 -> new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, $$0));
   public static final Item COPPER_HOE = registerItem("copper_hoe", $$0 -> new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, $$0));
   public static final Item STONE_SWORD = registerItem("stone_sword", new Item.Properties().sword(ToolMaterial.STONE, 3.0F, -2.4F));
   public static final Item STONE_SHOVEL = registerItem("stone_shovel", $$0 -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, $$0));
   ...
   public static final Item STONE_AXE = registerItem("stone_axe", $$0 -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, $$0));
   public static final Item STONE_HOE = registerItem("stone_hoe", $$0 -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, $$0));
   public static final Item GOLDEN_SWORD = registerItem("golden_sword", new Item.Properties().sword(ToolMaterial.GOLD, 3.0F, -2.4F));
   public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", $$0 -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, $$0));
   ...
   public static final Item GOLDEN_AXE = registerItem("golden_axe", $$0 -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, $$0));
   public static final Item GOLDEN_HOE = registerItem("golden_hoe", $$0 -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, $$0));
   public static final Item IRON_SWORD = registerItem("iron_sword", new Item.Properties().sword(ToolMaterial.IRON, 3.0F, -2.4F));
   public static final Item IRON_SHOVEL = registerItem("iron_shovel", $$0 -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, $$0));
   public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", new Item.Properties().pickaxe(ToolMaterial.IRON, 1.0F, -2.8F));
   public static final Item IRON_AXE = registerItem("iron_axe", $$0 -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, $$0));
   public static final Item IRON_HOE = registerItem("iron_hoe", $$0 -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, $$0));
   ...
   public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", $$0 -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, $$0));
   ...
   public static final Item DIAMOND_AXE = registerItem("diamond_axe", $$0 -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, $$0));
   public static final Item DIAMOND_HOE = registerItem("diamond_hoe", $$0 -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, $$0));
   ...
   public static final Item NETHERITE_SHOVEL = registerItem(
      "netherite_shovel", $$0 -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, $$0), new Item.Properties().fireResistant()
   );
   ...
   public static final Item NETHERITE_AXE = registerItem(
      "netherite_axe", $$0 -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, $$0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_HOE = registerItem(
      "netherite_hoe", $$0 -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, $$0), new Item.Properties().fireResistant()
   );
   ...
   public static final Item PAINTING = registerItem("painting", $$0 -> new HangingEntityItem(EntityType.PAINTING, $$0));
   ...
   public static final Item OAK_SIGN = registerBlock(
      Blocks.OAK_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.OAK_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item SPRUCE_SIGN = registerBlock(
      Blocks.SPRUCE_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.SPRUCE_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item BIRCH_SIGN = registerBlock(
      Blocks.BIRCH_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.BIRCH_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item JUNGLE_SIGN = registerBlock(
      Blocks.JUNGLE_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.JUNGLE_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item ACACIA_SIGN = registerBlock(
      Blocks.ACACIA_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.ACACIA_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item CHERRY_SIGN = registerBlock(
      Blocks.CHERRY_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.CHERRY_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item DARK_OAK_SIGN = registerBlock(
      Blocks.DARK_OAK_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.DARK_OAK_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item PALE_OAK_SIGN = registerBlock(
      Blocks.PALE_OAK_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.PALE_OAK_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item MANGROVE_SIGN = registerBlock(
      Blocks.MANGROVE_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.MANGROVE_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item BAMBOO_SIGN = registerBlock(
      Blocks.BAMBOO_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.BAMBOO_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item CRIMSON_SIGN = registerBlock(
      Blocks.CRIMSON_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.CRIMSON_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item WARPED_SIGN = registerBlock(
      Blocks.WARPED_SIGN, ($$0, $$1) -> new SignItem($$0, Blocks.WARPED_WALL_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item OAK_HANGING_SIGN = registerBlock(
      Blocks.OAK_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.OAK_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item SPRUCE_HANGING_SIGN = registerBlock(
      Blocks.SPRUCE_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.SPRUCE_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item BIRCH_HANGING_SIGN = registerBlock(
      Blocks.BIRCH_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.BIRCH_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item JUNGLE_HANGING_SIGN = registerBlock(
      Blocks.JUNGLE_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.JUNGLE_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item ACACIA_HANGING_SIGN = registerBlock(
      Blocks.ACACIA_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.ACACIA_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item CHERRY_HANGING_SIGN = registerBlock(
      Blocks.CHERRY_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.CHERRY_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item DARK_OAK_HANGING_SIGN = registerBlock(
      Blocks.DARK_OAK_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.DARK_OAK_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item PALE_OAK_HANGING_SIGN = registerBlock(
      Blocks.PALE_OAK_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.PALE_OAK_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item MANGROVE_HANGING_SIGN = registerBlock(
      Blocks.MANGROVE_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.MANGROVE_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item BAMBOO_HANGING_SIGN = registerBlock(
      Blocks.BAMBOO_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.BAMBOO_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item CRIMSON_HANGING_SIGN = registerBlock(
      Blocks.CRIMSON_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.CRIMSON_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item WARPED_HANGING_SIGN = registerBlock(
      Blocks.WARPED_HANGING_SIGN, ($$0, $$1) -> new HangingSignItem($$0, Blocks.WARPED_WALL_HANGING_SIGN, $$1), new Item.Properties().stacksTo(16)
   );
   public static final Item BUCKET = registerItem("bucket", $$0 -> new BucketItem(Fluids.EMPTY, $$0), new Item.Properties().stacksTo(16));
   public static final Item WATER_BUCKET = registerItem(
      "water_bucket", $$0 -> new BucketItem(Fluids.WATER, $$0), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
   );
   public static final Item LAVA_BUCKET = registerItem(
      "lava_bucket", $$0 -> new BucketItem(Fluids.LAVA, $$0), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
   );
   public static final Item POWDER_SNOW_BUCKET = registerItem(
      "powder_snow_bucket",
      $$0 -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, $$0),
   ...
   public static final Item PUFFERFISH_BUCKET = registerItem(
      "pufferfish_bucket",
      $$0 -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item SALMON_BUCKET = registerItem(
      "salmon_bucket",
      $$0 -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item COD_BUCKET = registerItem(
      "cod_bucket",
      $$0 -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item TROPICAL_FISH_BUCKET = registerItem(
      "tropical_fish_bucket",
      $$0 -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item AXOLOTL_BUCKET = registerItem(
      "axolotl_bucket",
      $$0 -> new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item TADPOLE_BUCKET = registerItem(
      "tadpole_bucket",
      $$0 -> new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, $$0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   ...
   public static final Item EGG = registerItem(
      "egg",
      EggItem::new,
      new Item.Properties().stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>(ChickenVariants.TEMPERATE))
   );
   public static final Item BLUE_EGG = registerItem(
      "blue_egg",
      EggItem::new,
      new Item.Properties().stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>(ChickenVariants.COLD))
   );
   public static final Item BROWN_EGG = registerItem(
      "brown_egg",
      EggItem::new,
      new Item.Properties().stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder<ChickenVariant>(ChickenVariants.WARM))
   );
   ...
   public static final Item WHITE_DYE = registerItem("white_dye", $$0 -> new DyeItem(DyeColor.WHITE, $$0));
   public static final Item ORANGE_DYE = registerItem("orange_dye", $$0 -> new DyeItem(DyeColor.ORANGE, $$0));
   public static final Item MAGENTA_DYE = registerItem("magenta_dye", $$0 -> new DyeItem(DyeColor.MAGENTA, $$0));
   public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", $$0 -> new DyeItem(DyeColor.LIGHT_BLUE, $$0));
   public static final Item YELLOW_DYE = registerItem("yellow_dye", $$0 -> new DyeItem(DyeColor.YELLOW, $$0));
   public static final Item LIME_DYE = registerItem("lime_dye", $$0 -> new DyeItem(DyeColor.LIME, $$0));
   public static final Item PINK_DYE = registerItem("pink_dye", $$0 -> new DyeItem(DyeColor.PINK, $$0));
   public static final Item GRAY_DYE = registerItem("gray_dye", $$0 -> new DyeItem(DyeColor.GRAY, $$0));
   public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", $$0 -> new DyeItem(DyeColor.LIGHT_GRAY, $$0));
   public static final Item CYAN_DYE = registerItem("cyan_dye", $$0 -> new DyeItem(DyeColor.CYAN, $$0));
   public static final Item PURPLE_DYE = registerItem("purple_dye", $$0 -> new DyeItem(DyeColor.PURPLE, $$0));
   public static final Item BLUE_DYE = registerItem("blue_dye", $$0 -> new DyeItem(DyeColor.BLUE, $$0));
   public static final Item BROWN_DYE = registerItem("brown_dye", $$0 -> new DyeItem(DyeColor.BROWN, $$0));
   public static final Item GREEN_DYE = registerItem("green_dye", $$0 -> new DyeItem(DyeColor.GREEN, $$0));
   public static final Item RED_DYE = registerItem("red_dye", $$0 -> new DyeItem(DyeColor.RED, $$0));
   public static final Item BLACK_DYE = registerItem("black_dye", $$0 -> new DyeItem(DyeColor.BLACK, $$0));
   ...
   public static final Item CRAFTER = registerBlock(
      Blocks.CRAFTER, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item BREWING_STAND = registerBlock(
      Blocks.BREWING_STAND, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item HAPPY_GHAST_SPAWN_EGG = registerItem(
   ...
   public static final Item GLOW_SQUID_SPAWN_EGG = registerItem(
      "glow_squid_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.GLOW_SQUID)
   );
   ...
   public static final Item IRON_GOLEM_SPAWN_EGG = registerItem(
      "iron_golem_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.IRON_GOLEM)
   );
   ...
   public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem(
      "magma_cube_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.MAGMA_CUBE)
   );
   ...
   public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.PHANTOM));
   public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.PIG));
   public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.PIGLIN));
   ...
   public static final Item POLAR_BEAR_SPAWN_EGG = registerItem(
      "polar_bear_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.POLAR_BEAR)
   );
   public static final Item PUFFERFISH_SPAWN_EGG = registerItem(
      "pufferfish_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.PUFFERFISH)
   );
   ...
   public static final Item SILVERFISH_SPAWN_EGG = registerItem(
      "silverfish_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.SILVERFISH)
   );
   ...
   public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem(
      "snow_golem_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.SNOW_GOLEM)
   );
   ...
   public static final Item VINDICATOR_SPAWN_EGG = registerItem(
      "vindicator_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.VINDICATOR)
   );
   public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem(
      "wandering_trader_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WANDERING_TRADER)
   );
   public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WARDEN));
   public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WITCH));
   public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WITHER));
   public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem(
      "wither_skeleton_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WITHER_SKELETON)
   );
   public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.WOLF));
   public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.ZOGLIN));
   public static final Item CREAKING_SPAWN_EGG = registerItem("creaking_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.CREAKING));
   public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.ZOMBIE));
   ...
   public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem(
      "zombified_piglin_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(EntityType.ZOMBIFIED_PIGLIN)
   );
   ...
   public static final Item ITEM_FRAME = registerItem("item_frame", $$0 -> new ItemFrameItem(EntityType.ITEM_FRAME, $$0));
   public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", $$0 -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, $$0));
   ...
   public static final Item SKELETON_SKULL = registerBlock(
      ...
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute($$1)),
   ...
   public static final Item WITHER_SKELETON_SKULL = registerBlock(
      ...
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute($$1)),
   ...
   public static final Item PLAYER_HEAD = registerBlock(
      Blocks.PLAYER_HEAD,
      ($$0, $$1) -> new PlayerHeadItem($$0, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute($$1)),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item ZOMBIE_HEAD = registerBlock(
      Blocks.ZOMBIE_HEAD,
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute($$1)),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item CREEPER_HEAD = registerBlock(
      Blocks.CREEPER_HEAD,
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute($$1)),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item DRAGON_HEAD = registerBlock(
      Blocks.DRAGON_HEAD,
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute($$1)),
   ...
   public static final Item PIGLIN_HEAD = registerBlock(
      Blocks.PIGLIN_HEAD,
      ($$0, $$1) -> new StandingAndWallBlockItem($$0, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute($$1)),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   ...
   public static final Item COMMAND_BLOCK_MINECART = registerItem(
      "command_block_minecart", $$0 -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, $$0), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
   );
   ...
   public static final Item WHITE_BANNER = registerBlock(
      Blocks.WHITE_BANNER,
      ($$0, $$1) -> new BannerItem($$0, Blocks.WHITE_WALL_BANNER, $$1),
   ...
   public static final Item BARREL = registerBlock(
      Blocks.BARREL, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item SMOKER = registerBlock(
      Blocks.SMOKER, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item BLAST_FURNACE = registerBlock(
      Blocks.BLAST_FURNACE, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static final Item CAMPFIRE = registerBlock(
      Blocks.CAMPFIRE, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   public static final Item SOUL_CAMPFIRE = registerBlock(
      Blocks.SOUL_CAMPFIRE, (UnaryOperator<Item.Properties>)($$0 -> $$0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
   );
   ...
   public static Item registerBlock(Block $$0, Item.Properties $$1) {
      return registerBlock($$0, BlockItem::new, $$1);
   }

   public static Item registerBlock(Block $$0, UnaryOperator<Item.Properties> $$1) {
      return registerBlock($$0, (BiFunction<Block, Item.Properties, Item>)(($$1x, $$2) -> new BlockItem($$1x, (Item.Properties)$$1.apply($$2))));
   }

   public static Item registerBlock(Block $$0, Block... $$1) {
      Item $$2 = registerBlock($$0);
