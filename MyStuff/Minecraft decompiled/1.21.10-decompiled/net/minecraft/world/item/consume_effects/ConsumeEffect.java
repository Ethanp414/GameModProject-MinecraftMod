...
public interface ConsumeEffect {
   ...
   public static record Type<T extends ConsumeEffect>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
      ...
      private static <T extends ConsumeEffect> ConsumeEffect.Type<T> register(String $$0, MapCodec<T> $$1, StreamCodec<RegistryFriendlyByteBuf, T> $$2) {
         return Registry.register(BuiltInRegistries.CONSUME_EFFECT_TYPE, $$0, new ConsumeEffect.Type<>($$1, $$2));
      }
   }
}
