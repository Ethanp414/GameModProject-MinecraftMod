...
public record RecipeDisplayEntry(
   ...
   public List<ItemStack> resultItems(ContextMap $$0) {
      return this.display.result().resolveForStacks($$0);
   }

   public boolean canCraft(StackedItemContents $$0) {
      return this.craftingRequirements.isEmpty()
         ? false
         : $$0.canCraft((List<? extends StackedContents.IngredientInfo<Holder<Item>>>)this.craftingRequirements.get(), null);
   }
}
