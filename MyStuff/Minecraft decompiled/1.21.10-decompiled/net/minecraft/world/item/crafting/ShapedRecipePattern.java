...
public final class ShapedRecipePattern {
   ...
   public static final MapCodec<ShapedRecipePattern> MAP_CODEC = ShapedRecipePattern.Data.MAP_CODEC
      .flatXmap(
         ...
         $$0 -> (DataResult)$$0.data.map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe"))
      );
      ...
      for(String $$6 : $$1) {
         for(int $$7 = 0; $$7 < $$6.length(); ++$$7) {
            ...
            if ($$8 == ' ') {
               ...
               Ingredient $$10 = (Ingredient)$$0.key.get($$8);
               if ($$10 == null) {
   ...
   static String[] shrink(List<String> $$0) {
      ...
      if ($$0.size() == $$4) {
         ...
         for(int $$9 = 0; $$9 < $$8.length; ++$$9) {
            $$8[$$9] = ((String)$$0.get($$9 + $$3)).substring($$1, $$2 + 1);
         }
   ...
   private boolean matches(CraftingInput $$0, boolean $$1) {
      for(int $$2 = 0; $$2 < this.height; ++$$2) {
         for(int $$3 = 0; $$3 < this.width; ++$$3) {
            ...
            if ($$1) {
               $$4 = (Optional)this.ingredients.get(this.width - $$3 - 1 + $$2 * this.width);
            } else {
               $$4 = (Optional)this.ingredients.get($$3 + $$2 * this.width);
            }
