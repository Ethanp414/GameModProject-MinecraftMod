...
public enum CookingBookCategory implements StringRepresentable {
   ...
   private static final IntFunction<CookingBookCategory> BY_ID = ByIdMap.continuous($$0 -> $$0.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
   ...
   private CookingBookCategory(final int param3, final String param4) {
      this.id = $$0;
      this.name = $$1;
   }
