   ...
   public List<RecipeDisplay> display() {
      return List.of(
         new ShapedCraftingRecipeDisplay(
            this.pattern.width(),
            this.pattern.height(),
            this.pattern.ingredients().stream().map($$0 -> (SlotDisplay)$$0.map(Ingredient::display).orElse(SlotDisplay.Empty.INSTANCE)).toList(),
   ...
   public static class Serializer implements RecipeSerializer<ShapedRecipe> {
      public static final MapCodec<ShapedRecipe> CODEC = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("show_notification", Boolean.valueOf(true)).forGetter($$0x -> $$0x.showNotification)
               )
      ...
      private static ShapedRecipe fromNetwork(RegistryFriendlyByteBuf $$0) {
         ...
         ShapedRecipePattern $$3 = ShapedRecipePattern.STREAM_CODEC.decode($$0);
         ItemStack $$4 = ItemStack.STREAM_CODEC.decode($$0);
