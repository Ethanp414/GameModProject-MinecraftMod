...
public interface RecipeType<T extends Recipe<?>> {
   ...
   static <T extends Recipe<?>> RecipeType<T> register(final String $$0) {
      return Registry.register(BuiltInRegistries.RECIPE_TYPE, ResourceLocation.withDefaultNamespace($$0), new RecipeType<T>() {
