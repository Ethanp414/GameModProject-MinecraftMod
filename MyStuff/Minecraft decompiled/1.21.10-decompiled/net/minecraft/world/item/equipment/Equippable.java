...
public record Equippable(
   ...
   public static final Codec<Equippable> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               Codec.BOOL.optionalFieldOf("equip_on_interact", Boolean.valueOf(false)).forGetter(Equippable::equipOnInteract),
               Codec.BOOL.optionalFieldOf("can_be_sheared", Boolean.valueOf(false)).forGetter(Equippable::canBeSheared),
               SoundEvent.CODEC
   ...
   public static Equippable llamaSwag(DyeColor $$0) {
      return builder(EquipmentSlot.BODY)
         ...
         .setAsset((ResourceKey<EquipmentAsset>)EquipmentAssets.CARPETS.get($$0))
   ...
   public static Equippable harness(DyeColor $$0) {
      ...
      return builder(EquipmentSlot.BODY)
         ...
         .setAsset((ResourceKey<EquipmentAsset>)EquipmentAssets.HARNESSES.get($$0))
   ...
   public InteractionResult swapWithEquipmentSlot(ItemStack $$0, Player $$1) {
      if ($$1.canUseSlot(this.slot) && this.canBeEquippedBy($$1.getType())) {
         ...
         if ((!EnchantmentHelper.has($$2, EnchantmentEffectComponents.PREVENT_ARMOR_CHANGE) || $$1.isCreative())
            && !ItemStack.isSameItemSameComponents($$0, $$2)) {
   ...
   public boolean canBeEquippedBy(EntityType<?> $$0) {
      return this.allowedEntities.isEmpty() || ((HolderSet)this.allowedEntities.get()).contains($$0.builtInRegistryHolder());
   }
   ...
   public static class Builder {
      ...
      public Equippable.Builder setCameraOverlay(ResourceLocation $$0) {
