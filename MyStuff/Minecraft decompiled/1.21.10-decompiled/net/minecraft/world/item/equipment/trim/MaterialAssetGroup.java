...
public record MaterialAssetGroup(MaterialAssetGroup.AssetInfo base, Map<ResourceKey<EquipmentAsset>, MaterialAssetGroup.AssetInfo> overrides) {
   ...
   public static MaterialAssetGroup create(String $$0) {
      return new MaterialAssetGroup(new MaterialAssetGroup.AssetInfo($$0), Map.of());
   }

   public static MaterialAssetGroup create(String $$0, Map<ResourceKey<EquipmentAsset>, String> $$1) {
      return new MaterialAssetGroup(new MaterialAssetGroup.AssetInfo($$0), Map.copyOf(Maps.transformValues($$1, MaterialAssetGroup.AssetInfo::new)));
   }

   public MaterialAssetGroup.AssetInfo assetId(ResourceKey<EquipmentAsset> $$0) {
      return (MaterialAssetGroup.AssetInfo)this.overrides.getOrDefault($$0, this.base);
   }
