...
public interface EquipmentAssets {
   ...
   Map<DyeColor, ResourceKey<EquipmentAsset>> CARPETS = Util.makeEnumMap(DyeColor.class, $$0 -> createId($$0.getSerializedName() + "_carpet"));
   ResourceKey<EquipmentAsset> TRADER_LLAMA = createId("trader_llama");
   Map<DyeColor, ResourceKey<EquipmentAsset>> HARNESSES = Util.makeEnumMap(DyeColor.class, $$0 -> createId($$0.getSerializedName() + "_harness"));
