...
public class InstrumentItem extends Item {
   ...
   public InteractionResult use(Level $$0, Player $$1, InteractionHand $$2) {
      ...
      Optional<? extends Holder<Instrument>> $$4 = this.getInstrument($$3, $$1.registryAccess());
      if ($$4.isPresent()) {
   ...
   public int getUseDuration(ItemStack $$0, LivingEntity $$1) {
      Optional<Holder<Instrument>> $$2 = this.getInstrument($$0, $$1.registryAccess());
      return $$2.map($$0x -> Mth.floor(((Instrument)$$0x.value()).useDuration() * 20.0F)).orElse(0);
   }
