...
public class BundleItem extends Item {
   ...
   public static ItemStack getSelectedItemStack(ItemStack $$0) {
      BundleContents $$1 = $$0.get(DataComponents.BUNDLE_CONTENTS);
      return $$1 != null && $$1.getSelectedItem() != -1 ? $$1.getItemUnsafe($$1.getSelectedItem()) : ItemStack.EMPTY;
   }
   ...
   private boolean dropContent(ItemStack $$0, Player $$1) {
      BundleContents $$2 = $$0.get(DataComponents.BUNDLE_CONTENTS);
      if ($$2 != null && !$$2.isEmpty()) {
         Optional<ItemStack> $$3 = removeOneItemFromBundle($$0, $$1, $$2);
         if ($$3.isPresent()) {
            $$1.drop((ItemStack)$$3.get(), true);
            return true;
         } else {
            return false;
         }
   ...
   public Optional<TooltipComponent> getTooltipImage(ItemStack $$0) {
      ...
      return !$$1.shows(DataComponents.BUNDLE_CONTENTS)
         ? Optional.empty()
         : Optional.ofNullable($$0.get(DataComponents.BUNDLE_CONTENTS)).map(BundleTooltip::new);
   }
