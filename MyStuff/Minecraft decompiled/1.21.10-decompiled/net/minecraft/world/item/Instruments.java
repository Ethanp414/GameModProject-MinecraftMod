...
public interface Instruments {
   ...
   static void bootstrap(BootstrapContext<Instrument> $$0) {
   ...
   static void register(BootstrapContext<Instrument> $$0, ResourceKey<Instrument> $$1, Holder<SoundEvent> $$2, float $$3, float $$4) {
