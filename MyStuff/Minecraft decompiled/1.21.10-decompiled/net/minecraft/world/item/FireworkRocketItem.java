...
public class FireworkRocketItem extends Item implements ProjectileItem {
         ...
         if ($$1 instanceof ServerLevel $$3) {
            ...
            Projectile.spawnProjectile(
               new FireworkRocketEntity(
                  $$1,
                  $$0.getPlayer(),
                  $$5.x + (double)$$6.getStepX() * 0.15,
                  $$5.y + (double)$$6.getStepY() * 0.15,
                  $$5.z + (double)$$6.getStepZ() * 0.15,
                  $$4
               ),
               $$3,
               $$4
   ...
   private static Vec3 getEntityJustOutsideOfBlockPos(BlockSource $$0, Direction $$1) {
      return $$0.center()
         .add((double)$$1.getStepX() * 0.5000099999997474, (double)$$1.getStepY() * 0.5000099999997474, (double)$$1.getStepZ() * 0.5000099999997474);
   }
}
