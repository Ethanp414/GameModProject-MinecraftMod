...
public class Potions {
   ...
   public static final Holder<Potion> STRONG_SWIFTNESS = register(
      "strong_swiftness", new Potion("swiftness", new MobEffectInstance(MobEffects.SPEED, 1800, 1))
   );
   ...
   public static final Holder<Potion> STRONG_HEALING = register(
      "strong_healing", new Potion("healing", new MobEffectInstance(MobEffects.INSTANT_HEALTH, 1, 1))
   );
   ...
   public static final Holder<Potion> STRONG_HARMING = register(
      "strong_harming", new Potion("harming", new MobEffectInstance(MobEffects.INSTANT_DAMAGE, 1, 1))
   );
   ...
   public static final Holder<Potion> STRONG_STRENGTH = register(
      "strong_strength", new Potion("strength", new MobEffectInstance(MobEffects.STRENGTH, 1800, 1))
   );
