...
public class ShovelItem extends Item {
   ...
   public InteractionResult useOn(UseOnContext $$0) {
      ...
      if ($$0.getClickedFace() == Direction.DOWN) {
         ...
         BlockState $$5 = (BlockState)FLATTENABLES.get($$3.getBlock());
         BlockState $$6 = null;
         if ($$5 != null && $$1.getBlockState($$2.above()).isAir()) {
            $$1.playSound($$4, $$2, SoundEvents.SHOVEL_FLATTEN, SoundSource.BLOCKS, 1.0F, 1.0F);
            $$6 = $$5;
         } else if ($$3.getBlock() instanceof CampfireBlock && $$3.getValue(CampfireBlock.LIT)) {
            if (!$$1.isClientSide()) {
               $$1.levelEvent(null, 1009, $$2, 0);
            }

            CampfireBlock.dowse($$0.getPlayer(), $$1, $$2, $$3);
            $$6 = $$3.setValue(CampfireBlock.LIT, Boolean.valueOf(false));
         }
