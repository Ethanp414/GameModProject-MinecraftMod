...
public class MerchantOffer {
   public static final Codec<MerchantOffer> CODEC = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               ItemStack.CODEC.fieldOf("sell").forGetter($$0x -> $$0x.result),
               Codec.INT.lenientOptionalFieldOf("uses", Integer.valueOf(0)).forGetter($$0x -> $$0x.uses),
               Codec.INT.lenientOptionalFieldOf("maxUses", Integer.valueOf(4)).forGetter($$0x -> $$0x.maxUses),
               Codec.BOOL.lenientOptionalFieldOf("rewardExp", Boolean.valueOf(true)).forGetter($$0x -> $$0x.rewardExp),
               Codec.INT.lenientOptionalFieldOf("specialPrice", Integer.valueOf(0)).forGetter($$0x -> $$0x.specialPriceDiff),
               Codec.INT.lenientOptionalFieldOf("demand", Integer.valueOf(0)).forGetter($$0x -> $$0x.demand),
               Codec.FLOAT.lenientOptionalFieldOf("priceMultiplier", Float.valueOf(0.0F)).forGetter($$0x -> $$0x.priceMultiplier),
               Codec.INT.lenientOptionalFieldOf("xp", Integer.valueOf(1)).forGetter($$0x -> $$0x.xp)
            )
   ...
   public boolean satisfiedBy(ItemStack $$0, ItemStack $$1) {
      if (!this.baseCostA.test($$0) || $$0.getCount() < this.getModifiedCostCount(this.baseCostA)) {
         ...
         return ((ItemCost)this.costB.get()).test($$1) && $$1.getCount() >= ((ItemCost)this.costB.get()).count();
      }
   }
   ...
   public static MerchantOffer createFromStream(RegistryFriendlyByteBuf $$0) {
      ...
      ItemStack $$2 = ItemStack.STREAM_CODEC.decode($$0);
      Optional<ItemCost> $$3 = (Optional)ItemCost.OPTIONAL_STREAM_CODEC.decode($$0);
