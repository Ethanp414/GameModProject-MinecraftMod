...
public class DibsModel extends EntityModel<DibsRenderState>
{
    //WILL BE CHANGED TO USE THE MODEL FROM BLOCKBENCH

    // Storing specific model parts as fields for use below.
    private final ModelPart head;

	protected DibsModel(ModelPart root) 
	{
		super(root);
    ...
    @Override
    public void setupAnim(DibsRenderState state) {
