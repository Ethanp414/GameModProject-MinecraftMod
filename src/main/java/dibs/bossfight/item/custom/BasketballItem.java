...
public class BasketballItem extends Item implements ProjectileItem {
   ...
   public BasketballItem(Item.Properties $$0) {
      super($$0);
   }
   ...
   public InteractionResult use(Level $$0, Player $$1, InteractionHand $$2) {
      ...
      if ($$0 instanceof ServerLevel $$4) {
         Projectile.spawnProjectileFromRotation(BasketballProjectileEntity::new, $$4, $$3, $$1, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F);
      }
   ...
   public Projectile asProjectile(Level $$0, Position $$1, ItemStack $$2, Direction $$3) {
      return new BasketballProjectileEntity($$0, $$1.x(), $$1.y(), $$1.z(), $$2);
   }
}
